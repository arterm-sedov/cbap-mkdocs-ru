...
- Расширенный фильтр комбинируется с уже применёнными [фильтрами в таблице](https://kb.comindware.ru/article.php?id=4815#table_personal_use_filter).
...
- *[Настройка представления карточек](https://kb.comindware.ru/article.php?id=4799)*
