...
**Функции** предназначены для использования в действии «[**Задача-вызов сервиса**](https://kb.comindware.ru/article.php?id=4729)».

Примечание

Создание новых функций в **Comindware Platform** версии 5 не предусмотрено, возможно только редактировать имеющиеся функции.

Вместо функций рекомендуется использовать [**сценарии**](https://kb.comindware.ru/article.php?id=4717).

## Просмотр полного списка функций

1. На странице [«**Администрирование**»](https://kb.comindware.ru/article.php?id=4661) в разделе «**Архитектура**» выберите пункт «**Функции**» *‌*.
2. Отобразится список функций в составе всех приложений.

_![Список функций во всех приложениях](/platform/v5.0/administration/architecture/img/functions_page.png)_

## Просмотр списка функций для приложения

1. В разделе «[**Администрирование**](https://kb.comindware.ru/article.php?id=4714)» приложения выберите пункт «**Функции**» *‌*.
2. Отобразится список функций в составе данного приложения.

_![Список функций в одном приложении](/platform/v5.0/administration/architecture/img/functions_business_app_page.png)_
...
_![Настройка глобальной функции](/platform/v5.0/administration/architecture/img/functions_create.png)_
