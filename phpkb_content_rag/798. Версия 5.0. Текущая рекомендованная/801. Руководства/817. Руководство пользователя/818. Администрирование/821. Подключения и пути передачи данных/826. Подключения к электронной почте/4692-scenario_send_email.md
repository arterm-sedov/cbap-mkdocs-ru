...
kbId: 4692
url: 'https://kb.comindware.ru/article.php?id=4692'
updated: '2024-10-30 19:43:56'
---
...
В **Comindware Platform** можно настроить отправку эл. почты из [сценариев](https://kb.comindware.ru/article.php?id=4717). При этом письма могут содержать данные из шаблонов, в том числе вложенные файлы.

Для отправки эл. почты с помощью сценариев используются подключения типов «**Отправка эл. почты через SMTP**» и «**Отправка эл. почты через Exchange**». В [процессах](https://kb.comindware.ru/article.php?id=4721) используются подключения типа «**[Отправка эл. почты из процесса](https://kb.comindware.ru/article.php?id=4690)**».
...
Сценарий для отправки почты можно запускать по любому **[событию](https://kb.comindware.ru/article.php?id=4718)**:
