...
2. В [меню элемента](https://kb.comindware.ru/article.php?id=4721#mcetoc_1h28cr6421) события нажмите кнопку «**Свойства**» *‌*.
...
5. На вкладке «**Данные сообщения**» сопоставьте **[атрибуты сообщения](#атрибуты-сообщения)** с атрибутами **[шаблона записи](https://kb.comindware.ru/article.php?id=4759)**, связанного с шаблоном процесса, к которому относится диаграмма.
