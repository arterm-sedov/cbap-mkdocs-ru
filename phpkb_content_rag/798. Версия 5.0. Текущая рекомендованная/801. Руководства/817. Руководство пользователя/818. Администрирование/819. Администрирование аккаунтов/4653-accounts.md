...
- создание аккаунтов;
- объединение аккаунтов в [группы](https://kb.comindware.ru/article.php?id=4654);
...
Администраторы, в свою очередь, имеют различные [**системные роли**](https://kb.comindware.ru/article.php?id=4662). Максимальным доступом обладают системные администраторы: им доступны все действия в Системе, поскольку для них не выполняются проверки прав доступа.

Обычные пользователи нетипизированы и равноправны. Доступные им возможности при работе с Системой определяются правами в соответствии с назначенными [**ролями**](https://kb.comindware.ru/article.php?id=4803).
...
- **Настройка через API**
  ...
  См. *«[Методы System Core API](https://kb.comindware.ru/article.php?id=4862#api_system_core_account)»*.
- **Синхронизация с сервером каталогов** — **на стороне сервера каталогов** необходимо задать значения следующих атрибутов (они не должны быть пустыми и не должны иметь значение `Null`):
  ...
  См. *«[Синхронизация с сервером каталогов (Active Directory)](https://kb.comindware.ru/article.php?id=4655)»*.

## Просмотр списка, создание и настройка аккаунтов

1. На странице «[**Администрирование**](https://kb.comindware.ru/article.php?id=4661)» в разделе — «**Администрирование аккаунтов**» выберите пункт «**Аккаунты**» *‌*.
...
См. *«[Замещения. Настройка конфигурации](https://kb.comindware.ru/article.php?id=4665#substitution_configuration)»*.

Замещение позволяет на заданный период времени назначить вместо аккаунта другие аккаунты в качестве [исполнителей пользовательских задач](https://kb.comindware.ru/article.php?id=4730) и передать им определённые [системные роли](https://kb.comindware.ru/article.php?id=4662) и [роли в приложении](https://kb.comindware.ru/article.php?id=4803). См. *«[Замещения. Создание, настройка, удаление](https://kb.comindware.ru/article.php?id=4665)»*.

Здесь представлены инструкции по настройке замещений с помощью страницы «**Администрирование**» — «**Аккаунты**».

Если у пользователя есть разрешение на просмотр аккаунтов (заданное с помощью [системной роли](https://kb.comindware.ru/article.php?id=4662)), то он сможет аналогичным образом настроить для себя замещение на странице «**Мой аккаунт**».
...
Для каждого аккаунта в системе можно настроить индивидуальные учётные данные, которые будут использоваться для подключений к внешним сервисам. См. раздел «**[Подключения](https://kb.comindware.ru/article.php?id=4675)**».
...
Чтобы добавить аккаунту дополнительные атрибуты, изначально не предусмотренные в **Comindware Platform**, его следует привязать к [шаблону аккаунта](https://kb.comindware.ru/article.php?id=4757).
...
Подробные сведения о лицензировании **Comindware Platform** см. в разделе «**[Лицензирование»](https://kb.comindware.ru/article.php?id=4670)**.
...
Архивные аккаунты не будут отображаться для включения в [groups](https://kb.comindware.ru/article.php?id=4654), в [списках аккаунтов](https://kb.comindware.ru/article.php?id=4785#form_dynamic_elements_account) на формах, а также в раскрывающихся списках при назначении [исполнителей пользовательских задач](https://kb.comindware.ru/article.php?id=4730).
...
- [Лицензирование. Активация продукта, использование ключей, назначение, отзыв и продление лицензий](https://kb.comindware.ru/article.php?id=4670)
...
- [Настройка поля атрибута типа «Дата и время» на форме](https://kb.comindware.ru/article.php?id=4785)
- [Глобальная конфигурация](https://kb.comindware.ru/article.php?id=4668)
- [Методы System Core API](https://kb.comindware.ru/article.php?id=4862#api_system_core_account)
