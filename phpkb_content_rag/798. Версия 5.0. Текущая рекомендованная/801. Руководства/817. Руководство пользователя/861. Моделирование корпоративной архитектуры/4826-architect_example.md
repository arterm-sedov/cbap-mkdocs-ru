...
_![Настройка раздела навигации для использования модуля «Корпоративная архитектура»](/platform/v5.0/architect/img/architect_example_navigation_configure.png)_
...
«**Корпоративная архитектура**» позволяет [импортировать](https://kb.comindware.ru/article.php?id=4832#architect_importing_process_entity) готовые диаграммы процессов в формате BPMN, редактировать и использовать их для моделирования архитектуры своего предприятия.
...
10. Поэкспериментируйте с готовыми диаграммами: [отредактируйте](https://kb.comindware.ru/article.php?id=4835), используйте их в новой или имеющейся [группе процессов](#создание-групп-процессов).
