...
См. также статью *«[Представление атрибута «Изображение» на форме](https://kb.comindware.ru/article.php?id=4785#mcetoc_1hkh14toi1 "Представление атрибута «Изображение» на форме")»*.
...
**[Представление атрибута «Изображение» на форме](https://kb.comindware.ru/article.php?id=4785#mcetoc_1hkh14toi1 "Представление атрибута «Изображение» на форме")**
