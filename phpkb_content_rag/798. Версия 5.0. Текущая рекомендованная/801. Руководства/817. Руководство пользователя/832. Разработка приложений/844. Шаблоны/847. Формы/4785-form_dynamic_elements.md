...
kbId: 4785
url: 'https://kb.comindware.ru/article.php?id=4785'
...
**Динамические элементы** формы — это поля атрибутов, кнопки и вложенные формы, вынесенные на форму. Их представление настраивается с помощью [конструктора формы](https://kb.comindware.ru/article.php?id=4786) и [правил для формы](https://kb.comindware.ru/article.php?id=4784) и формируется для пользователя на основе данных, отображающихся в форме.

- **[Поля атрибутов](#настройка-полей-атрибутов)** — при перетаскивании атрибута на форму создаётся поле, представление которого зависит от [типа атрибута](https://kb.comindware.ru/article.php?id=4772).
- [**Вложенные формы**](#form_dynamic_elements_embedded_form) — вложенные формы можно поместить на форму и на **[вкладки](https://kb.comindware.ru/article.php?id=4787#form_static_elements_tabs)**. Это позволяет повторно использовать формы в качестве стандартных блоков.
- **Кнопки** — кнопки можно поместить в области кнопок, которые предусмотрены у формы, областей формы, таблиц и вкладок. См. *«[Настройка области кнопок](https://kb.comindware.ru/article.php?id=4791#button_area_configure)»* и *«[Настройка кнопки](https://kb.comindware.ru/article.php?id=4790)».*

## Настройка полей атрибутов

1. Откройте [конструктор формы](https://kb.comindware.ru/article.php?id=4786).
2. Выберите атрибут на макете формы или перетащите атрибут из панели элементов внутрь [области](https://kb.comindware.ru/article.php?id=4787#form_static_elements_area), [вкладки](https://kb.comindware.ru/article.php?id=4787#form_static_elements_tabs) или [колонки](https://kb.comindware.ru/article.php?id=4787#form_static_elements_columns).
...
- **Системное имя** — уникальное имя поля в рамках текущей формы, используемое для настройки [правил для формы](https://kb.comindware.ru/article.php?id=4784).
...
- **Доступ** — режим доступа к данным атрибута и отображения поля:
  ...
  - **Скрыть** — поле не будет отображаться на форме. Показать скрытое поле можно с помощью [правил для формы](https://kb.comindware.ru/article.php?id=4784).
...
Представление этого поля на форме определяется свойствами поля и **допустимыми схемами URI**, заданными в [свойствах атрибута](https://kb.comindware.ru/article.php?id=4766).
...
Представление поля атрибута типа «**Длительность**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=4775).
...
Представление поля атрибута типа «**Документ**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=4782), см. примеры на иллюстрациях ниже.
...
Представление поля атрибута типа «**Изображение**» на форме определяется сочетанием свойств поля и [свойств атрибута](https://kb.comindware.ru/article.php?id=4771).
...
Представление поля атрибута типа «**Запись**» на форме определяется сочетанием свойств поля и [свойств атрибута](https://kb.comindware.ru/article.php?id=4780).
...
- **Представление** — выберите представление поля на форме:
  ...
  - **Диаграмма Ганта** — [настройте диаграмму Ганта](https://kb.comindware.ru/article.php?id=4891);
...
Сведения о настройке форм поиска см. в статье *«[Расширенная фильтрация. Настройка форм поиска](https://kb.comindware.ru/article.php?id=5069)»*.
...
2. Задайте значения атрибутов, по которым следует отфильтровать список.
   ...
   - Фильтрация настраивается также, как для столбцов таблицы. См. *«[Настройка фильтрации](https://kb.comindware.ru/article.php?id=4815#table_personal_use_filter)»*.
...
- **Карточки** — выберите [представление карточек](https://kb.comindware.ru/article.php?id=4799), которое требуется использовать для таблицы.
- **Фильтр**
...
См. также статьи *«[Шевроны. Правила окрашивания. Пример настройки](https://kb.comindware.ru/article.php?id=4890)»* и *«[Шевроны. Визуализация этапов процесса. Пример настройки](https://kb.comindware.ru/article.php?id=4915)»*.
...
Подробные сведения см. в статьях *«[Диаграмма Ганта. Настройка](https://kb.comindware.ru/article.php?id=4891)»* и *«[Диаграмма Ганта. Использование](https://kb.comindware.ru/article.php?id=4817)»*.
...
Подробные сведения см. в статьях *«[Карты. Настройка](https://kb.comindware.ru/article.php?id=4679)»* и *«[Карты. Использование](https://kb.comindware.ru/article.php?id=4814)»*.
...
Представление поля «**Обсуждения**» на формах определяется сочетанием свойств поля и [свойств шаблона](https://kb.comindware.ru/article.php?id=4788#mcetoc_1h7hu3akn4).  См. статью *«[Настройка обсуждений](https://kb.comindware.ru/article.php?id=4788)»*.
...
Подробные сведения см. в статье *«[Использование обсуждения](https://kb.comindware.ru/article.php?id=4818)»*.

1. Поместите на неё поле «**Обсуждение**».
2. При необходимости настройте быстрые ответы, см. *«[Настройка быстрых ответов](https://kb.comindware.ru/article.php?id=4788#discussion_configure_quick_answers)»*.
...
- **Представление** — выберите способ отображения поля на форме:
  ...
  - **Диаграмма** — поле будет отображаться в виде диаграммы экземпляра процесса, связанного с текущей записью (если не задан **фильтр**), или экземпляра процесса, ID которого вернул **фильтр**. См. статью *«[Просмотр диаграммы процесса](https://kb.comindware.ru/article.php?id=4721)»*.
  - **Таблица** — поле будет отображаться в виде таблицы со списком экземпляров процесса, связанных с текущей записью (если не задан **фильтр**), или экземпляров процесса, ID которых вернул **фильтр**. В таблице связанных процессов предусмотрены следующие столбцы:
    ...
    - **Название экземпляра процесса** — гиперссылка на экземпляр процесса, см. статью *«[Использование диаграммы экземпляра процесса](https://kb.comindware.ru/article.php?id=4723)»*;
    ...
    - **Задачи** — гиперссылки на [пользовательские задачи](https://kb.comindware.ru/article.php?id=4730) по процессу, назначенные исполнителям.
...
Представление поля атрибута типа «**Список значений**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=4779).

У этого поля предусмотрены только [общие свойства](#общие-свойства-полей).

См. также статьи *«[Атрибут типа «Список значений». Вычисление значения по справочнику](https://kb.comindware.ru/article.php?id=4916)» и «[Атрибут типа «Список значений». Вычисление текущего значения](https://kb.comindware.ru/article.php?id=4913)»* .
...
Представление поля атрибута типа «**Роль**» на форме определяется сочетанием свойств поля и [свойств атрибута](https://kb.comindware.ru/article.php?id=4783).
...
Представление поля атрибута типа «**Текст**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=4768).
...
Сведения о настройке и пример использования **форматов отображения** с **масками ввода** см. в статье [*«Атрибут типа «Текст»*](https://kb.comindware.ru/article.php?id=4768).
...
Представление поля системного [атрибута «**Цвет**»](https://kb.comindware.ru/article.php?id=4763) на форме определяется свойствами поля.
...
По умолчанию сектора диаграмм окрашиваются цветами, заданными в разделе «**[Цвета графиков и диаграмм](https://kb.comindware.ru/article.php?id=4708#themes_graphic_diagram_color)**» в текущей **теме**.
...
Подробные сведения см. в статьях *«[Чертёж. Подготовка и импорт файла DWG](https://kb.comindware.ru/article.php?id=4906)»* и *«[Чертёж. Настройка](https://kb.comindware.ru/article.php?id=4761)»*.
...
- **Маркеры**
  ...
  - **Таблица** — выберите таблицу, которая будет отображаться на вкладке «**Заявки**» слева от плана. Если для таблицы назначено [представление карточек](https://kb.comindware.ru/article.php?id=4799), то оно будет отображаться вместо таблицы.
...
Представление поля атрибута типа «**Число**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=4773).
...
Представление поля атрибута типа «**Штрихкод**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=4764).
...
- **Системное имя** — уникальное имя вложенной формы в рамках текущей формы, используемое для настройки [правил для формы](https://kb.comindware.ru/article.php?id=4784).
  Не должно начинаться с цифры. Разрешены английские и русские буквы, цифры и символ «\_». Рекомендуется использовать английские буквы.
  Обычно заполняется автоматически по названию.
...
- **Доступ** — режим доступа к данным на вложенной форме и её отображения:
  ...
  - **Скрыть** — вложенная форма не будет отображаться на текущей форме. Показать скрытую вложенную форму можно с помощью [правил для формы](https://kb.comindware.ru/article.php?id=4784).
...
- *[Статические элементы формы: области, вкладки, колонки, статичный текст. Настройка представления](https://kb.comindware.ru/article.php?id=4787)*
...
- *[Расширенная фильтрация. Настройка форм поиска](https://kb.comindware.ru/article.php?id=5069)*
