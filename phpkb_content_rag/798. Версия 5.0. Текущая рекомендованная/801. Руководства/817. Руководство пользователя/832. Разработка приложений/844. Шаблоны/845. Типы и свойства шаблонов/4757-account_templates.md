...
**Шаблон аккаунта** — это специальный [шаблон записи](https://kb.comindware.ru/article.php?id=4759), в котором хранятся особые атрибуты аккаунтов.
...
В карточке аккаунта на странице [«**Администрирование**» — «**Аккаунты**»](https://kb.comindware.ru/article.php?id=4653) отображаются данные из *системного шаблона аккаунта*.

См. *«[Системные атрибуты шаблона аккаунта](#account_template_attribute_system_names)»*.

Примечание

- Для того чтобы шаблон аккаунта применялся к аккаунтам и группам, их следует к нему привязать. См. раздел «**[Привязка аккаунта к шаблону аккаунта](https://kb.comindware.ru/article.php?id=4653#accounts_link_to_template)**»
- Шаблон аккаунта можно связать с атрибутом типа «**[Аккаунт](https://kb.comindware.ru/article.php?id=4774)**».

## Свойства шаблона аккаунта

У шаблона аккаунта предусмотрены только [общие свойства](https://kb.comindware.ru/article.php?id=4756).
...
Подробности см. в параграфе *«[Обязательные атрибуты и уникальность аккаунтов](https://kb.comindware.ru/article.php?id=4653#accounts_required_unique)»*.
