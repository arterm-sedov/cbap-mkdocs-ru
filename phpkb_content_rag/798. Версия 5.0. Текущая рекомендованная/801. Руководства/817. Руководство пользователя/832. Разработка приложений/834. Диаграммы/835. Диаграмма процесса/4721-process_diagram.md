...
3. Отобразится диаграмма процесса в режиме просмотра со следующими кнопками:
   ...
   **(1)** Операций с диаграммой
   ...
   - **Выбрать версию** — [управление опубликованными версиями](https://kb.comindware.ru/article.php?id=4722) диаграммы процесса.
...
- **Восстановить** — [восстановление](https://kb.comindware.ru/article.php?id=4722) опубликованной версии диаграммы процесса.
...
**(2) Панель элементов** — содержит [элементы](https://kb.comindware.ru/article.php?id=4724), которые можно перетащить на диаграмму процесса.

**(3) Панель свойств элемента** — отображается, когда выбран элемент диаграммы и содержит [общие свойства элемента](https://kb.comindware.ru/article.php?id=4725):
