...
kbId: 4723
url: 'https://kb.comindware.ru/article.php?id=4723'
...
3. Откройте [список версий](https://kb.comindware.ru/article.php?id=4722) диаграммы процесса.
...
2. **Сведения об экземпляре процесса**
   ...
   - **Свойства** — контекст экземпляра процесса:
     ...
     - **Версия** — ссылка на версию диаграммы, по которой был запущен экземпляр процесса.
       См. *«[Управление версиями диаграммы процесса](https://kb.comindware.ru/article.php?id=4722)»*.
