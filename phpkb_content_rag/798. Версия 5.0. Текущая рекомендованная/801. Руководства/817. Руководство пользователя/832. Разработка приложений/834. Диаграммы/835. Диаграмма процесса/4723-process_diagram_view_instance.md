...
2. **Сведения об экземпляре процесса**
   ...
   - **Свойства** — контекст экземпляра процесса:
     ...
     - **Версия** — ссылка на версию диаграммы, по которой был запущен экземпляр процесса. См. *«[Управление версиями диаграммы процесса](https://kb.comindware.ru/article.php?id=4722)»*.
