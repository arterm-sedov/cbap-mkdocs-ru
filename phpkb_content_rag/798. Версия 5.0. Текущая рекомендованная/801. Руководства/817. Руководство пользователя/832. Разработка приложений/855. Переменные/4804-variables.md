...
Например, с их помощью можно настроить автонумерацию записей, см. *[«Автонумерация записей с помощью формулы, C#-скрипта или выражения N3»](https://kb.comindware.ru/article.php?id=4895)*.

Помимо переменных приложения в **Comindware Platform** имеются системные и локальные переменные, которые применяются в сценариях, см. подробнее *[«Использование переменных в сценарии»](https://kb.comindware.ru/article.php?id=4719)*.
...
1. На странице «**[Администрирование](https://kb.comindware.ru/article.php?id=4714)**» приложения выберите пункт «**Переменные**» *‌*.
