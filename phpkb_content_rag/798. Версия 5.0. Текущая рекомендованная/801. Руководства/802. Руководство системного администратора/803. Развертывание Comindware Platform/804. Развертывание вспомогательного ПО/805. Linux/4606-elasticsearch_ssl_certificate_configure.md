...
Для работы ПО **Comindware Platform** требуется сервер Elasticsearch версии не ниже 8.1.0.
...
Дальнейшие инструкции предполагают, что служба Elasticsearch развёрнута согласно инструкциям в статье «**[Установка и настройка Elasticsearch без сертификатов подлинности](https://kb.comindware.ru/article.php?id=4612)**» на виртуальных машинах с ОС Ubuntu 22.04.4 LTS.
