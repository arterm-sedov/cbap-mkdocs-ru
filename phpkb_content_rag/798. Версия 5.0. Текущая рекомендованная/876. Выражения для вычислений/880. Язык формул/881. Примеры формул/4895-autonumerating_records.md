...
- Для нумерации имеющихся и новых записей с учётом их удаления см. *[пример настройки автонумерации записей с пересчётом при удалении](https://kb.comindware.ru/article.php?id=5092)*.
...
- *[Автонумерация записей с пересчётом при удалении](https://kb.comindware.ru/article.php?id=5092)*
