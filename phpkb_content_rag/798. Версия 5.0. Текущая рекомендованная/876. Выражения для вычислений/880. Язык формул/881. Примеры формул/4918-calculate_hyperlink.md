...
- к основной форме любой записи (см. *[Настройка свойств формы](https://kb.comindware.ru/article.php?id=4786#mcetoc_1gk3dol903)*);
- к определённой форме конкретной записи;
- к форме пользовательской задачи (см. [Пользовательская задача](https://kb.comindware.ru/article.php?id=4730), *[Редактирование формы пользовательской задачи](https://kb.comindware.ru/article.php?id=4726#mcetoc_1h2b5hqtl1)**)*;
- к диаграмме экземпляра бизнес-процесса (см.*`![](https://kb.comindware.ru/images/marker.png)Использование диаграммы экземпляра процесса {Article-ID:4723}`).*
...
Для записи универсальная ссылка всегда ведёт на основную форму шаблона, то есть форму, в свойствах которой установлен флажок «**По умолчанию**». См. *[Настройка свойств формы](https://kb.comindware.ru/article.php?id=4786#mcetoc_1gk3dol903).*
...
11. Настройте [подключение к SMTP-серверу](https://kb.comindware.ru/article.php?id=4692) с названием *«Системное уведомление»*.
12. Настройте [путь передачи данных для отправки эл. почты из процесса](https://kb.comindware.ru/article.php?id=4690#mcetoc_1h2t519lb2):
    - **Основные свойства**
...
4. Перейдите по ссылке, просмотрите диаграмму, попробуйте остановить процесс или перезапустить его. См. *`![](https://kb.comindware.ru/images/marker.png)Использование диаграммы экземпляра процесса {Article-ID:4723}`***.**
...
**`![](https://kb.comindware.ru/images/marker.png)Использование диаграммы экземпляра процесса {Article-ID:4723}`**

**`![](https://kb.comindware.ru/images/marker.png)Формы. Определения, редактирование, удаление, использование списка форм {Article-ID:4786}`**

**`![](https://kb.comindware.ru/images/marker.png)Пользовательская задача {Article-ID:4730}`**

**`![](https://kb.comindware.ru/images/marker.png)Атрибут типа  «Гиперссылка» {Article-ID:4766}`**

**`![](https://kb.comindware.ru/images/marker.png)Отправка эл. почты через SMTP. Настройка подключения {Article-ID:4692}`**

[**Настройка пути передачи данных типа «Отправка эл. почты из процесса»**](https://kb.comindware.ru/article.php?id=4690#mcetoc_1h2t519lb2)

**`![](https://kb.comindware.ru/images/marker.png)Использование переменных в сценарии {Article-ID:4719}`**

**[Редактирование формы пользовательской задачи](https://kb.comindware.ru/article.php?id=4726#mcetoc_1h2b5hqtl1)**

**[Настройка свойств формы](https://kb.comindware.ru/article.php?id=4786#mcetoc_1gk3dol903)**