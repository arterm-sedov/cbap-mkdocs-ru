...
- *[Скачивание архива с файлами из выбранных строк таблицы или одной записи](https://kb.comindware.ru/article.php?id=4921)*
...
Чтобы скачать документы и прикрепить их к записи, настройте [кнопку](https://kb.comindware.ru/article.php?id=4790) и C#-скрипт для неё.
...
3. Создайте кнопку *«Скачать архив документов»* со следующими свойствами:
   ...
   См. *«[Написание скриптов на языке C#](https://kb.comindware.ru/article.php?id=4864)»*.
