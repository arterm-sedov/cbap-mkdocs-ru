...
- Действие «**Проверить результат выражения**» с выражением на N3 в позволяет создать **[переменную в сценарии](https://kb.comindware.ru/article.php?id=4719)** и поместить в неё необходимые данные для дальнейшего использования.
