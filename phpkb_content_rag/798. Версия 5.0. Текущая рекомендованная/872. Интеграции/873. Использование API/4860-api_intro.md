...
- При вызове методов API в интерфейсе [Swagger](#использование-swagger) на странице `https://your-host/docs` уже выполнен вход в **Comindware Platform**, и дополнительная аутентификация не требуется.
