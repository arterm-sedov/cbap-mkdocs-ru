...
- Необходимо указать разные корзины для резервных копий, загруженных и временных файлов.
  - Сведения о назначении имени корзины для резервного копирования см. в статье *«[Резервное копирование. Настройка, запуск и просмотр журнала сеансов](https://kb.comindware.ru/article.php?id=4642)»*.
