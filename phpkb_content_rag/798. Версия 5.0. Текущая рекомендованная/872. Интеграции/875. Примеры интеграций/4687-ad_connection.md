...
1. Откройте [список подключений](https://kb.comindware.ru/article.php?id=4675#mcetoc_1hphbmq0k0).
...
См. параграф *«[Обновление keytab-файла аутентификации](https://kb.comindware.ru/article.php?id=4613#mcetoc_1hpavbqqi2)».*
...
**`![](https://kb.comindware.ru/images/marker.png)Аутентификация через Active Directory. Настройка контроллера домена и экземпляра ПО (Linux) {Article-ID:4605}`**

**`![](https://kb.comindware.ru/images/marker.png)Настройка единого входа (SSO-аутентификации) (Windows) {Article-ID:4657}`**

**`![](https://kb.comindware.ru/images/marker.png)Аутентификация через единый вход (SSO). Настройка контроллера домена, экземпляра ПО и компьютера конечного пользователя (Linux) {Article-ID:4613}`**

**`![](https://kb.comindware.ru/images/marker.png)Синхронизация с Active Directory {Article-ID:4655}`**

**[Проверка соединения](https://kb.comindware.ru/article.php?id=4675#mcetoc_1gjrlqi4l5)**

**[Удаление подключения](https://kb.comindware.ru/article.php?id=4675#mcetoc_1gjrlqi4l6)**