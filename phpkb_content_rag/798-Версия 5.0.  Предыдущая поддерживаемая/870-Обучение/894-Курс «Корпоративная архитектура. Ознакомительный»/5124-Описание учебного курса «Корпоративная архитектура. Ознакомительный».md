...
# Описание учебного курса «Корпоративная архитектура. Ознакомительный»

## Введение

Данный курс ориентирован на специалистов, которые хотят повысить прозрачность, управляемость и эффективность бизнес-процессов предприятия с помощью цифровых инструментов моделирования корпоративной архитектуры, реализованных в **Comindware Platform Enterprise**.
...
- После прохождения курса проверьте себя с помощью [практических заданий и тестов](https://kb.comindware.ru/article.php?id=5131).
...
- [Справочник по модулю «Корпоративная архитектура»](https://kb.comindware.ru/article.php?id=4828#architect_description)
- Примеры использования **Comindware Platform Enterprise**:
...
- [Справочник по разработке приложений в Comindware Platform Enterprise](https://kb.comindware.ru/article.php?id=4714)
...
Материалы курса демонстрируют, как с помощью модуля «Корпоративная архитектура» можно структурировать, оптимизировать и интегрировать бизнес-процессы и организационную структуру предприятия.
...
Ваша задача — с помощью **Comindware Platform Enterprise** быстро внедрить необходимые инструменты и изменения.

В ходе обучения вы пройдёте базовые этапы построения корпоративной архитектуры для цифровой трансформации предприятия с помощью **Comindware Platform Enterprise**:

1. **Обзор возможностей и понятий:** изучите назначение и возможности **Comindware Platform Enterprise** для моделирования корпоративной архитектуры.
...
- Понять назначение и возможности модуля «**Корпоративная архитектура**».
...
- Уверенно работать с интерфейсом и ролями в **Comindware Platform Enterprise**.
...
- **[Урок 1. Обзор возможностей Comindware Platform Enterprise](https://kb.comindware.ru/article.php?id=5125)**
- **Описание:** знакомство с назначением и возможностями **Comindware Platform Enterprise** для моделирования корпоративной архитектуры.
- **Цели и навыки:**
  ...
  - Изучить назначение, возможности и область применения **Comindware Platform Enterprise**.
- **[Урок 2. Рабочий стол, навигация, роли, оргструктура](https://kb.comindware.ru/article.php?id=5126)**
- **Описание:** знакомство с интерфейсом модуля «Корпоративная архитектура», настройка рабочего стола и навигации, создание оргструктуры, настройка ролей и атрибутов.
- **Цели и навыки:**
...
- **[Урок 3. Моделирование процессной архитектуры, импорт диаграмм, экспорт регламентов](https://kb.comindware.ru/article.php?id=5127)**
...
- **[Урок 4. Согласование, аудит, публикация, контроль изменений](https://kb.comindware.ru/article.php?id=5128)**
...
- **[Урок 5. Экспорт диаграмм, настройка экспорта регламентов, управление версиями архитектуры](https://kb.comindware.ru/article.php?id=5129)**
...
- **[Заключение. Итоги, дальнейшие шаги, ресурсы, саморазвитие](https://kb.comindware.ru/article.php?id=5130)**
- **Описание:** основные выводы, рекомендации по развитию, дополнительные ресурсы, советы по самообучению.
- **[Тесты и практические задания](https://kb.comindware.ru/article.php?id=5131)**
...
Теперь переходите к [первому уроку](https://kb.comindware.ru/article.php?id=5125), чтобы ознакомиться с интерфейсом, ролями, рабочим столом и навигацией в **Comindware Platform Enterprise**.