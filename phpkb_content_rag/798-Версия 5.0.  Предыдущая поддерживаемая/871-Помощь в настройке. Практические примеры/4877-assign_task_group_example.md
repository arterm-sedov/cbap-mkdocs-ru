...
- указать атрибут типа «[**Аккаунт**](https://kb.comindware.ru/article.php?id=4774)» или «[**Роль**](https://kb.comindware.ru/article.php?id=4783)», содержащий ID исполнителей;
...
**`![](https://kb.comindware.ru/images/marker.png)Группы. Создание, настройка, выбор участников, синхронизация с AD, удаление {Article-ID:4654}`**

**`![](https://kb.comindware.ru/images/marker.png)Пользовательская задача {Article-ID:4730}`**

**`![](https://kb.comindware.ru/images/marker.png)Атрибут типа «Аккаунт» {Article-ID:4774}`**

**`![](https://kb.comindware.ru/images/marker.png)Атрибут типа «Роль» {Article-ID:4783}`**

**`![](https://kb.comindware.ru/images/marker.png)Администрирование системы {Article-ID:4661}`**