...
**Comindware Platform** позволяет настраивать **системные уведомления**, которые формируются в **[сценариях](https://kb.comindware.ru/article.php?id=4717)** и отображаются в **информационной панели и в push-сообщениях**.
...
2. В сценарии [настройте действие «**Отправить сообщение**»](https://kb.comindware.ru/article.php?id=4718#scenario_actions_send_message) с использованием созданного пути передачи данных.
...
- [Сценарии. Действие «Отправить сообщение»](https://kb.comindware.ru/article.php?id=4718#scenario_actions_send_message)
- [Push-уведомления в браузере. Включение](https://kb.comindware.ru/article.php?id=5133)
