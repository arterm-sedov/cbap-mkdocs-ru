...
## Описание технологии Comindware ElasticData

**Comindware ElasticData** — это первоклассная гибкая технология управления данными следующего поколения, которая лежит в основе современных веб-приложений. В основе **Comindware ElasticData** лежит графовая модель данных, тип баз данных, расширяющий возможности и обеспечивающий более гибкий подход, чем традиционные реляционные модели данных.
...
Графовая модель данных, которая используется в **Comindware ElasticData**, обеспечивает такие возможности **Comindware Platform**, которые практически невозможно реализовать для приложений на основе реляционных баз данных без значительных издержек. Графовая модель данных по своей сути обладает гораздо большей гибкостью в определении структур данных и изменении этих структур в режиме реального времени. Это возможно благодаря уникальному и гораздо более гибкому подходу к хранению и управлению данными.

Технология **Comindware ElasticData** основана на принципах семантической паутины, сформулированных известным консорциумом W3C consortium. Согласно определению консорциума W3C: «Семантическая паутина обеспечивает общую структуру, позволяющую распределять и повторно использовать данные в рамках приложения, предприятия и группы». Использование принципов семантической паутины позволяет создавать приложения, которые проще понять и настраивать.
...
И напротив, технология **Comindware ElasticData** была разработана с расчетом на то, что модель данных и процессы можно будет изменить на этапе выполнения, что позволит лучше удовлетворять потребности современных компаний, которые должны адаптироваться к постоянно изменяющимся условиям.
...
_![Пример реляционной модели данных](/platform/v5.0/business_apps/img/elasticdata_description_relational_db_example.png)_
...
_![Пример графовой модели данных](/platform/v5.0/business_apps/img/elasticdata_description_graph_db_example.png)_

Таким образом факты сохраняются в графовой базе данных:

_![Способ хранения данных в графовой базе данных](/platform/v5.0/business_apps/img/elasticdata_description_graph_storage_example.png)_

Бизнес-правила в **Comindware ElasticData** имеют расширенный вид по сравнению со стандартом N3 для работы с комплексными правилами. Пример.

_![Сложные бизнес-правила в Comindware ElasticData](/platform/v5.0/business_apps/img/elasticdata_description_compex_rules.png)_
...
_![Обновление структуры данных в реляционной модели данных](/platform/v5.0/business_apps/img/elasticdata_description_relational_db_update.png)_

**Comindware ElasticData** работает с отдельными фактами о данных вместо предварительно определенных таблиц с данными. Для добавления новых данных или изменения структуры данных необходимо просто добавить новые факты, это можно сделать даже на этапе выполнения. Таким образом, можно создать совершенно новые типы данных и связать их с имеющимися данными, а модифицировать модель данных можно, не прерывая работу пользователей с приложением.

_![Обновление структуры данных в графовой модели данных](/platform/v5.0/business_apps/img/elasticdata_description_graph_db_update.png)_
...
_![Поиск, основанный на глубокой взаимосвязи объектов в реляционной модели данных](/platform/v5.0/business_apps/img/elasticdata_description_relational_db_search.png)_
...
При использовании графовой базы данных, например **Comindware ElasticData**, поисковые запросы выглядят намного проще:

_![Поиск, основанный на глубокой взаимосвязи объектов в графовой модели данных](/platform/v5.0/business_apps/img/elasticdata_description_graph_db_search.png)_
...
## Функции Comindware Platform, обеспечиваемые технологией Comindware ElasticData

Как здесь показано, графовая модель данных, используемая **Comindware ElasticData**, гораздо более гибкая, она обеспечивает важные преимущества для современных бизнес-приложений по сравнению с традиционными реляционными базами данных.

Технология **Comindware ElasticData** открывает широкие возможности для создания бизнес-приложений на базе **Comindware Platform**, в том числе:
...
- Модели данных можно также изменять в реальном времени без реорганизации. С помощью **Comindware ElasticData** новые типы объектов и связи между ними можно добавить без остановки текущих процессов. В приложениях на основе системы управления реляционными базами данных добавление новых типов объектов зачастую связано со сложной и неудобной операцией, во время которой необходимо решить множество задач, например по созданию новых столбцов и таблиц. С помощью **Comindware ElasticData** любой тип бизнес-объекта можно легко добавить и связать с другими бизнес-объектами в системе.
