...
Для использования геометок необходимо предварительно настроить подключение к картографической службе. См. *«[Карты. Настройка подключения, шаблона и формы](https://kb.comindware.ru/article.php?id=5314)»*.
