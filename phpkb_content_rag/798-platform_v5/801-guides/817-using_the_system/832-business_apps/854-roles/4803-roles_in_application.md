...
Для контроля доступа к системным ресурсам используются **[системные роли](https://kb.comindware.ru/article.php?id=4662)**. **Системные роли** определяют политику безопасности для пользователей, настраивающих систему и приложения, а также для интеграции с внешними службами.
...
1. На странице [«**Администрирование**» приложения](https://kb.comindware.ru/article.php?id=4714) выберите пункт «**Роли**» *‌*.
...
_![Список ролей в приложении](/platform/v5.0/business_apps/img/role_list.png)_
...
- **Раздел навигации** — выберите [раздел навигации](https://kb.comindware.ru/article.php?id=4809), который будет отображаться для аккаунтов с данной ролью.
...
_![Настройка свойств роли](/platform/v5.0/business_apps/img/role_properties.png)_
...
1. Откройте вкладку «**Разрешения**», на которой предусмотрены следующие области:
   ...
   **(2)** **Список разрешений** — показывает ресурсы и назначенные для них разрешения для данной роли. Каждая строка задаёт набор разрешений для одного ресурса.
   ...
   ![Настройка разрешений роли](/platform/v5.0/business_apps/img/role_permissions.png)
