...
- [Управление версиями приложения. Экспорт и импорт](https://kb.comindware.ru/article.php?id=5652)
- [Экспорт и импорт версий приложения с помощью Git](https://kb.comindware.ru/article.php?id=5649)
...
1. Убедитесь, что для продуктивной среды настроено и выполняется регулярное резервное копирование, и перед обновлением создана наиболее актуальная резервная копия. См. *«[Резервное копирование и восстановление. Рекомендации по организации и оптимизации](https://kb.comindware.ru/article.php?id=5568)»*.
2. Сформируйте новую версию приложения в среде разработки.
3. Выполните шаги, указанные в статье *«[Подготовка приложения к экспорту](https://kb.comindware.ru/article.php?id=5652#version_control_app_prepare)»*.
...
Общие особенности поведения при экспорте и импорте, а также перечень сущностей, которые переносятся или не переносятся, подробно описаны в статье *«[Управление версиями приложения. Экспорт и импорт](https://kb.comindware.ru/article.php?id=5652)»*.
...
Подробную информацию о влиянии экспорта и импорта на идентификаторы и системные имена см. в статье *«[Идентификаторы и системные имена](https://kb.comindware.ru/article.php?id=5181)»*.
...
- заранее готовьте приложения к экспорту согласно разделу «[Подготовка приложения к экспорту](https://kb.comindware.ru/article.php?id=5652#version_control_app_prepare)»;
...
- создайте резервную копию продуктивного экземпляра **Comindware Platform**;
- разверните копию на отдельном сервере или в отдельном экземпляре, руководствуясь *[рекомендациями по резервному копированию и восстановлению](https://kb.comindware.ru/article.php?id=5568)*.

2. Настройте подключение к репозиторию Git, если планируется использование Git. См. статью *«[Управление версиями через Git. Настройка подключения](https://kb.comindware.ru/article.php?id=5623)»*.
...
- [Экспорт и импорт версий приложения вручную](https://kb.comindware.ru/article.php?id=5653)
- [Экспорт и импорт версий приложения с помощью Excel](https://kb.comindware.ru/article.php?id=5651)
- [Управление версиями через Git. Настройка подключения](https://kb.comindware.ru/article.php?id=5623)
- [Идентификаторы и системные имена](https://kb.comindware.ru/article.php?id=5181)
