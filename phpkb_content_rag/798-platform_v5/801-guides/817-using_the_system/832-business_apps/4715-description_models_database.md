...
Для настройки модели данных приложений в **Comindware Platform** используются [**шаблоны записей**](https://kb.comindware.ru/article.php?id=4759). В терминологии других систем шаблон записи — это аналог справочника, таблицы, сущности, класса и т. п.
...
Физически данные данные хранятся в графовой базе данных. Подробное описание фирменной технологии графовых БД **Comindware** см. в статье *«[Технология Comindware ElasticData](https://kb.comindware.ru/article.php?id=4584)».*

Привязка шаблона к приложению

Следует учитывать, что каждый шаблон записи привязан к конкретному [**приложению**](https://kb.comindware.ru/article.php?id=4714).

Шаблон можно привязать к другому приложению для установления связей между разными приложениями. См. «[**Использование шаблона в нескольких приложениях**](https://kb.comindware.ru/article.php?id=4709#templates_move)».
