...
- **Действия**
  ...
  - **Форма** *‌* — настройка [формы](https://kb.comindware.ru/article.php?id=4726) для задачи.
...
- **Разрешить переназначение этой задачи** — установите этот флажок, чтобы назначенную задачу можно было передать другому исполнителю. См. *«[Пользовательская задача. Переназначение исполнителя](https://kb.comindware.ru/article.php?id=5087)»*.
...
- **Использовать путь передачи данных** — выберите из раскрывающегося списка или [создайте путь](https://kb.comindware.ru/article.php?id=4676) типа «**Уведомления о задачах**».
