...
При настройке приложения может потребоваться разграничить доступ к информационным страницам (и пользовательским ссылкам) в соответствии с **[ролями](https://kb.comindware.ru/article.php?id=5738)**.
...
- *[Рабочий стол. Использование](https://kb.comindware.ru/article.php?id=5646)*
