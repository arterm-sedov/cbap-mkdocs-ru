...
kbId: 4791
url: 'https://kb.comindware.ru/article.php?id=4791'
...
- **Область кнопок** содержит [кнопки](https://kb.comindware.ru/article.php?id=4790) для [таблицы](https://kb.comindware.ru/article.php?id=4800) (и связанных с ней карточек), [формы](https://kb.comindware.ru/article.php?id=4786) или области формы.
...
- Кнопка отображается для конечного пользователя, если в его [роли](https://kb.comindware.ru/article.php?id=4803) разрешено использование этой кнопки и если выполняется [условие отображения кнопки](https://kb.comindware.ru/article.php?id=4790).
...
2. Отобразится список всех областей кнопок, используемых в таблицах и формах шаблона со следующими сведениями:
   ...
   - **Для списков задач** (у шаблона процесса) — флажок установлен для области кнопок, которая используется по умолчанию в списках задач по процессу на странице «[**Мои задачи**](https://kb.comindware.ru/article.php?id=4812)».
   - **Для экземпляров** (у шаблона процесса) — флажок установлен для области кнопок, которая используется по умолчанию на [диаграмме экземпляра процесса](https://kb.comindware.ru/article.php?id=4723).
   - **Для диаграммы** (у шаблона процесса) — флажок установлен для области кнопок, которая используется по умолчанию в режиме [просмотра диаграммы процесса](https://kb.comindware.ru/article.php?id=4758).
   - **Кнопок** — количество кнопок в области.

_![Список областей кнопок в шаблоне записи](/platform/v5.0/business_apps/templates/img/buttons_area_list.png)_
...
3. Настройте свойства области кнопок:
   ...
   - **По умолчанию для списков задач** (в шаблоне процесса) — установите этот флажок, чтобы область кнопок использовалась по умолчанию для списков задач по процессу на странице «[**Мои задачи**](https://kb.comindware.ru/article.php?id=4812)».
   - **По умолчанию для экземпляров процесса** (в шаблоне процесса) — установите этот флажок, чтобы область кнопок использовалась по умолчанию для экземпляра процесса — на [диаграмме экземпляра процесса](https://kb.comindware.ru/article.php?id=4723).
   - **По умолчанию для конструктора диаграммы** (в шаблоне процесса) — установите этот флажок, чтобы область кнопок использовалась по умолчанию в режиме [просмотра диаграммы процесса](https://kb.comindware.ru/article.php?id=4758).
...
_![Конструктор области кнопок для таблиц шаблона процесса](/platform/v5.0/business_apps/templates/img/button_area_constructor.png)_
...
- *В каждой [области](https://kb.comindware.ru/article.php?id=4787#form_static_elements_area) формы и на каждой [вкладке](https://kb.comindware.ru/article.php?id=4787#form_static_elements_tabs)* предусмотрена пустая область кнопок, в которую можно поместить кнопки из текущего шаблона.
...
_![Конструктор области кнопок на форме](/platform/v5.0/business_apps/templates/img/button_area_constructor_form.png)_
...
4. Чтобы настроить кнопку или группу кнопок, выберите её на макете:
   ...
   - **Цвет** — выберите один из цветов, заданных в текущей [теме на вкладке «**Цвета приоритетов**»](https://kb.comindware.ru/article.php?id=4708#themes_graphic_diagram_color).
5. Чтобы найти необходимую кнопку, введите часть её названия в поле «**Поиск**» на панели элементов.
6. Чтобы создать новую кнопку, нажмите значок *‌* рядом с пунктом «**Кнопки**» на панели элементов. Откроется [конструктор кнопки](https://kb.comindware.ru/article.php?id=4790).
7. Чтобы отредактировать кнопку, нажмите значок *‌* рядом с названием кнопки на панели элементов. Откроется [конструктор кнопки](https://kb.comindware.ru/article.php?id=4790).
8. Чтобы удалить элемент, перетащите его за пределы макета.

   ![Добавление разделителя в группу кнопок](/platform/v5.0/business_apps/templates/img/button_area_divide_add.png)
...
8. [Настройте область кнопок](https://kb.comindware.ru/article.php?id=4791#button_area_configure).
