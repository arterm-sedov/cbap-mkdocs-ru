...
kbId: 4709
url: 'https://kb.comindware.ru/article.php?id=4709'
...
Для каждого [приложения](https://kb.comindware.ru/article.php?id=4714) предусмотрен отдельный набор шаблонов. См. *«[Просмотр списка шаблонов приложения](#templates_view_in_app)».*
...
- **[шаблоны моделей](https://kb.comindware.ru/article.php?id=5149)** — для хранения элементов процессной архитектуры Архитекта

У шаблонов различных типов имеются общие и специфические свойства.

Шаблон любого типа содержит и позволяет настраивать:

- [общие свойства шаблона](https://kb.comindware.ru/article.php?id=4756);
- [таблицы](https://kb.comindware.ru/article.php?id=4800) для отображения данных;
- [карточки](https://kb.comindware.ru/article.php?id=4799#cards_configure_assign_to_table);
- [формы](https://kb.comindware.ru/article.php?id=4786) для просмотра и ввода данных;
- [кнопки](https://kb.comindware.ru/article.php?id=4790) для выполнения операций в приложении;
- [области кнопок](https://kb.comindware.ru/article.php?id=4791) для форм и таблиц.

Шаблоны **записи, аккаунта, роли** и **оргединицы** содержат:

- [атрибуты](https://kb.comindware.ru/article.php?id=4772) бизнес-сущности;
- записи с экземплярами бизнес-сущностей;
- [шаблоны экспорта](https://kb.comindware.ru/article.php?id=4797) данных в форматах DOCX, XLSX и PDF.

Шаблон **процесса** содержит:

- [диаграмму бизнес-процесса](https://kb.comindware.ru/article.php?id=4721);
...
1. На странице [«**Администрирование**»](https://kb.comindware.ru/article.php?id=4661) в разделе «**Архитектура**» выберите пункт «**Шаблоны**» *‌*.
2. Отобразится список всех шаблонов в составе всех [приложений](https://kb.comindware.ru/article.php?id=4714).
...
[Шаблон роли](https://kb.comindware.ru/article.php?id=4760) и [шаблон организационной единицы](https://kb.comindware.ru/article.php?id=4755) создаются автоматически при создании приложения.
...
5. Настройте [свойства шаблона записи](https://kb.comindware.ru/article.php?id=4759#record_template_properties).
6. Сохраните шаблон.
...
3. Нажмите кнопку «**Создать**».
4. Откроется окно «**Новый шаблон**».
5. Настройте [общие свойства шаблона](https://kb.comindware.ru/article.php?id=4759).
...
6. Настройте связь шаблона процесса с шаблоном записи.
   ...
   - «Создать новый шаблон» — к новому шаблону процесса будет привязан вновь созданный связанный шаблон записи:
     ...
     - «Системное имя нового шаблона записи» — укажите уникальное имя шаблона.
       ...
       Обычно заполняется автоматически по названию.![Привязка нового шаблона записи](/platform/v5.0/business_apps/templates/img/create_related_template.png)
   ...
   - «Связать с существующим шаблоном» — к новому шаблону процесса будет привязан имеющийся шаблон записи.
     - «Связанный шаблон» — выберите из раскрывающегося списка шаблон записи для привязки к создаваемому шаблону процесса.![Привязка имеющегося шаблона записи](/platform/v5.0/business_apps/templates/img/relate_existing_template.png)
...
3. Нажмите кнопку «**Создать**».
4. Откроется окно «**Новый шаблон**».
5. Настройте [свойства шаблона аккаунта](https://kb.comindware.ru/article.php?id=4757).
6. Сохраните шаблон.
...
4. Настройте [свойства шаблона](https://kb.comindware.ru/article.php?id=4756).
...
Шаблоны можно переносить между [приложениями](https://kb.comindware.ru/article.php?id=4714) для рефакторинга или формирования связи между несколькими приложениями.
...
1. Нажмите кнопку «**Сменить приложение**» в разделе «**Основные свойства**» на вкладке «**[Свойства](https://kb.comindware.ru/article.php?id=4756)**» шаблона.
...
Подробные сведения о разрешениях на доступ к ресурсам приложения и свойствах ролей см. в разделе «**[Роли в приложении](https://kb.comindware.ru/article.php?id=4803)**».
...
- Архивный шаблон записи нельзя будет связать с атрибутами типа «**[Запись](https://kb.comindware.ru/article.php?id=4780)**».
- Архивный шаблон аккаунта нельзя будет связать с атрибутами типа «**[Аккаунт](https://kb.comindware.ru/article.php?id=4774)**».
...
- При удалении шаблона записи или аккаунта:
  ...
  - удаляются записи, связанные с **[атрибутами типа «Запись»](https://kb.comindware.ru/article.php?id=4780)**, в свойствах которых установлен флажок «**Удалять связанные записи**» (см. [пример](https://kb.comindware.ru/article.php?id=4780#attribute_record_example)).
...
- *[Формы. Определения и настройка](https://kb.comindware.ru/article.php?id=4786)*
- *[Кнопки. Определения и настройка](https://kb.comindware.ru/article.php?id=4790)*
