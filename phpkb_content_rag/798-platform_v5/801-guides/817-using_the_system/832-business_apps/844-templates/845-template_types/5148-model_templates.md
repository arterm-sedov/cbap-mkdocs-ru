...
- **Шаблон модели** служит для определения свойств и хранения моделей **[корпоративной архитектуры](https://kb.comindware.ru/article.php?id=4828#architect_description)** и их экземпляров (элементов корпоративной архитектуры). Шаблон модели содержит **[атрибуты](https://kb.comindware.ru/article.php?id=4772)**, формы и другие данные модели. Используется аналогично **[шаблону записи](https://kb.comindware.ru/article.php?id=4759)**. Шаблон модели можно связать с другими шаблонами.
- **Шаблон модели процесса** можно преобразовать в **[шаблон автоматизированного процесса](https://kb.comindware.ru/article.php?id=4758)**.
...
Помимо **[общих свойств](https://kb.comindware.ru/article.php?id=4756)** шаблоны моделей содержат системные атрибуты.
...
- построение иерархических связей между элементами корпоративной архитектурны (например, между группами процессов и процессами) посредством **[атрибута типа «Модель»](https://kb.comindware.ru/article.php?id=5148)**;
...
Для установления связей с шаблонами моделей используется **[атрибут типа «Модель»](https://kb.comindware.ru/article.php?id=5148)**, который позволяет:
...
- [Модуль «Корпоративная архитектура»](https://kb.comindware.ru/article.php?id=4828#architect_description)
