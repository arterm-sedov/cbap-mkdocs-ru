...
- Вычисляемыми могут быть атрибуты следующих типов:
  ...
  - [Часовой пояс](https://kb.comindware.ru/article.php?id=5098)
...
1. Установите флажок «**Вычислять автоматически**» в [свойствах атрибута](https://kb.comindware.ru/article.php?id=4772#attributes_configure).
