...
- [Модель](https://kb.comindware.ru/article.php?id=5148)
...
По умолчанию в списке атрибутов отображаются [системные](https://kb.comindware.ru/article.php?id=4781) и [архивные атрибуты](#attributes_archive). При необходимости их можно скрыть из списка.
...
- *[Атрибуты. Смена системного имени, типа данных и связанного шаблона](https://kb.comindware.ru/article.php?id=4762)*
- *[Общие свойства атрибутов](https://kb.comindware.ru/article.php?id=4765)*