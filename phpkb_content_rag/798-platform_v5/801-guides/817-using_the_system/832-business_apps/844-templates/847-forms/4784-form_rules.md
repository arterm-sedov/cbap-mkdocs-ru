...
- Каждое [правило](#настройка-правила) состоит из одного или нескольких действий над [элементами формы](https://kb.comindware.ru/article.php?id=4786) и задаёт условие их выполнения.
...
_![Переход к конструктору правил для формы](/platform/v5.0/business_apps/templates/forms/img/form_rules_menu.png)_
...
4. Отобразится конструктор правил для формы, состоящий из следующих областей:
   ...
   **(1) Панель элементов** — содержит элементы, которые можно перетащить в рабочую область.
   ...
   - [**Действие**](#настройка-действия) — действие над [элементом формы](https://kb.comindware.ru/article.php?id=4786), которое будет выполняться при соблюдении условий, заданных в правиле и действии.
...
_![Конструктор правил для формы](/platform/v5.0/business_apps/templates/forms/img/form_rules_designer.png)_
...
3. Настройте правило с помощью панели «**Свойства правила**»:
   ...
   - Если форма с правилами вложена в другую форму, то контекстом для условий выполнения правил вложенной формы является запись, которая выводится о вложенной форме:
     ...
     - если вложенная форма относится к шаблону, связанному с [атрибутом типа «**Запись**»](https://kb.comindware.ru/article.php?id=4780), то контекстом является запись, указанная в этом атрибуте.

_![Настройка правила](/platform/v5.0/business_apps/templates/forms/img/form_rules_properties.png)_
...
_![Настройка действия](/platform/v5.0/business_apps/templates/forms/img/form_rules_properties_action.png)_
...
_![Внешний вид сообщения об ошибке на поле](/platform/v5.0/business_apps/templates/forms/img/form_rules_show_error.png)_
...
_![Удаление правила для формы](/platform/v5.0/business_apps/templates/forms/img/form_rules_delete.png)_
