...
- Информация о новых сообщениях в **обсуждениях** отправляеются в push-уведомлениях при использовании **[Comindware Mobile](https://kb.comindware.ru/article.php?id=5090)** и веб-версии **Comindware Platform**.

## Добавление обсуждения на форму

1. Откройте [конструктор формы](https://kb.comindware.ru/article.php?id=4786#form_designer).
...
1. Откройте [страницу свойств шаблона](https://kb.comindware.ru/article.php?id=4709).
...
3. Настройте конфигурацию обсуждений.
   ...
   - **Отключить прикрепление файлов к обсуждениям** — установите этот флажок, чтобы отключить функцию прикрепления файлов к сообщениям в обсуждениях.![Настройка конфигурации обсуждений в шаблоне](/platform/v5.0/business_apps/templates/forms/img/discussion_configure_template.png)
...
- *[Обсуждение. Использование](https://kb.comindware.ru/article.php?id=4818)*
