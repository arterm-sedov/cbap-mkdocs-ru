...
3. Выберите требуемый подраздел, нажав пункт «**Процессы**».
   ...
   ![Выбор показателей производительности для просмотра](/platform/v5.0/administration/infrastructure/img/performance_view_selection.png)
...
_![Показатели производительности процессов](/platform/v5.0/administration/infrastructure/img/performance_page.png)_
...
_![Показатели производительности скриптов](/platform/v5.0/administration/infrastructure/img/performance_scripts.png)_
...
_![Показатели производительности системных служб](/platform/v5.0/administration/infrastructure/img/performance_system_services.png)_
...
_![Показатели производительности сеансов получения и отправки сообщений](/platform/v5.0/administration/infrastructure/img/performance_messages.png)_
...
_![Показатели производительности сеансов вычисления выражений](/platform/v5.0/administration/infrastructure/img/performance_expressions.png)_
