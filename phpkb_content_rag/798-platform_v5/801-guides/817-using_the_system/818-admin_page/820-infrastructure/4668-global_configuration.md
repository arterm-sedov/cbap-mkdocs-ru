...
См. *«[Конфигурация экземпляра, компонентов ПО и служб. Настройка](https://kb.comindware.ru/article.php?id=5067)»*.

Здесь представлены инструкции по настройке только параметров, доступных на странице администрирования **Comindware Platform**.

1. На странице «[**Администрирование**](https://kb.comindware.ru/article.php?id=4661)» в разделе «**Инфраструктура**» выберите пункт «**Глобальная конфигурация**» *‌*.
...
Включите или выключите двухфакторную аутентификацию для мобильного приложения. См. статью *«[Двухфакторная аутентификация. Настройка](https://kb.comindware.ru/article.php?id=4652)»*.
