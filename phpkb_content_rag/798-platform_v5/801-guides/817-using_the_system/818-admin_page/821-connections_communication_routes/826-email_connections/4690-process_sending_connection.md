...
На диаграмме процесса можно использовать [промежуточные](https://kb.comindware.ru/article.php?id=4740) и [конечные](https://kb.comindware.ru/article.php?id=4745) события для отправки электронных писем с данными бизнес-процесса.
...
3. Для отправки писем с уведомлениями о пользовательских задачах:
   ...
   - [Настройте путь передачи данных](https://kb.comindware.ru/article.php?id=4684) типа «**Уведомления о задачах**».

## Настройка подключения типа «Отправка эл. почты из процесса»

Подключения типа «**Отправка эл. почты из процесса**» используются в **[промежуточных событиях-отправки сообщений](https://kb.comindware.ru/article.php?id=4740)**, **[конечных событиях-отправки сообщений](https://kb.comindware.ru/article.php?id=4745)**.

1. На странице **[«Администрирование» — «Подключения»](https://kb.comindware.ru/article.php?id=4661)** создайте или откройте подключение типа «**Отправка эл. почты из процесса**».
2. Настройте свойства подключения:

   - **Отключить** — установите этот флажок, чтобы временно деактивировать подключение.
   - **Использовать по умолчанию** — установите этот флажок, чтобы использовать подключение для отправки [**уведомлений о пользовательских задачах**](https://kb.comindware.ru/article.php?id=4684).
...
Пути передачи данных типа «**Отправка эл. почты из процесса**» используются в [промежуточных событиях-отправки сообщений](https://kb.comindware.ru/article.php?id=4740) и [конечных событиях-отправки сообщений](https://kb.comindware.ru/article.php?id=4745).
...
1. Поместите на диаграмму процесса [промежуточное](https://kb.comindware.ru/article.php?id=4740) или [конечное](https://kb.comindware.ru/article.php?id=4745) событие-отправку сообщения.
...
2. В [меню элемента](https://kb.comindware.ru/article.php?id=4721#process_diagram_call_element_menu) события нажмите кнопку «**Свойства**» *‌*.
...
- *[Пути передачи данных. Типы, создание, настройка, удаление](https://kb.comindware.ru/article.php?id=4676)*
...
- *[Общие уведомления. Настройка пути передачи данных, диаграммы процесса и глобальной конфигурации](https://kb.comindware.ru/article.php?id=4681)*
- *[Уведомления о задачах. Настройка пути передачи данных](https://kb.comindware.ru/article.php?id=4684)*
- *[Пример: согласование заявлений по эл. почте. Настройка подключений, путей передачи данных и диаграммы процесса](https://kb.comindware.ru/article.php?id=4691)*
- *[Получение эл. почты с помощью сценариев через IMAP и Exchange. Настройка подключения, пути передачи данных и сценария](https://kb.comindware.ru/article.php?id=4693)*
