...
Сведения об использовании карт см. в статье *«[Карты. Использование](https://kb.comindware.ru/article.php?id=5595)»*.
...
9. Сохраните форму.
10. Протестируйте работу карты на форме: добавьте, переместите, переименуйте и удалите метки. См. [*«Карты. Использование»*](https://kb.comindware.ru/article.php?id=5595).

## Связанные статьи

- *[Карты. Использование](https://kb.comindware.ru/article.php?id=5595)*
- *[Динамические элементы формы. Настройка карты](https://kb.comindware.ru/article.php?id=5723#form_dynamic_elements_map)*