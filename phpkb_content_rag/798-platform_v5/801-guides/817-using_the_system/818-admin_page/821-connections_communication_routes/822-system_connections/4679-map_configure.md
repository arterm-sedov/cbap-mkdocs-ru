...
kbId: 4679
url: 'https://kb.comindware.ru/article.php?id=4679'
...
Сведения об использовании карт см. в статье *«[Карты. Использование](https://kb.comindware.ru/article.php?id=4814)»*.
...
_![Свойства подключения к картографической службе](/platform/v5.0/administration/connections_communication_routes/system_connections/img/maps_connection_properties.png)_
...
9. Сохраните форму.
10. Протестируйте работу карты на форме: добавьте, переместите, переименуйте и удалите метки. См. [*«Карты. Использование»*](https://kb.comindware.ru/article.php?id=4814).

## Связанные статьи

- *[Карты. Использование](https://kb.comindware.ru/article.php?id=4814)*
- *[Динамические элементы формы. Настройка карты](https://kb.comindware.ru/article.php?id=4785#form_dynamic_elements_map)*