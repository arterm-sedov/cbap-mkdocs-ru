...
- в push-сообщениях при использовании **[Comindware Mobile](https://kb.comindware.ru/article.php?id=5090)** и веб-версии **Comindware Platform** (сервер должен быть подключен к интернету и Apache Kafka);
...
- настроить подключение типа «**Отправка эл. почты из процесса**» и установить в его свойствах флажок «**Использовать по умолчанию**» (см. *«[Отправка эл. почты из процесса. Настройка подключения, пути передачи данных и события на диаграмме процесса](https://kb.comindware.ru/article.php?id=4690)»*);
...
2. В свойствах **[пользовательской задачи](https://kb.comindware.ru/article.php?id=4730)** настройте сопоставление атрибутов **пути передачи данных** с **данными сообщения**.
...
3. Задайте значения атрибутов сообщения с помощью вкладки «**Данные сообщения**» в свойствах [**пользовательской задачи**](https://kb.comindware.ru/article.php?id=4730), использующей этот путь передачи данных.
...
- [Гиперссылка на задачу. Вычисление с помощью N3 и формулы](https://kb.comindware.ru/article.php?id=4879)
