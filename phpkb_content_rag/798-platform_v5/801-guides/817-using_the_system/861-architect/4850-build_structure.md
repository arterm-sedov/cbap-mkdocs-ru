...
kbId: 4850
url: 'https://kb.comindware.ru/article.php?id=4850'
...
- [конструктор организационно-функциональной диаграммы](https://kb.comindware.ru/article.php?id=4848).
...
Каждая оргединица представляет собой запись в [шаблоне оргединицы](https://kb.comindware.ru/article.php?id=4755).

Оргединицы можно использовать в качестве ресурсов и исполнителей в [процессной архитектуре](https://kb.comindware.ru/article.php?id=4833) организации.

Атрибуты и форму свойств оргединицы можно [изменить](https://kb.comindware.ru/article.php?id=4850#architect_organizational_structure_design_unit_configure_form_and_attributes).
...
1. В [панели навигации](https://kb.comindware.ru/article.php?id=4824) выберите пункт «**Оргструктура**» — «**Реестр**» для просмотра всей иерархии оргструктуры.
...
3. Чтобы [открыть организационно-функциональную диаграмму](https://kb.comindware.ru/article.php?id=4848), дважды нажмите требуемую оргединицу в реестре или выберите её на панели навигации.
...
1. В [конструкторе организационно-функциональной диаграммы](https://kb.comindware.ru/article.php?id=4848) выберите оргединицу, для которой требуется создать дочернюю оргединицу.
2. Выберите пункт «**Должность**» *‌* или «**Подразделение**» *‌* в разделе «**Быстрое создание**» [меню элемента](https://kb.comindware.ru/article.php?id=4848#architect_organizational_structure_diagram_edit_element_menu).
...
1. Перетащите на диаграмму комментарий или надпись из [палитры элементов](https://kb.comindware.ru/article.php?id=4848).
2. Новый элемент появится на диаграмме.
3. При необходимости соедините элемент с другим с помощью стрелки из раздела «**Быстрое создание**» [меню элемента](https://kb.comindware.ru/article.php?id=4848#architect_organizational_structure_diagram_edit_element_menu).
...
1. В [реестре оргединиц](https://kb.comindware.ru/article.php?id=4850) нажмите кнопку «**Создать**».
...
1. В [реестре оргединиц](https://kb.comindware.ru/article.php?id=4850) установите флажок выбора в строке оргединицы или щёлкните её правой кнопкой мыши.
...
1. В разделе «**Оргструктура**» [панели навигации](https://kb.comindware.ru/article.php?id=4824) нажмите кнопку «**Действия**» *‌* у оргединицы или у пункта «**Реестр**».
...
1. Дважды нажмите оргединицу в [конструкторе организационно-функциональной диаграммы](https://kb.comindware.ru/article.php?id=4848).
...
1. Выберите оргединицу в [конструкторе организационно-функциональной диаграммы](https://kb.comindware.ru/article.php?id=4848).
...
У каждого элемента оргструктуры предусмотрены настраиваемые свойства ([атрибуты](https://kb.comindware.ru/article.php?id=4850#architect_organizational_structure_design_unit_configure_form_and_attributes)).

Свойства элемента оргструктуры (значения его атрибутов) можно изменить с помощью панели свойств в конструкторе диаграммы.

1. Выберите организационную единицу в [конструкторе организационно-функциональной диаграммы](https://kb.comindware.ru/article.php?id=4848).
2. Откройте панель свойств, нажав кнопку «**Свойства**» *‌*.
3. Настройте свойства оргединицы с помощью панели свойств.
4. Нажмите пустое место диаграммы, чтобы применить изменения.
5. При необходимости [отредактируйте форму и атрибуты оргединицы](https://kb.comindware.ru/article.php?id=4850#architect_organizational_structure_design_unit_configure_form_and_attributes).
...
Атрибуты и формы оргединицы хранятся в [шаблоне оргединицы](https://kb.comindware.ru/article.php?id=4755).
...
5. Создайте или отредактируйте атрибуты оргединицы. См. *«[Операции на панели элементов конструктора форм](https://kb.comindware.ru/article.php?id=4786#form_designer_elements_operations)»*.
6. Перетащите на форму новые атрибуты и визуальные элементы или удалите ненужные. См. *«[Редактирование формы](https://kb.comindware.ru/article.php?id=4786#form_designer)»*.
7. Сохраните форму.
...
1. Выберите оргединицу в [конструкторе организационно-функциональной диаграммы](https://kb.comindware.ru/article.php?id=4848).
2. Выберите цвет в разделе «**Изменить цвет**» [меню элемента](https://kb.comindware.ru/article.php?id=4848#architect_organizational_structure_diagram_edit_element_menu).
...
1. В [реестре оргединиц](https://kb.comindware.ru/article.php?id=4850) наведите указатель мыши на первую ячейку в строке оргединицы, которую требуется переместить на другой уровень иерархии.
...
В [панели навигации](https://kb.comindware.ru/article.php?id=4824) нажмите и перетащите оргединицу на её новую родительскую оргединицу или между оргединицами.
...
1. Выберите оргединицу или несколько оргединиц в [конструкторе организационно-функциональной диаграммы](https://kb.comindware.ru/article.php?id=4848).
...
1. Установите для подлежащих удалению оргединиц флажки в первом столбце [реестра](https://kb.comindware.ru/article.php?id=4850) или щелкните правой кнопкой мыши подлежащую удалению оргединицу.
...
- *[Редактирование организационно-функциональной диаграммы](https://kb.comindware.ru/article.php?id=4848)*
