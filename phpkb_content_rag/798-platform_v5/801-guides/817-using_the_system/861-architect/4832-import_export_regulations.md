...
kbId: 4832
url: 'https://kb.comindware.ru/article.php?id=4832'
...
2. Выберите **источник импорта** и импортируйте диаграммы.
   ...
   - **Загрузить файлы BPMN** — выберите файлы на компьютере и нажмите кнопку «**Продолжить**».![Загрузка файлов BPMN](/platform/v5.0/architect/process_architecture_modeling/img/importing_process_entity_from_files.png)

   Загрузка файлов BPMN

   - **Импортировать из другой BPM-системы** — выберите внешнюю BPM-систему, введите учётные данные для доступа к ней, и нажмите кнопку «**Продолжить**».![Импорт диаграмм из другой BPM-системы](/platform/v5.0/architect/process_architecture_modeling/img/importing_process_entity_from_BPMS.png)
