...
- [конструктор диаграмм](https://kb.comindware.ru/article.php?id=4835) бизнес-способностей и процессов;
...
1. В [панели навигации](https://kb.comindware.ru/article.php?id=4824) выберите пункт «**Процессы**» — «**Реестр**» для просмотра всей иерархии процессов.
...
1. В [конструкторе диаграммы](https://kb.comindware.ru/article.php?id=4835) перетащите на диаграмму требуемый элемент из палитры элементов.
...
Чтобы создать поток управления, выберите пункт «**Поток управления**» в разделе «**Быстрое создание**» [меню элемента](https://kb.comindware.ru/article.php?id=4835#architect_process_architecture_diagram_designer_element_menu).
...
Созданные на диаграмме элементы «**Встроенный подпроцесс**», «**Группа процессов**», «**Ссылка на процесс**» и «**Ссылка на группу процессов**» автоматически появляются в [реестре процессов](https://kb.comindware.ru/article.php?id=4833).

### Создание элемента на верхнем уровне иерархии с помощью реестра

1. В [реестре процессов](https://kb.comindware.ru/article.php?id=4833#architect_process_architecture_design_registry_view) нажмите кнопку «**Создать**».
...
1. В [реестре процессов](https://kb.comindware.ru/article.php?id=4833#architect_process_architecture_design_registry_view) установите флажок выбора в строке группы процессов или щёлкните её правой кнопкой мыши.
...
1. В разделе «**Процессы**» [панели навигации](https://kb.comindware.ru/article.php?id=4824) нажмите кнопку «**Действия**» *‌* у группы процессов или у пункта «**Реестр**».
...
1. Дважды нажмите элемент в [конструкторе диаграммы](https://kb.comindware.ru/article.php?id=4835).
...
1. Выберите элемент в [конструкторе диаграммы](https://kb.comindware.ru/article.php?id=4835).
...
У каждого элемента процессной архитектуры предусмотрены настраиваемые свойства ([атрибуты](https://kb.comindware.ru/article.php?id=4833#architect_process_architecture_design_entity_form_attributes_configure)).
...
1. Перейдите к [конструктору диаграммы](https://kb.comindware.ru/article.php?id=4835) элемента процессной архитектуры.
...
6. При необходимости [отредактируйте атрибуты и форму свойств элемента](https://kb.comindware.ru/article.php?id=4833#architect_process_architecture_design_entity_form_attributes_configure).

Примечание

Изменения, внесённые в [конструкторе диаграмм](https://kb.comindware.ru/article.php?id=4835), сохраняются автоматически. Отмена изменений не предусмотрена.
...
7. Создайте или отредактируйте атрибуты элемента процессной архитектуры. См. *«[Операции на панели элементов конструктора форм](https://kb.comindware.ru/article.php?id=4786#form_designer_elements_operations)»*.
8. Перетащите на форму новые атрибуты и визуальные элементы или удалите ненужные. См. *«[Редактирование формы](https://kb.comindware.ru/article.php?id=4786#form_designer)»*.
...
1. Выберите элемент на диаграмме.
2. Нажмите кнопку требуемого цвета в разделе «**Изменить цвет**» [меню элемента](https://kb.comindware.ru/article.php?id=4835#architect_process_architecture_diagram_designer_element_menu).
...
1. В [реестре процессов](https://kb.comindware.ru/article.php?id=4833) наведите указатель мыши на первую ячейку в строке процесса или группы процессов, которую требуется переместить на другой уровень иерархии.
...
В [панели навигации](https://kb.comindware.ru/article.php?id=4824) нажмите и перетащите процесс или группу процессов в новую родительскую группу.
...
1. В разделе «**Процессы**» [панели навигации](https://kb.comindware.ru/article.php?id=4824) нажмите кнопку «**Действия**» *‌* у элемента, который требуется дублировать.
...
4. Присвойте наглядное название созданному элементу. См. «*[Переименование элемента процессной архитектуры](https://kb.comindware.ru/article.php?id=4833#architect_process_architecture_design_entity_rename)*».
...
При удалении с диаграммы элемента «**Встроенный подпроцесс**», «**Группа процессов**», «**Ссылка на процесс**» или «**Ссылка на группу процессов**» этот элемент также будет удалён из [реестра процессов](https://kb.comindware.ru/article.php?id=4833).

Кроме того, будут удалены все ссылки на данный элемент на других диаграммах.

1. Выберите элемент, подлежащий удалению, в [конструкторе диаграммы](https://kb.comindware.ru/article.php?id=4835).
...
1. Установите для подлежащих удалению элементов флажки выбора в первом столбце [реестра процессов](https://kb.comindware.ru/article.php?id=4833).
...
- *[Редактирование диаграмм процессов и бизнес-способностей](https://kb.comindware.ru/article.php?id=4835)*
- *[Проверка диаграммы процесса](https://kb.comindware.ru/article.php?id=4835#architect_process_architecture_diagram_verify)*
- *[Редактирование формы](https://kb.comindware.ru/article.php?id=4786#form_designer)*
- *[Операции на панели элементов конструктора форм](https://kb.comindware.ru/article.php?id=4786#form_designer_elements_operations)*
