...
1. В разделе «**Процессы**» [панели навигации](https://kb.comindware.ru/article.php?id=4824) нажмите кнопку «**Действия**» *‌* у любого элемента.
...
1. Перейдите к [конструктору диаграммы](https://kb.comindware.ru/article.php?id=4835).
...
См. также *[Подробный пример экспорта регламента процессов](https://kb.comindware.ru/article.php?id=4826#architect_demo_organizational_structure_processes_export)*.
...
- *[Просмотр реестра процессов](https://kb.comindware.ru/article.php?id=4833)*
