...
Для быстрого развёртывания **Comindware Platform** в Linux компания **Comindware** предоставляет дистрибутив с установщиком, настраивающим необходимое программное обеспечение. См. *[Comindware Platform 5.0. Перечень стороннего программного обеспечения для Linux](https://kb.comindware.ru/article.php?id=4582)*.
...
2. Установите ПО **Comindware Platform**.
...
Следуйте письменным инструкциям
...
4. Установите ПО из дистрибутива:
   ...
   Скрипт `prerequisites_install.sh` устанавливает необходимые для **Comindware Platform** компоненты, включая Java, .NET, Mono, NGINX.
...
Для установки ПО **Comindware Platform** всегда следуйте письменным инструкциям, представленным ниже.
...
1. Перейдите в режим суперпользователя:
   ...
   su -
   ```
2. Скачайте и распакуйте дистрибутив ПО **Comindware Platform**, полученный по ссылке от компании **Comindware**:
...
3. Перейдите в директорию со скриптами для развёртывания ПО:
   ...
   Здесь: `<distPath>/CMW_<osname>_<versionNumber>/` — путь к распакованному дистрибутиву со ПО **Comindware Platform**.
4. Установите ПО из дистрибутива:
...
Для создания экземпляра ПО **Comindware Platform** всегда следуйте письменным инструкциям, представленным ниже.
...
1. Перейдите в режим суперпользователя:
   ...
   su -
   ```
2. Просмотрите список имеющихся экземпляров ПО **Comindware Platform**:
...
3. Перейдите в директорию со скриптами для развёртывания ПО **Comindware Platform**:
...
- [Пути и содержимое директорий экземпляра ПО](https://kb.comindware.ru/article.php?id=4620)
- [Обновление версии экземпляра ПО с его остановкой](https://kb.comindware.ru/article.php?id=4624)
