...
4.15. Дождитесь открытия начальной страницы «**Корпоративная архитектура**».

4.16. На этом этапе развёртывание экземпляра ПО завершено и можно приступать к работе.

_![Рисунок 4.5. Начальная страница «**Корпоративная архитектура**»](https://kb.comindware.ru/assets/img_63beae2d4c4e5.png)_