...
11. Создайте записи со следующими *названиями*:
    ...
    ![Заполненный справочник «Статусы заявок»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_7_request_statuses_list.png)
...
13. С помощью меню элемента создайте атрибут в шаблоне *«Заявки на автомобили»*:
    ...
    ![Представление связей на диаграмме модели данных](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_7_data_model_relations.png)
