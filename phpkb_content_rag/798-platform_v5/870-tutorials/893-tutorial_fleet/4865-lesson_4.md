...
**Предусловия:** пройден *[урок 3 «Мой первый бизнес-процесс»](https://kb.comindware.ru/article.php?id=5414)*.
...
**Comindware Platform** позволяет анализировать состояние запущенных и завершённых экземпляров бизнес-процессов.
...
3. В списке выберите один из запущенных экземпляров процесса, дважды нажав его.
   ...
   ![Переход к экземпляру процесса из списка](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_4_process_instance_list.png)
...
6. На панели справа отобразится информация о её выполнении.
   ...
   ![Информация о токенах на задаче на диаграмме экземпляра процесса](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_4_process_instance_tokens.png)
...
9. Аналогично выберите любой другой элемент диаграммы процесса для просмотра сведений о нём.
   ...
   ![Журнал изменений задачи на диаграмме экземпляра процесса](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_4_process_instance_changelog.png)
...
**Comindware Platform** позволяет создавать информационные страницы (дашборды) для мониторинга и анализа статистических данных за определённый период. Информационная страница может содержать диаграммы, списки, показатели и другие виджеты для визуализации бизнес-данных.
...
9. В панели элементов слева нажмите кнопку «**Создать страницу**» *‌* рядом с пунктом «**Страницы**».
   ...
   ![Переименование раздела навигации и создание информационной страницы](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_4_navigation_section_rename.png)
...
13. Обновите страницу в браузере, чтобы последующие шаги выполнялись корректно. Если браузер выдаст предупреждение о возможной утрате несохранённых изменений, подтвердите обновление страниц.
    ...
    ![Переименование и сохранение страницы](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_4_page_rename.png)
...
16. Нажмите кнопку «**Редактировать**» *‌* рядом с пунктом *«Статистика заявок»* в панели элементов.
    ...
    ![Переход к редактированию страницы](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_4_page_edit.png)
...
18. Нажмите кнопку со значком «**Создать диаграмму**» *‌* рядом с пунктом «**Диаграммы**» в панели элементов.
    ...
    ![Создание диаграммы](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_4_chart_create.png)
...
21. Просмотрите и сохраните результирующую диаграмму.
    ...
    ![Настройка и сохранение круговой диаграммы](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_4_piechart_configure.png)
...
25. Сохраните страницу *«Статистика заявок»*.
    ...
    ![Добавление диаграммы на страницу](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_4_page_chart_configure.png)
...
28. Сохраните раздел навигации.
    ...
    ![Добавление страницы в раздел навигации](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_4_navigation_section_page_add.png)
...
Созданный **раздел навигации** *«Сводки»* мы впоследствии используем в [Уроке 8](https://kb.comindware.ru/article.php?id=5406).

В [следующем уроке](https://kb.comindware.ru/article.php?id=5409) вы познакомитесь с новым типом атрибутов — **Запись**, а также создадите справочник и мастер-данные.