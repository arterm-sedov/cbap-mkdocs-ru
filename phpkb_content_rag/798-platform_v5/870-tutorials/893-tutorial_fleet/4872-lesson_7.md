...
В [следующем уроке](https://kb.comindware.ru/article.php?id=4867) вы настроите пользователей, роли и права доступа для различных элементов приложения.