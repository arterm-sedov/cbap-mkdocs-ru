...
kbId: 4873
url: 'https://kb.comindware.ru/article.php?id=4873'
...
2. Нажмите кнопку «**Создать**».
   ...
   ![Переход к созданию приложения](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_app_create.png)
...
4. Нажмите кнопку «**Сохранить**».
   ...
   ![Настройка свойств нового приложения](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_app_configure.png)
...
6. Отобразится страница «**Администрирование**» приложения.
   ...
   ![Переход к странице администрирования приложения](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_app_list.png)
...
1. На странице «**Администрирование**» приложения *«Управление автопарком»*. выберите пункт «**Шаблоны**» *‌*.
   ...
   ![Переход к списку шаблонов приложения](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_template_list_open.png)
...
4. Нажмите кнопку «**Создать**».
   ...
   ![Переход к созданию шаблона записи](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_record_template_create.png)
...
10. Нажмите кнопку «**Создать**».
    ...
    ![Создание шаблона записи](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_record_template_configure.png)
...
2. Нажмите кнопку «**Создать**».
   ...
   ![Переход к созданию атрибута шаблона записи](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_attribute_create.png)
...
8. Нажмите кнопку «**Сохранить**».
   ...
   ![Настройка свойств атрибута](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_attribute_configure.png)
...
2. В списке форм дважды нажмите пункт *«Заявки на автомобили — Основная форма»*.
   ...
   ![Переход к редактированию формы из списка](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_form_edit.png)
...
5. Перетащите на макет формы атрибут *«Время подачи»* с панели элементов.
   ...
   ![Перетаскивание атрибута на форму](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_form_add_field.png)
...
7. На панели элементов щелкните значок «**Редактировать**» *‌* у атрибута *«Время подачи»*.
   ...
   ![Переход к редактированию атрибута из панели элементов](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_form_edit_attribute.png)
...
10. Нажмите кнопку «**Сохранить**».
    ...
    ![Выбор формата отображения атрибута типа «Дата / время»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_attribute_date_time_edit.png)
...
2. В поле «**Доступ**» на панели свойств поля выберите режим «**Требовать ввод**».
   ...
   ![Выбор режима доступа к полю в форме](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_form_field_access_select.png)
...
5. Перетащите поля *«Время подачи»* и *«Место подачи»* с макета формы соответственно в левый и правый столбцы элемента «**Колонки**».
   ...
   ![Упорядочивание элементов формы с помощью колонок](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_form_columns_arrange.png)
...
7. Сохраните форму, нажав кнопку «**Сохранить**» в конструкторе форм.
   ...
   ![Переименование области формы и сохранение формы](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_form_rename.png)
...
1. Нажмите кнопку «**Настроить шаблон**» *‌*.
   ...
   ![Переход из конструктора формы к настройке шаблона записи](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_form_template_edit.png)

   Переход из конструктора формы к настройке шаблона записи
2. Нажмите кнопку «**Перейти к экземплярам**».

   ![Переход к списку записей шаблона](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_template_open_record_list.png)
...
4. Нажмите кнопку «**Создать**», чтобы оформить новую заявку на автомобиль — запись в шаблоне.
   ...
   ![Переход к созданию записи из списка записей шаблона](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_template_record_create.png)
...
6. Заполните все поля и нажмите кнопку «**Сохранить**».
   ...
   ![Заполнение заявки на автомобиль](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_request_create.png)

   Заполнение заявки на автомобиль
7. Нажмите ссылку «**Заявки на автомобили**» над формой, чтобы вернуться к списку заявок.

   ![Переход с формы к списку записей шаблона](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_request_return_to_list.png)
...
10. Двойным нажатием в списке записей откройте созданную запись, измените данные заявки и сохраните её.
    ...
    ![Открытие записи из списка](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_template_record_open.png)
...
1. Перейдите к настройке шаблона записи. Для этого нажмите кнопку «**Мои настройки**» *‌* на странице «**Все записи**» и выберите пункт «**Настроить шаблон**».
   ...
   ![Переход к настройкам шаблона из списка записей](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_template_edit_from_list.png)

   Переход к настройкам шаблона из списка записей
2. На странице шаблона записи выберите вкладку «**Атрибуты**».
3. Нажмите кнопку «**Создать**».

   ![Переход к созданию атрибута в шаблоне](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_template_attribute_create.png)
...
6. Нажмите кнопку «**Сохранить**».
   ...
   ![Создание атрибута «Заявка одобрена» типа «Логический»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_template_attribute_configure.png)
...
1. Перейдите на вкладку «**Таблицы**» шаблона записи и дважды нажмите строку «**Все записи**».
   ...
   ![Переход к конструктору таблицы](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_template_table_edit.png)
...
6. Оставьте в таблице столбцы «**Создатель**» и «**Дата изменения**».
   ...
   ![Конструктор таблицы — удаление столбцов](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_table_designer_column_delete.png)
...
11. В меню *‌* выберите пункт «**Настроить шаблон**».
    ...
    ![Конструктор таблицы — добавление столбцов и возврат к настройке шаблона](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_table_designer_column_add.png)
...
13. Нажмите кнопку «**Перейти к экземплярам**», чтобы открыть список заявок в виде таблицы с настроенными столбцами.
    ...
    ![Таблица со список заявок на автомобили с настроенными столбцами](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_request_list.png)
...
1. Нажмите заголовок столбца *«Время подачи»*, чтобы отсортировать данные по этому столбцу:
   ...
   ![Сортировка таблицы нажатием заголовка столбца](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_table_sort.png)
...
4. Нажмите кнопку «**Сохранить**».
   ...
   ![Применение фильтра записей по содержимому столбца](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_table_filter.png)
...
6. Чтобы сбросить фильтр записей, нажмите значок фильтра *‌* в столбце *«Маршрут»*, снимите флажок «**Фильтровать данные**» и нажмите кнопку «**Сохранить**».
   ...
   ![Отключение фильтрации записей в таблице](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_table_filter_disable.png)
...
2. В раскрывшемся меню установите флажок «**Группировать**» и нажмите кнопку «**Сохранить**».
   ...
   ![Группировка записей в таблице](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_table_group.png)
...
2. В раскрывшемся меню выберите пункт «**Настроить внешний вид**».
   ...
   ![Переход к пользовательской настройке внешнего вида таблицы](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_table_go_to_personal_config.png)
...
6. Чтобы восстановить исходную конфигурацию отображения таблицы, нажмите кнопку «**Сбросить**».
   ...
   ![Настройка пользовательской конфигурации внешнего вида таблицы](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_table_personal_config.png)
...
2. Отобразится конструктор таблицы.
   ...
   ![Переход к конструктору таблицы](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_table_go_to_designer.png)
...
6. Нажмите кнопку «**Сохранить**».
   ...
   ![Настройка параметров сортировки, группировки и фильтрации списка по умолчанию для всех пользователей](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_2_table_designer_advanced_properties.png)
