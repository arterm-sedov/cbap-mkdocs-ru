...
**Предусловие:** пройдены *[урок 3 «Мой первый бизнес-процесс»](https://kb.comindware.ru/article.php?id=5405)* и *[урок 4 «Мониторинг и аналитика»](https://kb.comindware.ru/article.php?id=5405)*.
...
6. Укажите **название** роли — *«Заказчик»*.
   ...
   ![Создание роли «Заказчик»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_role_create_customer.png)
...
12. Для кнопок «**Создать**» и «**Завершить задачу**» установите разрешения «**Использование кнопки**», как показано на иллюстрации.
    ...
    ![Настройка разрешений для приложения, шаблона процесса и кнопок «Создать» и «Завершить задачу»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_role_permissions_customer_fleet_management.png)
...
13. Перетащите на таблицу разрешений справочник *«Типы автомобилей»* и установите для него разрешение «**Просмотр**».
    ...
    ![Назначение разрешения «Просмотр» для справочника «Типы автомобилей»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_role_permissions_customer_vehicle_types.png)
...
18. Сохраните роль *«Заказчик»*.
    ...
    ![Настройка разрешений роли «Заказчик» для создания и просмотра заявок на автомобиль](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_role_permissions_customer_requests.png)
...
_![Настройка разрешений роли «Секретарь»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_role_permissions_secretary.png)_
...
_![Настройка разрешений роли «Диспетчер гаража»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_role_permissions_garage_manager.png)_
...
_![Настройка разрешений роли «Водитель»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_role_permissions_driver.png)_
...
3. Укажите название группы *«Секретари»* и нажмите кнопку «**Создать**», чтобы сохранить группу.
   ...
   ![Создание новой группы аккаунтов](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_group_create.png)
...
5. Создайте группу *«Сотрудники»*, которая будет включать в себя всех сотрудников:
   ...
   - Эти группы отобразятся в правом столбце будут добавлены в группу *«Сотрудники»*.![Участники группы «Сотрудники»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_group_members_employees.png)

   Участники группы «Сотрудники»
6. Нажмите кнопку «**Создать**», чтобы сохранить группу *«Сотрудники»*.

   ![Результирующий список групп](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_groups_resulting.png)
...
2. В отобразившемся списке ролей откройте роль *«Заказчик»*, дважды нажав её.
   ...
   ![Переход к настройке роли](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_open_role.png)
...
4. Сохраните роль *«Заказчик»*.
   ...
   ![Выбор группы аккаунтов для роли «Заказчик»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_role_group_assign.png)
...
7. В меню элемента нажмите кнопку «**Свойства**» *‌*.
   ...
   ![Переход к настройке свойств задачи с диаграммы процесса](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_diagram_task_properties_open.png)
...
10. Нажмите кнопку «**Сохранить**».
    ...
    ![Назначение исполнителей задачи](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_diagram_task_assignees_select.png)
...
2. В списке аккаунтов нажмите кнопку «**Создать**».
   ...
   ![Переход к созданию аккаунта](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_account_list_create.png)
...
8. Нажмите кнопку «**Создать**», чтобы сохранить аккаунт.
   ...
   ![Создание аккаунта Диспетчера](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_account_create_garage_manager.png)
...
11. Создайте аккаунт *Заказчика* с любой должностью. Пользователь этого аккаунта будет создавать заявки.
    ...
    ![Результирующий список аккаунтов](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_accounts_resulting.png)
...
5. Сохраните группу.
   ...
   ![Выбор участников группы «Водители»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_group_drivers_account_select.png)
...
7. Выберите группу *«Сотрудники»* и добавьте в неё аккаунт любого из *Заказчиков*.
   ...
   ![Добавление аккаунта Заказчика в группу «Сотрудники»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_group_employees_customer_add.png)
...
8. Назначьте разделу навигации выбрать роль, для пользователей которой он будет отображаться:
   ...
   - Нажмите кнопку «**Применить**».![Выбор роли для раздела навигации](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_navigation_section_role_select.png)
...
10. Сохраните раздел навигации.
    ...
    ![Настройка раздела навигации для роли «Заказчик»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_navigation_section_configure_customer.png)
...
_![Настройка раздела навигации для роли «Секретарь»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_navigation_section_configure_secretary.png)_
...
1. Откройте список разделов навигации приложения *«Управление автопарком»*.
2. Откройте раздел навигации *«Сводки»*, созданный в ходе [Урока 4](https://kb.comindware.ru/article.php?id=5405).
...
_![Настройка раздела навигации для сотрудников гаража](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_navigation_section_configure_garage_employees.png)_

_![Результирующий список разделов навигации приложения «Управление автопарком»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_navigation_sections_resulting.png)_
...
Для удобства проводите тестирование в новом окне браузера в режиме *«Инкогнито»* или разных браузерах.
...
3. Заполните поля стартовой формы, чтобы создать заявку на автомобиль и запустить бизнес-процесс.
   ...
   ![Панель навигации Заказчика и стартовая форма заявки на автомобиль](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_request_create.png)
...
4. Выйдите из системы: для этого нажмите значок пользователя в правом верхнем углу страницы и выберите пункт «**Выход**».
   ...
   ![Выход из системы](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_logout.png)
...
3. Откройте задачу *«Рассмотреть заявку»*, дважды нажав её.
   ...
   ![Страница «Мои задачи» для Секретаря](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_my_tasks_secretary.png)
...
5. Выйдите из системы.
   ...
   ![Панель навигации и форма заявки на автомобиль для Диспетчера гаража](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_task_accept_request.png)
...
4. Завершите задачу.
   ...
   ![Панель навигации и форма заявки на автомобиль для Водителя](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_8_task_perform_ride.png)
...
В ходе [следующего урока](https://kb.comindware.ru/article.php?id=5408) вы научитесь формировать документы с данными из приложения.