...
5. Нажмите кнопку «**Сохранить**».
   ...
   ![Создание новой диаграммы модели данных](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_data_model_diagram_create.png)
...
6. Отобразится конструктор диаграммы модели данных.
   ...
   **Конструктор диаграммы модели данных** содержит следующие области:
   ...
   ![Конструктор диаграммы модели данных](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_data_model_diagram_designer.png)

   Конструктор диаграммы модели данных
7. Перетащите на диаграмму шаблон записи *«Заявки на автомобили»* с панели элементов слева.

   ![Добавление шаблона на диаграмму модели данных](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_data_model_diagram_add_template.png)
...
2. В отобразившемся окне настройте и сохраните **новый шаблон**:
   ...
   - **Системное имя:** будет заполнено автоматически![Настройка шаблона записи с помощью диаграммы модели данных](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_template_create.png)
...
7. Аналогичным образом создайте ещё два типа автомобилей — *«Представительский» и «Автобус».*
   ...
   ![Создание записи с типом автомобиля и переход к списку записей](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_vehicle_type_create.png)
...
8. Должен получиться показанный ниже справочник типов автомобилей.
   ...
   ![Справочник «Типы автомобилей»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_vehicle_type_list.png)
...
2. В меню элемента нажмите кнопку «**Добавить новый атрибут**» *‌*.
   ...
   ![Создание атрибута шаблона записи с помощью диаграммы модели данных](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_data_model_attribute_create.png)
...
3. В отобразившемся окне настройте и сохраните **новый атрибут**:
   ...
   - **Связанный шаблон:** *Типы автомобилей*![Настройка атрибута «Тип автомобиля»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_attribute_record_properties.png)
...
_![Отображение связи между шаблонами](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_data_model_relations_show_requests.png)_
...
4. Отобразится вкладка «**Атрибуты**» со списком атрибутов шаблона.
   ...
   ![Создание нового шаблона записи с помощью диаграммы модели данных и переход к его списку атрибутов](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_data_model_template_create.png)
...
_![Атрибуты шаблона записи «Автомобили»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_template_attibutes_vehicles.png)_
...
_![Настройка формы «Автомобиль»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_form_vehicle_configure.png)_
...
_![Настройка таблицы «Автомобили»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_table_vehicles_configure.png)_
...
6. Нажмите ссылку «*Автомобили*» над формой, чтобы вернуться к списку записей.
   ...
   ![Создание новой записи в шаблоне «Автомобили»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_vehicle_create.png)
...
7. Создайте ещё несколько записей в шаблоне *«Автомобили»*, указав при этом разные данные и типы автомобилей, как показано на следующей иллюстрации.
   ...
   ![Список автомобилей](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_vehicles_list.png)
...
_![Группировка записей по значению атрибута «Тип»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_vehicle_list_group_type.png)_
...
_![Создание атрибута «Заявки на автомобиль», взаимосвязанного с атрибутом «Автомобили»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_attribute_vehicle_requests_configure.png)_
...
3. Для поля *«Заявки на автомобиль»* выберите **представление** «**Таблица**» с помощью панели свойств.
   ...
   ![Добавление таблицы на форму](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_form_vehicle_table_add.png)
...
5. Перетащите в таблицу на форме атрибуты *«Время подачи», «Маршрут»* и *«Создатель»*.
   ...
   ![Добавление столбцов в таблицу на форме](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_form_vehicle_table_columns_add.png)
...
9. Сохраните форму.
   ...
   ![Настройка кнопок для работы с записями в связанном шаблоне](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_form_vehicle_table_buttons_add.png)
...
2. С помощью меню элемента перейдите на вкладку «**Формы**».
   ...
   ![Переход к списку формы шаблона записи с диаграммы модели данных](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_data_model_form_list_open.png)
...
6. Нажмите кнопку «**Настроить шаблон**» *‌*, чтобы перейти к свойствам шаблона.
   ...
   ![Настройка формы «Типы затрат — Основная форма»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_form_cost_type.png)
...
4. Нажмите кнопку «**Настроить шаблон**» *‌*, чтобы перейти к свойствам шаблона.
   ...
   ![Настройка таблицы «Типы затрат»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_table_cost_type.png)
...
_![Список типов затрат](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_cost_type_list.png)_
...
5. Сохраните форму.
   ...
   ![Настройка формы «Затраты»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_form_costs_configure.png)
...
8. Если связь не отображается, в меню элемента шаблона *«Типы затрат»* нажмите кнопку «**Показать связанные элементы**» *‌*.
   ...
   ![Отображение связей шаблона «Типы затрат» на диаграмме модели данных](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_data_model_template_cost_types_relations_show.png)
...
3. Создайте атрибут со следующими свойствами:
   ...
   - **Взаимная связь с атрибутом: с новым**
     ...
     - **Хранить несколько значений:** не устанавливайте флажок![Настройка взаимосвязанных атрибутов «Затраты» и «Заявка»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_costs_reqest_relation_configure.png)
...
4. На диаграмме должна отображаться связь между шаблонами *«Заявки на автомобили»* и *«Затраты»*. Если связь не отображается, в меню элемента шаблона *«Заявки на автомобили»* нажмите кнопку «**Показать связанные элементы**» *‌*.
   ...
   ![Отображение связей шаблона записи «Заявки на автомобили»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_data_model_relations_show.png)
...
2. Перейдите к списку таблиц шаблона *«Затраты»*, выбрав в его меню элемента пункт «**Перейти к шаблону**» *‌* — «**Таблицы**» *‌*.
   ...
   ![Переход к таблицам шаблона записи «Затраты» с диаграммы модели данных](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_data_model_costs_table_edit.png)
...
4. Сохраните таблицу.
   ...
   ![Настройка таблицы «Все записи» шаблона «Затраты»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_5_costs_table_configure.png)
...
В [следующем уроке](https://kb.comindware.ru/article.php?id=5410) мы усовершенствуем наш процесс — используем созданный справочник, мастер-данные и транзакционные данные.