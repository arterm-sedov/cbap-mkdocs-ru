...
**Предусловия:** пройден *[урок 5 «Структуры данных»](https://kb.comindware.ru/article.php?id=4869)*.
...
В [следующем уроке](https://kb.comindware.ru/article.php?id=4872) вы настроите автоматическое вычисление номера, статуса и итоговой суммы затрат по заявке, а также фильтрацию при выборе типа автомобиля.