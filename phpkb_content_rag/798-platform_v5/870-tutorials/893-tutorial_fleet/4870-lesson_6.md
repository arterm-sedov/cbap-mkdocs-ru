...
kbId: 4870
url: 'https://kb.comindware.ru/article.php?id=4870'
...
**Предусловия:** пройден *[урок 5 «Структуры данных»](https://kb.comindware.ru/article.php?id=5409)*.
...
_![Добавление атрибута «Тип автомобиля» на форму заявки на автомобиль](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_6_request_form_vehicle_type_add.png)_
...
4. В меню элемента нажмите кнопку «**Форма**» *‌*.
   ...
   ![Переход к настройке формы задачи «Принять заявку» на диаграмме процесса](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_6_process_accept_task_form.png)
...
8. Сохраните форму.
   ...
   ![Добавление атрибута «Автомобиль» на форму задачи «Принять заявку»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_6_accept_task_form_vehicle_add.png)
...
4. В панели свойств для поля *«Затраты»* выберите **представление** «**Таблица**».
   ...
   ![Добавление на форму задачи «Выполнить рейс» раскрывающегося списка «Автомобиль» и таблицы «Затраты»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_6_driver_task_form_costs_car_add.png)
...
7. Выберите **область кнопок** таблицы *«Затраты»* и перетащите на нее из панели элементов кнопки «**Создать**», «**Редактировать**» и «**Перейти**». Это позволит пользователю создавать, редактировать и просматривать записи о затратах в таблице *«Затраты»* на форме.
   ...
   ![Добавление в таблицу на форме задачи «Выполнить рейс» атрибутов записи «Затраты»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_6_driver_task_form_cost_type_add.png)
...
2. Настройте **новый атрибут**:
   ...
   - **Тип данных: число**
   - **Количество знаков после запятой: 2**![Настройка атрибута «Итоговая сумма затрат» в шаблоне «Заявки на автомобили»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_6_total_cost_attribute_configure.png)
...
5. Укажите **форму** для создания записей: *«Автомобиль — Основная форма».*
   ...
   ![Настройка атрибута «Автомобиль» для создания записей на лету](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_6_driver_task_form_select_vehicle.png)
...
2. В форме задачи *«Выполнить рейс»* нажмите кнопку «**Создать**» в поле *«Автомобиль».*
   ...
   ![Создание автомобиля с помощью раскрывающегося списка на форме](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_6_vehicle_select.png)
...
В [следующем уроке](https://kb.comindware.ru/article.php?id=5411) вы настроите автоматическое вычисление номера, статуса и итоговой суммы затрат по заявке, а также фильтрацию при выборе типа автомобиля.