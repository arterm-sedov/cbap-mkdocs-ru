...
kbId: 4866
url: 'https://kb.comindware.ru/article.php?id=4866'
updated: '2026-06-20 18:05:33'
---
...
**Предусловие:** пройден *[урок 9 «Формирование документов»](https://kb.comindware.ru/article.php?id=5408)*.
...
4. Сохраните атрибут.
   ...
   ![Настройка атрибута типа «Документ»](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_10_document_attribute_configure.png)
...
7. Сохраните форму задачи.
   ...
   ![Добавление атрибута типа «Документ» в таблицу на форме](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_10_document_add_to_table.png)
...
_![Загрузка и скачивание файла с помощью таблицы на форме](/platform/v5.0/tutorials/tutorial_fleet/img/lesson_10_file_download_upload.png)_
