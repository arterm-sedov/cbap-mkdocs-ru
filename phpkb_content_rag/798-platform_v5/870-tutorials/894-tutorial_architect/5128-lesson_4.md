...
4. Создайте шаблон процесса со следующими свойствами:
   ...
   - **Связанный шаблон: Процессы**![Создание шаблона процесса «Согласование процесса»](/platform/v5.0/tutorials/tutorial_architect/img/lesson_4_process_create.png)
...
5. Выберите задачу на диаграмме и с помощью меню элемента настройте **свойства** задачи:
   ...
   - На вкладке «**Дополнительные**»:
     ...
     - Задайте **заголовок задачи** *«Согласовать процесс»*.![Настройка свойств пользовательской задачи «Согласовать процессю](/platform/v5.0/tutorials/tutorial_architect/img/lesson_4_USERTASK_SETTINGS.png)
...
4. Задайте для **начального события** следующие свойства:
   ...
   - **Контекстный шаблон: Процессы**![Свойства начального события сценария](/platform/v5.0/tutorials/tutorial_architect/img/lesson_4_trigger_properties.png)
...
- [Шаблоны моделей](https://kb.comindware.ru/article.php?id=5149)
- [Атрибут типа «Модель»](https://kb.comindware.ru/article.php?id=5148)
