...
**Предусловия:** пройден [урок 3 «Моделирование процессной архитектуры»](https://kb.comindware.ru/article.php?id=5420).
...
В ходе [следующего урока](https://kb.comindware.ru/article.php?id=5417) вы научитесь формировать собственные шаблоны экспорта регламентов корпоративной архитектуры, управлять версиями корпоративной архитектуры, а также экспортировать диаграммы в различных форматах для интеграции с внешними системами.

## Связанные статьи

Подробные сведения о настройке **Comindware Platform Enterprise** представлены в руководстве пользователя:

- [Шаблоны моделей](https://kb.comindware.ru/article.php?id=5719)
- [Атрибут типа «Модель»](https://kb.comindware.ru/article.php?id=5691)
- [Шаблон автоматизированного процесса](https://kb.comindware.ru/article.php?id=5694)
- [Диаграмма автоматизированного процесса. Настройка](https://kb.comindware.ru/article.php?id=5657)
- [Элементы диаграммы автоматизированного процесса](https://kb.comindware.ru/article.php?id=5662)
- [Стартовая форма и форма пользовательской задачи автоматизированного процесса.](https://kb.comindware.ru/article.php?id=5660)
- [Кнопки. Настройка](https://kb.comindware.ru/article.php?id=5728)
