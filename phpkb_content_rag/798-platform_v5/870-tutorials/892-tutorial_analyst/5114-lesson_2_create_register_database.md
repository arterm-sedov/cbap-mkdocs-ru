...
В ходе этого урока вы научитесь входить в **Comindware Platform** и ознакомитесь с основными элементами системы.
...
**Предусловия:** пройден [урок 1 «Обзор возможностей Comindware Platform и понятий BPMS»](https://kb.comindware.ru/article.php?id=5114).
...
_![Страница входа в Comindware Platform](/platform/v5.0/tutorials/tutorial_hr/img/lesson_2_login_page.png)_
...
В [следующем уроке](https://kb.comindware.ru/article.php?id=5115) вы узнаете, как спроектировать и запустить бизнес-процесс.