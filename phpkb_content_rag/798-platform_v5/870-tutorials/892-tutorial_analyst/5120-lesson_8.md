...
**Предусловия:** пройден [урок 4. Связи и коллекции записей, документооборот](https://kb.comindware.ru/article.php?id=5116).
...
2. Создайте атрибут *«Ссылка на запись»* со следующими свойствами:
   ...
   ![Настройка атрибута «Ссылка на запись»](/platform/v5.0/tutorials/tutorial_hr/img/lesson_8_attribute_link.png)
...
4. Создайте атрибут *«Имя файла»* со следующими свойствами:
   ...
   - **Вычисляемое значение: N3**
     ...
     **Язык N3** — это компактный язык для описания данных и правил обработки информации. В **Comindware Platform** он используется для создания вычисляемых атрибутов, автоматизации бизнес-логики и интеграции с внешними системами.
     ...
     Подробное описание синтаксиса и возможностях языка N3 см. в *[Руководстве по языку N3](https://kb.comindware.ru/article.php?id=4931)»*.

_![Настройка атрибута «Имя файла»](/platform/v5.0/tutorials/tutorial_hr/img/lesson_8_attribute_filename.png)_
...
_![Подготовка шаблона экспорта в Excel](/platform/v5.0/tutorials/tutorial_hr/img/lesson_8_excel_export_template.png)_
...
_![Настройка шаблона экспорта](/platform/v5.0/tutorials/tutorial_hr/img/lesson_8_export_template_setting.png)_
...
_![Настройка кнопки «Отчёт о найме»](/platform/v5.0/tutorials/tutorial_hr/img/lesson_8_button_settings.png)_
...
7. Сохраните форму.
   ...
   ![Настройка формы «Выгрузка отчёта»](/platform/v5.0/tutorials/tutorial_hr/img/lesson_8_form_export.png)
...
6. Нажмите кнопку *«Отчёт о найме»* и дождитесь экспорта (скачивания) сформированного PDF-документа.
   ...
   ![Выгрузка сформированного по шаблону экспорта документа с помощью кнопки на форме](/platform/v5.0/tutorials/tutorial_hr/img/lesson_hr_8_download_report.png)
...
_![PDF-документ отчёта о найме, экспортированный по шаблону в формате Excel](/platform/v5.0/tutorials/tutorial_hr/img/lesson_hr_8_report.png)_
...
На этом курс «**Аналитик. Базовый**» завершён. Ознакомьтесь с *[Заключением](https://kb.comindware.ru/article.php?id=5121)*.