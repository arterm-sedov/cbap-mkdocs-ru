...
3. Создайте атрибут типа «**Запись**» со следующими свойствами:
   ...
   - **Хранить несколько значений:** флажок установлен![Свойства атрибута «Документы»](/platform/v5.0/tutorials/tutorial_hr/img/lesson_4_attribute_multiple.png)
...
В [следующем уроке](https://kb.comindware.ru/article.php?id=5117) вы познакомитесь с вычисляемыми атрибутами, и автоматизацией расчётов в системе, условным управлением потоками процесса и контролем ввода данных.