...
**Предусловия:** пройден [урок 6. Управление доступом: аккаунты, роли, навигация](https://kb.comindware.ru/article.php?id=5118).
...
В ходе [следующего урока](https://kb.comindware.ru/article.php?id=5120) вы научитесь формировать отчётные документы с данными из приложения.