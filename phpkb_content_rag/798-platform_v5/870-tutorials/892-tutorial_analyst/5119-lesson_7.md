...
**Предусловия:** пройден [урок 6. Управление доступом: аккаунты, роли, навигация](https://kb.comindware.ru/article.php?id=5401).
...
В ходе [следующего урока](https://kb.comindware.ru/article.php?id=5403) вы научитесь формировать отчётные документы с данными из приложения.