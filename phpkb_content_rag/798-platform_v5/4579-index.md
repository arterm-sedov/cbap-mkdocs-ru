...
Здесь представлены инструкции для ПО **Comindware Platform** предыдущей поддерживаемой версии **5.0**.
...
- Версии **Comindware Platform**, выпущенные **до 31.12.2025**, содержат критические уязвимости. Рекомендуется перейти на **версию 5.0 от 31.12.2025 или более позднюю**.
