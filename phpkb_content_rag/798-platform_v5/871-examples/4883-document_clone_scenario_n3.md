...
Здесь представлены инструкции по настройке сценария для клонирования записи вместе с файлами, прикреплёнными к [атрибуту типа «**Документ**»](https://kb.comindware.ru/article.php?id=4782).
...
1. На странице [администрирования приложения](https://kb.comindware.ru/article.php?id=4714) выберите пункт «**Сценарии**».
2. Создайте сценарий:
