...
См. также *«[Чертёж. Подготовка и импорт файла DWG](https://kb.comindware.ru/article.php?id=4906)»* и *«[Атрибут типа «Чертёж». Настройка шаблонов, атрибутов, форм и полей](https://kb.comindware.ru/article.php?id=4785#form_dynamic_elements_drawing)»*.
...
Имеется подготовленный чертёж в формате DWG с четырьмя слоями. Для корректного импорта чертёж необходимо подготовить в соответствии с требованиями, приведёнными в статье *«[Чертёж. Подготовка и импорт файла DWG](https://kb.comindware.ru/article.php?id=4906)»*.
...
6. Настройте привязку записей из шаблона *«Заявки»* к маркерам на плане с помощью панели «**Свойства маркеров**»:
   ...
   - **Таблица:** *Все записи.* Эта таблица будет отображаться на вкладке «**Заявки**» слева от плана. Если для таблицы назначено [представление карточек](https://kb.comindware.ru/article.php?id=4799), то оно будет отображаться вместо таблицы.
...
- *[Чертёж. Подготовка и импорт файла DWG](https://kb.comindware.ru/article.php?id=4906)*
- *[Чертёж. Настройка поля на форме](https://kb.comindware.ru/article.php?id=4785#form_dynamic_elements_drawing)*