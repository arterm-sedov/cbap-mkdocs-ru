...
См. также *«[Уведомления. Типы, назначение, настройка, использование](https://kb.comindware.ru/article.php?id=4682)»*.
...
5. Настройте событие-отправку сообщения. См. *«[Отправка эл. почты из сценариев](https://kb.comindware.ru/article.php?id=4692)»*.
...
- [Вычисление пользователей, у которых есть активные задачи](https://kb.comindware.ru/article.php?id=4966)
- [Отправка эл. почты из сценариев](https://kb.comindware.ru/article.php?id=4692)
