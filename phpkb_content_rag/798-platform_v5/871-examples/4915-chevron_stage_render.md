...
6. На вкладке «**Основные**» настройте параметры следующим образом:
   ...
   - **Атрибут связи:** *Этапы открытия магазина → Этап из справочника* (в этот атрибут будет записываться **ID** [этапа из справочника](#example_chevron_stage_render_stages_reference), возвращённый **выражением для выборки объектов**, для каждой созданной записи в шаблоне *«[Этапы](#example_chevron_stage_render_stages_template)»)*.![Настройка вызова процесса «Копирование этапов из справочника»](https://kb.comindware.ru/assets/img_660a6ed14aa42.png)
