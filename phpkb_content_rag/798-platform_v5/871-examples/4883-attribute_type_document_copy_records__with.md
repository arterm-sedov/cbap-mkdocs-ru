---
title: 'Атрибут типа «Документ». Клонирование записи вместе с прикреплёнными файлами с помощью сценария по нажатию кнопки'
kbId: 4883
url: 'https://kb.comindware.ru/article.php?id=4883'
updated: '2026-06-20 18:05:45'
---

# Атрибут типа «Документ». Клонирование записи вместе с прикреплёнными файлами с помощью сценария по нажатию кнопки

## Введение

Здесь представлены инструкции по настройке сценария для клонирования записи вместе с файлами, прикреплёнными к [атрибуту типа «**Документ**»](https://kb.comindware.ru/article.php?id=5716).
...
1. На странице [администрирования приложения](https://kb.comindware.ru/article.php?id=5643) выберите пункт «**Сценарии**».
2. Создайте сценарий:
