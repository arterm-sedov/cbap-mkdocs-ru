...
kbId: 4917
url: 'https://kb.comindware.ru/article.php?id=4917'
updated: '2026-06-20 20:26:00'
---

# Атрибут типа «Текст». Поиск подстроки с помощью N3

## Введение

**[Текстовый атрибут](https://kb.comindware.ru/article.php?id=4768)** может содержать неограниченное количество символов, например письмо или заявку. Чтобы найти в тексте ключевые слова, например запрещённые или обозначающие срочность, важность и т. п., можно использовать выражение на N3.
