...
Если в **Comindware Platform** настроено подключение к **Р7-Офис**, для полей атрибутов типа «**Документ**» (кроме атрибутов с форматом отображения «**Документ с цифровой подписью**») будут доступны операции «**[Открыть](#открытие-прикреплённого-документа-в-р7-офис-или-collabora-online)**» и «**[Создать](#создание-документа-в-р7-офис-или-collabora-online)**» в зависимости от контекста приложения. См. *«[Collabora Online. Настройка подключения](https://kb.comindware.ru/article.php?id=5627)*».
