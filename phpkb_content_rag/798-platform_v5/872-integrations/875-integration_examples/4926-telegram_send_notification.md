...
**`![](https://kb.comindware.ru/images/marker.png)Шаблоны. Определения, создание, настройка, перенос между приложениями, архивирование, очистка, удаление {Article-ID:4709}`**

**`![](https://kb.comindware.ru/images/marker.png)Кнопки. Определение, настройка, удаление {Article-ID:4790}`**
...
**`![](https://kb.comindware.ru/images/marker.png)Сценарии. Определения, создание, настройка, использование {Article-ID:4717}`**