...
1. Откройте [список подключений](https://kb.comindware.ru/article.php?id=4675).
...
См. параграф [*«Обновление keytab-файла аутентификации»*](https://kb.comindware.ru/article.php?id=4613#sso_authentication_configure_keytab_update).

_![Настройка основных свойств подключения к серверу каталогов](/platform/v5.0/administration/connections_communication_routes/authentication/img/ad_connection_properties_settings.png)_
...
_![Настройка групп на сервере каталогов](/platform/v5.0/administration/connections_communication_routes/authentication/img/ad_connection_groups_settings.png)_
...
_![Сопоставление атрибутов для подключения к серверу каталогов](/platform/v5.0/administration/connections_communication_routes/authentication/img/ad_connection_attributes_difference.png)_
...
- **Домен** — укажите домен сервера каталогов, используемый для аутентификации.
  ...
  - В поле «**Домен**» укажите домен, который будет использоваться как **домен по умолчанию** для данного подключения и (при настройке SSO через Kerberos в Linux) как домен по умолчанию для аутентификации. См. *«[SSO-аутентификация. Настройка ПО, контроллера домена и ПК пользователя](https://kb.comindware.ru/article.php?id=4613)»*.
...
_![Настройка дополнительных свойств подключения к серверу каталогов](/platform/v5.0/administration/connections_communication_routes/authentication/img/ad_connection_advanced_settings.png)_
...
- *[Удаление подключения](https://kb.comindware.ru/article.php?id=4675)*