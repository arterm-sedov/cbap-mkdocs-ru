...
kbId: 4697
url: 'https://kb.comindware.ru/article.php?id=4697'
...
1. [Настройте подключение](https://kb.comindware.ru/article.php?id=4702) типа «**Подключения REST и OData**» — «**Синхронизация с веб-сервисом**».
...
1. Настройте [подключение к OData-сервису](https://kb.comindware.ru/article.php?id=4702).
2. Откройте приложение из списка [приложений](https://kb.comindware.ru/article.php?id=4714).
...
- *[Журнал сеансов синхронизации по OData](https://kb.comindware.ru/article.php?id=4673#logs_odata_integration)*
