...
**Comindware Platform** может обращаться к API внешних систем через [подключения](https://kb.comindware.ru/article.php?id=4675) и [пути передачи данных](https://kb.comindware.ru/article.php?id=4676), а также может обрабатывать запросы из внешних систем через интерфейсы **REST API** трёх типов:
