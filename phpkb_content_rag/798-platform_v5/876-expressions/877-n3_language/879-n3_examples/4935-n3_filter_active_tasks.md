...
См. также *«[Создание таблицы со списком задач](https://kb.comindware.ru/article.php?id=4800#table_configure_tasks_view)»*.
...
- [Вычисление пользователей с активными задачами](https://kb.comindware.ru/article.php?id=4966)
- [Вычисление исполнителя активной задачи](https://kb.comindware.ru/article.php?id=4950)
