...
- *[Подробное описание и другие примеры использования атрибута типа «Список значений»](https://kb.comindware.ru/article.php?id=4779)*
- *[Фильтрация связанных записей по значению атрибута типа «Список значений» с помощью N3](https://kb.comindware.ru/article.php?id=5077)*
- *[Пример настройки интерфейса приложения на нескольких языках](https://kb.comindware.ru/article.php?id=5064)*
...
- *[Написание выражений на языке N3](https://kb.comindware.ru/article.php?id=4852)*
...
- *[Интерфейс на нескольких языках. Настройка приложения](https://kb.comindware.ru/article.php?id=5064)*