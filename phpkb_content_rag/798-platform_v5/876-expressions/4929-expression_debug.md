...
Чтобы выявить ошибки в именах функций, атрибутов, шаблонов и переменных, а также в синтаксисе формулы, выражения N3 или скрипта, используйте функцию проверки в **[редакторе выражений](https://kb.comindware.ru/article.php?id=5025)**.
...
- *[Введение в язык формул Comindware](https://kb.comindware.ru/article.php?id=4999)*
- *[Список функций языка формул Comindware](https://kb.comindware.ru/article.php?id=4993)*
- *[Настройка действий сценария](https://kb.comindware.ru/article.php?id=4718)*