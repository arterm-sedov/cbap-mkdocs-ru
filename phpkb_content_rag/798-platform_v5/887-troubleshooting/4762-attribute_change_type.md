...
- Вместо смены вышеперечисленных свойств мы рекомендуем создавать новый атрибут с необходимыми свойствами, а старый атрибут [архивировать](https://kb.comindware.ru/article.php?id=4772#attributes_archive).
...
- восстановить резервную копию экземпляра ПО **Comindware Platform**, см. статью *«[Общие свойства атрибутов](https://kb.comindware.ru/article.php?id=4765)»;*
- импортировать ранее выгруженную таблицу со значениями атрибута, см. статью *«[Импорт данных в шаблон](https://kb.comindware.ru/article.php?id=4802)»*.
