...
kbId: 1980
url: 'https://kb.comindware.ru/article.php?id=1980'
updated: '2022-02-25 05:52:49'
---
...
Для исключения архивных записей из результата вычисления добавьте в вычисляемое выражение условие «***EQUALS(a-> \_isDisabled,false)***» (пример приведен в статье `![](https://kb.comindware.ru/images/marker.png){Article-ID:1357}`).
