...
kbId: 1978
url: 'https://kb.comindware.ru/article.php?id=1978'
updated: '2024-07-01 14:54:59'
---
...
- Вместо смены вышеперечисленных свойств мы рекомендуем создавать новый атрибут с необходимыми свойствами, а старый атрибут [архивировать](https://kb.comindware.ru/article.php?id=2252#mcetoc_1gk3c03r50).
...
- восстановить резервную копию экземпляра ПО **Comindware Business Application Platform**, см. статью *«`![](https://kb.comindware.ru/images/marker.png)Резервное копирование. Настройка и запуск, просмотр журнала сеансов {Article-ID:2190}`»;*
- импортировать ранее выгруженную таблицу со значениями атрибута, см. статью *«`![](https://kb.comindware.ru/images/marker.png)Импорт данных в шаблон {Article-ID:2555}`»*.

## Связанные статьи

**`![](https://kb.comindware.ru/images/marker.png)Атрибуты. Определения, типы, настройка, архивирование, удаление {Article-ID:2252}`**

**`![](https://kb.comindware.ru/images/marker.png)Вычисляемые атрибуты {Article-ID:2254}`**

**`![](https://kb.comindware.ru/images/marker.png)Общие свойства атрибутов {Article-ID:2260}`**
...
**`![](https://kb.comindware.ru/images/marker.png)Импорт данных в шаблон {Article-ID:2555}`**