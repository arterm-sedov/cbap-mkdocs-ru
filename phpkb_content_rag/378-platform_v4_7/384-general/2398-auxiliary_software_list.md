...
kbId: 2398
url: 'https://kb.comindware.ru/article.php?id=2398'
updated: '2024-10-23 11:31:26'
---
...
В настоящей статье представлен перечень стороннего программного обеспечения (ПО), которое поставляется вместе с **Comindware Business Application Platform** версии 4.7 для операционных систем (ОС) семейства Linux: «Альт Сервер» 10.0–10.1, Astra Linux SE 1.7.5 «Смоленск».
