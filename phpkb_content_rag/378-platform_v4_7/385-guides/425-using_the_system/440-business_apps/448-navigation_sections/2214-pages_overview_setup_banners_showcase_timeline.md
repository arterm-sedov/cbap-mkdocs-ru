...
kbId: 2214
url: 'https://kb.comindware.ru/article.php?id=2214'
updated: '2024-10-31 18:14:48'
---
...
- Страницы можно включить в состав [рабочего стола](https://kb.comindware.ru/article.php?id=2215).

## Настройка свойств и макета страницы

1. Откройте [раздел навигации](https://kb.comindware.ru/article.php?id=2212).
...
2. **Панель элементов слева** — список виджетов, которые можно перетащить на страницу.
   ...
   - **Вкладки**, **Колонки**, **Статичный текст** — эти элементы на страницах используются так же, как на формах. См. статью «[Статические элементы формы: области, вкладки, колонки, статичный текст. Настройка представления](https://kb.comindware.ru/article.php?id=2530)».
...
3. Настройте витрину с помощью панели «**Свойства виджета**»:
   ...
   - **Внешний вид действия** — выберите способ отображения кнопки на плитке:
     ...
     - **Ссылка**
     - **Кнопка**
   - **Действие** — выберите [кнопку](https://kb.comindware.ru/article.php?id=2276) из **шаблона**, которая должна отображаться на плитке.
...
**Временная шкала** отображает данные из выбранного шаблона в графической форме, аналогичной [диаграмме Ганта](https://kb.comindware.ru/article.php?id=2107). Конечный пользователь может нажимать элементы на временной шкале, чтобы перейти к соответствующим записям.

Для формирования временной шкалы потребуется создать шаблон записи (шаблон работ) с атрибутами указанных ниже типов.

Если в приложении уже настроена диаграмма Ганта, для построения временной шкалы можно использовать шаблон работ, используемый для построения диаграммы Ганта. См. статьи *«[Диаграмма Ганта. Настройка](https://kb.comindware.ru/article.php?id=2107)»* и *«[Диаграмма Ганта. Использование](https://kb.comindware.ru/article.php?id=2108)».*

#### Настройка шаблона работ

1. Создайте **[шаблон записи](https://kb.comindware.ru/article.php?id=2221)** *«Работы».*
...
- **Добро пожаловать** — стандартный баннер **Comindware Business Application Platform** содержащий ссылки на следующие разделы:
  ...
  - **Управление лицензиями** — переход к странице «[**Лицензирование**](https://kb.comindware.ru/article.php?id=2183)».
...
- **Активные задачи** — переход к странице «**[Мои задачи](https://kb.comindware.ru/article.php?id=2282)**».
- **Последние события** — недавние общие уведомления и уведомления о задачах. Для того чтобы отображались последние события, должны быть включены уведомления в **[Глобальной конфигурации](https://kb.comindware.ru/article.php?id=2185)**.
