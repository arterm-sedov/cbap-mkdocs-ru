...
kbId: 2348
url: 'https://kb.comindware.ru/article.php?id=2348'
...
Кнопка экспорта записи создается автоматически при создании [шаблона экспорта](https://kb.comindware.ru/article.php?id=2349) (её также можно создать вручную).
...
3. Создайте или откройте кнопку экспорта. См. [*«Кнопки. Определение, настройка, удаление»*](https://kb.comindware.ru/article.php?id=2276).
4. Настройте свойства кнопки экспорта:
   ...
   - **Шаблон экспорта** — укажите ранее созданный [шаблон экспорта](https://kb.comindware.ru/article.php?id=2349).
5. Сохраните кнопку.
...
1. Откройте шаблон, для которого настроен [шаблон экспорта](https://kb.comindware.ru/article.php?id=2349).
2. Откройте [конструктор формы](https://kb.comindware.ru/article.php?id=2271#form_designer).
...
1. Откройте раздел «**[Роли](https://kb.comindware.ru/article.php?id=2208)**» приложения.
