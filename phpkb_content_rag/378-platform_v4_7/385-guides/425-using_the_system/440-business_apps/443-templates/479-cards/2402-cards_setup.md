...
kbId: 2402
url: 'https://kb.comindware.ru/article.php?id=2402'
updated: '2024-10-16 00:05:22'
---
...
- Представление карточек привязано к **[таблице](https://kb.comindware.ru/article.php?id=2548)** и наследует настроенные для таблицы параметры фильтрации и сортировки данных.
...
3. Создайте или откройте представление карточек.
   ...
   ![Создание представления карточек](https://kb.comindware.ru/assets/cards_layout_create.png)
...
4. Отобразится конструктор карточки со следующими элементами:
   ...
   **(4) Кнопки:**
   ...
   - **Настроить шаблон** *‌* — перейти к странице свойств шаблона.![Конструктор карточки](https://kb.comindware.ru/assets/cards_layout_designer.png)
...
**[Таблицы. Определения, настройка, удаление](https://kb.comindware.ru/article.php?id=2548)**