...
kbId: 2627
url: 'https://kb.comindware.ru/article.php?id=2627'
updated: '2024-10-14 13:44:49'
---
...
- если для записи задано значение атрибута «**Цвет**», строки этой записи в [таблицах шаблона](https://kb.comindware.ru/article.php?id=2550), [таблицах на форме](https://kb.comindware.ru/article.php?id=2531#form_dynamic_elements_table), [шевроны](https://kb.comindware.ru/article.php?id=2531#form_dynamic_elements_chevron) и [сектора диаграмм](https://kb.comindware.ru/article.php?id=2531#form_dynamic_elements_color_diagram_example) для неё будут отображаться с заливкой заданным цветом.

Значение атрибута «**Цвет**» можно изменять вручную на форме (**в шестнадцатеричном формате**) или с помощью **[сценариев](https://kb.comindware.ru/article.php?id=2151)** и **[C#-скриптов](https://kb.comindware.ru/article.php?id=2400)** (**в десятичном формате**).
...
Сведения о настройке поля атрибута «**Цвет**» на формах и в таблицах см. в параграфе «*[Динамические элементы формы. Цвет](https://kb.comindware.ru/article.php?id=2531#form_dynamic_elements_color)*».
...
**[Таблица. Настройка в шаблоне](https://kb.comindware.ru/article.php?id=2550)**

**[Таблица. Настройка на форме](https://kb.comindware.ru/article.php?id=2531#form_dynamic_elements_table)**

**[Шевроны. Настройка представления](https://kb.comindware.ru/article.php?id=2531#form_dynamic_elements_chevron)**

**[Сектора диаграмм. Окрашивание по атрибуту «Цвет»](https://kb.comindware.ru/article.php?id=2531#form_dynamic_elements_color_diagram_example)**
