...
kbId: 2253
url: 'https://kb.comindware.ru/article.php?id=2253'
...
Помимо **[общих свойств](https://kb.comindware.ru/article.php?id=2260)** для атрибута типа «**Изображение**» предусмотрены перечисленные ниже свойства.
...
См. также статью *«[Представление атрибута «Изображение» на форме](https://kb.comindware.ru/article.php?id=2531#mcetoc_1hkh14toi1 "Представление атрибута «Изображение» на форме")»*.
...
**[Представление атрибута «Изображение» на форме](https://kb.comindware.ru/article.php?id=2531#mcetoc_1hkh14toi1 "Представление атрибута «Изображение» на форме")**
