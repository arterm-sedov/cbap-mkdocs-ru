...
kbId: 2241
url: 'https://kb.comindware.ru/article.php?id=2241'
updated: '2024-08-01 15:07:51'
---
...
Помимо **[общих свойств](https://kb.comindware.ru/article.php?id=2260)** для атрибута типа «**Документ**» предусмотрены перечисленные ниже свойства.
...
**`![](https://kb.comindware.ru/images/marker.png) Копирование записи вместе с прикреплённым документом. Настройка сценария {Article-ID:2608}`**
