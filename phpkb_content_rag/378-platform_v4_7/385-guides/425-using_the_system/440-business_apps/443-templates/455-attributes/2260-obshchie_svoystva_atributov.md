...
kbId: 2260
url: 'https://kb.comindware.ru/article.php?id=2260'
updated: '2024-07-01 13:38:21'
---
...
У атрибутов всех [типов](https://kb.comindware.ru/article.php?id=2252) предусмотрены перечисленные ниже общие свойства.

- **ID** — уникальный идентификатор атрибута — генерируется автоматически и отображается только в [списке атрибутов](https://kb.comindware.ru/article.php?id=2252#mcetoc_1gk3bvt3k0).

Остальные свойства атрибута отображаются на вкладке «**Свойства**» в [окне свойств атрибута](https://kb.comindware.ru/article.php?id=2252#mcetoc_1gk3bvt3k0):

- **Тип данных** — тип значения атрибута. См. [типы атрибутов](https://kb.comindware.ru/article.php?id=2252).
...
- **Архивировать** — если установлен этот флажок, атрибут находится в архиве. См. раздел «**[Архивные атрибуты](https://kb.comindware.ru/article.php?id=2252#mcetoc_1gk3c03r50)**».

_![Общие свойства атрибута](https://kb.comindware.ru/assets/attribute_common_properties.png)_

## Проверка значения

На вкладке «**Проверка значения**» в [окне свойств атрибута](https://kb.comindware.ru/article.php?id=2252#mcetoc_1gk3bvt3k0) можно настроить выражение и сообщение для контроля значения атрибута.
...
На вкладке «**Связи**» в [окне свойств атрибута](https://kb.comindware.ru/article.php?id=2252#mcetoc_1gk3bvt3k0) отображается список объектов, в которых используется атрибут.
