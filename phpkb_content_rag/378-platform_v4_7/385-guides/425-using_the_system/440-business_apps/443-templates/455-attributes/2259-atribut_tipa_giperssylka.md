...
kbId: 2259
url: 'https://kb.comindware.ru/article.php?id=2259'
...
Помимо **[общих свойств](https://kb.comindware.ru/article.php?id=2260)** для атрибута типа «**Гиперссылка**» предусмотрены перечисленные ниже свойства.
...
8. Если вы щёлкните гиперссылку на Telegram, то откроется чат с указанным пользователем.
   ...
   ![Корректно заполненные гиперссылки](https://kb.comindware.ru/assets/img_6682b70329047.png)
...
9. При попытке ввода в поле *«Телеграм»* ссылки `t.me/username` без префикса `https://` отобразится сообщение об ошибке «**Не соответствует формату ссылки на Telegram**».
   ...
   _![](https://kb.comindware.ru/assets/img_6682b6c5e5402.png)_   Проверка формата гиперссылки
