...
kbId: 2204
url: 'https://kb.comindware.ru/article.php?id=2204'
...
Сведения об использовании репозитория Git см. в статье «**`![](https://kb.comindware.ru/images/marker.png)Управление версиями через Git {Article-ID:2216}`**».
...
**`![](https://kb.comindware.ru/images/marker.png)Управление версиями через Git {Article-ID:2216}`**
