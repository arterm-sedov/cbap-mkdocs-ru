...
kbId: 2193
url: 'https://kb.comindware.ru/article.php?id=2193'
updated: '2024-10-30 19:47:29'
---
...
1. На странице «[**Администрирование**](https://kb.comindware.ru/article.php?id=2191)» в разделе — «**Администрирование аккаунтов**» выберите пункт «**Группы**» *‌*.
...
5. Сохраните группу.
   ...
   ![Настройка группы](https://kb.comindware.ru/assets/new_group.png)
