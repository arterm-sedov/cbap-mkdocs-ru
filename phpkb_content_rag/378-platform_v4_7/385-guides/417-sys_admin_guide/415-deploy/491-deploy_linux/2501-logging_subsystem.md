...
kbId: 2501
url: 'https://kb.comindware.ru/article.php?id=2501'
updated: '2024-10-31 13:31:57'
---
...
Журнал ошибок содержит данные обо всех ошибках, возникающих в ходе работы экземпляра ПО, а также об [импорте и экспорте версий приложений](https://kb.comindware.ru/article.php?id=2217).
