...
kbId: 2098
url: 'https://kb.comindware.ru/article.php?id=2098'
...
- `![](https://kb.comindware.ru/images/marker.png)Zabbix Server, Zabbix Agent, Zabbix Frontend и MySQL. Инструкции по установке {Article-ID:2292}`
- `![](https://kb.comindware.ru/images/marker.png)Zabbix Agent. Инструкции по установке для Ubuntu 22.04 {Article-ID:2291}`
- `![](https://kb.comindware.ru/images/marker.png)Zabbix Agent. Инструкции по установке для MS Windows {Article-ID:2304}`
