...
kbId: 2011
url: 'https://kb.comindware.ru/article.php?id=2011'
...
1. Создайте новое [подключение для **синхронизации с веб-сервисом**](https://kb.comindware.ru/article.php?id=2504).
...
**`![](https://kb.comindware.ru/images/marker.png)Интеграция по OData {Article-ID:2315}`**
