...
kbId: 2080
url: 'https://kb.comindware.ru/article.php?id=2080'
updated: '2024-11-18 11:47:01'
---
...
- Запрос формирует и отправляет [промежуточное](https://kb.comindware.ru/article.php?id=2381) или [конечное событие](https://kb.comindware.ru/article.php?id=2385) отправки сообщения в процессе.

Примечание

Для отправки запросов с помощью сценариев и событий процесса требуется настроить [подключение](https://kb.comindware.ru/article.php?id=2205) к внешней службе и [путь передачи данных](https://kb.comindware.ru/article.php?id=2201).
...
2. Отобразится страница **Comindware Business Application Platform API** со следующими разделами:
   - **RESTful Web API** — общие методы для всех версий ПО (см. `![](https://kb.comindware.ru/images/marker.png){Article-ID:1940}`);
   - **System Core API** — системные методы, которые могут отличаться для разных версий ПО (см. `![](https://kb.comindware.ru/images/marker.png){Article-ID:2150}`);
   - **Solution API** — методы для шаблонов бизнес-приложений (см. `![](https://kb.comindware.ru/images/marker.png){Article-ID:2073}`).
...
**`![](https://kb.comindware.ru/images/marker.png)Методы Solution API {Article-ID:2073}`**

**`![](https://kb.comindware.ru/images/marker.png)Методы System Core API {Article-ID:2150}`**

**`![](https://kb.comindware.ru/images/marker.png)Методы Web API {Article-ID:1940}`**