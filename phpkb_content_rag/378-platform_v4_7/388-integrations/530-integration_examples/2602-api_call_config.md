...
kbId: 2602
url: 'https://kb.comindware.ru/article.php?id=2602'
updated: '2024-05-23 10:43:22'
---

# Настройка вызова API

В **Comindware Business Application Platform** есть возможность вызова из внешних систем веб-сервисов системы для обмена данными, например, создание объекта, запуск процесса или получение информации по документу. Полный перечень веб-сервисов и описание можно посмотреть [здесь](https://kb.comindware.ru/article.php?id=2080).
