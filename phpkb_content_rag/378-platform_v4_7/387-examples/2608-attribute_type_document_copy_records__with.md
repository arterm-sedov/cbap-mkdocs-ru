...
kbId: 2608
url: 'https://kb.comindware.ru/article.php?id=2608'
updated: '2024-08-01 17:53:11'
---
...
В этой статье представлены инструкции по настройке сценария для копирования записи, в которой имеется [атрибут типа «**Документ**»](https://kb.comindware.ru/article.php?id=2241), вместе с файлами, прикреплёнными к этому атрибуту.
...
1. На странице [администрирования приложения](https://kb.comindware.ru/article.php?id=2209#mcetoc_1gjrm25045) выберите пункт «**Сценарии**».
2. Создайте сценарий:
...
**`![](https://kb.comindware.ru/images/marker.png) Атрибут типа «Документ» {Article-ID:2241}`**
