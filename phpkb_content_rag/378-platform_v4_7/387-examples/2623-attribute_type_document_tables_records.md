...
kbId: 2623
url: 'https://kb.comindware.ru/article.php?id=2623'
updated: '2024-08-01 13:54:29'
---
...
8. Браузер скачает архив с файлами, прикреплёнными к записи.
   ...
   ![Отображение кнопки «Скачать вложения» в таблице записей шаблона «Реестр документов»](https://kb.comindware.ru/assets/download_archive_csharp_button.png)
...
**[Написание скриптов на языке C#](https://kb.comindware.ru/article.php?id=2400)**