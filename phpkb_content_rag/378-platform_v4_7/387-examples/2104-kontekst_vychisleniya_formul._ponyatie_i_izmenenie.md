...
kbId: 2104
url: 'https://kb.comindware.ru/article.php?id=2104'
updated: '2024-08-01 18:06:52'
---
...
Больше о вызове связанных данных читайте в статье `![](https://kb.comindware.ru/images/marker.png){Article-ID:2105}`.
...
Больше о настройке выражения типа select читайте в статье `![](https://kb.comindware.ru/images/marker.png){Article-ID:1863}`.
