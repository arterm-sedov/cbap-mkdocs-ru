...
kbId: 2624
url: 'https://kb.comindware.ru/article.php?id=2624'
updated: '2024-08-08 15:55:18'
---
...
Атрибут [типа «**Список значений**»](https://kb.comindware.ru/article.php?id=2244) содержит в себе перечень значений на нескольких языках — русском, английском и немецком. При этом, нельзя напрямую получить текстовое значение атрибута.
