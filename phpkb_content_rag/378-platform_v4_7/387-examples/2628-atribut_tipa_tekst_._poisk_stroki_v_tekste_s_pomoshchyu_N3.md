...
kbId: 2628
url: 'https://kb.comindware.ru/article.php?id=2628'
updated: '2024-08-06 18:23:24'
---
...
**[Текстовый атрибут](https://kb.comindware.ru/article.php?id=2257)** может содержать неограниченное количество символов, например письмо или заявку. Чтобы найти в тексте ключевые слова, например запрещённые или обозначающие срочность, важность и т. п., можно использовать выражение на N3.
...
**[Атрибут типа «Текст»](https://kb.comindware.ru/article.php?id=2257)**

**[Написание выражений на языке N3](https://kb.comindware.ru/article.php?id=2401)**