...
7. Откройте **журнал изменений** и нажмите значок ![Кнопка перехода к цепочке событий скрипта](/platform/v6.0/business_apps/diagrams/process_diagram/../../expressions/img/expression_debug_script_button.png) рядом с названием задачи-выполнения сценария.
...
- *[Просмотр цепочки событий](https://kb.comindware.ru/article.php?id=5658#events_chain_view)*
