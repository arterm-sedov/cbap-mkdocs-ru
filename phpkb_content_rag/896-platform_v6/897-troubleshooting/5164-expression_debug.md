...
kbId: 5164
url: 'https://kb.comindware.ru/article.php?id=5164'
updated: '2026-06-16 19:14:24'
---
...
Чтобы выявить ошибки в именах функций, атрибутов, шаблонов и переменных, а также в синтаксисе формулы, выражения N3 или скрипта, используйте функцию проверки в **[редакторе выражений](https://kb.comindware.ru/article.php?id=5185)**.
...
6. Нажмите значок ![Кнопка перехода к цепочке событий скрипта](/platform/v6.0/business_apps/expressions/img/expression_debug_script_button.png) рядом с названием задачи-выполнения сценария.
...
- *[Введение в язык формул Comindware](https://kb.comindware.ru/article.php?id=5215)*
