...
В настоящем документе представлено краткое описание функций и возможностей Comindware Platform (далее «Продукт»).
...
Подробные сведения см. в статье `![](https://kb.comindware.ru/images/marker.png){Article-ID:5443}`.
