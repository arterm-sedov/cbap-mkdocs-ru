...
# Описание Comindware Platform 6
...
См. *[описание и инструкции по использованию модуля «Корпоративная архитектура»](https://kb.comindware.ru/article.php?id=5588#architect_description)*.
