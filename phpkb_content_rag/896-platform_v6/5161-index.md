...
Здесь представлены инструкции для ПО **Comindware Platform** текущей рекомендованной версии **6.0**.
...
- Версии **Comindware Platform**, выпущенные **до 31.12.2025**, содержат критические уязвимости. Рекомендуется перейти на **текущую рекомендуемую версию 6.0 или более позднюю**.
...
- О выявленных уязвимостях сообщайте через **[службу поддержки](https://www.comindware.ru/company/contact-us/#tab_support) строго согласно [политике обработки уязвимостей](https://kb.comindware.ru/article.php?id=5427)**.
...
- **Рекомендуемый цикл разработки** и развёртывания при работе с продуктивными средами (стендами, контурами):
  ...
  - **Предварительное уведомление пользователей.** Заранее информируйте пользователей о предстоящих работах и возможном простое системы. Например, с помощью [общих уведомлений](https://kb.comindware.ru/article.php?id=5625) или информационных рассылок.
