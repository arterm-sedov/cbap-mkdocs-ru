...
kbId: 5562
url: 'https://kb.comindware.ru/article.php?id=5562'
updated: '2026-06-22 14:15:29'
---
...
См. также общие рекомендации в статье *«[Обеспечение высокой доступности и отказоустойчивости Comindware Platform](https://kb.comindware.ru/article.php?id=5445)»*.
...
1. **Подготовьте серверы**: убедитесь, что все машины, на которых будет развёрнут кластер, соответствуют системным требованиям, установите необходимое программное обеспечение. См. *«[Системные требования Comindware Platform](https://kb.comindware.ru/article.php?id=5429)».*
...
1. Перейдите в режим суперпользователя:
   ...
   su -
   ```
2. Установите ПО и разверните экземпляр **Comindware Platform** одинаковой версии. См. *«[Установка, запуск, инициализация и остановка ПО](https://kb.comindware.ru/article.php?id=5558)»*.
...
1. Перейдите в режим суперпользователя:
   ...
   su -
   ```
2. Создайте [резервную копию](https://kb.comindware.ru/article.php?id=5572) экземпляра ПО.
...
3. Откройте файл конфигурации экземпляра ПО для редактирования:
   ...
   ```
4. Отредактируйте файл конфигурации экземпляра ПО по следующему образцу (см. *«[Конфигурация экземпляра, компонентов ПО и служб. Настройка](https://kb.comindware.ru/article.php?id=5554)»*):
...
- *[Apache Ignite. Установка и настройка](https://kb.comindware.ru/article.php?id=5452)*
