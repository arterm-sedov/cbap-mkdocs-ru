...
kbId: 5559
url: 'https://kb.comindware.ru/article.php?id=5559'
...
Здесь представлены примеры событий и данных, которые регистрируются в журналах экземпляра ПО **Comindware Platform**. Названия событий даны согласно тре­бованиям по информацион­ной безопасно­сти, предъявляемым к Автоматизированным системам.
...
Системная информация:
  ...
  Операционная система: Unix 5.16.0.89
