...
kbId: 5557
url: 'https://kb.comindware.ru/article.php?id=5557'
...
Сведения о фактическом расположении файлов см. в статье *«[Пути и содержимое папок экземпляра ПО](https://kb.comindware.ru/article.php?id=5561)»*.
...
_![Пример журнала аудита](/platform/v6.0/administration/deploy/img/logging_engine_audit_log.png)_
...
_![Пример журнала интеграции](/platform/v6.0/administration/deploy/img/logging_engine_integration_log.png)_
...
_![Пример журнала интеграции с сырыми данными](/platform/v6.0/administration/deploy/img/logging_engine_integration_raw.png)_
...
_![Пример журнала исправности](/platform/v6.0/administration/deploy/img/logging_engine_heartbeat_log.png)_
...
_![Пример журнала обновления](/platform/v6.0/administration/deploy/img/logging_engine_update_log.png)_

#### Журнал ошибок

Журнал ошибок содержит данные обо всех ошибках, возникающих в ходе работы экземпляра ПО, а также об [импорте и экспорте версий приложений](https://kb.comindware.ru/article.php?id=5652).
...
_![Пример журнала ошибок](/platform/v6.0/administration/deploy/img/logging_engine_errror_log.png)_
...
_![Пример журнала процессов](/platform/v6.0/administration/deploy/img/logging_engine_process_log.png)_
...
_![Пример журнала резервного копирования](/platform/v6.0/administration/deploy/img/logging_engine_backup_log.png)_
...
_![Пример журнала сценариев](/platform/v6.0/administration/deploy/img/logging_engine_trigger_log.png)_
...
_![Пример системного журнала](/platform/v6.0/administration/deploy/img/logging_engine_system_log.png)_

#### Журналы адаптеров

Журналы адаптеров содержат данные о событиях подключений и путей передачи данных, относящихся к [адаптерам](https://kb.comindware.ru/article.php?id=5615) в экземпляре ПО.
...
_![Пример журнала аудита](/platform/v6.0/administration/deploy/img/logging_engine_adapter_log.png)_
...
- *[Просмотр показателей мониторинга с помощью страницы «Администрирование»](https://kb.comindware.ru/article.php?id=5617)*
- *[Просмотр журналов событий с помощью страницы «Администрирование»](https://kb.comindware.ru/article.php?id=5614)*
- *[Просмотр показателей производительности с помощью страницы «Администрирование»](https://kb.comindware.ru/article.php?id=5620)*
- *[Конфигурация журналирования. Настройка, скачивание журналов](https://kb.comindware.ru/article.php?id=5618)*