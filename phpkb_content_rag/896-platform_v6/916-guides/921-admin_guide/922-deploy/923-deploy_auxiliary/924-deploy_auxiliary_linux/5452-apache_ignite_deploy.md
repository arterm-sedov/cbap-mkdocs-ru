...
kbId: 5452
url: 'https://kb.comindware.ru/article.php?id=5452'
updated: '2026-06-22 14:15:17'
---
...
Здесь представлены краткие инструкции по установке и настройке Apache Ignite 2.18.0 в ОС Linux для работы с **Comindware Platform** в простейшей конфигурации.
...
4. Дополнительные модули для использования Ignite в сочетании с Comindware Platform не требуются.
...
- [Apache Ignite. Дефрагментация и обслуживание кластера](https://kb.comindware.ru/article.php?id=5455)
- [Установка, запуск, инициализация и остановка ПО](https://kb.comindware.ru/article.php?id=5558)
- [Создание полной резервной копии без остановки экземпляра ПО](https://kb.comindware.ru/article.php?id=5572)
- [Восстановление базы данных из полной резервной копии](https://kb.comindware.ru/article.php?id=5575)
- [Оптимизация работы вспомогательного ПО](https://kb.comindware.ru/article.php?id=5454)