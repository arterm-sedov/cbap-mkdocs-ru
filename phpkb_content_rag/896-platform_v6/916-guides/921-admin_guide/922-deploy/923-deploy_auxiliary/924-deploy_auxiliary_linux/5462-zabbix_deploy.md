...
kbId: 5462
url: 'https://kb.comindware.ru/article.php?id=5462'
...
Система **Comindware Platform** использует службы, которые должны быть постоянно работоспособны.
...
- `![](https://kb.comindware.ru/images/marker.png)Zabbix Server, Zabbix Agent, Zabbix Frontend и MySQL. Инструкции по установке {Article-ID:5458}`
- `![](https://kb.comindware.ru/images/marker.png)Zabbix Agent. Инструкции по установке для Ubuntu 22.04 {Article-ID:5463}`
- `![](https://kb.comindware.ru/images/marker.png)Zabbix Agent. Инструкции по установке для MS Windows {Article-ID:5552}`
...
- [Установка и настройка Zabbix 6.0 (на русском языке, serveradmin.ru)](https://serveradmin.ru/ustanovka-i-nastrojka-zabbix-5-0/)
