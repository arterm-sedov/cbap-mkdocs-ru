...
kbId: 5642
url: 'https://kb.comindware.ru/article.php?id=5642'
updated: '2024-10-22 14:46:59'
---
...
Для настройки модели данных приложений в **Comindware Platform** используются [**шаблоны записей**](https://kb.comindware.ru/article.php?id=5693). В терминологии других систем шаблон записи — это аналог справочника, таблицы, сущности, класса и т. п.
...
В **Comindware Platform** предварительная настройка база данных как таковая не требуется, она формируется автоматически при проектировании модели данных с помощью инструментов low-code.

Физически данные данные хранятся в графовой базе данных. Подробное описание фирменной технологии графовых БД **Comindware** см. в статье *«[Технология Comindware ElasticData](https://kb.comindware.ru/article.php?id=5259)».*

Привязка шаблона к приложению

Следует учитывать, что каждый шаблон записи привязан к конкретному [**приложению**](https://kb.comindware.ru/article.php?id=5643).

Шаблон можно привязать к другому приложению для установления связей между разными приложениями. См. «[**Использование шаблона в нескольких приложениях**](https://kb.comindware.ru/article.php?id=5638#templates_move)».
