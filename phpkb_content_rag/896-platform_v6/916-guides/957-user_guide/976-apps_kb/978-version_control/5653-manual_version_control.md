...
kbId: 5653
url: 'https://kb.comindware.ru/article.php?id=5653'
...
3. Отобразится раздел «**Ручное управление версиями**» с двумя вкладками:
   ...
   ![Страница «Ручное управление версиями»](/platform/v6.0/business_apps/version_control/img/manual_version_control.png)
...
_![Список ошибок экспорта приложения](/platform/v6.0/business_apps/version_control/img/manual_version_control_export_errors.png)_
...
4. Отобразятся **сведения об импортируемом приложении** и параметры импорта:
   ...
   ![Выбор импортируемого файла](/platform/v6.0/business_apps/version_control/img/manual_version_control_file_select.png)
...
6. Настройте параметры импорта:
   ...
   ![Настройка параметров импорта приложения](/platform/v6.0/business_apps/version_control/img/manual_version_control_import_config.png)
...
9. Отобразится результат импорта:
   ...
   ![Результат импорта приложения из файла CTF без ошибок](/platform/v6.0/business_apps/version_control/img/manual_version_import_check_no_errors.png)
