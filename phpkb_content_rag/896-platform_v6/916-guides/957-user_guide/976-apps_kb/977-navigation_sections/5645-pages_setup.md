...
kbId: 5645
url: 'https://kb.comindware.ru/article.php?id=5645'
...
- Страницы можно включить в состав [рабочего стола](https://kb.comindware.ru/article.php?id=5646).

## Настройка свойств и макета страницы

1. Откройте [раздел навигации](https://kb.comindware.ru/article.php?id=5644).
2. Создайте или откройте страницу для редактирования:

   - Нажмите кнопку «**Создать**» *‌* рядом с пунктом «**Страницы**» на панели элементов.
   - Раскройте пункт «**Страницы**» в списке элементов и нажмите кнопку «**Редактировать**» *‌* рядом с пунктом с названием страницы.![Создание информационной страницы](/platform/v6.0/business_apps/navigation_sections/img/pages_setup_add.png)
...
6. Чтобы удалить элементы со страницы, перетащите их за пределы макета или нажмите кнопку «Очистить» и подтвердите удаление. Сохраните страницу.
   ...
   ![Добавление элемента на страницу](/platform/v6.0/business_apps/navigation_sections/img/pages_setup_edit.png)
...
2. **Панель элементов слева** — список виджетов, которые можно перетащить на страницу.
   ...
   - **Вкладки**, **Колонки**, **Статичный текст** — эти элементы на страницах используются так же, как на формах. См. статью «[Статические элементы формы: области, вкладки, колонки, статичный текст. Настройка представления](https://kb.comindware.ru/article.php?id=5725)».
...
_![Конструктор страницы](/platform/v6.0/business_apps/navigation_sections/img/pages_setup_designer.png)_
...
_![Добавление страницы в раздел навигации](/platform/v6.0/business_apps/navigation_sections/img/pages_setup_add_page.png)_
...
Сведения о настройке доступа к страницам и виджетам см. в статье *[«Информационные страницы. Контроль доступа»](https://kb.comindware.ru/article.php?id=5648)*.

_![Переход к редактированию элемента страницы](/platform/v6.0/business_apps/navigation_sections/img/pages_setup_element_edit.png)_
...
_![Настройка области](/platform/v6.0/business_apps/navigation_sections/img/pages_setup_area_setting.png)_
...
_![Настройка баннера](/platform/v6.0/business_apps/navigation_sections/img/pages_setup_banner_setting.png)_
...
3. Настройте витрину с помощью панели «**Свойства виджета**»:
   ...
   - **Внешний вид действия** — выберите способ отображения кнопки на плитке:
     ...
     - **Ссылка**
     - **Кнопка**
   - **Действие** — выберите [кнопку](https://kb.comindware.ru/article.php?id=5728) из **шаблона**, которая должна отображаться на плитке.
...
_![Настройка витрины](/platform/v6.0/business_apps/navigation_sections/img/pages_setup_showcase_setting.png)_
...
**Временная шкала** отображает данные из выбранного шаблона в графической форме, аналогичной [диаграмме Ганта](https://kb.comindware.ru/article.php?id=5362). Конечный пользователь может нажимать элементы на временной шкале, чтобы перейти к соответствующим записям.

Для формирования временной шкалы потребуется создать шаблон записи (шаблон работ) с атрибутами указанных ниже типов.

Если в приложении уже настроена диаграмма Ганта, для построения временной шкалы можно использовать шаблон работ, используемый для построения диаграммы Ганта. См. статьи *«[Диаграмма Ганта. Настройка](https://kb.comindware.ru/article.php?id=5362)»* и *«[Диаграмма Ганта. Использование](https://kb.comindware.ru/article.php?id=5363)».*

#### Настройка шаблона работ

1. Создайте **[шаблон записи](https://kb.comindware.ru/article.php?id=5693)** *«Работы».*
...
_![Настройка временной шкалы](/platform/v6.0/business_apps/navigation_sections/img/pages_setup_timeline_setting.png)_
...
3. Настройте **свойства виджета**:
   ...
   - **Детализация данных** — настройте таблицу со сводными данными записей, по которым построена диаграмма. Эта таблица будет отображаться при нажатии сектора, столбца или графика на диаграмме.
     ...
     См. *«[Области кнопок. Определение, настройка, клонирование, удаление](https://kb.comindware.ru/article.php?id=5729)»*.
4. Сохраните диаграмму.

_![Настройка диаграммы](/platform/v6.0/business_apps/navigation_sections/img/pages_setup_diagram_setting.png)_
...
_![Настройка плитки](/platform/v6.0/business_apps/navigation_sections/img/pages_setup_tile_setting.png)_
...
_![Настройка показателя](/platform/v6.0/business_apps/navigation_sections/img/pages_setup_metric_setting.png)_
...
- **Добро пожаловать** — стандартный баннер **Comindware Platform** содержащий ссылки на следующие разделы:
  ...
  - **Управление лицензиями** — переход к странице «[**Лицензирование**](https://kb.comindware.ru/article.php?id=5616)».
...
- **Активные задачи** — переход к странице «**[Мои задачи](https://kb.comindware.ru/article.php?id=5604)**».
- **Последние события** — недавние общие уведомления и уведомления о задачах. Для того чтобы отображались последние события, должны быть включены уведомления в **[Глобальной конфигурации](https://kb.comindware.ru/article.php?id=5619)**.
...
_![Настройка списка](/platform/v6.0/business_apps/navigation_sections/img/pages_setup_list_setting.png)_
...
_![Настройка шагов](/platform/v6.0/business_apps/navigation_sections/img/pages_setup_steps_setting.png)_

## Связанные статьи

- *[Информационные страницы. Использование](https://kb.comindware.ru/article.php?id=5607)*
- *[Настройка разделов навигации](https://kb.comindware.ru/article.php?id=5644)*
- *[Настройка рабочего стола](https://kb.comindware.ru/article.php?id=5646)*
- *[«Контроль доступа к информационным страницам»](https://kb.comindware.ru/article.php?id=5648)*