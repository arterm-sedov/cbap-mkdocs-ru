...
kbId: 5667
url: 'https://kb.comindware.ru/article.php?id=5667'
...
При переходе токена на этот элемент автоматически выполняется назначенная задаче **[функция](https://kb.comindware.ru/article.php?id=5640)**.
...
_![Задача-вызов сервиса и её меню элемента](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/actions/img/service_call_task_menu.png)_

## Операции в меню элемента «Задача-выполнение сценария»

- **Действия**
  - **Свойства** *‌* — переход к окну [свойств задачи-вызова сервиса](https://kb.comindware.ru/article.php?id=5667#mcetoc_1h28bak441).
...
_![Настройка основных свойств задачи-выполнения сценария](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/actions/img/service_call_task_properties_setting.png)_

### Дополнительные

На этой вкладке следует выбрать [функцию](https://kb.comindware.ru/article.php?id=5640), которая будет выполняться при переходе токена на задачу-выполнение сценария.

_![Выбор глобальной функции для задачи-вызова сервиса](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/actions/img/service_call_task_global_function_choice.png)_
...
- **Формула** — введите [формулу](https://kb.comindware.ru/article.php?id=5215), вычисляющую значение.
...
- *[Редактирование диаграммы процесса](https://kb.comindware.ru/article.php?id=5639)*