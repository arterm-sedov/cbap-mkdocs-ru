...
kbId: 5666
url: 'https://kb.comindware.ru/article.php?id=5666'
...
_![Пользовательская задача и её меню элемента](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/actions/img/user_task.png)_
...
- **Действия**
  ...
  - **Форма** *‌* — настройка [формы](https://kb.comindware.ru/article.php?id=5660) для задачи.
...
_![Основные свойства пользовательской задачи](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/actions/img/user_task_general_properties.png)_
...
- **Разрешить переназначение этой задачи** — установите этот флажок, чтобы назначенную задачу можно было передать другому исполнителю. См. *«[Пользовательская задача. Переназначение исполнителя](https://kb.comindware.ru/article.php?id=5391)»*.
...
_![Дополнительные свойства пользовательской задачи](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/actions/img/user_task_advanced_propertes.png)_

### Данные сообщения

На этой вкладке можно настроить уведомления для исполнителей о назначенной задаче.

- **Использовать путь передачи данных** — выберите из раскрывающегося списка или [создайте путь](https://kb.comindware.ru/article.php?id=5302) типа «**Уведомления о задачах**».
...
_![Данные сообщения для пользовательской задачи](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/actions/img/message_data.png)_
