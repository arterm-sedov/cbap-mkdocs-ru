...
kbId: 5670
url: 'https://kb.comindware.ru/article.php?id=5670'
...
_![Начальное событие-таймер и его меню элемента](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/events/start/img/timer_start_event.png)_
...
_![Основные свойства начального события-таймера](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/events/start/img/timer_start_event_general_properties.png)_
...
- **Тип таймера** — выберите интервал срабатывания таймера. Для типа таймера задаются отдельные параметры расписания запуска процесса.
  ...
  ![Параметры таймера по минутам](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/events/start/img/timer_start_event_minutes.png)
  ...
  ![Параметры таймера по дням](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/events/start/img/timer_start_event_days.png)
  ...
  ![Параметры таймера по неделям](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/events/start/img/timer_start_event_weeks.png)
  ...
  ![Параметры таймера по месяцам](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/events/start/img/timer_start_event_months.png)
  ...
  ![Параметры таймера по годам](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/events/start/img/timer_start_event_years.png)
