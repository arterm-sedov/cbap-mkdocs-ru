...
kbId: 5675
url: 'https://kb.comindware.ru/article.php?id=5675'
...
_![Простое промежуточное событие и его меню элемента](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/events/intermediate/img/none_intermediate_event.png)_
...
_![Основные свойства простого промежуточного события](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/events/intermediate/img/none_intermediate_event_general_properties.png)_
...
- **Временная веха** — задайте время после запуска экземпляра процесса, за которое токен должен дойти до данного события.
  ...
  - Это значение влияет на **текущее состояние процесса**, отображающееся в [списке его экземпляров](https://kb.comindware.ru/article.php?id=5638).
    ...
    - Если превышена [продолжительность выполнения процесса](https://kb.comindware.ru/article.php?id=5682#process-duration), заданная в каком-либо **[конечном событии](https://kb.comindware.ru/article.php?id=5681)**, процесс выполняется **с опозданием**.
...
_![Дополнительные свойства простого промежуточного события](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/events/intermediate/img/none_intermediate_event_advanced_properties.png)_
