...
kbId: 5657
url: 'https://kb.comindware.ru/article.php?id=5657'
...
- **Диаграмма процесса** служит для моделирования и исполнения бизнес-процесса. Она обладает следующими характеристиками:
  - привязана к [шаблону процесса](https://kb.comindware.ru/article.php?id=5694);
...
_![Диаграмма шаблона процесса в режиме просмотра](/platform/v6.0/business_apps/diagrams/process_diagram/img/process_diagram_view.png)_

## Редактирование диаграммы процесса

1. Откройте вкладку «**[Диаграммы](https://kb.comindware.ru/article.php?id=5657#process_diagram_view)**» шаблона процесса.
2. При необходимости [выберите версию диаграммы](https://kb.comindware.ru/article.php?id=5659).
...
_![Добавление и настройка элемента на диаграмме](/platform/v6.0/business_apps/diagrams/process_diagram/img/process_diagram_designer_add_element.png)_
...
_![Конструктор диаграммы процесса](/platform/v6.0/business_apps/diagrams/process_diagram/img/process_diagram_designer.png)_

## Публикация диаграммы процесса

1. Откройте [конструктор диаграммы](https://kb.comindware.ru/article.php?id=5657#process_diagram_designer).
...
_![Просмотр ошибок диаграммы процесса](/platform/v6.0/business_apps/diagrams/process_diagram/img/process_diagram_validation_errors.png)_
...
- [Диаграммы в приложении](https://kb.comindware.ru/article.php?id=5639)
