...
Скрипт на С# можно использовать для операции «**Экспорт записи**» с целью подготовки данных для шаблона экспорта. Cм. [*«Настройка шаблона экспорта с использованием C#»*](https://kb.comindware.ru/article.php?id=5336) и [*«Подготовка файла шаблона экспорта»*](https://kb.comindware.ru/article.php?id=5730#mcetoc_1h1p7o4cm4).
...
Ниже представлены примеры условий отображения кнопки на [языке формул Comindware](https://kb.comindware.ru/article.php?id=5216).
...
В сценарии по нажатию кнопки локальные переменные будут доступны в объекте `dialogVariables`. См. [пример](https://kb.comindware.ru/article.php?id=5656).
