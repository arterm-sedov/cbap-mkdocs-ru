...
kbId: 5729
url: 'https://kb.comindware.ru/article.php?id=5729'
...
4. Чтобы настроить кнопку или группу кнопок, выберите её на макете:
   ...
   - **Цвет** — выберите один из цветов, заданных в текущей [теме на вкладке «**Цвета приоритетов**»](https://kb.comindware.ru/article.php?id=5637#mcetoc_1gjriujcbf).
