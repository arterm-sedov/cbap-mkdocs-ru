...
kbId: 5734
url: 'https://kb.comindware.ru/article.php?id=5734'
updated: '2025-04-04 14:39:49'
---
...
- Представление карточек привязано к [**таблице**](https://kb.comindware.ru/article.php?id=5735) и наследует настроенные для таблицы параметры фильтрации и сортировки данных.
...
3. Создайте или откройте представление карточек.
   ...
   ![Создание представления карточек](/platform/v6.0/business_apps/templates/cards/img/cards_layout_create.png)
...
_![Конструктор карточки](/platform/v6.0/business_apps/templates/cards/img/cards_layout_designer.png)_
...
_![Перетаскивание атрибута на карточку и свойства поля атрибута](/platform/v6.0/business_apps/templates/cards/img/cards_layout_add_attribute.png)_
...
_![Выбор представления карточек для таблицы](/platform/v6.0/business_apps/templates/cards/img/cards_select_for_table.png)_
...
_![Выбор представления карточек для таблицы](/platform/v6.0/business_apps/templates/cards/img/cards_select_for_table_on_form.png)_
...
_![Удаление представления карточек](/platform/v6.0/business_apps/templates/cards/img/cards_layout_delete.png)_

## Связанные статьи

- *[Карточки. Использование в браузере и мобильном приложении](https://kb.comindware.ru/article.php?id=5601)*
- *[Таблицы. Определения, настройка, удаление](https://kb.comindware.ru/article.php?id=5735)*