...
6. Настройте связь шаблона процесса с шаблоном записи.
   ...
   ![Привязка нового шаблона записи](/platform/v6.0/business_apps/templates/img/create_related_template.png)
   ...
   ![Привязка имеющегося шаблона записи](/platform/v6.0/business_apps/templates/img/relate_existing_template.png)
