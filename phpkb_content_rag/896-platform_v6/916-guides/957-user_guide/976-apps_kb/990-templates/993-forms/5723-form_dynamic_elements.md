...
kbId: 5723
url: 'https://kb.comindware.ru/article.php?id=5723'
updated: '2025-12-15 16:41:39'
---
...
**Динамические элементы** формы — это поля атрибутов, кнопки и вложенные формы, вынесенные на форму. Их представление настраивается с помощью [конструктора формы](https://kb.comindware.ru/article.php?id=5724) и [правил для формы](https://kb.comindware.ru/article.php?id=5721) и формируется для пользователя на основе данных, отображающихся в форме.

- **[Поля атрибутов](#настройка-полей-атрибутов)** — при перетаскивании атрибута на форму создаётся поле, представление которого зависит от [типа атрибута](https://kb.comindware.ru/article.php?id=5706).
- [**Вложенные формы**](#form_dynamic_elements_embedded_form) — вложенные формы можно поместить на форму и на **[вкладки](https://kb.comindware.ru/article.php?id=5725#form_static_elements_tabs)**. Это позволяет повторно использовать формы в качестве стандартных блоков.
- **Кнопки** — кнопки можно поместить в области кнопок, которые предусмотрены у формы, областей формы, таблиц и вкладок. См. *«[Настройка области кнопок](https://kb.comindware.ru/article.php?id=5729#button_area_configure)»* и *«[Настройка кнопки](https://kb.comindware.ru/article.php?id=5728)».*

## Настройка полей атрибутов

1. Откройте [конструктор формы](https://kb.comindware.ru/article.php?id=5724).
2. Выберите атрибут на макете формы или перетащите атрибут из панели элементов внутрь [области](https://kb.comindware.ru/article.php?id=5725#form_static_elements_area), [вкладки](https://kb.comindware.ru/article.php?id=5725#form_static_elements_tabs) или [колонки](https://kb.comindware.ru/article.php?id=5725#form_static_elements_columns).
...
- **Системное имя** — уникальное имя поля в рамках текущей формы, используемое для настройки [правил для формы](https://kb.comindware.ru/article.php?id=5721).
...
- **Доступ** — режим доступа к данным атрибута и отображения поля:
  ...
  - **Скрыть** — поле не будет отображаться на форме. Показать скрытое поле можно с помощью [правил для формы](https://kb.comindware.ru/article.php?id=5721).
...
_![Добавление поля атрибута на форму и настройка его свойств](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_attribute_field_add.png)_
...
_![Поле атрибута типа «Аккаунт»: несколько значений, только чтение](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_account_multiple_values_read_only.png)_

_![Поле атрибута типа «Аккаунт»: несколько значений, раскрывающийся список](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_account_multiple_values_dropdown_list.png)_

_![Поле атрибута типа «Аккаунт»: несколько значений, таблица](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_account_multiple_values_table.png)_
...
_![Список атрибутов шаблона аккаунта в панели элементов конструктора форм](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_account_attribute_list.png)_

### Гиперссылка

Представление этого поля на форме определяется свойствами поля и **допустимыми схемами URI**, заданными в [свойствах атрибута](https://kb.comindware.ru/article.php?id=5712).
...
4. Адрес должен отобразиться в виде гиперссылки.
   ...
   ![Гиперссылка типа **HTTPS** на форме](/platform/v6.0/business_apps/templates/forms/../attributes/img/attribute_hyperlink_example_valid.png)
...
6. Над полем должно отобразиться сообщение об ошибке «**Не соответствует формату HTTPS-ссылки**».
   ...
   ![Проверка формата гиперссылки](/platform/v6.0/business_apps/templates/forms/../attributes/img/attribute_hyperlink_example_invalid.png)
...
Представление поля атрибута типа «**Длительность**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=5703).
...
Представление поля атрибута типа «**Документ**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=5716), см. примеры на иллюстрациях ниже.
...
_![Поле «Акты»: документы без предпросмотра](/platform/v6.0/business_apps/templates/forms/../attributes/img/attribute_document_example_no_preview.png)_

_![Поле «Приложение»: документ с предпросмотром](/platform/v6.0/business_apps/templates/forms/../attributes/img/attribute_document_example_preview.png)_

_![Поле «Документы на подпись»: документы с цифровой подписью](/platform/v6.0/business_apps/templates/forms/../attributes/img/attribute_document_example_digital_signature.png)_

### Изображение

Представление поля атрибута типа «**Изображение**» на форме определяется сочетанием свойств поля и [свойств атрибута](https://kb.comindware.ru/article.php?id=5707).
...
- **Разрешить удаление** — установите этот флажок, чтобы пользователи могли удалять прикреплённые к атрибуту файлы.
- **Фотографии только с устройства** — установите этот флажок, чтобы запретить пользователям выбор изображений из галереи и файловой системы устройства и разрешить только съемку фотографий с помощью камеры устройства.
...
_![Поля с несколькими изображениями в виде карточек и в виде картинок](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_image_cards_fields.png)_
...
_![Поля атрибута с типа «Логический» в виде флажка и в виде переключателя на форме](/platform/v6.0/business_apps/templates/forms/img/Boolean_field_form_appearance.gif)_
...
Представление поля атрибута типа «**Запись**» на форме определяется сочетанием свойств поля и [свойств атрибута](https://kb.comindware.ru/article.php?id=5718).
...
- **Представление** — выберите представление поля на форме:
  ...
  - **Диаграмма Ганта** — [настройте диаграмму Ганта](https://kb.comindware.ru/article.php?id=5362);
...
_![Список атрибутов связанного шаблона записи в панели элементов конструктора форм](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_record_attribute_list.png)_
...
Сведения о настройке форм поиска см. в статье *«[Расширенная фильтрация. Настройка форм поиска](https://kb.comindware.ru/article.php?id=5722)»*.
...
2. Задайте значения атрибутов, по которым следует отфильтровать список.
   ...
   - Фильтрация настраивается также, как для столбцов таблицы. См. *«[Настройка фильтрации](https://kb.comindware.ru/article.php?id=5594#table_personal_use_filter)»*.
3. Чтобы применить настроенный фильтр, нажмите кнопку «**Найти**».
4. Чтобы отменить фильтрацию, нажмите кнопку «**Сбросить фильтры**».

_![Поле атрибута типа «Запись»: несколько значений, только чтение](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_record_attribute_field_multiple_values_read_only.png)_

_![Поле атрибута типа «Запись»: раскрывающийся список](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_record_attribute_field_multiple_values_dropdown_list.png)_
...
_![Поле атрибута типа «Запись»: иерархическая таблица](/platform/v6.0/business_apps/templates/forms/img/hierarchical_table.gif)_
...
- **Карточки** — выберите [представление карточек](https://kb.comindware.ru/article.php?id=5734), которое требуется использовать для таблицы.
- **Фильтр**
...
_![Пример работы с древовидной таблицей с иерархической нумерацией](/platform/v6.0/business_apps/templates/forms/img/HierarchicalTable-optimized.gif)_
...
См. также статьи *«[Шевроны. Правила окрашивания. Пример настройки](https://kb.comindware.ru/article.php?id=5364)»* и *«[Шевроны. Визуализация этапов процесса. Пример настройки](https://kb.comindware.ru/article.php?id=5379)»*.

_![Поле атрибута типа «Запись»: шевроны и таблица исходных записей для них](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_record_chevron_table.png)_
...
_![Настройка цвета и условия окраски шевронов](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_chevron_color_configure.png)_
...
Подробные сведения см. в статьях *«[Диаграмма Ганта. Настройка](https://kb.comindware.ru/article.php?id=5362)»* и *«[Диаграмма Ганта. Использование](https://kb.comindware.ru/article.php?id=5363)»*.

_![Поле атрибута типа «Запись»: диаграмма Ганта и таблица исходных записей для диаграммы](/platform/v6.0/business_apps/templates/forms/img/gantt_chart_example2.png)_
...
Подробные сведения см. в статьях *«[Карты. Настройка](https://kb.comindware.ru/article.php?id=5314)»* и *«[Карты. Использование](https://kb.comindware.ru/article.php?id=5595)»*.
...
_![Поле атрибута типа «Запись»: карта](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_record_field_map.png)_

### Обсуждение

Представление поля «**Обсуждения**» на формах определяется сочетанием свойств поля и [свойств шаблона](https://kb.comindware.ru/article.php?id=5727#mcetoc_1h7hu3akn4).  См. статью *«[Настройка обсуждений](https://kb.comindware.ru/article.php?id=5727)»*.
...
Подробные сведения см. в статье *«[Использование обсуждения](https://kb.comindware.ru/article.php?id=5602)»*.

1. Поместите на неё поле «**Обсуждение**».
2. При необходимости настройте быстрые ответы, см. *«[Настройка быстрых ответов](https://kb.comindware.ru/article.php?id=5727#discussion_configure_quick_answers)»*.
3. Откройте форму, отправляйте и отвечайте на сообщения в чате, архивируйте их и прикрепляйте к ним файлы.

_![Обсуждение записи на форме](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_record_form_discussion.png)_
...
_![Поле атрибута типа «Организационная единица»: несколько значений, только чтение](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_attribute_organizational_unit_multiple_values_read_only.png)_

_![Поле атрибута типа «Организационная единица»: несколько значений, раскрывающийся список](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_attribute_organizational_unit_multiple_values_dropdown_list.png)_

_![Поле атрибута типа «Организационная единица»: несколько значений, таблица](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_attribute_organizational_unit_multiple_values_table.png)_
...
_![Список атрибутов шаблона оргединицы в панели элементов конструктора форм](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_organizational_unit_attribute_list.png)_
...
- **Представление** — выберите способ отображения поля на форме:
  ...
  - **Диаграмма** — поле будет отображаться в виде диаграммы экземпляра процесса, связанного с текущей записью (если не задан **фильтр**), или экземпляра процесса, ID которого вернул **фильтр**. См. статью *«[Просмотр диаграммы процесса](https://kb.comindware.ru/article.php?id=5657)»*.
  - **Таблица** — поле будет отображаться в виде таблицы со списком экземпляров процесса, связанных с текущей записью (если не задан **фильтр**), или экземпляров процесса, ID которых вернул **фильтр**. В таблице связанных процессов предусмотрены следующие столбцы:
    ...
    - **Название экземпляра процесса** — гиперссылка на экземпляр процесса, см. статью *«[Использование диаграммы экземпляра процесса](https://kb.comindware.ru/article.php?id=5658)»*;
    ...
    - **Задачи** — гиперссылки на [пользовательские задачи](https://kb.comindware.ru/article.php?id=5666) по процессу, назначенные исполнителям.
...
_![Поле «Связанные процессы» в виде таблицы и диаграммы](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_linked_process_field.png)_

### Список значений

Представление поля атрибута типа «**Список значений**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=5699).

У этого поля предусмотрены только [общие свойства](#общие-свойства-полей).

См. также статьи *«[Атрибут типа «Список значений». Вычисление значения по справочнику](https://kb.comindware.ru/article.php?id=5381)» и «[Атрибут типа «Список значений». Вычисление текущего значения](https://kb.comindware.ru/article.php?id=5377)»* .
...
3. Отобразится раскрывающийся список с названиями и значками автомобилей, пункты списка будут окрашены указанными цветами.
   ...
   ![Раскрывающийся список значений на форме](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_form_enum_dropdown_list.png)
...
5. Столбец *«Тип транспортного средства»* должен выглядеть как показано на иллюстрации.
   ...
   ![Представление атрибута типа «Список значений» в таблице](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_attribute_enum_table.png)
...
_![Поле атрибута типа «Роль»: несколько значений, только чтение](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_attribute_role_field_multiple_values_read_only.png)_

_![Поле атрибута типа «Роль»: несколько значений, раскрывающийся список](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_attribute_role_field_multiple_values_dropdown_list.png)_

_![Поле атрибута типа «Роль»: несколько значений, таблица](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_attribute_role_field_multiple_values_table.png)_

#### Настройка представления

Представление поля атрибута типа «**Роль**» на форме определяется сочетанием свойств поля и [свойств атрибута](https://kb.comindware.ru/article.php?id=5720).
...
_![Список атрибутов шаблона роли в панели элементов конструктора формы](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_template_role_attributes_list.png)_

### Текст

Представление поля атрибута типа «**Текст**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=5710).
...
Сведения о настройке и пример использования **форматов отображения** с **масками ввода** см. в статье [*«Атрибут типа «Текст»*](https://kb.comindware.ru/article.php?id=5710).
...
_![Редактирование значения в поле с HTML-текстом на форме](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_html_text_field_edit.png)_

### Цвет

Представление поля системного [атрибута «**Цвет**»](https://kb.comindware.ru/article.php?id=5715) на форме определяется свойствами поля.
...
_![Поле атрибута «Цвет» с палитрой для выбора цвета](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_attribute_color_field_palette.png)_

_![Отображение атрибута «Цвет» в таблице](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_attribute_color_table.png)_
...
По умолчанию сектора диаграмм окрашиваются цветами, заданными в разделе «**[Цвета графиков и диаграмм](https://kb.comindware.ru/article.php?id=5637#themes_graphic_diagram_color)**» в текущей **теме**.
...
10. На диаграмме *«Заявки по типу»* должны отобразиться четыре сектора: красный, синий, зелёный и жёлтый, показывающие количество заявок на перевозку соответствующими типами ТС. См. пример на следующей иллюстрации.
    ...
    ![Диаграмма с секторами, окрашенными с помощью атрибута «Цвет» связанных записей](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_attribute_color_sector_diagram.png)
...
Подробные сведения см. в статьях *«[Чертёж. Подготовка и импорт файла DWG](https://kb.comindware.ru/article.php?id=5371)»* и *«[Чертёж. Настройка](https://kb.comindware.ru/article.php?id=5380)»*.
...
- **Маркеры**
  ...
  - **Таблица** — выберите таблицу, которая будет отображаться на вкладке «**Заявки**» слева от плана. Если для таблицы назначено [представление карточек](https://kb.comindware.ru/article.php?id=5734), то оно будет отображаться вместо таблицы.
...
_![Настройка свойств связей для поля атрибута типа «Чертёж»](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_attribute_drawing_links_configure.png)_

_![Поле атрибута типа «Чертёж»: загруженный план и привязанные к нему данные](/platform/v6.0/business_apps/templates/forms/img/drawing_on_form.png)_

### Число

Представление поля атрибута типа «**Число**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=5705).
...
Представление поля атрибута типа «**Штрихкод**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=5714).
...
_![Отображение и редактирование QR-кода на форме](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_attribute_barcode_appearance.png)_
...
- **Системное имя** — уникальное имя вложенной формы в рамках текущей формы, используемое для настройки [правил для формы](https://kb.comindware.ru/article.php?id=5721).
  Не должно начинаться с цифры. Разрешены английские и русские буквы, цифры и символ «\_». Рекомендуется использовать английские буквы.
  Обычно заполняется автоматически по названию.
...
- **Доступ** — режим доступа к данным на вложенной форме и её отображения:
  ...
  - **Скрыть** — вложенная форма не будет отображаться на текущей форме. Показать скрытую вложенную форму можно с помощью [правил для формы](https://kb.comindware.ru/article.php?id=5721).
- **Редактировать форму** — нажмите эту кнопку, чтобы перейти к конструктору исходной формы.

_![Добавление вложенной формы и настройка её свойств](/platform/v6.0/business_apps/templates/forms/img/form_dynamic_elements_embedded_form_configure.png)_

## Связанные статьи

- *[Статические элементы формы: области, вкладки, колонки, статичный текст. Настройка представления](https://kb.comindware.ru/article.php?id=5725)*
...
- *[Расширенная фильтрация. Настройка форм поиска](https://kb.comindware.ru/article.php?id=5722)*
