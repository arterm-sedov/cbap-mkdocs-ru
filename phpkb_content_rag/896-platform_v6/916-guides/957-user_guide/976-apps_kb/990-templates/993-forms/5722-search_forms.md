...
kbId: 5722
url: 'https://kb.comindware.ru/article.php?id=5722'
updated: '2025-02-20 18:01:18'
---
...
Расширенная фильтрация улучшает поиск данных в **Comindware Platform**, позволяя фильтровать таблицы и списки по дополнительным полям.
...
- *[Таблицы. Расширенная фильтрация](https://kb.comindware.ru/article.php?id=5594#table_personal_use_filter_extended)*
- *[Динамические элементы формы. Настройка раскрывающегося списка](https://kb.comindware.ru/article.php?id=5723)*
...
- Доступ к формам поиска определяется с помощью [ролей](https://kb.comindware.ru/article.php?id=5738).
...
9. Сохраните форму.
10. Настройте доступ к форме поиска с [помощью ролей](https://kb.comindware.ru/article.php?id=5738).
...
_![Конструктор формы поиска](/platform/v6.0/business_apps/templates/forms/img/search_forms_designer.png)_
