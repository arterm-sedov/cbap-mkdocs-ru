...
kbId: 5725
url: 'https://kb.comindware.ru/article.php?id=5725'
updated: '2025-02-21 14:17:53'
---
...
**Статические элементы** формы — это визуальные элементы. Их представление для конечного пользователя формируется с помощью [конструктора формы](https://kb.comindware.ru/article.php?id=5724) и помощью [правил для формы](https://kb.comindware.ru/article.php?id=5721) и не зависит от данных, отображающихся в форме.
...
- **Группа кнопок**, **Разделитель кнопок** — позволяют упорядочить кнопки в [области кнопок](https://kb.comindware.ru/article.php?id=5729#button_area_configure) на форме.
...
В каждой области предусмотрена [область кнопок](https://kb.comindware.ru/article.php?id=5729#button_area_configure), отдельная от основной области кнопок формы.
...
- **Системное имя** — уникальное имя элемента формы, используемое при настройке [правил для формы](https://kb.comindware.ru/article.php?id=5721).
...
- **Доступ** — режим доступа к данным полей внутри области и отображения области:
  ...
  - **Скрыть** — область и элементы внутри неё не будут отображаться на форме. Показать скрытую область можно с помощью [правил для формы](https://kb.comindware.ru/article.php?id=5721).

_![Настройка области на форме](/platform/v6.0/business_apps/templates/forms/img/form_static_elements_area.png)_
...
На каждой вкладке предусмотрена [область кнопок](https://kb.comindware.ru/article.php?id=5729#button_area_configure), отдельная от основной области кнопок формы.
...
- **Доступ** — режим доступа к данным полей внутри вкладок и отображения вкладок. Доступ можно настроить как для отдельных, так и для всех вкладок.
  ...
  - **Скрыть** — вкладки и элементы внутри них не будут отображаться на форме. Показать скрытый элемент можно с помощью [правил для формы](https://kb.comindware.ru/article.php?id=5721).
...
Каждая вкладка имеет собственное системное имя, и, следовательно, для каждой вкладки (как и для элемента в целом) имеется возможность настроить отдельное [правило](https://kb.comindware.ru/article.php?id=5721) отображения.

С помощью панели «**Свойства элемента «Вкладки**» можно добавлять новые вкладки, менять их порядок и удалять.

_![Настройка вкладок на форме](/platform/v6.0/business_apps/templates/forms/img/form_static_elements_tabs.png)_
...
- **Доступ** — режим доступа к данным полей внутри колонок и отображения колонок. Доступ можно настроить как для отдельных, так и для всех колонок.
  ...
  - **Скрыть** — колонки и элементы внутри них не будут отображаться на форме. Показать скрытый элемент можно с помощью [правил для формы](https://kb.comindware.ru/article.php?id=5721).
...
_![Настройка колонок на форме](/platform/v6.0/business_apps/templates/forms/img/form_static_elements_columns.png)_
...
- **Системное имя** — уникальное имя элемента формы, используемое при настройке [правил для формы](https://kb.comindware.ru/article.php?id=5721).
  Не должно начинаться с цифры. Разрешены английские и русские буквы, цифры и символ «\_». Рекомендуется использовать английские буквы.
  Обычно заполняется автоматически по названию.
- **Текст** — HTML-текст, который будет отображаться на форме. См. *«[Перечень поддерживаемых тегов и элементов HTML](https://kb.comindware.ru/article.php?id=5373)»*.

_![Настройка статичного текста на форме](/platform/v6.0/business_apps/templates/forms/img/form_static_elements_static_text.png)_
...
- *[Перечень поддерживаемых тегов и элементов HTML](https://kb.comindware.ru/article.php?id=5373)*
