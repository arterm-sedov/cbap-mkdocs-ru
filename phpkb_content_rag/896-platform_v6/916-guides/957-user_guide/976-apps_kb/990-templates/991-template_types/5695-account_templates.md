...
kbId: 5695
url: 'https://kb.comindware.ru/article.php?id=5695'
...
**Шаблон аккаунта** — это специальный [шаблон записи](https://kb.comindware.ru/article.php?id=5693), в котором хранятся особые атрибуты аккаунтов.
...
В карточке аккаунта на странице [«**Администрирование**» — «**Аккаунты**»](https://kb.comindware.ru/article.php?id=5579) отображаются данные из *системного шаблона аккаунта*.

См. *«[Системные атрибуты шаблона аккаунта](#account_template_attribute_system_names)»*.

Примечание

- Для того чтобы шаблон аккаунта применялся к аккаунтам и группам, их следует к нему привязать. См. раздел «**[Привязка аккаунта к шаблону аккаунта](https://kb.comindware.ru/article.php?id=5579#accounts_link_to_template)**»
- Шаблон аккаунта можно связать с атрибутом типа «**[Аккаунт](https://kb.comindware.ru/article.php?id=5704)**».

## Свойства шаблона аккаунта

У шаблона аккаунта предусмотрены только [общие свойства](https://kb.comindware.ru/article.php?id=5696).

_![Свойства шаблона аккаунта](/platform/v6.0/business_apps/templates/template_types/img/account_templates_properties.png)_
...
`cmw.account.username` (Имя пользователя) и `cmw.account.mbox` (Адрес эл. почты) являются **обязательными атрибутами** и должны быть **уникальны** для каждого аккаунта в **Comindware Platform**.

Это необходимо учитывать при манипуляциях с аккаунтами с помощью **формул**, **N3** и **C#**.

Подробности см. в параграфе *«[Обязательные атрибуты и уникальность аккаунтов](https://kb.comindware.ru/article.php?id=5579#accounts_required_unique)»*.
