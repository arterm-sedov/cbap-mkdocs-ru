...
kbId: 5694
url: 'https://kb.comindware.ru/article.php?id=5694'
...
- Шаблон процесса состоит из [диаграммы процесса](https://kb.comindware.ru/article.php?id=5657) в нотации BPMN 2.0, данных и других свойств, определяющих, как должны выполняться все процессы определенного вида.
- Каждый шаблон процесса должен и может быть связан только с одним [шаблоном записи](https://kb.comindware.ru/article.php?id=5693). Данные в ходе исполнения процесса хранятся в связанном шаблоне записи.
...
## Преимущества автоматизированных бизнес-процессов
...
Помимо [общих свойств](https://kb.comindware.ru/article.php?id=5696) на странице «**Свойства**» шаблона процесса отображаются перечисленные ниже поля.
...
_![Свойства шаблона процесса](/platform/v6.0/business_apps/templates/template_types/img/process_templates_properties.png)_
...
1. Откройте [список шаблонов](https://kb.comindware.ru/article.php?id=5638).
...
5. Отобразится список экземпляров процесса, в котором можно выполнить следующие действия:
   ...
   - **Открыть** — дважды нажмите строку экземпляра процесса в списке. Отобразится диаграмма экземпляра процесса. См. «*[Использование диаграммы экземпляра процесса](https://kb.comindware.ru/article.php?id=5658)*».
...
Процесс также может остановить пользователь. В этом случае **статус** процесса сменится на «**Завершен**». См. *«[Отмена процесса по кнопке. Настройка шаблонов, процессов и кнопки](https://kb.comindware.ru/article.php?id=5372)»*.
...
- *[Диаграмма процесса. Определения](https://kb.comindware.ru/article.php?id=5657)*
- *[Использование диаграммы экземпляра процесса](https://kb.comindware.ru/article.php?id=5658)*
- *[Общие свойства шаблонов](https://kb.comindware.ru/article.php?id=5696)*
...
- *[Отмена процесса по кнопке. Настройка шаблонов записи, шаблонов процесса и кнопки](https://kb.comindware.ru/article.php?id=5372)*