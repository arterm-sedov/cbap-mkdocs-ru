...
kbId: 5691
url: 'https://kb.comindware.ru/article.php?id=5691'
...
- **Шаблон модели** служит для определения свойств и хранения моделей **[корпоративной архитектуры](https://kb.comindware.ru/article.php?id=5588#architect_description)** и их экземпляров (элементов корпоративной архитектуры). Шаблон модели содержит **[атрибуты](https://kb.comindware.ru/article.php?id=5706)**, формы и другие данные модели. Используется аналогично **[шаблону записи](https://kb.comindware.ru/article.php?id=5693)**. Шаблон модели можно связать с другими шаблонами.
- **Шаблон модели процесса** можно преобразовать в **[шаблон автоматизированного процесса](https://kb.comindware.ru/article.php?id=5694)**.
...
Помимо **[общих свойств](https://kb.comindware.ru/article.php?id=5696)** шаблоны моделей содержат системные атрибуты.
...
- построение иерархических связей между элементами корпоративной архитектурны (например, между группами процессов и процессами) посредством **[атрибута типа «Модель»](https://kb.comindware.ru/article.php?id=5691)**;
...
Для установления связей с шаблонами моделей используется **[атрибут типа «Модель»](https://kb.comindware.ru/article.php?id=5691)**, который позволяет:

- связывать любые шаблоны с шаблонами моделей;
- устанавливать связи между шаблонами моделей.

Атрибут типа «**Модель**» аналогичен [атрибуту типа «**Запись**»](https://kb.comindware.ru/article.php?id=5718), поэтому с ним можно выполнять такие же операции:
...
- [Модуль «Корпоративная архитектура»](https://kb.comindware.ru/article.php?id=5588#architect_description)
