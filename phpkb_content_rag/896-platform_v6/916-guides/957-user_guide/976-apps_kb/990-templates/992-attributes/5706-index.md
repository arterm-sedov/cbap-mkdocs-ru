...
kbId: 5706
url: 'https://kb.comindware.ru/article.php?id=5706'
...
По умолчанию в списке атрибутов отображаются [системные](https://kb.comindware.ru/article.php?id=5717) и [архивные атрибуты](#mcetoc_1gk3c03r50). При необходимости их можно скрыть из списка.
...
**`![](https://kb.comindware.ru/images/marker.png)Атрибуты. Смена системного имени, типа данных и связанного шаблона {Article-ID:5170}`**
