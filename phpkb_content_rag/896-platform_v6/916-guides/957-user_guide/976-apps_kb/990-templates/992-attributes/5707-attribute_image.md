...
kbId: 5707
url: 'https://kb.comindware.ru/article.php?id=5707'
updated: '2025-12-24 19:07:14'
---
...
Извлечение файлов из атрибута типа «Изображение» с помощью N3
...
Помимо **[общих свойств](https://kb.comindware.ru/article.php?id=5713)** для атрибута типа «**Изображение**» предусмотрены перечисленные ниже свойства.
...
- **Использовать для поиска записей** — установите этот флажок, чтобы записи шаблона можно было искать по именам загруженных в атрибут файлов изображений. См. раздел «**[Атрибуты для поиска записей шаблона](https://kb.comindware.ru/article.php?id=5702)**».

_![Свойства атрибута типа «Изображение»](/platform/v6.0/business_apps/templates/attributes/img/attribute_image_properties.png)_

## Пример использования

Прикрепление к отчёту сканов чеков: чёрно-белых с ограничением размера

См. также статью *«[Представление атрибута «Изображение» на форме](https://kb.comindware.ru/article.php?id=5723#form_dynamic_elements_image)»*.
...
_![Исходный и преобразованный файлы](/platform/v6.0/business_apps/templates/attributes/img/attribute_image_example.png)_

## Связанные статьи

- *[Представление атрибута «Изображение» на форме](https://kb.comindware.ru/article.php?id=5723#form_dynamic_elements_image)*
