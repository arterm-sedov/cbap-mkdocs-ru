...
kbId: 5708
url: 'https://kb.comindware.ru/article.php?id=5708'
...
1. Установите флажок «**Вычислять по выражению**» в [свойствах атрибута](https://kb.comindware.ru/article.php?id=5706#attributes_configure).
2. В отобразившемся поле «**Вычисляемое значение**» выберите способ вычисления значения: «**Формула**», «**DMN**», «**N3**» или «**Атрибут**».

   ![Поле «Вычисляемое значение»](/platform/v6.0/business_apps/templates/attributes/img/calculated_attribute_calculated_expression.png)
...
4. Введите выражение в компактном редакторе выражений или выберите атрибут с помощью селектора.
   ...
   ![Компактный редактор выражений](/platform/v6.0/business_apps/templates/attributes/img/calculated_attribute_compact_editor.png)

   Компактный редактор выражений

   ![Селектор атрибута](/platform/v6.0/business_apps/templates/attributes/img/calculated_attribute_select_attribute.png)
...
_![Полный редактор выражений](/platform/v6.0/business_apps/templates/attributes/img/calculated_attribute_full_editor.png)_
