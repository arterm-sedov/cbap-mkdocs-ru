...
kbId: 5719
url: 'https://kb.comindware.ru/article.php?id=5719'
...
Атрибут типа «**Модель**» содержит одну или несколько ссылок на элементы корпоративной архитектуры, хранящиеся в **[шаблоне модели](https://kb.comindware.ru/article.php?id=5719)**. Ссылка представляет собой уникальный идентификатор элемента (записи в шаблоне модели).
...
Помимо **[общих свойств](https://kb.comindware.ru/article.php?id=5713)** для атрибута типа «**Модель**» предусмотрены перечисленные ниже свойства.

- «**Связанный шаблон**» — укажите **[шаблон модели](https://kb.comindware.ru/article.php?id=5719)**, на который будет ссылаться данный атрибут.
...
- [Шаблоны моделей](https://kb.comindware.ru/article.php?id=5719)\_
