...
- Вкладка «**Свойства**»
  ...
  ![Свойства атрибута типа «Список значений»](/platform/v6.0/business_apps/templates/attributes/img/attribute_enum_properties.png)
...
- Вкладка «**Список значений**»
  ...
  ![Список значений](/platform/v6.0/business_apps/templates/attributes/img/attribute_enum_properties_value_list_tab.png)
