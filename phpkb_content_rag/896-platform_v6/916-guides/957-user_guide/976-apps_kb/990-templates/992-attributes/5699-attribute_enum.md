...
kbId: 5699
url: 'https://kb.comindware.ru/article.php?id=5699'
updated: '2026-06-08 12:42:10'
---
...
Помимо **[общих свойств](https://kb.comindware.ru/article.php?id=5713)** для атрибута типа «**Список значений**» предусмотрены перечисленные ниже свойства.
...
- Вкладка «**Свойства**»
  ...
  - **Формат отображения:**
    ...
    - **Бейдж** — значение и значок атрибута будут отображаться на подложке заданного цвета. См. [пример](#attribute_enum_examples).![Свойства атрибута типа «Список значений»](/platform/v6.0/business_apps/templates/attributes/img/attribute_enum_properties.png)
...
- Вкладка «**Список значений**»
  ...
  - **Значок** — значок, который будет отображаться рядом со значением атрибута.![Список значений](/platform/v6.0/business_apps/templates/attributes/img/attribute_enum_properties_value_list_tab.png)
...
_![Создание элементов списка значений](/platform/v6.0/business_apps/templates/attributes/img/attribute_enum_create_value_list.png)_
...
_![Удаление элементов из списка значений](/platform/v6.0/business_apps/templates/attributes/img/attribute_enum_delete_values.png)_
...
- *[Вычисление текущего значения](https://kb.comindware.ru/article.php?id=5377)*
- *[Вычисление значения по справочнику](https://kb.comindware.ru/article.php?id=5381)*
- *[Фильтрация связанных записей по значению атрибута с помощью N3](https://kb.comindware.ru/article.php?id=5243)*
- *[Вычисление значения с помощью N3 и формул](https://kb.comindware.ru/article.php?id=5244)*
...
_![Раскрывающийся список значений на форме](/platform/v6.0/business_apps/templates/attributes/img/attribute_enum_example.png)_

## Связанные статьи

- *[Атрибут типа «Список значений». Вычисление текущего значения](https://kb.comindware.ru/article.php?id=5377)*
- *[Атрибут типа «Список значений». Вычисление значения по справочнику](https://kb.comindware.ru/article.php?id=5381)*
- *[Атрибут типа «Список значений». Фильтрация связанных записей по значению атрибута с помощью N3](https://kb.comindware.ru/article.php?id=5243)*
- *[Атрибут типа «Список значений». Вычисление значения с помощью N3 и формул](https://kb.comindware.ru/article.php?id=5244)*
