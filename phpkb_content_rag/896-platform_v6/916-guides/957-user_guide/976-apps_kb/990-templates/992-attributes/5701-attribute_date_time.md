...
kbId: 5701
url: 'https://kb.comindware.ru/article.php?id=5701'
...
Помимо **[общих свойств](https://kb.comindware.ru/article.php?id=5713)** для атрибута типа «**Дата и время**» предусмотрены перечисленные ниже свойства:
...
_![Свойства атрибута типа «Дата и время»](/platform/v6.0/business_apps/templates/attributes/img/attribute_date_time_properties.png)_
...
- [Атрибут «Дата и время». Форматирование значений с помощью формул](https://kb.comindware.ru/article.php?id=5222)
- [Форматирование значений в файле шаблона экспорта и формулах](https://kb.comindware.ru/article.php?id=5217)
