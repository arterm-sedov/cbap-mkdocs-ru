...
kbId: 5710
url: 'https://kb.comindware.ru/article.php?id=5710'
...
Помимо [**общих свойств**](https://kb.comindware.ru/article.php?id=5713) для атрибута типа «**Текст**» предусмотрены перечисленные ниже свойства.
...
- «**Использовать для поиска записей**» — установите этот флажок, чтобы записи шаблона можно было искать по значению данного атрибута. См. раздел «**[Атрибуты для поиска записей шаблона](https://kb.comindware.ru/article.php?id=5702)**».

_![Свойства атрибута типа «Текст»](/platform/v6.0/business_apps/templates/attributes/img/attribute_text_properties.png)_
