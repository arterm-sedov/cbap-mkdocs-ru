...
kbId: 5712
url: 'https://kb.comindware.ru/article.php?id=5712'
...
Помимо **[общих свойств](https://kb.comindware.ru/article.php?id=5713)** для атрибута типа «**Гиперссылка**» предусмотрены перечисленные ниже свойства.
...
_![Свойства атрибута типа «Гиперссылка»](/platform/v6.0/business_apps/templates/attributes/img/attribute_hyperlink_properties.png)_
...
5. В поле *«Телеграм»* введите ссылку на Telegram в формате `https://t.me/username`.
   ...
   ![Корректно заполненные гиперссылки](/platform/v6.0/business_apps/templates/attributes/img/attribute_hyperlink_example_telegram_valid.png)
...
4. При попытке ввода в поле *«Телеграм»* ссылки `t.me/username` без префикса `https://` отобразится сообщение об ошибке «**Не соответствует формату ссылки на Telegram**».
   ...
   ![Проверка формата гиперссылки](/platform/v6.0/business_apps/templates/attributes/img/attribute_hyperlink_example_telegram_invalid.png)
...
- *[Динамические элементы формы. Настройка представления гиперссылки](https://kb.comindware.ru/article.php?id=5723#form_dynamic_elements_hyperlink)*