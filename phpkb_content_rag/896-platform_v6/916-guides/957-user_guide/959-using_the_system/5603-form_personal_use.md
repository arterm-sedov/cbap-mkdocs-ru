...
kbId: 5603
url: 'https://kb.comindware.ru/article.php?id=5603'
...
При просмотре формы конечному пользователю доступны различные элементы управления в зависимости от его [разрешений](https://kb.comindware.ru/article.php?id=5612э):

1. [Кнопки](https://kb.comindware.ru/category.php?id=994), настроенные для конкретной формы.
2. Стандартные кнопки для формы:
   ...
   - **Информация** *‌*
     ...
     - **Настроить шаблон** — переход к странице свойств [шаблона](https://kb.comindware.ru/category.php?id=991), к которому относится текущая запись.
