...
kbId: 5601
url: 'https://kb.comindware.ru/article.php?id=5601'
updated: '2025-04-04 14:40:18'
---
...
2. Нажмите кнопку «**Карточки**» *‌* над таблицей.
   ...
   ![Переход к представлению карточек для таблицы](/platform/v6.0/using_the_system/img/cards_switch_from_table_desktop.png)

   Переход к представлению карточек для таблицы
3. Чтобы вернуться к таблице, нажмите кнопку «**Таблица**» *‌* над карточками.

   ![Переход к таблице из представления карточек](/platform/v6.0/using_the_system/img/cards_switch_to_table_desktop.png)
...
2. Нажмите кнопку «**…**» над таблицей и выберите пункт «**Карточки**» над таблицей.
   ...
   ![Переход к представлению карточек для таблицы](/platform/v6.0/using_the_system/img/cards_switch_from_table_mobile.png)

   Переход к представлению карточек для таблицы
3. Чтобы вернуться к таблице, нажмите кнопку «**…**» над карточками и выберите пункт «**Таблица**».

   ![Переход к таблице из представления карточек](/platform/v6.0/using_the_system/img/cards_switch_to_table_mobile.png)
...
- Расширенный фильтр комбинируется с уже применёнными [фильтрами в таблице](https://kb.comindware.ru/article.php?id=5594#table_personal_use_filter).
...
- *[Настройка представления карточек](https://kb.comindware.ru/article.php?id=5734)*
