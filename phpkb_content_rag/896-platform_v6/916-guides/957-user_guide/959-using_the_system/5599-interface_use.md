...
kbId: 5599
url: 'https://kb.comindware.ru/article.php?id=5599'
...
**Comindware Platform** предоставляет удобный пользовательский интерфейс, который имеет следующие преимущества:
...
Здесь представлены инструкции по использованию основных элементов интерфейса **Comindware Platform**.

## Основные элементы интерфейса

Интерфейс **Comindware Platform** состоит из следующих элементов:
...
_![Элементы интерфейса Comindware Platform](/platform/v6.0/using_the_system/img/interface_use_elements.png)_

## Использование справки

В **Comindware Platform** предусмотрена контекстная справка.
...
Контекстная справка предусмотрена для часто используемых системных разделов **Comindware Platform**, таких как конструкторы диаграмм, форм, таблиц и сценариев, функций администрирования и т. п..
...
В **Comindware Platform** предусмотрен поиск по содержимому записей.
...
Для пользователей **Comindware Platform** формируются индивидуальные уведомления — сообщения о задачах, уведомления о новых сообщениях в обсуждении, а также системные сообщения.
...
В **Comindware Platform** предусмотрен журнал, содержащий сведения о действиях и ошибках пользователя.
...
В **Comindware Platform** предусмотрена возможность одновременного редактирования записей.
...
4. Возможность и логика одновременного редактирования записи будет зависеть от фактической конфигурации **Comindware Platform**.
