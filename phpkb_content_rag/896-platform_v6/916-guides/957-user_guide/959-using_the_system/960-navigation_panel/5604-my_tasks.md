...
kbId: 5604
url: 'https://kb.comindware.ru/article.php?id=5604'
...
- в [панели навигации](https://kb.comindware.ru/article.php?id=5605) отображается пункт «**Мои задачи**»;
- страница «**Мои задачи**» отображается в качестве начальной страницы при входе в систему пользователя с данным аккаунтом;
- если аккаунту доступен **[Рабочий стол](https://kb.comindware.ru/article.php?id=5606)**, то при входе в систему он отображается вместо страницы «**Мои задачи**».

_![Страница «Мои задачи»](/platform/v6.0/using_the_system/navigation_panel/img/my_tasks.png)_
...
- **Переназначить** — выбор нового исполнителя для задачи. Эта кнопка доступна, если для задачи разрешено переназначение исполнителя. См. *«[Пользовательская задача. Переназначение исполнителя. Настройка диаграммы и смена исполнителя](https://kb.comindware.ru/article.php?id=5391)»*.
- **Обновить** *‌* — загрузка актуальных данных задачи.
- **Ошибки** *‌* — просмотр ошибок заполнения полей формы задачи.
- **Обсуждение** *‌* — [обсуждение](https://kb.comindware.ru/article.php?id=5602) задачи (для записи, связанной с задачей, может использоваться отдельное обсуждение в зависимости от настроек).
- **Информация** *‌*
  - **Журнал изменений** *‌* — просмотр изменений задачи.
  - **Перейти к диаграмме процесса** *‌* — переход к диаграмме экземпляра процесса, связанного с текущей задачей. См. *«[Использование диаграммы экземпляра процесса](https://kb.comindware.ru/article.php?id=5658)»*.
  - **Настроить шаблон** *‌* — переход к странице свойств [шаблона записи](https://kb.comindware.ru/article.php?id=5693), с которым связан процесс.
...
- *[Пользовательская задача. Назначение нового исполнителя](https://kb.comindware.ru/article.php?id=5391)*