...
kbId: 5594
url: 'https://kb.comindware.ru/article.php?id=5594'
updated: '2025-06-16 18:59:09'
---
...
Таблицы в ПО **Comindware Platform** настраиваются на двух уровнях:
...
Сведения о настройке таблиц для разработчиков приложений см. в статьях *«[Настройка таблицы в шаблоне](https://kb.comindware.ru/article.php?id=5735#table_configure_template)»* и *«[Динамические элементы формы: настройка таблицы](https://kb.comindware.ru/article.php?id=5723#form_dynamic_elements_table)».*

## Элементы управления для таблицы

При просмотре таблицы конечному пользователю доступны различные элементы управления в зависимости от его [разрешений](https://kb.comindware.ru/article.php?id=5612):

1. [Кнопки](https://kb.comindware.ru/article.php?id=5728), настроенные для конкретной таблицы.
2. Стандартные кнопки для таблицы
   ...
   - **Мои настройки** *‌*
     ...
     - **Настроить таблицу** — переход к [конструктору таблицы](https://kb.comindware.ru/article.php?id=5735#table_configure_template).
     - **Настроить шаблон** — переход к странице свойств [шаблона](https://kb.comindware.ru/article.php?id=5638), к которому относится текущая запись.
...
_![Элементы управления для таблицы](/platform/v6.0/using_the_system/img/table_personal_use_elements.png)_
...
2. Чтобы настроить ширину столбцов, перетащите с помощью мыши границы заголовков таблицы.
   ...
   ![Изменение ширины столбцов таблицы](/platform/v6.0/using_the_system/img/ColumnResize.gif)
...
3. Чтобы настроить отображение и порядок столбцов, нажмите кнопку «**Мои настройки**» *‌* над таблицей и в раскрывающемся меню выберите пункт «**Настроить внешний вид**».
   ...
   ![Переход к настройке внешнего вида таблицы](/platform/v6.0/using_the_system/img/table_personal_use_table_settings_transfer.png)
...
_![Изменение порядка столбцов таблицы](/platform/v6.0/using_the_system/img/ColumnReorder.gif)_
...
_![Таблица с ручной загрузкой данных](/platform/v6.0/using_the_system/img/table_personal_use_hand_load.png)_
...
_![Настройка фильтров для столбца таблицы](/platform/v6.0/using_the_system/img/table_personal_use_filter_settings.png)_
...
Инструкции по настройке форм поиска: *[Расширенная фильтрация. Настройка форм поиска](https://kb.comindware.ru/article.php?id=5722)*.
...
_![Настройка расширенной фильтрации](/platform/v6.0/using_the_system/img/table_personal_use_filter_extended.png)_
...
_![Пример таблицы с группировкой по столбцу «Тип заявки», подсчётом итогов по столбцам «Тип заявки» и «Длительность» и сортировкой по столбцам «Тип заявки» и «Статус»](/platform/v6.0/using_the_system/img/table_personal_use_example.png)_
...
1. Для **сортировки** значений таблицы нажимайте текст заголовка столбца. При каждом нажатии будет циклически меняться порядок сортировки:
   ...
   - исходный порядок, заданный в приложении (см. *«[Настройка таблицы в шаблоне](https://kb.comindware.ru/article.php?id=5735#table_configure_template)»)*.
...
_![Настройка сортировки по столбцу](/platform/v6.0/using_the_system/img/table_personal_use_column_settings.png)_
...
_![Настройка группировки по столбцу](/platform/v6.0/using_the_system/img/table_personal_use_column_group_settings.png)_
...
_![Настройка подсчёта итогов по столбцу](/platform/v6.0/using_the_system/img/table_personal_use_column_count_settings.png)_
...
1. Чтобы вернуть исходный внешний вид таблицы (порядок и видимость столбцов, закрепление столбцов, способ отображения формы записей, режим загрузки данных) с сохранением остальных персональных настроек (ширины столбцов, фильтров, сортировки, группировки, сортировки):
   ...
   ![Сброс внешнего вида таблицы](/platform/v6.0/using_the_system/img/table_personal_use_drop_settings.png)
...
2. Чтобы сбросить все персональные настройки таблицы (вернуть исходный внешний вид таблицы и сбросить все фильтры, ширину столбцов, а также параметры группировки и сортировки), выберите пункт «**Сбросить**» в раскрывающемся меню «**Мои настройки**» *‌* над таблицей.
   ...
   ![Полный сброс персональных настроек таблицы](/platform/v6.0/using_the_system/img/table_personal_use_full_drop_settings.png)

   Полный сброс персональных настроек таблицы

## Связанные статьи

- *[Настройка таблицы в шаблоне](https://kb.comindware.ru/article.php?id=5735#table_configure_template)*
