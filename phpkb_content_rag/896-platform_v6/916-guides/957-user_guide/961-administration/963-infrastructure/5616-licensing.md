...
kbId: 5616
url: 'https://kb.comindware.ru/article.php?id=5616'
updated: '2025-12-09 11:33:37'
---
...
Для использования **Comindware Platform** необходимо активировать с помощью **лицензионного ключа**.

- **Лицензионный ключ** — это уникальный код, позволяющий активировать одну или несколько лицензий на **продукт**.
- **Продукт**, **Именная лицензия**, **Конкурентная** **лицензия** — см. определения в ***[Лицензионном соглашении конечного пользователя программного обеспечения Comindware](https://www.comindware.ru/policy/)**.*
...
_![Список лицензионных ключей](/platform/v6.0/administration/infrastructure/img/licensing_key_list.png)_

## Добавление лицензионного ключа и активация продукта

1. Нажмите кнопку «**Добавить**» в списке лицензионных ключей.
2. Отобразится окно «**Активация Comindware Platform**».

   ![Активация лицензионных ключей. Способ активации](/platform/v6.0/administration/infrastructure/img/license_key_activation_1.png)
...
1. Выберите пункт «**Онлайн-активация**» на шаге «**1. Способ активации**» в окне «**Активация Comindware Platform**».

   ![Активация лицензионных ключей. Способ активации: онлайн-активация](/platform/v6.0/administration/infrastructure/img/license_key_activation_1.png)

   Активация лицензионных ключей. Способ активации: онлайн-активация
2. Нажмите кнопку «**Продолжить**».

   ![Онлайн-активация. Проверка ключей](/platform/v6.0/administration/infrastructure/img/license_key_activation_2.png)
...
5. В случае успешной активации отобразится сообщение «**Продукт активирован**».
   ...
   ![Онлайн-активация. Продукт активирован](/platform/v6.0/administration/infrastructure/img/license_key_activation_3.png)

   Онлайн-активация. Продукт активирован

### Ручная активация

1. Выберите пункт «**Ручная активация**» на шаге «**1. Способ активации**» в окне «**Активация Comindware Platform**».

   ![Активация лицензионных ключей. Способ активации: ручная активация](/platform/v6.0/administration/infrastructure/img/license_key_activation_manual_1.png)
...
3. Если у вас нет файла ответа активации, Нажмите кнопку «**Продолжить**».
   ...
   ![Ручная активация. Формирование запроса активации](/platform/v6.0/administration/infrastructure/img/license_key_activation_manual_2.png)
...
5. Нажмите кнопку «**Сгенерировать файл запроса активации**».
   ...
   ![Ручная активация. Получение ответа](/platform/v6.0/administration/infrastructure/img/license_key_activation_manual_3.png)
...
11. В случае успешной активации отобразится сообщение «**Продукт активирован**».
    ...
    ![Ручная активация. Продукт активирован](/platform/v6.0/administration/infrastructure/img/license_key_manual_activation_4.png)
...
_![Свойства лицензионного ключа](/platform/v6.0/administration/infrastructure/img/license_key_properties.png)_
...
- Если пользователь вошёл в систему, после чего у него была отозвана лицензия, назначенная напрямую или через группу, лицензия будет продолжать действовать не более периода, установленного ***[Лицензионным соглашением конечного пользователя программного обеспечения Comindware](https://www.comindware.ru/policy/)***.
...
_![Назначение именных лицензий](/platform/v6.0/administration/infrastructure/img/license_named_assign.png)_
...
- Если пользователь получил конкурентную лицензию, она будет отозвана у него при выходе из системы, а также после периода бездействия, установленного ***[Лицензионным соглашением конечного пользователя программного обеспечения Comindware](https://www.comindware.ru/policy/)***. При следующем входе пользователь сможет снова получить лицензию при наличии свободных лицензий.
- Если лицензия будет отозвана у группы, то при следующем входе её участники не получат лицензии, назначенные этой группе.

_![Назначение конкурентных лицензий аккаунтам и группам](/platform/v6.0/administration/infrastructure/img/license_concurrent_assign.png)_
...
_![Отзыв лицензий](/platform/v6.0/administration/infrastructure/img/license_recall.png)_
...
Если после восстановления **Comindware Platform** из резервной копии требуется использовать прежние лицензионные ключи, выполните инструкции в параграфе *«[Восстановление базы данных. Восстановление лицензионных ключей](https://kb.comindware.ru/article.php?id=5576#backup_restore_cdbbz_license_keys)»*.
