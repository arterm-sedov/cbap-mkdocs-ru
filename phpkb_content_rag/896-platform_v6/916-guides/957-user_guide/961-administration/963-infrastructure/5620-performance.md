...
kbId: 5620
url: 'https://kb.comindware.ru/article.php?id=5620'
...
В **Comindware Platform** предусмотрена возможность просмотра и сброса показателей производительности процессов, скриптов, системных служб, сеансов получения и отправки сообщений, а также сеансов вычисления выражений.
...
2. Отобразится страница «**Производительность**»:
   ...
   ![Страница «Производительность»](/platform/v6.0/administration/infrastructure/img/performance_page.png)

   Страница «Производительность»
3. Выберите требуемый подраздел, нажав пункт «**Процессы**».

   ![Выбор показателей производительности для просмотра](/platform/v6.0/administration/infrastructure/img/performance_view_selection.png)

   Выбор показателей производительности для просмотра
...
_![Показатели производительности процессов](/platform/v6.0/administration/infrastructure/img/performance_page.png)_
...
_![Показатели производительности скриптов](/platform/v6.0/administration/infrastructure/img/performance_scripts.png)_
...
_![Показатели производительности системных служб](/platform/v6.0/administration/infrastructure/img/performance_system_services.png)_
...
_![Показатели производительности сеансов получения и отправки сообщений](/platform/v6.0/administration/infrastructure/img/performance_messages.png)_
...
_![Показатели производительности сеансов вычисления выражений](/platform/v6.0/administration/infrastructure/img/performance_expressions.png)_
