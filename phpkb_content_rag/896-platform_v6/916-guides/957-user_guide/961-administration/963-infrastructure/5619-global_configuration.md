...
kbId: 5619
url: 'https://kb.comindware.ru/article.php?id=5619'
...
См. *«[Конфигурация экземпляра, компонентов ПО и служб. Настройка](https://kb.comindware.ru/article.php?id=5554)»*.

Здесь представлены инструкции по настройке только параметров, доступных на странице администрирования **Comindware Platform**.

1. На странице «[**Администрирование**](https://kb.comindware.ru/article.php?id=5608)» в разделе «**Инфраструктура**» выберите пункт «**Глобальная конфигурация**» *‌*.
2. Настройте и сохраните перечисленные ниже параметры.
3. Если изменения не вступили в силу автоматически, перезапустите экземпляр ПО **Comindware Platform**.

Внимание!

После изменения большинства параметров глобальной конфигурации требуется перезапуск экземпляра ПО **Comindware Platform** на стороне сервера. Для этого обращайтесь к системному администратору.
...
Включите или выключите двухфакторную аутентификацию для мобильного приложения. См. статью *«[Двухфакторная аутентификация. Настройка](https://kb.comindware.ru/article.php?id=5578)»*.

После включения двухфакторной аутентификации необходимо перезагрузить экземпляр ПО **Comindware Platform**, чтобы изменения вступили в силу.
