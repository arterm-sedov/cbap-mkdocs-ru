...
kbId: 5637
url: 'https://kb.comindware.ru/article.php?id=5637'
...
1. На странице «**[Администрирование](https://kb.comindware.ru/article.php?id=5608)**» в разделе «**Внешний вид**» выберите пункт «**Темы**» *‌*.
...
_![Доступные темы, выбранная тема отмечена флажком](/platform/v6.0/administration/appearance/themes/img/available_themes.png)_
...
_![Сохранение настроек в разделе «Свойства системы»](/platform/v6.0/administration/appearance/themes/img/theme_save_settings.png)_
...
_![Название системы в верхней информационной панели](/platform/v6.0/administration/appearance/themes/img/system_name_theme.png)_
...
- **Логотип** — это изображение по умолчанию используется в качестве логотипа **[страниц входа и регистрации](https://kb.comindware.ru/article.php?id=5636)**;
- **Фон страниц** — это изображение по умолчанию используется в качестве фона **страниц входа и регистрации**.

_![Фирменные изображения](/platform/v6.0/administration/appearance/themes/img/branded_images.png)_
...
_![Меню операций с изображением](/platform/v6.0/administration/appearance/themes/img/image_manipulation.png)_
...
_![Шрифты](/platform/v6.0/administration/appearance/themes/img/fonts.png)_
...
_![Цветовая палитра — Основные элементы](/platform/v6.0/administration/appearance/themes/img/palette_basic.png)_

### Цвета приоритетов

Здесь можно настроить цвета, которые можно будет назначать различным кнопкам при конструировании бизнес-решений.

_![Цветовая палитра — Приоритеты](/platform/v6.0/administration/appearance/themes/img/palette_priority.png)_
...
_![Цветовая палитра — Дополнительно](/platform/v6.0/administration/appearance/themes/img/palette_additional.png)_
...
_![Цветовая палитра — Графики и диаграммы](/platform/v6.0/administration/appearance/themes/img/palette_charts.png)_
...
_![Цветовая палитра — Пользовательские стили](/platform/v6.0/administration/appearance/themes/img/palette_custom_css.png)_
...
_![Предварительный просмотр — Основные элементы](/platform/v6.0/administration/appearance/themes/img/preview_basic.png)_

_![Предварительный просмотр — Формы](/platform/v6.0/administration/appearance/themes/img/preview_forms.png)_

_![Предварительный просмотр — Формы](/platform/v6.0/administration/appearance/themes/img/preview_tables.png)_
