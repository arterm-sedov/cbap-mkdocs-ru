...
title: 'Функции'
kbId: 5640
url: 'https://kb.comindware.ru/article.php?id=5640'
updated: '2025-10-01 19:26:00'
---
...
**Функции** предназначены для использования в действии «[**Задача-вызов сервиса**](https://kb.comindware.ru/article.php?id=5667)».

Примечание

Создание новых функций в **Comindware Platform** версии 5 не предусмотрено, возможно только редактировать имеющиеся функции.

Вместо функций рекомендуется использовать [**сценарии**](https://kb.comindware.ru/article.php?id=5654).

## Просмотр полного списка функций

1. На странице [«**Администрирование**»](https://kb.comindware.ru/article.php?id=5608) в разделе «**Архитектура**» выберите пункт «**Функции**» *‌*.
2. Отобразится список функций в составе всех приложений.

_![Список функций во всех приложениях](/platform/v6.0/administration/architecture/img/functions_page.png)_

## Просмотр списка функций для приложения

1. В разделе «[**Администрирование**](https://kb.comindware.ru/article.php?id=5643)» приложения выберите пункт «**Функции**» *‌*.
2. Отобразится список функций в составе данного приложения.

_![Список функций в одном приложении](/platform/v6.0/administration/architecture/img/functions_business_app_page.png)_
...
_![Настройка глобальной функции](/platform/v6.0/administration/architecture/img/functions_create.png)_
...
1. Зарегистрируйте **Comindware Platform** во внешней веб-службе в качестве клиента.
2. Настройте аутентификацию **Comindware Platform** во внешней веб-службе.
