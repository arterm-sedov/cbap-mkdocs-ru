...
kbId: 5638
url: 'https://kb.comindware.ru/article.php?id=5638'
updated: '2026-06-16 19:14:32'
---
...
Для каждого [приложения](https://kb.comindware.ru/article.php?id=5643) предусмотрен отдельный набор шаблонов. См. *«[Просмотр списка шаблонов приложения](#templates_view_in_app)».*

В **Comindware Platform** предусмотрены шаблоны следующих типов:
...
- **[шаблон роли](https://kb.comindware.ru/article.php?id=5692)**
- **[шаблон организационной единицы](https://kb.comindware.ru/article.php?id=5697)**
- **[шаблоны моделей](https://kb.comindware.ru/article.php?id=5719)** — для хранения элементов процессной архитектуры Архитекта

У шаблонов различных типов имеются общие и специфические свойства.

Шаблон любого типа содержит и позволяет настраивать:

- [общие свойства шаблона](https://kb.comindware.ru/article.php?id=5696);
- [таблицы](https://kb.comindware.ru/article.php?id=5735) для отображения данных;
- [карточки](https://kb.comindware.ru/article.php?id=5734#cards_configure_assign_to_table);
- [формы](https://kb.comindware.ru/article.php?id=5724) для просмотра и ввода данных;
- [кнопки](https://kb.comindware.ru/article.php?id=5728) для выполнения операций в приложении;
- [области кнопок](https://kb.comindware.ru/article.php?id=5729) для форм и таблиц.

Шаблоны **записи, аккаунта, роли** и **оргединицы** содержат:

- [атрибуты](https://kb.comindware.ru/article.php?id=5706) бизнес-сущности;
- записи с экземплярами бизнес-сущностей;
- [шаблоны экспорта](https://kb.comindware.ru/article.php?id=5733) данных в форматах DOCX, XLSX и PDF.

Шаблон **процесса** содержит:

- [диаграмму бизнес-процесса](https://kb.comindware.ru/article.php?id=5657);
...
1. На странице [«**Администрирование**»](https://kb.comindware.ru/article.php?id=5608) в разделе «**Архитектура**» выберите пункт «**Шаблоны**» *‌*.
2. Отобразится список всех шаблонов в составе всех [приложений](https://kb.comindware.ru/article.php?id=5643).

_![Список шаблонов в составе приложения](/platform/v6.0/business_apps/templates/img/template_list.png)_
...
_![Кнопки операций в списке шаблонов](/platform/v6.0/business_apps/templates/img/template_list_operations.png)_
...
[Шаблон роли](https://kb.comindware.ru/article.php?id=5692) и [шаблон организационной единицы](https://kb.comindware.ru/article.php?id=5697) создаются автоматически при создании приложения.
...
5. Настройте [свойства шаблона записи](https://kb.comindware.ru/article.php?id=5693#record_template_properties).
6. Сохраните шаблон.

_![Создание шаблона записи](/platform/v6.0/business_apps/templates/img/record_templates_create.png)_
...
3. Нажмите кнопку «**Создать**».
4. Откроется окно «**Новый шаблон**».
5. Настройте [общие свойства шаблона](https://kb.comindware.ru/article.php?id=5693).

   ![Создание шаблона процесса](/platform/v6.0/business_apps/templates/img/process_templates_create.png)
...
6. Настройте связь шаблона процесса с шаблоном записи.
   ...
   - «Создать новый шаблон» — к новому шаблону процесса будет привязан вновь созданный связанный шаблон записи:
     ...
     - «Системное имя нового шаблона записи» — укажите уникальное имя шаблона.
       ...
       Обычно заполняется автоматически по названию.![Привязка нового шаблона записи](/platform/v6.0/business_apps/templates/img/create_related_template.png)
   ...
   - «Связать с существующим шаблоном» — к новому шаблону процесса будет привязан имеющийся шаблон записи.
     - «Связанный шаблон» — выберите из раскрывающегося списка шаблон записи для привязки к создаваемому шаблону процесса.![Привязка имеющегося шаблона записи](/platform/v6.0/business_apps/templates/img/relate_existing_template.png)
...
3. Нажмите кнопку «**Создать**».
4. Откроется окно «**Новый шаблон**».
5. Настройте [свойства шаблона аккаунта](https://kb.comindware.ru/article.php?id=5695).
6. Сохраните шаблон.

_![Создание шаблона аккаунта](/platform/v6.0/business_apps/templates/img/account_templates_create.png)_
...
4. Настройте [свойства шаблона](https://kb.comindware.ru/article.php?id=5696).
5. Нажмите кнопку «**Сохранить**».

_![Страница «Свойства» шаблона](/platform/v6.0/business_apps/templates/img/template_common_properties.png)_
...
_![Кнопки операций с шаблоном и панель «Связи» на странице «Свойства»](/platform/v6.0/business_apps/templates/img/common_actions.png)_
...
Шаблоны можно переносить между [приложениями](https://kb.comindware.ru/article.php?id=5643) для рефакторинга или формирования связи между несколькими приложениями.
...
1. Нажмите кнопку «**Сменить приложение**» в разделе «**Основные свойства**» на вкладке «**[Свойства](https://kb.comindware.ru/article.php?id=5696)**» шаблона.
2. Откроется окно «**Смена приложения**».
3. Выберите **новое приложение**.
4. Нажмите кнопку «**Сохранить**».
5. Нажмите кнопку «**Сохранить**» на странице «**Свойства**» шаблона.

_![Смена приложения для шаблона записи](/platform/v6.0/business_apps/templates/img/changing_app_for_template.png)_

## Просмотр разрешений на доступ к шаблону

Подробные сведения о разрешениях на доступ к ресурсам приложения и свойствах ролей см. в разделе «**[Роли в приложении](https://kb.comindware.ru/article.php?id=5738)**».
...
_![Разрешения на доступ к шаблону](/platform/v6.0/business_apps/templates/img/process_templates_permissions.png)_
...
_![Фильтрация неактивных ролей](/platform/v6.0/business_apps/templates/img/template_permissions_audit_filtering.png)_
...
- Архивный шаблон записи нельзя будет связать с атрибутами типа «**[Запись](https://kb.comindware.ru/article.php?id=5718)**».
- Архивный шаблон аккаунта нельзя будет связать с атрибутами типа «**[Аккаунт](https://kb.comindware.ru/article.php?id=5704)**».
...
_![Подтверждение архивирования шаблона записи](/platform/v6.0/business_apps/templates/img/template_archiving_confirmation_record.png)_
...
_![Подтверждение разархивирования шаблона записи](/platform/v6.0/business_apps/templates/img/template_unarchiving_confirmation_record.png)_
...
- При удалении шаблона записи или аккаунта:
  ...
  - удаляются записи, связанные с **[атрибутами типа «Запись»](https://kb.comindware.ru/article.php?id=5718)**, в свойствах которых установлен флажок «**Удалять связанные записи**» (см. [пример](https://kb.comindware.ru/article.php?id=5718#attribute_record_example)).
...
_![Выбор и удаление шаблона в списке шаблонов](/platform/v6.0/business_apps/templates/img/template_delete_button.png)_
...
_![Выбор и очистка шаблона в списке](/platform/v6.0/business_apps/templates/img/template_cleaning_button.png)_
...
- *[Формы. Определения и настройка](https://kb.comindware.ru/article.php?id=5724)*
- *[Кнопки. Определения и настройка](https://kb.comindware.ru/article.php?id=5728)*
