...
3. Настройте путь передачи данных:
   ...
   ![Тема и текст письма для Руководителя с заполнителями для подстановки значений атрибутов](/platform/v6.0/examples/img/process_email_configure_email_manager_example.png)
...
3. Настройте путь передачи данных:
   ...
   - **Свойства сообщения**
     ...
     ![Тема и текст письма заявителю с уведомлением «Отпуск согласован» с заполнителями для подстановки значений атрибутов](/platform/v6.0/examples/img/process_email_configure_email_agree_example.png)
...
3. Настройте путь передачи данных:
   ...
   - **Свойства сообщения**
     ...
     - **Сообщение**
       ...
       ![Тема и текст письма заявителю с уведомлением «В отпуске отказано» с заполнителями для подстановки значений атрибутов](/platform/v6.0/examples/img/process_email_configure_email_restrict_example.png)
