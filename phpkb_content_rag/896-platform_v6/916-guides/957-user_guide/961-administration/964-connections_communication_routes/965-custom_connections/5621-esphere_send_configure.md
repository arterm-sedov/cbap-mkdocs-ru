...
kbId: 5621
url: 'https://kb.comindware.ru/article.php?id=5621'
updated: '2024-12-10 13:10:59'
---
...
В **Comindware Platform** можно настроить подключение к системе электронного документооборота «СФЕРА Курьер». Интеграция с этой системой позволяет:
...
_![Сценарий отправки запроса в «СФЕРА Курьер» для синхронизации данных контрагента](/platform/v6.0/administration/connections_communication_routes/custom_connections/img/esphere_send_configure_scenario.png)_
...
- *[Получение документов через «СФЕРА Курьер»](https://kb.comindware.ru/article.php?id=5622)*
