...
kbId: 5623
url: 'https://kb.comindware.ru/article.php?id=5623'
...
Сведения об использовании репозитория Git см. в статье «**[Управление версиями приложения через Git. Инициализация репозитория, экспорт и импорт](https://kb.comindware.ru/article.php?id=5649)**».
...
_![Настройка подключения типа «Управление версиями через Git»](/platform/v6.0/administration/connections_communication_routes/system_connections/img/git_connection_properties_edit.png)_

## Связанные статьи

- *[Управление версиями приложения через Git. Инициализация репозитория, экспорт и импорт](https://kb.comindware.ru/article.php?id=5649)*
