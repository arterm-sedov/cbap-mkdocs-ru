...
kbId: 5392
url: 'https://kb.comindware.ru/article.php?id=5392'
...
**Comindware Platform** позволяет настраивать **системные уведомления**, которые формируются в **[сценариях](https://kb.comindware.ru/article.php?id=5654)** и отображаются в **информационной панели и в push-сообщениях**.
...
_![Пример системного уведомления в информационной панели](/platform/v6.0/administration/connections_communication_routes/system_connections/notifications/img/system_notifications_example.png)_
...
2. В сценарии [настройте действие «**Отправить сообщение**»](https://kb.comindware.ru/article.php?id=5655#scenario_actions_send_message) с использованием созданного пути передачи данных.
...
_![Настройка основных свойств пути передачи данных для системных уведомлений](/platform/v6.0/administration/connections_communication_routes/system_connections/notifications/img/system_notifications_general.png)_
...
_![Настройка атрибутов сообщения пути передачи данных для уведомлений о задачах](/platform/v6.0/administration/connections_communication_routes/system_connections/notifications/img/system_notifications_attributes.png)_
...
_![Настройка свойств сообщения пути передачи данных для системных уведомлений](/platform/v6.0/administration/connections_communication_routes/system_connections/notifications/img/system_notifications_message_properties.png)_
...
- [Сценарии. Действие «Отправить сообщение»](https://kb.comindware.ru/article.php?id=5655#scenario_actions_send_message)
- [Push-уведомления в браузере. Включение](https://kb.comindware.ru/article.php?id=5596)
