...
kbId: 5624
url: 'https://kb.comindware.ru/article.php?id=5624'
updated: '2025-10-27 16:39:39'
---
...
**Comindware Platform** выводит стандартные уведомления о пользовательских задачах, если не настроены **путь передачи данных** типа «**Уведомления о задачах**» и **данные сообщения пользовательской задачи**.

Если стандартное содержимое системного уведомления о задаче вас не устраивает, **Comindware Platform** позволяет настроить тему и текст уведомления для отправки пользователям дополнительной информации о задачах.
...
_![Пример системного уведомления о новой задаче](/platform/v6.0/administration/connections_communication_routes/system_connections/notifications/img/task_notifications_example_default.png)_
...
- в push-сообщениях при использовании **[Comindware Mobile](https://kb.comindware.ru/article.php?id=5598)** и веб-версии **Comindware Platform** (сервер должен быть подключен к интернету и Apache Kafka);
...
- настроить подключение типа «**Отправка эл. почты из процесса**» и установить в его свойствах флажок «**Использовать по умолчанию**» (см. *«[Отправка эл. почты из процесса. Настройка подключения, пути передачи данных и события на диаграмме процесса](https://kb.comindware.ru/article.php?id=5366)»*);
...
_![Просмотр уведомлений о задачах](/platform/v6.0/administration/connections_communication_routes/system_connections/notifications/img/task_notifications_view.png)_
...
2. В свойствах **[пользовательской задачи](https://kb.comindware.ru/article.php?id=5666)** настройте сопоставление атрибутов **пути передачи данных** с **данными сообщения**.
...
_![Настройка основных свойств пути передачи данных для уведомлений о задачах](/platform/v6.0/administration/connections_communication_routes/system_connections/notifications/img/task_notifications_primary_setting.png)_
...
3. Задайте значения атрибутов сообщения с помощью вкладки «**Данные сообщения**» в свойствах [**пользовательской задачи**](https://kb.comindware.ru/article.php?id=5666), использующей этот путь передачи данных.
...
_![Настройка атрибутов сообщения пути передачи данных для уведомлений о задачах](/platform/v6.0/administration/connections_communication_routes/system_connections/notifications/img/task_notifications_attributes_setting.png)_
...
_![Настройка свойств сообщения пути передачи данных для уведомлений о задачах](/platform/v6.0/administration/connections_communication_routes/system_connections/notifications/img/task_notifications_message_setting.png)_
...
- [Гиперссылка на задачу. Вычисление с помощью N3 и формулы](https://kb.comindware.ru/article.php?id=5343)
