...
kbId: 5308
url: 'https://kb.comindware.ru/article.php?id=5308'
updated: '2025-08-08 17:17:35'
---
...
1. [Настройте подключение](https://kb.comindware.ru/article.php?id=5632) типа «**Подключения REST и OData**» — «**Синхронизация с веб-сервисом**».
...
1. Настройте [подключение к OData-сервису](https://kb.comindware.ru/article.php?id=5632).
2. Откройте приложение из списка [приложений](https://kb.comindware.ru/article.php?id=5643).
...
_![Настройка свойств интеграции](/platform/v6.0/administration/connections_communication_routes/rest_odata_connections/img/integrations_configuration_properties.png)_
...
- **Динамический фильтр** — настройте фильтрацию данных по дате и времени. Для этого укажите атрибут типа «**Дата и время**». Значение этого атрибута в импортируемых записях будет сравниваться с датой и временем отправки запроса на синхронизацию за вычетом **интервала фильтра**.
  ...
  - **Пример**
    ...
    - Синхронизация началась `06.01.2025` (в часовом поясе `UTC+0`).
...
_![Настройки импорта данных из OData-сервиса](/platform/v6.0/administration/connections_communication_routes/rest_odata_connections/img/integrations_configuration_import.png)_
...
_![Настройка постпроцессинга](/platform/v6.0/administration/connections_communication_routes/rest_odata_connections/img/integrations_configuration_postprocessing.png)_
...
_![Настройка экспорта](/platform/v6.0/administration/connections_communication_routes/rest_odata_connections/img/integrations_configuration_export.png)_
...
_![Запуск синхронизации](/platform/v6.0/administration/connections_communication_routes/rest_odata_connections/img/integrations_synchronization_start.png)_
...
_![Журнал сеансов синхронизации данных по OData](/platform/v6.0/administration/connections_communication_routes/rest_odata_connections/img/integrations_log.png)_
...
![Файл integration_raw_ГГГГ-ММ-ЧЧ.log в папке журналов](/platform/v6.0/administration/connections_communication_routes/rest_odata_connections/img/integrations_log_file.png)
...
![Содержимое файла integration_raw.log](/platform/v6.0/administration/connections_communication_routes/rest_odata_connections/img/integrations_log_content.png)
...
- *[Журнал сеансов синхронизации по OData](https://kb.comindware.ru/article.php?id=5614#logs_odata_integration)*
