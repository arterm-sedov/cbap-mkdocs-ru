...
kbId: 5580
url: 'https://kb.comindware.ru/article.php?id=5580'
updated: '2025-06-03 18:20:28'
---
...
1. На странице «[**Администрирование**](https://kb.comindware.ru/article.php?id=5608)» в разделе — «**Администрирование аккаунтов**» выберите пункт «**Группы**» *‌*.
2. Отобразится страница «**Группы**» со списком групп.

   ![Список групп](/platform/v6.0/administration/account_administration/img/groups_page.png)
...
5. Сохраните группу.
   ...
   ![Настройка группы](/platform/v6.0/administration/account_administration/img/new_group.png)
...
_![Выбор участников группы](/platform/v6.0/administration/account_administration/img/groups_member_selection.png)_
...
_![Выбор родительских групп](/platform/v6.0/administration/account_administration/img/groups_parent_selection.png)_

## Настройка синхронизации группы с сервером каталогов

По умолчанию аккаунт, исключённый из группы на сервере каталогов (Active Directory, AD), не архивируется и не деактивируется в **Comindware Platform** Это поведение можно настроить на вкладке «**Сервер каталогов**».
...
Если аккаунт находится в нескольких группах и в свойствах одной из них установлен любой из вышеуказанных флажков, а в других группах этот флажок установлен, то при исключении аккаунта из любой из этих групп в AD, он не будет архивирован (деактивирован) в **Comindware Platform**.

_![Настройка синхронизации группы с сервером каталогов](/platform/v6.0/administration/account_administration/img/groups_active_directory.png)_
