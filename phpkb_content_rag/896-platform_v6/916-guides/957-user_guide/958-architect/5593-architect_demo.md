...
kbId: 5593
url: 'https://kb.comindware.ru/article.php?id=5593'
updated: '2025-08-06 18:42:15'
---
...
Здесь представлено описание стенда, демонстрирующего возможности модуля «**Корпоративная архитектура**».

Модуль «**Корпоративная архитектура**» в составе **Comindware Platform Enterprise** предоставляет инструменты для моделирования и анализа бизнес-архитектуры организаций.
...
Этот материал ориентирован на бизнес-аналитиков, начинающих знакомство с инструментами **Comindware Platform Enterprise**.
...
- **Введение в конструктор корпоративной архитектуры**
  ...
  - Две роли, используемые в демонстрации:
    ...
    - *Сотрудник* занимается просмотром моделей процессов, оргструктуры и выполнением задач, связанных с согласованием и аудитом
...
*Архитектор* занимается построением процессной архитектуры и оргструктуры, наполнением и созданием справочников, связанных с корпоративной архитектурой:
...
- **С чего начать** — виджет с типовыми операциями, которые выполняет *Архитектор*:
  ...
  1. Формирование оргструктуры и заполнение справочников:
...
В модуле «**Корпоративная архитектура**» предусмотрены следующие возможности построения оргструктуры:

- Построение организационно-функциональной диаграммы.
...
### Использование демонстрационной оргструктуры
...
В модуле «**Корпоративная архитектура**» предусмотрены следующие возможности построения процессной архитектуры:
...
12. Настройте шаблон экспорта регламента процесса, который был сформирован на предыдущем шаге:
    ...
    ![Скачивание файла шаблона экспорта](/platform/v6.0/architect/img/architect_demo_export_template_download.png)

    Скачивание файла шаблона экспорта

## Версионирование, согласование и аудит моделей процессов

На демонстрационном стенде настроены связанные с архитектурными моделями процессов автоматизированные процессы: *«Аудиты»* и *«Согласования»*.
...
9. Перейдите к диаграмме автоматизированного процесса, нажав над диаграммой кнопку «**Мои настройки**» *‌* и выбрав пункт «**Процессы**».
...
5. Перейдите в процесс, связанный с записью. Для этого перейдите к диаграмме автоматизированного процесса, нажав над диаграммой кнопку «**Мои настройки**» *‌* и выбрав пункт «**Процессы**».
6. Откройте запущенный процесс.
7. Отобразится диаграмма автоматизированного процесса, показывающая движение токена, остановившегося на задаче «**Назначить аудитора**».

   Логика определения исполнителя задачи по выбору аудитора

   Эта задача назначается на *Сотрудника*, занимающего должность **Главного аудитора** из нашей оргструктуры.
...
2. Отобразятся следующие разделы:
   ...
   - **Мои задачи** — задачи *Сотрудника* по автоматизированным процессам «**Согласование**» и «**Аудит**», участником которых он является.
...
Модуль «**Корпоративная архитектура**» позволяет бизнес-аналитикам структурировать процессы и организационную структуру предприятия, что способствует эффективному управлению и анализу.

Демонстрационный стенд дает общее представление о возможностях **Comindware Platform** и служит отправной точкой для более глубокого изучения продукта.
