...
kbId: 5365
url: 'https://kb.comindware.ru/article.php?id=5365'
updated: '2026-06-16 19:18:40'
---
...
См. также *«[Уведомления. Типы, назначение, настройка, использование](https://kb.comindware.ru/article.php?id=5626)»*.
...
5. Настройте событие-отправку сообщения. См. *«[Отправка эл. почты из сценариев](https://kb.comindware.ru/article.php?id=5630)»*.
...
6. Настройте сценарий на входе в действие «**Вызов процесса**» для создания записей, по которым будет запускаться подпроцесс.
   ...
   3. Добавьте действие «**Изменить значения атрибутов**» и настройте таблицу атрибутов следующим образом:
      ...
      - **Значение:** `$$local`![Настройка действия «Изменить значения атрибутов»](https://kb.comindware.ru/assets/trigger4.jpg)
...
7. Настройте вызов процесса:
   ...
   - **Шаблон вызываемого процесса**: атрибут *«Отправка напоминания»*![Настройка подпроцесса](https://kb.comindware.ru/assets/trigger5.jpg)
...
- [Вычисление пользователей, у которых есть активные задачи](https://kb.comindware.ru/article.php?id=5292)
- [Отправка эл. почты из сценариев](https://kb.comindware.ru/article.php?id=5630)
