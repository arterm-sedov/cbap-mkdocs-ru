...
kbId: 5204
url: 'https://kb.comindware.ru/article.php?id=5204'
updated: '2026-06-16 19:18:21'
---
...
3. Создайте [**кнопку**](https://kb.comindware.ru/article.php?id=5728) *«Скачать вложения»* со следующими свойствами:
...
8. Браузер скачает архив с файлами, прикреплёнными к записи.
   ...
   ![Отображение кнопки «Скачать вложения» в таблице записей шаблона «Реестр документов»](/platform/v6.0/examples/img/download_archive_csharp_button.png)
