...
kbId: 5304
url: 'https://kb.comindware.ru/article.php?id=5304'
...
_![Сценарий отправки HTTP-запроса методом POST](/platform/v6.0/administration/connections_communication_routes/rest_odata_connections/img/http_send_post.png)_
