...
kbId: 5393
url: 'https://kb.comindware.ru/article.php?id=5393'
...
Если вам требуется отфильтровать список задач, см. также *«[Фильтр списка по активным задачам текущего пользователя: по всем процессам, по конкретному процессу](https://kb.comindware.ru/article.php?id=5262)»*.
.
...
- выводить только задачи, у которых **задан крайний срок** (задачи без крайнего срока, не должны отображаться в таблице).
  ...
  **Продолжительность выполнения** можно установить в свойствах **пользовательской задачи** на вкладке «**Дополнительные**».
  ...
  См. *«[Пользовательская задача](https://kb.comindware.ru/article.php?id=5666)»*.
...
3. Добавьте в столбцы таблицы атрибуты:
   ...
   - **Крайний срок**
   - **Дата завершения**
4. Добавьте таблицу *«Статус просрочки задач»* на требуемую информационную страницу приложения. Например, *[на страницу «Мои задачи»](https://kb.comindware.ru/article.php?id=5735#table_configure_add_to_my_tasks)*.
...
- [Создание таблицы со списком задач](https://kb.comindware.ru/article.php?id=5735#table_configure_tasks_view)
- [Добавление таблицы на страницу «Мои задачи»](https://kb.comindware.ru/article.php?id=5735#table_configure_add_to_my_tasks)
- [Справочник по языку N3](https://kb.comindware.ru/article.php?id=5251)
- [Справочник по формулам](https://kb.comindware.ru/article.php?id=5218)
- [Фильтр списка по активным задачам текущего пользователя: по всем процессам, по конкретному процессу](https://kb.comindware.ru/article.php?id=5262)