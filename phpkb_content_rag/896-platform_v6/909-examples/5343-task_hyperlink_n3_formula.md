...
kbId: 5343
url: 'https://kb.comindware.ru/article.php?id=5343'
updated: '2025-10-02 18:38:53'
---
...
См. также *«[Уведомления о задачах. Настройка особого текста](https://kb.comindware.ru/article.php?id=5624)*».
...
3. Создайте **вычисляемый текстовый** атрибут *«Ссылка на задачу»* и введите следующую **формулу** в качестве **вычисляемого значения**:
   ...
   - `https://<your-host>` — адрес экземпляра **Comindware Platform**;
