...
- указать атрибут типа «[**Аккаунт**](https://kb.comindware.ru/article.php?id=5704)» или «[**Роль**](https://kb.comindware.ru/article.php?id=5720)», содержащий ID исполнителей;
...
**`![](https://kb.comindware.ru/images/marker.png)Группы. Создание, настройка, выбор участников, синхронизация с AD, удаление {Article-ID:5580}`**

**`![](https://kb.comindware.ru/images/marker.png)Пользовательская задача {Article-ID:5666}`**

**`![](https://kb.comindware.ru/images/marker.png)Атрибут типа «Аккаунт» {Article-ID:5704}`**

**`![](https://kb.comindware.ru/images/marker.png)Атрибут типа «Роль» {Article-ID:5720}`**

**`![](https://kb.comindware.ru/images/marker.png)Администрирование системы {Article-ID:5608}`**