...
kbId: 5335
url: 'https://kb.comindware.ru/article.php?id=5335'
...
При проектировании бизнес-процессов можно назначить исполнителями **[пользовательской задачи](https://kb.comindware.ru/article.php?id=5666)** аккаунты и (или) роли:

- выбрать определённые аккаунты и роли;
- указать [атрибут типа «Аккаунт»](https://kb.comindware.ru/article.php?id=5704) или [атрибут типа «Роль»](https://kb.comindware.ru/article.php?id=5720), содержащий ID исполнителей;
...
1. Создайте группы на странице **[«Администрирование» — «Администрирование аккаунтов» — «Группы»](https://kb.comindware.ru/article.php?id=5580)**и добавьте в них аккаунты.
