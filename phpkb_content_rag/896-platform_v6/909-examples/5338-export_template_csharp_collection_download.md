...
kbId: 5338
url: 'https://kb.comindware.ru/article.php?id=5338'
updated: '2026-06-16 19:14:29'
---

# Шаблон экспорта. Выгрузка нескольких коллекций и изображений с помощью C#

Данная статья ориентирована на разработчиков С# скриптов. См. также: [Шаблон экспорта, Настройка с использованием C#](https://kb.comindware.ru/article.php?id=5336).

Рассмотрим выгрузку записи в формате PDF. Будут выгружены две коллекции (в виде таблиц) и атрибут типа «**Изображение**», содержащий изображение (изображения).
...
- В строках 54, 65 приведён пример получения ФИО из атрибута типа «**Аккаунт**».
