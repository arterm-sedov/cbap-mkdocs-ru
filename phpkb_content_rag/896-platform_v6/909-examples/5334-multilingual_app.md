...
kbId: 5334
url: 'https://kb.comindware.ru/article.php?id=5334'
updated: '2026-06-16 19:18:37'
---
...
См. также [пример вычисления значения атрибут типа «Список значений» на определённом языке](https://kb.comindware.ru/article.php?id=5244).
...
1. Войдите в **Comindware Platform** используя аккаунт, у которого задан русский язык и который входит в группу *«Пользователи RU»*.
