...
kbId: 5391
url: 'https://kb.comindware.ru/article.php?id=5391'
...
См. «*[Методы System Core API — UserTask — пользовательские задачи](https://kb.comindware.ru/article.php?id=5331#api_system_core_user_task)*».
...
1. Откройте [диаграмму процесса для редактирования](https://kb.comindware.ru/article.php?id=5657#process_diagram_designer).
2. На диаграмме процесса перейдите к свойствам [пользовательской задачи](https://kb.comindware.ru/article.php?id=5666).
...
2. Перейдите к задаче, исполнителя которой требуется изменить:
   ...
   - откройте [диаграмму экземпляра процесса для просмотра](https://kb.comindware.ru/article.php?id=5658) и дважды нажмите задачу;

   или

   - откройте задачу на [странице «**Мои задачи**»](https://kb.comindware.ru/article.php?id=5604).
...
- *[Методы System Core API — UserTask — пользовательские задачи](https://kb.comindware.ru/article.php?id=5331#api_system_core_user_task)*