...
kbId: 5402
url: 'https://kb.comindware.ru/article.php?id=5402'
...
5. Нажмите кнопку «**Сохранить**».
   ...
   ![Создание диаграммы модели данных](/platform/v6.0/tutorials/tutorial_hr/img/lesson_6_data_model_create.png)

   Создание диаграммы модели данных
6. Отобразится конструктор диаграммы модели данных.

   ![Конструктор диаграммы модели данных](/platform/v6.0/tutorials/tutorial_hr/img/lesson_5_data_model_diagram_designer.png)
...
_![Пример ER-диаграммы для процесса найма](/platform/v6.0/tutorials/tutorial_hr/img/lesson_6_er_diagram.png)_
...
_![Пример диаграммы бизнес-способностей](/platform/v6.0/tutorials/tutorial_hr/img/lesson_6_capability_diagram.png)_
...
4. В панели элементов слева нажмите кнопку «**Создать страницу**» *‌* рядом с пунктом «**Страницы**».
   ...
   ![Создание раздела навигации для HR-менеджера](/platform/v6.0/tutorials/tutorial_hr/img/lesson_6_workspace_create.png)
...
9. Нажмите кнопку со значком «**Создать диаграмму**» *‌* рядом с пунктом «**Диаграммы**» в панели элементов.
   ...
   ![Создание страницы для раздела навигации](/platform/v6.0/tutorials/tutorial_hr/img/lesson_6_page_create.png)
...
12. Просмотрите и сохраните результирующую диаграмму.
    ...
    ![Настройка кольцевой диаграммы](/platform/v6.0/tutorials/tutorial_hr/img/lesson_6_diagram_setting.png)
...
16. Сохраните страницу *«Отдел кадров»*.
    ...
    ![Настройка страницы для раздела навигации](/platform/v6.0/tutorials/tutorial_hr/img/lesson_6_hr_page.png)
...
_![Настройка раздела навигации](/platform/v6.0/tutorials/tutorial_hr/img/lesson_6_hr_workspace.png)_
...
_![Мониторинг позиции токена на диаграмме процесса](/platform/v6.0/tutorials/tutorial_hr/img/lesson_6_token_monitoring.png)_
...
_![Настройка таблицы для шаблона «Кандидаты»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_6_table_setting.png)_
