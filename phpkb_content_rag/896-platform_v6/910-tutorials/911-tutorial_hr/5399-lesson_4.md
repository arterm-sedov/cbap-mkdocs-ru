...
kbId: 5399
url: 'https://kb.comindware.ru/article.php?id=5399'
...
_![Макет формы шаблона записи «Типы документов»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_4_document_type_form.png)_
...
3. Создайте атрибут типа «**Запись**» со следующими свойствами:
   ...
   ![Свойства атрибута «Документы»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_4_attribute_multiple.png)
...
7. Атрибуты будут добавлены в качестве столбцов таблицы.
   ...
   ![Настройка атрибута «Документы» на форме](/platform/v6.0/tutorials/tutorial_hr/img/lesson_4_form_table.png)
...
_![Настройка области кнопок атрибута «Документы» на форме](/platform/v6.0/tutorials/tutorial_hr/img/lesson_4_form_button_area.png)_
...
_![Настройка атрибута «Вакансия» на форме](/platform/v6.0/tutorials/tutorial_hr/img/lesson_4_form_create_new_record.png)_
