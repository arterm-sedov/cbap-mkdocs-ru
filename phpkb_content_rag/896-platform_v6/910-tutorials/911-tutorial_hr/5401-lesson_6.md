...
kbId: 5401
url: 'https://kb.comindware.ru/article.php?id=5401'
...
**Предусловия:** пройден [урок 3. Мой первый бизнес-процесс](https://kb.comindware.ru/article.php?id=5398).
...
8. Перейдите на вкладку «**Разрешения**».
   ...
   ![Создание роли «HR-менеджер»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_7_hr_role_create.png)
...
12. Для кнопок «**Создать**» и «**Завершить задачу**» установите разрешения «**Использование кнопки**».
    ...
    ![Настройка разрешений для приложения, шаблона процесса и кнопок «Создать» и «Завершить задачу»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_8_role_permissions_customer_fleet_management.png)
...
_![Разрешения для роли «HR-менеджер»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_7_hr_role_permissions.png)_
...
_![Разрешения для роли «Нанимающий менеджер»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_7_manager_role.png)_
...
_![Разрешения для роли «Сотрудник службы безопасности»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_7_security_role.png)_
...
8. Назначьте разделу навигации роль, для пользователей которой он будет отображаться:
   ...
   ![Переход к назначению роли разделу навигации](/platform/v6.0/tutorials/tutorial_hr/img/lesson_7_workspace_to_role.png)
...
_![Настройка раздела навигации «HR-менеджер»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_7_workspace_hr_setting.png)_
...
10. Нажмите кнопку «**Сохранить**».
    ...
    ![Назначение задачи «Зафиксировать результаты тестирования» роли «HR-менеджер»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_7_task_to_role.png)
...
_![Создание и настройка аккаунта](/platform/v6.0/tutorials/tutorial_hr/img/lesson_7_account_creating.png)_
...
![Назначение роли  _«HR-менеджер»_ аккаунту](/platform/v6.0/tutorials/tutorial_hr/img/lesson_7_account_to_role.png)
...
В [следующем уроке](https://kb.comindware.ru/article.php?id=5402) вы научитесь строить ER-диаграммы и диаграммы бизнес-способностей, отслеживать ход процесса по его диаграмме, настраивать дашборды для мониторинга процесса найма, а также сортировать и группировать данные в таблицах.