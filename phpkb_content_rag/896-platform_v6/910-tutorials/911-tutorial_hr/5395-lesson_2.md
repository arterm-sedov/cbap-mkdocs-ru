...
kbId: 5395
url: 'https://kb.comindware.ru/article.php?id=5395'
...
**Предусловия:** пройден [урок 1 «Обзор возможностей Comindware Platform и понятий BPMS»](https://kb.comindware.ru/article.php?id=5395).
...
_![Страница входа в Comindware Platform](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_login_page.png)_
...
3. Должен отобразиться раздел «**Мой аккаунт**».
   ...
   ![Переход в «Мой аккаунт»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_go_to_my_account.png)
...
5. Чтобы изменения вступили в силу, нажмите кнопку «**Сохранить**».
   ...
   ![Мой аккаунт — просмотр сведений, смена пароля и сохранение изменений](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_my_account_change_password.png)
...
2. Нажмите кнопку «**Создать**».
   ...
   ![Переход к созданию приложения](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_app_create.png)
...
5. Будет создано приложение *«Управление персоналом»*.
   ...
   ![Настройка свойств нового приложения](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_app_configure.png)
...
7. Отобразится страница «**Администрирование**» приложения.
   ...
   ![Переход к странице администрирования приложения](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_app_list.png)
...
1. На странице «**Администрирование**» приложения *«Управление персоналом»* выберите пункт «**Шаблоны**» *‌*.
   ...
   ![Переход к списку шаблонов приложения](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_template_list_open.png)
...
4. Нажмите кнопку «**Создать**».
   ...
   ![Переход к созданию шаблона записи](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_record_template_create.png)
...
11. Будет создан шаблон записи *«Кандидаты»*, и отобразится страница его настройки.
    ...
    ![Создание шаблона записи](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_record_template_configure.png)
...
2. Нажмите кнопку «**Создать**».
   ...
   ![Переход к созданию атрибута шаблона записи](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_attribute_create.png)
...
9. Будет создан атрибут *«Ф. И. О. кандидата»*.
   ...
   ![Настройка свойств атрибута](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_attribute_configure.png)
...
2. В списке форм дважды нажмите пункт *«Кандидаты — Основная форма»*.
   ...
   ![Переход к редактированию формы из списка](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_form_edit.png)

   Переход к редактированию формы из списка
3. Отобразится **конструктор формы**:

   ![Конструктор формы](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_form_designer.png)
...
7. Нажмите кнопку «**Сохранить**», чтобы сохранить изменения формы.
   ...
   ![Перетаскивание атрибута на форму](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_form_add_field.png)
...
15. Установите флажок «**Использовать как заголовок записей**».
    ...
    ![Настройка атрибута «Название вакансии»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_attribute_title_use.png)
...
23. Нажмите кнопку «**Сохранить**».
    ...
    ![Настройка формы шаблона «Вакансии»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_form_vacancy.png)
...
1. На странице шаблона записи *«Вакансии»* нажмите кнопку «**Перейти к экземплярам**».
   ...
   ![Переход к списку записей шаблона](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_open_record_list.png)

   Переход к списку записей шаблона
2. Откроется список всех записей.
3. Нажмите кнопку «**Создать**».

   ![Переход к созданию записи из списка записей шаблона](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_template_record_create.png)

   Переход к созданию записи из списка записей шаблона
4. В поле *«Название»* введите *«Проектный менеджер»*.
5. Нажмите кнопку «**Сохранить**».

   ![Создание новой вакансии](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_new_record_create.png)

   Создание новой вакансии
6. Нажмите ссылку *«Вакансии»* над формой, чтобы вернуться к списку вакансий.

   ![Переход к списку записей шаблона](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_back_to_record_list.png)
...
8. Нажмите кнопку **«Сохранить»**.
   ...
   ![Создание связи между шаблонами при помощи атрибута](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_attribute_related_record.png)
...
13. Нажмите кнопку **«Сохранить»**.
    ...
    ![Добавление атрибута «Вакансия» на форму](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_form_attribute_add.png)
...
7. Нажмите кнопку **«Сохранить»**.
   ...
   ![Пример заполненной записи кандидата](/platform/v6.0/tutorials/tutorial_hr/img/lesson_2_record_example.png)
...
В [следующем уроке](https://kb.comindware.ru/article.php?id=5398) вы узнаете, как спроектировать и запустить бизнес-процесс.