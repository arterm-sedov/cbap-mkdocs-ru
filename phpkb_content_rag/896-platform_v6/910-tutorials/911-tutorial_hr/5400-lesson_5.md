...
kbId: 5400
url: 'https://kb.comindware.ru/article.php?id=5400'
updated: '2025-08-12 18:20:34'
---
...
В ходе этого урока вы научитесь автоматизировать бизнес-процесс найма персонала с помощью сценариев, вычисляемых атрибутов и формул. Мы рассмотрим, как реализовать автоматические проверки и условия перехода между этапами процесса, используя инструменты ПО **Comindware Platform**.
...
_![Настройка формы задачи «Зафиксировать результаты тестирования»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_5_task_test_form.png)_
...
_![Настройка формы задачи «Провести собеседование»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_5_task_interview.png)_
...
_![Настройка формы задачи «Провести проверку кандидата»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_5_task_check.png)_
...
5. Внутри действия «**Сменить контекст**» нажмите кнопку «**Добавить действие**» *‌* и выберите пункт «**Изменить значения атрибутов**».
   ...
   ![Кнопка «Добавить действие» в сценарии](/platform/v6.0/tutorials/tutorial_hr/img/lesson_5_scenario_add.png)
...
7. В заголовке действия «**Изменить значения атрибутов**» нажмите кнопку «**Изменить**» *‌*.
   ...
   ![Кнопка «Изменить» действия «Изменить значения атрибутов»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_5_change_scenario.png)
...
_![Настройка действия «Изменить значения атрибутов»](/platform/v6.0/tutorials/tutorial_hr/img/lesson_5_scenario_change_attributes_setting.png)_
...
В [следующем уроке](https://kb.comindware.ru/article.php?id=5401) вы научитесь настраивать систему управления доступом для участников процесса найма персонала.