...
kbId: 5421
url: 'https://kb.comindware.ru/article.php?id=5421'
...
В ходе этого урока вы познакомитесь с основными элементами интерфейса модуля «**Корпоративная архитектура**», научитесь настраивать рабочий стол и навигацию для решения повседневных задач.
...
## Вход в Comindware Platform Enterprise

1. Запустите браузер и введите в адресную строку адрес веб-сайта с **Comindware Platform**, развёрнутого в вашей компании или в облаке **Comindware** (если используется демо-доступ).
...
5. Отобразится начальная страница **Comindware Platform**.

_![Страница входа в Comindware Platform Enterprise](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_login_page.png)_
...
3. Отобразится страница «**Мой аккаунт**».
   ...
   ![Переход в «Мой аккаунт»](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_go_to_my_account.png)
...
5. Чтобы изменения вступили в силу, нажмите кнопку «**Сохранить**».
   ...
   ![Мой аккаунт — просмотр сведений, смена пароля и сохранение изменений](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_my_account_change_password.png)
...
Приложения в Comindware Platform Enterprise

**Приложения** в **Comindware Platform Enterprise** содержат все сущности, необходимые для моделирования архитектуры: реестры данных, навигацию, формы, роли и т. п.
...
2. Выберите пункт «**Администрирование**» *‌*.
   ...
   ![Переход к странице «Администрирование»](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_go_to_admin.png)
...
5. Создайте приложение *«Архитектура компании»*.
   ...
   ![Создание приложения «Архитектура компании»](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_business_app_create.png)
...
Роли в Comindware Platform Enterprise

**Роли** в приложениях **Comindware Platform Enterprise** служат для настройки доступа пользователей к ресурсам приложения согласно их полномочиям.

1. Откройте приложение *«Архитектура компании»*.

   ![Страница администрирования приложения](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_app_admin.png)
...
4. На вкладке «**Свойства роли**» добавьте свой аккаунт в список «**Выбранные аккаунты и группы**». Для этого дважды нажмите его в списке «**Доступные аккаунты и группы**» . Это необходимо для доступа к разделу навигации *«Архитектор»*.
   ...
   ![Настройка участников роли «Архитектор»](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_role_members_configure.png)
...
7. Сохраните роль.
   ...
   ![Настройка разрешений роли «Архитектор»](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_architect_role_settings.png)
...
Рабочий стол Comindware Platform Enterprise

На стандартном рабочем столе модуля «**Корпоративная архитектура**» предусмотрены полезные виджеты, например:
...
11. Назначьте раздел навигации роли *«Архитектор»*:
    ...
    ![Назначение роли разделу навигации](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_navigation_secttion_role_assign.png)
...
14. Теперь можно проверить работу навигации для *Архитектора*.
    ...
    ![Настройка раздела навигации «Архитектор»](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_architect_workspace_settings.png)
...
3. На вкладке «**Создайте архитектуру**» нажмите кнопку «**Реестр процессов**».
   ...
   ![Рабочий стол](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_desktop.png)
...
8. Откроется страница «**Управление версиями**».
   ...
   ![Страница «Управление версиями»](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_version_control.png)
...
4. В раскрывающемся меню выберите пункт «**Должность**» *‌*.
   ...
   ![Создание должности в реестре оргединиц](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_position_create.png)
...
8. Нажмите кнопку «**Редактировать**» *‌*.
   ...
   ![Переход к режиму редактирования оргединицы](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_orgunit_edit.png)
...
13. В меню элемента выберите пункт «**Новое подразделение**» *‌*.
    ...
    ![Создание нового подразделения](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_department_create.png)
...
20. Перетащите должность *«HR-менеджер»* на должность *«Руководитель HR-отдела»*.
    ...
    ![Перемещение должности «HR-менеджер» на диаграмме оргединицы](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_orgunit_diagram_edit.png)
...
_![Итоговая оргструктура](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_orgunit.png)_
...
5. Нажмите кнопку «**Изменить**» *‌*.
   ...
   ![Переход к настройке шаблона оргединицы](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_edit_button.png)
...
7. Чтобы создать новый атрибут, нажмите кнопку «**Добавить атрибут**» *‌* в панели слева.
   ...
   ![Добавление нового атрибута в шаблон оргединицы](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_orgunit_attribute_create.png)
...
10. Поместите атрибут *«Отдел»* на **форму** шаблона оргединицы.
    ...
    ![Добавление атрибута «Отдел» на форму](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_attribute_to_form.png)
...
11. В правилах для формы добавьте действие для элемента *«Отдел»* со следующими свойствами:
    ...
    ![Настройка правила для формы](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_form_rule.png)
...
_![Отображение атрибута «Отдел» в свойствах должности](/platform/v6.0/tutorials/tutorial_architect/img/lesson_2_department_property.png)_

## Итоги урока

Вы создали приложение *«Архитектура компании»*, настроили роль *«Архитектор»* с необходимыми правами, настроили рабочий стол и организовали навигацию по основным разделам модуля «**Корпоративная архитектура**».
