...
kbId: 5419
url: 'https://kb.comindware.ru/article.php?id=5419'
...
4. Создайте шаблон процесса со следующими свойствами:
   ...
   ![Создание шаблона процесса «Согласование процесса»](/platform/v6.0/tutorials/tutorial_architect/img/lesson_4_process_create.png)
...
5. Выберите задачу на диаграмме и с помощью меню элемента настройте **свойства** задачи:
   ...
   ![Настройка свойств пользовательской задачи «Согласовать процессю](/platform/v6.0/tutorials/tutorial_architect/img/lesson_4_USERTASK_SETTINGS.png)
...
8. В панели слева нажмите кнопку «**Добавить атрибут**» *‌* у атрибута «**Процессы**».
   ...
   ![Добавление нового атрибута](/platform/v6.0/tutorials/tutorial_architect/img/lesson_4_attribute_add.png)

   Добавление нового атрибута
9. Создайте **логический** атрибут *«Согласован»*.
10. Раскройте атрибут «**Процессы**» в панели слева.

    ![Кнопка раскрытия атрибута](/platform/v6.0/tutorials/tutorial_architect/img/lesson_4_attribute_full.png)
...
14. Сохраните форму.
    ...
    ![Настройка формы задачи «Согласовать процесс»](/platform/v6.0/tutorials/tutorial_architect/img/lesson_4_form_settings.png)
...
19. На вкладке «**Дополнительные**» установите следующие значения:
    ...
    ![Настройки развилки «Процесс согласован?»](/platform/v6.0/tutorials/tutorial_architect/img/lesson_4_gateway_properties.png)
...
22. Должна получиться показанная ниже диаграмма:
    ...
    ![Диаграмма процесса «Согласование процесса»](/platform/v6.0/tutorials/tutorial_architect/img/lesson_4_changess_accept_process_diagram.png)
...
7. Сохраните кнопку.
   ...
   ![Настройки кнопки «Согласовать»](/platform/v6.0/tutorials/tutorial_architect/img/lesson_4_accept_button.png)
...
11. Добавьте в область кнопок области «**Атрибуты по умолчанию**» кнопку *«Согласовать»*.
    ...
    ![Настройки формы «Процессы»](/platform/v6.0/tutorials/tutorial_architect/img/lesson_4_process_form_change.png)
...
4. Задайте для **начального события** следующие свойства:
   ...
   ![Свойства начального события сценария](/platform/v6.0/tutorials/tutorial_architect/img/lesson_4_trigger_properties.png)
...
5. После начального события добавьте действие «**Изменить значение атрибутов**» со следующими свойствами:
   ...
   ![Свойства действия «Изменить значение атрибутов»](/platform/v6.0/tutorials/tutorial_architect/img/lesson_4_change_attributes_action_properties.png)

   Свойства действия «Изменить значение атрибутов»
6. Сохраните действие.
7. Должен получиться показанный ниже сценарий:

   ![Сценарий «Редактирование процесса»](/platform/v6.0/tutorials/tutorial_architect/img/lesson_4_change_process_scenario.png)
