...
kbId: 5411
url: 'https://kb.comindware.ru/article.php?id=5411'
updated: '2025-08-01 16:07:54'
---
...
_![Добавление атрибутов на форму заявки на автомобиль](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_form_vehicle_request_configure.png)_
...
11. В отобразившемся раскрывающемся списке дважды нажмите пункт `Затраты` со значком *‌*.
    ...
    ![Вставка заготовки запроса from-where-select для шаблона «Затраты» в качестве аргумента функции SUM()](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_formula_editor_query_entry.png)
...
12. В формулу будет вставлена заготовка запроса записей из шаблона *«Затраты»*: `from a in db->Затраты where Ваше условие select a->id`.
    ...
    ![Заготовки запроса from-where-select для шаблона «Затраты»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_formula_editor_query_template.png)
...
15. В формулу будет вставлено системное имя атрибута `Заявка` шаблона *«Затраты».*
    ...
    ![Вставка в выражение системного имени атрибута «Заявка» шаблона «Затраты»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_formula_editor_attribute_system_name_entry.png)
...
18. В формулу будет вставлено системное имя `id` атрибута **ID** текущего шаблона *«Заявки на автомобили».*
    ...
    ![Вставка в выражение системного имени атрибута «ID» шаблона «Заявки на автомобили»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_formula_editor_id_entry.png)
...
21. В формулу будет вставлено системное имя атрибута `Сумма` шаблона *«Затраты»*.
    ...
    ![Вставка в выражение системного имени атрибута «Сумма» шаблона «Затраты»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_formula_editor_attribute_amount_entry.png)
...
_![Автоматическое вычисление итоговой суммы затрат](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_total_amount_calculated.png)_
...
5. Выберите начальное событие и в меню элемента нажмите кнопку «**Сценарий на выходе**» *‌*.
   ...
   ![Переход к сценарию на выходе из начального события с диаграммы процесса](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_event_start_exit_scenario.png)
...
7. Внутри действия «**Сменить контекст**» нажмите кнопку «**Добавить действие**» *‌* и в раскрывающемся меню выберите пункт «**Изменить значения атрибутов**».
   ...
   ![Создание действия «Изменить значения атрибутов» в сценарии](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_event_start_exit_scenario_add_action.png)
...
9. В заголовке действия «**Изменить значения атрибутов**» нажмите кнопку «**Изменить**» *‌*.
   ...
   ![Переход к настройке действия «Изменить значения атрибутов»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_event_start_exit_scenario_edit_action.png)
...
14. В столбце «**Значение**» выберите пункт «**Формула**».
    ...
    ![Добавление операции с атрибутом для действия «Изменить значения»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_event_start_exit_scenario_change_attribute_values_action_configure.png)
...
19. Вернитесь к диаграмме процесса и опубликуйте её.
    ...
    ![Настройка формулы для вычисления значения атрибута «Номер заявки» при выходе из начального события](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_event_start_exit_scenario_change_attribute_values_formula_configure.png)
...
5. Сохраните форму.
   ...
   ![Настройка режима только чтение для поля «Номер заявки» на форме заявки на автомобиль](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_form_vehicle_request_number_configure.png)
...
_![Автоматически сформированный с помощью формулы номер заявки](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_vehicle_request_number_calculated.png)_
...
6. Выберите шаблон *«Статусы заявок»* и в меню элемента выберите пункт «**Перейти к шаблону**» *‌* — «**Таблицы**» *‌*.
   ...
   ![Диаграмма модели данных — создание нового шаблона записи, добавление в него атрибута и переход к настройке таблиц](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_data_model_diagram_request_status_template_configure.png)
...
8. Сохраните таблицу.
   ...
   ![Настройка отображения справочника «Статусы заявок»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_request_status_template_table_configure.png)
...
9. Откройте конструктор основной формы шаблона *«Статусы заявок»* и настройте её так, чтобы она содержала только поле *«Название»*.
   ...
   ![Настройка формы «Статус заявки»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_form_request_status_configure.png)
...
11. Создайте записи со следующими *названиями*:
    ...
    ![Заполненный справочник «Статусы заявок»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_request_statuses_list.png)
...
13. С помощью меню элемента создайте атрибут в шаблоне *«Заявки на автомобили»*:
    ...
    ![Представление связей на диаграмме модели данных](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_data_model_relations.png)
...
3. В конструкторе сценария внутри действия «**Сменить контекст**» нажмите кнопку «**Изменить**» *‌* в заголовке действия «**Изменить значения атрибутов**», [созданного ранее](#формирование-номера-заявки).
   ...
   ![Переход к настройке действия «Изменить значения атрибутов»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_event_start_scenario_exit_action_edit.png)
...
6. Нажмите поле в столбце «**Значение**» и введите формулу:
   ...
   ![Настройка операции изменения атрибута «Статус» при выходе из начального события](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_event_start_scenario_exit_change_attibute_value_set_status.png)
...
6. Сохраните форму.
   ...
   ![Добавление атрибута «Статус» на форму заявки на автомобиль](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_vehicle_request_form_status_add.png)
...
_![Добавление в таблицу столбцов статуса и номера заявки](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_vehicle_request_table_status_number_add.png)_
...
_![Автоматическое заполненный статус заявки](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_vehicle_request_status_calculated.png)_
...
_![Представление списка задач по умолчанию](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_my_tasks_default_view.png)_
...
3. В меню элемента нажмите кнопку «**Свойства**» *‌*.
   ...
   ![Переход к свойствам задачи с диаграммы процесса](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_user_task_properties_open.png)
...
_![Сформированные с помощью выражений наглядные заголовки в списке задач](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_user_tasks_custom_titles_list.png)_

_![Сформированный с помощью выражения наглядный заголовок задачи](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_7_user_tast_custom_tile.png)_
