...
kbId: 5414
url: 'https://kb.comindware.ru/article.php?id=5414'
updated: '2025-11-12 13:29:59'
---
...
Рекомендуем вместо него пройти курс «[Аналитик. Ознакомительный](https://kb.comindware.ru/article.php?id=5397)».

## Введение

В ходе этого урока вы усовершенствуете **приложение**, созданное на [предыдущем уроке](https://kb.comindware.ru/article.php?id=5413), настроив следующий автоматизированный **процесс** заказа корпоративного автотранспорта:
...
**Предусловия:** пройден [урок 2 «Мой первый реестр данных»](https://kb.comindware.ru/article.php?id=5413).
...
_![Создание шаблона бизнес-процесса](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_template_create.png)_
...
2. Отобразится конструктор диаграммы бизнес-процесса.
   ...
   ![Конструктор диаграммы бизнес-процесса](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_diagram_designer.png)
...
4. Перетащите с панели элементов три дорожки на диаграмму процесса. Элемент «**Дорожка**» расположен в группе «**Общие элементы**».
   ...
   ![Перетаскивание дорожек на диаграмму бизнес-процесса](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_diagram_designer_lane_add.png)
...
6. Чтобы переименовать дорожку, выберите её и в раскрывающемся меню элемента нажмите кнопку «**Свойства**» *‌*.
   ...
   ![Переход к настройке дорожки](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_diagram_designer_lane_configure.png)

   Переход к настройке дорожки
7. В отобразившемся окне «**Свойства дорожки**» введите новое название и нажмите кнопку «**Сохранить**».

   ![Переименование дорожки](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_diagram_designer_lane_rename.png)

   Переименование дорожки
8. Удалите конечное событие. Для этого выберите его и в меню элемента нажмите кнопку «**Удалить**» *‌*.

   ![Удаление элемента диаграммы процесса](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_diagram_designer_delete_element.png)
...
14. Присвойте развилке название *«Одобрена?»*. Для этого дважды нажмите развилку и введите ее название или нажмите кнопку «**Свойства**» *‌* в меню элемента.
    ...
    ![Переход к настройке развилки «или/или»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_diagram_designer_exclusive_gate_configure.png)
...
19. Сохраните настроенные свойства развилки.
    ...
    ![Настройка потоков управления развилки «или/пли»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_exclusive_gate_sequence_flow_configure.png)
...
21. Присвойте конечному событию название *«Отказ»*.
    ...
    **События** в BPMN можно рассматривать как этапы процесса — старт, промежуточные вехи, варианты завершения.
    ...
    ![Диаграмма бизнес-процесса с задачами «Рассмотреть заявку», «Принять заявку», «Отменить поездку» и конечным событием «Отказ»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_diagram_review_accept_cancel.png)
...
25. Добавьте поток управления от развилки *«Есть машина?»* к развилке *«Рассмотрение заявки»*.
    ...
    ![Диаграмма с развилкой «Есть машина?»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_diagram_car_available.png)
...
31. В итоге должна получиться следующая диаграмма:
    ...
    ![Результирующая диаграмма бизнес-процесса заказа автотранспорта](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_diagram_final.svg)
...
1. Выберите на диаграмме «**Начальное событие**» и в раскрывшемся меню элемента нажмите кнопку «**Стартовая форма**» *‌*.
   ...
   ![Переход к настройке стартовой формы](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_diagram_start_form_configure.png)
...
6. Вернитесь к диаграмме процесса, нажав кнопку «**Назад**» в браузере.
   ...
   ![Помещение на стартовую форму вложенной формы заявки и сохранение стартовой формы](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_diagram_start_form_embed.png)
...
1. Выберите задачу *«Рассмотреть заявку»* и в меню элемента нажмите кнопку «**Форма**» *‌*.
   ...
   ![Переход к настройке формы задачи](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_diagram_task_form_configure.png)
...
8. Сохраните форму и вернитесь к диаграмме процесса, нажав кнопку «**Назад**» в браузере.
   ...
   ![Настройка формы задачи «Рассмотреть заявку»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_task_form_review_request.png)
...
5. Чтобы добавить атрибут в этот шаблон записи, нажмите кнопку «**Добавить атрибут**» *‌* рядом с пунктом *«Заявки на автомобили»* в панели элементов.
   ...
   ![Создание атрибута с помощью конструктора диаграммы процесса](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_diagram_designer_attribute_create.png)
...
7. Нажмите кнопку «**Сохранить**».
   ...
   ![Настройка нового логического атрибута](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_attribute_logical_configure.png)
...
11. Сохраните форму и вернитесь к диаграмме процесса с помощью кнопки «**Назад**» браузера.
    ...
    ![Добавление на форму логического поля и настройка способа его отображения](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_diagram_task_form_accept_request.png)
...
7. Сохраните форму и вернитесь к диаграмме процесса.
   ...
   ![Настройка вложенной формы только для чтения](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_diagram_task_form_read_only.png)
...
4. Сохраните форму и вернитесь к диаграмме процесса.
   ...
   ![Настройка формы задачи «Совершить поездку»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_diagram_task_form_take_ride.png)
...
3. На вкладке «**Дополнительные**» для потока к задаче *«Отменить поездку»* установите флажок «**Поток** «**иначе**».
   ...
   ![Выбор потока «иначе»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_exclusive_gate_default_flow_select.png)
...
11. Сохраните поток управления.
    ...
    ![Настройка условия для потока управления с помощью формулы, возвращающей значение атрибута «Заявка одобрена»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_exclusive_gate_formula_configure.png)
...
4. Нажмите кнопку *‌*.
   ...
   ![Ввод и сохранение выражения для доступа к атрибуту «Принято» в потоке управления](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_request_accepted_sequence_flow_formula.png)
...
6. Сохраните поток управления.
   ...
   ![Выбор потока управления по умолчанию и сохранение свойств развилки](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_exclusive_gate_request_accepted_default_flow_configure.png)
...
3. Введите заголовок задачи *«Заказ автотранспорта — Рассмотреть заявку».*
   ...
   ![Выбор исполнителя пользовательской задачи](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_user_task_assignee_select.png)
...
7. Сохраните пользовательскую задачу.
   ...
   ![Назначение исполнителя задачи по атрибуту _creator](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_user_task_assignee_set_creator.png)
...
_![Проверка и публикация диаграммы](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_diagram_validate_publish.png)_
...
2. Нажмите кнопку «**Перейти к экземплярам**».
   ...
   ![Переход к списку экземпляров бизнес-процесса](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_process_template_view_instances.png)
...
6. Нажмите кнопку «**Создать**».
   ...
   ![Создание новой заявки на автомобиль](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_create_request.png)
...
9. Перейдите на страницу «**Мои задачи**» с помощью панели навигации слева.
   ...
   ![Переход к странице «Мои задачи»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_my_tasks_view.png)
...
11. Откройте задачу, дважды нажав её в списке.
    ...
    ![Список активных задач пользователя](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3.png)
...
14. Нажмите кнопку «**Завершить задачу**».
    ...
    ![Рассмотрение заявки на автомобиль и завершение задачи](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_review_request.png)
...
18. Завершите задачу.
    ...
    ![Отклонение заявки на автомобиль в гараже и ее возврат Секретарю](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_3_return_request_to_review.png)
...
В [следующем уроке](https://kb.comindware.ru/article.php?id=5405) вы узнаете, как отследить историю запущенного процесса, и настроите информационные страницы с диаграммами для просмотра статистики за период.