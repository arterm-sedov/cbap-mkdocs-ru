...
kbId: 5415
url: 'https://kb.comindware.ru/article.php?id=5415'
...
Данный курс состоит из 10 уроков для поэтапного освоения ключевых возможностей **Comindware Platform** на примере сквозного сценария автоматизации бизнес-процесса.
...
- Освоить базовые концепции low-code-разработки в **Comindware Platform**.
...
- В ходе прохождения этих уроков вы изучите основополагающие понятия **Comindware Platform**.
...
*[Урок 1: Вход в систему и настройка аккаунта](https://kb.comindware.ru/article.php?id=5412)*

*[Урок 2: Мой первый реестр данных](https://kb.comindware.ru/article.php?id=5413)*

*[Урок 4: Мониторинг и аналитика](https://kb.comindware.ru/article.php?id=5405)*

*[Урок 5: Структуры данных](https://kb.comindware.ru/article.php?id=5409)*

*[Урок 6: Усовершенствованный процесс](https://kb.comindware.ru/article.php?id=5410)*

*[Урок 7: Автоматические вычисления](https://kb.comindware.ru/article.php?id=5411)*

*[Урок 8: Аккаунты, группы и роли](https://kb.comindware.ru/article.php?id=5406)*

*[Урок 9: Формирование документов](https://kb.comindware.ru/article.php?id=5408)*

*[Урок 10: Работа с файлами](https://kb.comindware.ru/article.php?id=5407)*

## Ключевые понятия Comindware Platform

Ниже перечислены основные концепции, сущности и возможности **Comindware Platform**, которые вы изучите во время выполнения данных уроков.
...
- **Comindware Platform** — low-code-система для построения и автоматизации сквозных бизнес-процессов, управления данными и цифровой трансформации организаций.
...
*[Урок 3: Мой первый бизнес-процесс](https://kb.comindware.ru/article.php?id=5414)*
...
- **Аккаунт** — учётная запись, используемая для доступа к **Comindware Platform**, содержит сведения о пользователе и его персональные настройки.
