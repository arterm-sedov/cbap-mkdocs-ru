...
kbId: 5408
url: 'https://kb.comindware.ru/article.php?id=5408'
updated: '2026-06-16 19:19:13'
---
...
Подробные сведения об использовании шаблонов экспорта см. в статье *«[Шаблоны экспорта](https://kb.comindware.ru/article.php?id=5733)»*.
...
_![Шаблон авансового отчёта в формате Excel](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_9_export_template_file.png)_
...
_![Настройка свойств шаблона экспорта](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_9_export_template_configure.png)_
...
1. Перейдите на вкладку «**Кнопки**» шаблона *«Заявки на автомобили»*.\*
   ...
   ![Переход к настройке кнопки экспорта документа](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_9_button_list.png)
...
3. Проверьте корректность свойств кнопки:
   ...
   - **шаблон экспорта** — Авансовый отчёт.![Свойства кнопки экспорта документа, сформированному по шаблону экспорта](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_9_button_properties.png)
...
7. Сохраните форму.
   ...
   ![Добавление кнопки экспорта документа на форму выгрузки отчёта](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_9_button_place_on_form.png)
...
13. Сохраните форму задачи.
    ...
    ![Добавление вложенной формы с кнопкой выгрузки отчёта на форму задачи «Выполнить рейс»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_9_perform_ride_task_form_add_export_form.png)
...
7. Сохраните роль.
   ...
   ![Добавление для роли «Водитель» разрешения на использование кнопки «Авансовый отчёт»](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_9_driver_role_add_button_permission.png)
...
Если вы прошли *[Урок 8 *«Аккаунты, группы и роли»*](https://kb.comindware.ru/article.php?id=5406)*, пользовательские задачи назначаются разным аккаунтам.
...
6. Нажмите кнопку *«Авансовый отчёт»* и дождитесь экспорта (скачивания) сформированного PDF-документа.
   ...
   ![Выгрузка сформированного по шаблону экспорта документа с помощью кнопки на форме](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_9_download_report.png)

   Выгрузка сформированного по шаблону экспорта документа с помощью кнопки на форме
7. Откройте экспортированный документ.
8. Завершите задачу.

   ![PDF-документ авансового отчёта, экспортированный по шаблону в формате Excel](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_9_report.png)
...
В ходе [следующего урока](https://kb.comindware.ru/article.php?id=5407) вы научитесь прикреплять файлы к записям.