...
3. Проверьте корректность свойств кнопки:
   ...
   ![Свойства кнопки экспорта документа, сформированному по шаблону экспорта](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_9_button_properties.png)
