...
kbId: 5405
url: 'https://kb.comindware.ru/article.php?id=5405'
...
3. В списке выберите один из запущенных экземпляров процесса, дважды нажав его.
   ...
   ![Переход к экземпляру процесса из списка](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_4_process_instance_list.png)
...
6. На панели справа отобразится информация о её выполнении.
   ...
   ![Информация о токенах на задаче на диаграмме экземпляра процесса](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_4_process_instance_tokens.png)
...
9. Аналогично выберите любой другой элемент диаграммы процесса для просмотра сведений о нём.
   ...
   ![Журнал изменений задачи на диаграмме экземпляра процесса](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_4_process_instance_changelog.png)
...
9. В панели элементов слева нажмите кнопку «**Создать страницу**» *‌* рядом с пунктом «**Страницы**».
   ...
   ![Переименование раздела навигации и создание информационной страницы](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_4_navigation_section_rename.png)
...
13. Обновите страницу в браузере, чтобы последующие шаги выполнялись корректно. Если браузер выдаст предупреждение о возможной утрате несохранённых изменений, подтвердите обновление страниц.
    ...
    ![Переименование и сохранение страницы](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_4_page_rename.png)
...
16. Нажмите кнопку «**Редактировать**» *‌* рядом с пунктом *«Статистика заявок»* в панели элементов.
    ...
    ![Переход к редактированию страницы](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_4_page_edit.png)
...
18. Нажмите кнопку со значком «**Создать диаграмму**» *‌* рядом с пунктом «**Диаграммы**» в панели элементов.
    ...
    ![Создание диаграммы](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_4_chart_create.png)
...
21. Просмотрите и сохраните результирующую диаграмму.
    ...
    ![Настройка и сохранение круговой диаграммы](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_4_piechart_configure.png)
...
25. Сохраните страницу *«Статистика заявок»*.
    ...
    ![Добавление диаграммы на страницу](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_4_page_chart_configure.png)
...
28. Сохраните раздел навигации.
    ...
    ![Добавление страницы в раздел навигации](/platform/v6.0/tutorials/tutorial_fleet/img/lesson_4_navigation_section_page_add.png)
