...
kbId: 5322
url: 'https://kb.comindware.ru/article.php?id=5322'
...
См. также статью *«`![](https://kb.comindware.ru/images/marker.png)Р7 Офис и Collabora Online. Использование для работы с документами {Article-ID:5320}`».*
...
**`![](https://kb.comindware.ru/images/marker.png)Р7 Офис и Collabora Online. Использование для работы с документами {Article-ID:5320}`**