...
kbId: 5328
url: 'https://kb.comindware.ru/article.php?id=5328'
updated: '2026-06-16 19:18:43'
---
...
- если задаче назначено **несколько возможных исполнителей**, пользователь **должен принять задачу в работу**. **Только принятая в работу** задача будет назначена пользователю как активная. См. *«[Кнопка «Принять в работу» для задачи. Настройка на C#](https://kb.comindware.ru/article.php?id=5327)»*
...
- [Кнопка «Принять в работу» для задачи. Настройка на C#](https://kb.comindware.ru/article.php?id=5327)
...
- [Шаблон процесса. Определение, настройка, удаление](https://kb.comindware.ru/article.php?id=5694)
- [Диаграмма процесса. Определения, просмотр, редактирование, публикация](https://kb.comindware.ru/article.php?id=5657)
- [Шаблон записи. Определение, настройка, удаление](https://kb.comindware.ru/article.php?id=5693)