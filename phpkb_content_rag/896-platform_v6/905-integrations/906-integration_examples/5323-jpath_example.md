...
kbId: 5323
url: 'https://kb.comindware.ru/article.php?id=5323'
...
_![Сценарий обработки данных из запроса с помощью JSONPath](/platform/v6.0/administration/connections_communication_routes/rest_odata_connections/img/jpath_example_scenario.png)_
