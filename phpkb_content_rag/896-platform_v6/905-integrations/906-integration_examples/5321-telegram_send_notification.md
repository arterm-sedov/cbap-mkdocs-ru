...
**`![](https://kb.comindware.ru/images/marker.png)Шаблоны. Определения, создание, настройка, перенос между приложениями, архивирование, очистка, удаление {Article-ID:5638}`**

**`![](https://kb.comindware.ru/images/marker.png)Кнопки. Определение, настройка, удаление {Article-ID:5728}`**

**`![](https://kb.comindware.ru/images/marker.png)Подключения. Типы, создание, настройка, удаление {Article-ID:5303}`**

**`![](https://kb.comindware.ru/images/marker.png)Пути передачи данных. Типы, создание, настройка, удаление {Article-ID:5302}`**

**`![](https://kb.comindware.ru/images/marker.png)Сценарии. Определения, создание, настройка, использование {Article-ID:5654}`**