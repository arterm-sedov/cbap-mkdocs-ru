...
kbId: 5185
url: 'https://kb.comindware.ru/article.php?id=5185'
updated: '2025-05-30 18:01:55'
---
...
4. Чтобы сохранить выражение в компактном редакторе, нажмите кнопку с зеленым флажком.
   ...
   ![Компактный редактор выражений с формулой](/platform/v6.0/business_apps/expressions/expression_editor/../../templates/attributes/img/calculated_attribute_compact_editor.png)

   Компактный редактор выражений с формулой
5. Чтобы перейти к полному редактору, нажмите кнопку «**Открыть в редакторе**» *‌*.

   ![Полный редактор выражений с формулой](/platform/v6.0/business_apps/expressions/expression_editor/img/expression_editor.png)
...
_![Список найденных в справочнике функций](/platform/v6.0/business_apps/expressions/expression_editor/img/expression_editor_found_functions.png)_
...
_![Сведения о функции LENGTH](/platform/v6.0/business_apps/expressions/expression_editor/img/expression_editor_function_info.png)_
...
_![Сведения об ошибке в выражении](/platform/v6.0/business_apps/expressions/expression_editor/img/expression_editor_function_error_report.png)_
...
_![Поиск текста в выражении](/platform/v6.0/business_apps/expressions/expression_editor/img/expression_editor_found_text.png)_
