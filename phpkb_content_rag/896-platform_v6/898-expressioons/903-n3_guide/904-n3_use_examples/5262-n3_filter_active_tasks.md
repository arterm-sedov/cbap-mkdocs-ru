...
См. также *«[Создание таблицы со списком задач](https://kb.comindware.ru/article.php?id=5735#table_configure_tasks_view)»*.
...
3. В свойствах таблицы установите следующий **системный фильтр** на языке **N3**:
   ...
   ```
4. Добавьте таблицу *«Задачи по всем процессам»* на страницу «**Мои задачи**». См. *«[Создание таблицы со списком задач](https://kb.comindware.ru/article.php?id=5735#table_configure_tasks_view)»*.

### Фильтр по задачам конкретного процесса

Чтобы получить в таблице список всех активных задач, где текущий пользователь является исполнителем (а также возможным исполнителем, если задача назначена на нескольких пользователей) по конкретному процессу, используйте следующее выражение в [**системном фильтре таблицы**](https://kb.comindware.ru/article.php?id=5735#table_configure_template):
...
- [Вычисление пользователей с активными задачами](https://kb.comindware.ru/article.php?id=5292)
- [Вычисление исполнителя активной задачи](https://kb.comindware.ru/article.php?id=5277)
