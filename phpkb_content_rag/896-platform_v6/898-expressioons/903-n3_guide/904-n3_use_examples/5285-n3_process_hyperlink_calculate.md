...
kbId: 5285
url: 'https://kb.comindware.ru/article.php?id=5285'
...
В этом примере показано, как с помощью выражения на N3 сформировать HTML‑ссылку на страницу истории процесса, связанного с текущей **[пользовательской задачей](https://kb.comindware.ru/article.php?id=5666)**.
...
- [Справочник по N3](https://kb.comindware.ru/article.php?id=5251)