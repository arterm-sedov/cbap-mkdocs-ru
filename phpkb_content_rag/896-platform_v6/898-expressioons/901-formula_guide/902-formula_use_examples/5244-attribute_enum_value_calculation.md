...
kbId: 5244
url: 'https://kb.comindware.ru/article.php?id=5244'
updated: '2026-06-08 12:42:08'
---
...
- *[Подробное описание и другие примеры использования атрибута типа «Список значений»](https://kb.comindware.ru/article.php?id=5699)*
- *[Фильтрация связанных записей по значению атрибута типа «Список значений» с помощью N3](https://kb.comindware.ru/article.php?id=5243)*
- *[Пример настройки интерфейса приложения на нескольких языках](https://kb.comindware.ru/article.php?id=5334)*
...
_![Диаграмма процесса «Обработка заявок»](/platform/v6.0/examples/img/enum_attribute_value_calculation_diagram.png)_
...
- *[Написание выражений на языке N3](https://kb.comindware.ru/article.php?id=5251)*
...
- *[Интерфейс на нескольких языках. Настройка приложения](https://kb.comindware.ru/article.php?id=5334)*