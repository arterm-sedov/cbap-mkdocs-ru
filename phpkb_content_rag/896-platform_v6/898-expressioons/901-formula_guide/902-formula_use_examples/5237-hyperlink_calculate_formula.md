...
- к основной форме любой записи (см. *[Настройка свойств формы](https://kb.comindware.ru/article.php?id=5724)*);
- к определённой форме конкретной записи;
- к форме пользовательской задачи (см. *[Пользовательская задача](https://kb.comindware.ru/article.php?id=5666)*, *[Редактирование формы пользовательской задачи](https://kb.comindware.ru/article.php?id=5660)\*\*)*;
- к диаграмме экземпляра бизнес-процесса (см. *[Использование диаграммы экземпляра процесса](https://kb.comindware.ru/article.php?id=5658)*).
...
Для записи универсальная ссылка всегда ведёт на основную форму шаблона, то есть форму, в свойствах которой установлен флажок «**По умолчанию**». См. *«[Настройка свойств формы](https://kb.comindware.ru/article.php?id=5724)»*.
...
Для перехода к [диаграмме экземпляра процесса](https://kb.comindware.ru/article.php?id=5658) используется ссылка следующего вида:
...
Для перехода к [пользовательской задаче](https://kb.comindware.ru/article.php?id=5666) используется ссылка следующего вида:
...
9. В начальном событии создайте и настройте сценарий «**Изменить значения атрибутов**»:
   ...
   **Здесь:**
   ...
   - `$$ProcessObject` — системная переменная, хранящая ID экземпляра процесса. См. *«[Использование переменных в сценарии](https://kb.comindware.ru/article.php?id=5656)»*.
...
13. Настройте [подключение к SMTP-серверу](https://kb.comindware.ru/article.php?id=5630) с названием *«Системное уведомление»*.
14. Настройте [путь передачи данных для отправки эл. почты из процесса](https://kb.comindware.ru/article.php?id=5366):
...
4. Перейдите по ссылке, просмотрите диаграмму, попробуйте остановить процесс или перезапустить его. См. *[Использование диаграммы экземпляра процесса](https://kb.comindware.ru/article.php?id=5658)*.
...
- [Формы. Определения, редактирование, удаление](https://kb.comindware.ru/article.php?id=5724)
- [Пользовательская задача](https://kb.comindware.ru/article.php?id=5666)
- [Атрибут типа  «Гиперссылка»](https://kb.comindware.ru/article.php?id=5712)
- [Отправка эл. почты из сценариев через SMTP и Exchange. Настройка подключения, пути передачи данных и сценария](https://kb.comindware.ru/article.php?id=5630)
- [Настройка пути передачи данных типа «Отправка эл. почты из процесса»](https://kb.comindware.ru/article.php?id=5366)
- [Переменные в сценарии](https://kb.comindware.ru/article.php?id=5656)
- [Редактирование формы пользовательской задачи](https://kb.comindware.ru/article.php?id=5660)
- [Настройка свойств формы](https://kb.comindware.ru/article.php?id=5724)