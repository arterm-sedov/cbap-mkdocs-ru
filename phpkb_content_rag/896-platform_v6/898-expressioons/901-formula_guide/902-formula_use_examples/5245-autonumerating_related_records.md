...
kbId: 5245
url: 'https://kb.comindware.ru/article.php?id=5245'
...
Примеры настройки автонумерации записей при их создании см. в статье *«[Автонумерация записей с помощью формулы, C#-скрипта или выражения N3](https://kb.comindware.ru/article.php?id=5194)»*.
...
- *Номер заявки*:
  ...
  Для этого можно воспользоваться приёмами из статьи *«[Автонумерация записей с помощью формулы, C#-скрипта или выражения N3](https://kb.comindware.ru/article.php?id=5194)»*
