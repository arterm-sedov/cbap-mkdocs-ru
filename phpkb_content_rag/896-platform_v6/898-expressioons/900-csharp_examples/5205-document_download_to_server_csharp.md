...
kbId: 5205
url: 'https://kb.comindware.ru/article.php?id=5205'
updated: '2026-06-16 19:18:35'
---
...
Здесь представлен C#-скрипт для **[кнопки](https://kb.comindware.ru/article.php?id=5728)**, который сохраняет все файлы, прикреплённые к атрибуту типа «**Документ**», из текущей записи в локальную папку **на сервере Comindware Platform**.
...
- *[Атрибут типа «Документ». Скачивание архива с файлами из всех строк таблицы с прикреплением архива к атрибуту](https://kb.comindware.ru/article.php?id=5214)*
