...
kbId: 5190
url: 'https://kb.comindware.ru/article.php?id=5190'
updated: '2026-06-16 19:14:57'
---

# Загрузка файла с компьютера в систему

Для того чтобы добавить файл из локальной папки на компьютере в атрибут типа «**Документ**», введите следующее выражение:
...
            Api.TeamNetwork.ObjectService.EditWithAlias(id, new Dictionary<string,object>('test', Undefined));
        }
        catch
        {
...
| Значение | Описание |
| --- | --- |
| `Putkfaylu` | Системное имя атрибута типа «**Текст**», в котором хранится путь к файлу для загрузки в систему, например `C:\\myfolder\\1.cs`. |
| `test` | Системное имя атрибута типа «**Документ**», в который нужно загрузить файл. |