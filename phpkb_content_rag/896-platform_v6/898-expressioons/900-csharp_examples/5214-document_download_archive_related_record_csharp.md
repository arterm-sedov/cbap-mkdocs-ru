...
- *[Клонирование записи вместе с прикреплёнными файлами](https://kb.comindware.ru/article.php?id=5339)*
- *[Скачивание файлов в папку на сервере](https://kb.comindware.ru/article.php?id=5205)*
- *[Скачивание архива с файлами из выбранных строк таблицы или одной записи](https://kb.comindware.ru/article.php?id=5204)*
...
Чтобы скачать документы и прикрепить их к записи, настройте [кнопку](https://kb.comindware.ru/article.php?id=5728) и C#-скрипт для неё.
...
3. Создайте кнопку *«Скачать архив документов»* со следующими свойствами:
   ...
   См. *«[Написание скриптов на языке C#](https://kb.comindware.ru/article.php?id=5211)»*.
...
- *[Атрибут типа «Документ». Скачивание архива с файлами из выбранных строк таблицы и записи](https://kb.comindware.ru/article.php?id=5204)*
- *[Атрибут типа «Документ». Скачивание файлов в папку на сервере](https://kb.comindware.ru/article.php?id=5205)*
- *[Атрибут типа «Документ». Клонирование записи вместе с прикреплёнными файлами](https://kb.comindware.ru/article.php?id=5339)*