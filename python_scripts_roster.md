...
| `phpkb_ingest.py` | Builds one LLM-ingestion Markdown bundle via `gitingest` (default: `phpkb_content_rag/896-platform_v6/`). | Writes `kb.comindware.ru.platform_v6_for_llm_ingestion.md` and copies to `kb.comindware.ru/platform/v6.0/`; `--folder`/`--output` for V5 798 tree. |
