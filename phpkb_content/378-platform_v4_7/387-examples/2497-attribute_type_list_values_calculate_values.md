...
kbId: 2497
url: 'https://kb.comindware.ru/article.php?id=2497'
updated: '2024-08-20 11:45:01'
---
...
В приложении может потребоваться определить (или сравнить с требуемым) значение атрибута типа «[**Список значений**](https://kb.comindware.ru/article.php?id=2244)».
