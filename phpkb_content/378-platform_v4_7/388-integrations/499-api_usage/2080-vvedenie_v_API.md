...
2. Отобразится страница **{{ productName }} API** со следующими разделами:
   - **RESTful Web API** — общие методы для всех версий ПО (см. [Методы Web API](https://kb.comindware.ru/article.php?id=1940));
...
**[Методы Web API](https://kb.comindware.ru/article.php?id=1940)**
