...
kbId: 2572
url: 'https://kb.comindware.ru/article.php?id=2572'
updated: '2024-09-10 17:56:36'
---
...
Сведения об использовании карт см. в статье *«[Карты. Использование](https://kb.comindware.ru/article.php?id=2635)»*.
...
9. Сохраните форму.
10. Протестируйте работу карты на форме: добавьте, переместите, переименуйте и удалите метки. См. [*«Карты. Использование»*](https://kb.comindware.ru/article.php?id=2635).

--8<-- "related_topics_heading.md"

**[Карты. Использование](https://kb.comindware.ru/article.php?id=2635)**

**[Динамические элементы формы. Настройка карты](https://kb.comindware.ru/article.php?id=2531#form_dynamic_elements_map)**
