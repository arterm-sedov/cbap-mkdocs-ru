...
kbId: 5078
url: 'https://kb.comindware.ru/article.php?id=5078'
updated: '2025-01-24 15:21:46'
---
...
Для достижения таких показателей, например, можно использовать кластерную конфигурацию с балансировкой нагрузки, резервированием компонентов и регулярным мониторингом состояния системы. См. [пример настройки простейшего кластера **{{ productName }}**](https://kb.comindware.ru/article.php?id=5076) и *[рекомендации по кластеризации в документации Apache Ignite (на английском языке)](https://ignite.apache.org/docs/latest/clustering/clustering)*.
