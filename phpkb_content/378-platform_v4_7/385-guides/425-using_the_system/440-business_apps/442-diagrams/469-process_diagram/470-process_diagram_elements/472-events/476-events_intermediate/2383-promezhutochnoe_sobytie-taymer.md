...
kbId: 2383
url: 'https://kb.comindware.ru/article.php?id=2383'
updated: '2024-04-02 15:27:50'
---
...
- **Прерывающее** — этот флажок отображается, если **промежуточное событие-таймер** [прикреплено к действию](https://kb.comindware.ru/article.php?id=2379#intermediate-event-use-methods). Если флажок установлен, то при наступлении данного события прикреплённое к нему [действие](https://kb.comindware.ru/article.php?id=2390) будет прервано.
