...
kbId: 2531
url: 'https://kb.comindware.ru/article.php?id=2531'
updated: '2024-10-21 15:56:28'
---
...
**Динамические элементы** формы — это поля атрибутов, кнопки и вложенные формы, вынесенные на форму. Их представление настраивается с помощью [конструктора формы](https://kb.comindware.ru/article.php?id=2271) и [правил для формы](https://kb.comindware.ru/article.php?id=2537) и формируется для пользователя на основе данных, отображающихся в форме.

- **[Поля атрибутов](#настройка-полей-атрибутов)** — при перетаскивании атрибута на форму создаётся поле, представление которого зависит от [типа атрибута](https://kb.comindware.ru/article.php?id=2252).
- [**Вложенные формы**](#form_dynamic_elements_embedded_form) — вложенные формы можно поместить на форму и на **[вкладки](https://kb.comindware.ru/article.php?id=2530#form_static_elements_tabs)**. Это позволяет повторно использовать формы в качестве стандартных блоков.
- **Кнопки** — кнопки можно поместить в области кнопок, которые предусмотрены у формы, областей формы, таблиц и вкладок. См. *«[Настройка области кнопок](https://kb.comindware.ru/article.php?id=2545#button_area_configure)»* и *«[Настройка кнопки](https://kb.comindware.ru/article.php?id=2276)».*

## Настройка полей атрибутов

1. Откройте [конструктор формы](https://kb.comindware.ru/article.php?id=2271).
2. Выберите атрибут на макете формы или перетащите атрибут из панели элементов внутрь [области](https://kb.comindware.ru/article.php?id=2530#form_static_elements_area), [вкладки](https://kb.comindware.ru/article.php?id=2530#form_static_elements_tabs) или [колонки](https://kb.comindware.ru/article.php?id=2530#form_static_elements_columns).
...
- **Системное имя** — уникальное имя поля в рамках текущей формы, используемое для настройки [правил для формы](https://kb.comindware.ru/article.php?id=2537). Не должно начинаться с цифры. Рекомендуется использовать буквы латинского алфавита, цифры и символ «\_». Заполняется автоматически по названию.
...
- **Доступ** — режим доступа к данным атрибута и отображения поля:
  ...
  - **Скрыть** — поле не будет отображаться на форме. Показать скрытое поле можно с помощью [правил для формы](https://kb.comindware.ru/article.php?id=2537).
...
Представление этого поля на форме определяется свойствами поля и **допустимыми схемами URI**, заданными в [свойствах атрибута](https://kb.comindware.ru/article.php?id=2259).
...
4. Адрес должен отобразиться в виде гиперссылки.
   ...
   ![Гиперссылка типа **HTTPS** на форме](https://kb.comindware.ru/assets/attribute_hyperlink_example_valid.png)
...
6. Над полем должно отобразиться сообщение об ошибке «**Не соответствует формату HTTPS-ссылки**».
   ...
   ![Проверка формата гиперссылки](https://kb.comindware.ru/assets/attribute_hyperlink_example_invalid.png)

   Проверка формата гиперссылки

### Дата и время

Представление поля атрибута типа «**Дата и время**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=2246).

У этого поля предусмотрены только [общие свойства](#общие-свойства-полей).

См. также статью [*«Работа с атрибутом типа «Дата и время»*](https://kb.comindware.ru/article.php?id=2004).

### Длительность

Представление поля атрибута типа «**Длительность**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=2248).
...
Представление поля атрибута типа «**Документ**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=2241), см. примеры на иллюстрациях ниже.
...
Представление поля атрибута типа «**Изображение**» на форме определяется сочетанием свойств поля и [свойств атрибута](https://kb.comindware.ru/article.php?id=2253).
...
Представление поля атрибута типа «**Запись**» на форме определяется сочетанием свойств поля и [свойств атрибута](https://kb.comindware.ru/article.php?id=2243).
...
- **Представление** — выберите представление поля на форме:
  ...
  - **Диаграмма Ганта** — [настройте диаграмму Ганта](https://kb.comindware.ru/article.php?id=2107);
...
- **Карточки** — выберите [представление карточек](https://kb.comindware.ru/article.php?id=2402), которое требуется использовать для таблицы.
- **Фильтр**
...
См. также статьи *«[Шевроны. Правила окрашивания. Пример настройки](https://kb.comindware.ru/article.php?id=2119)»* и *«[Шевроны. Визуализация этапов процесса. Пример настройки](https://kb.comindware.ru/article.php?id=2582)»*.
...
Подробные сведения см. в статьях *«[Диаграмма Ганта. Настройка](https://kb.comindware.ru/article.php?id=2107)»* и *«[Диаграмма Ганта. Использование](https://kb.comindware.ru/article.php?id=2108)»*.
...
Подробные сведения см. в статьях *«[Карты. Настройка](https://kb.comindware.ru/article.php?id=2572)»* и *«[Карты. Использование](https://kb.comindware.ru/article.php?id=2635)»*.
...
Представление поля «**Обсуждения**» на формах определяется сочетанием свойств поля и [свойств шаблона](https://kb.comindware.ru/article.php?id=2406#mcetoc_1h7hu3akn4).  См. статью *«[Настройка обсуждений](https://kb.comindware.ru/article.php?id=2406)»*.
...
Подробные сведения см. в статье *«[Использование обсуждения](https://kb.comindware.ru/article.php?id=2407)»*.
...
- **Представление** — выберите способ отображения поля на форме:
  ...
  - **Диаграмма** — поле будет отображаться в виде диаграммы экземпляра процесса, связанного с текущей записью (если не задан **фильтр**), или экземпляра процесса, ID которого вернул **фильтр**. См. статью *«[Просмотр диаграммы процесса](https://kb.comindware.ru/article.php?id=2360)»*.
  - **Таблица** — поле будет отображаться в виде таблицы со списком экземпляров процесса, связанных с текущей записью (если не задан **фильтр**), или экземпляров процесса, ID которых вернул **фильтр**. В таблице связанных процессов предусмотрены следующие столбцы:
    ...
    - **Название экземпляра процесса** — гиперссылка на экземпляр процесса, см. статью *«[Использование диаграммы экземпляра процесса](https://kb.comindware.ru/article.php?id=2355)»*;
    ...
    - **Задачи** — гиперссылки на [пользовательские задачи](https://kb.comindware.ru/article.php?id=2392) по процессу, назначенные исполнителям.
...
Представление поля атрибута типа «**Список значений**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=2244).
...
3. Отобразится раскрывающийся список с названиями и значками автомобилей, пункты списка будут окрашены указанными цветами.
   ...
   ![Раскрывающийся список значений на форме](https://kb.comindware.ru/assets/form_dynamic_elements_form_enum_dropdown_list.png)
...
5. Столбец *«Тип транспортного средства»* должен выглядеть как показано на иллюстрации.
   ...
   ![Представление атрибута типа «Список значений» в таблице](https://kb.comindware.ru/assets/form_dynamic_elements_attribute_enum_table.png)
...
Представление поля атрибута типа «**Роль**» на форме определяется сочетанием свойств поля и [свойств атрибута](https://kb.comindware.ru/article.php?id=2240).
...
Представление поля атрибута типа «**Текст**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=2257).
...
Сведения о настройке и пример использования **форматов отображения** с **масками ввода** см. в статье [*«Атрибут типа «Текст»*](https://kb.comindware.ru/article.php?id=2257).
...
Представление поля системного [атрибута «**Цвет**»](https://kb.comindware.ru/article.php?id=2627) на форме определяется свойствами поля.
...
По умолчанию сектора диаграмм окрашиваются цветами, заданными в разделе «**[Цвета графиков и диаграмм](https://kb.comindware.ru/article.php?id=2199#mcetoc_1gjriujcbf)**» в текущей **теме**.
...
10. На диаграмме *«Заявки по типу»* должны отобразиться четыре сектора: красный, синий, зелёный и жёлтый, показывающие количество заявок на перевозку соответствующими типами ТС. См. пример на следующей иллюстрации.
    ...
    ![Диаграмма с секторами, окрашенными с помощью атрибута «Цвет» связанных записей](https://kb.comindware.ru/assets/form_dynamic_elements_attribute_color_sector_diagram.png)
...
Подробные сведения см. в статьях *«[Чертёж. Подготовка и импорт файла DWG](https://kb.comindware.ru/article.php?id=2574)»* и *«[Чертёж. Настройка](https://kb.comindware.ru/article.php?id=2575)»*.
...
- **Маркеры**
  ...
  - **Таблица** — выберите таблицу, которая будет отображаться на вкладке «**Заявки**» слева от плана. Если для таблицы назначено [представление карточек](https://kb.comindware.ru/article.php?id=2402), то оно будет отображаться вместо таблицы.
...
Представление поля атрибута типа «**Число**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=2251).
...
Представление поля атрибута типа «**Штрихкод**» на форме определяется свойствами поля и **форматом отображения**, заданным в [свойствах атрибута](https://kb.comindware.ru/article.php?id=2393).
...
- **Системное имя** — уникальное имя вложенной формы в рамках текущей формы, используемое для настройки [правил для формы](https://kb.comindware.ru/article.php?id=2537). Не должно начинаться с цифры. Рекомендуется использовать буквы латинского алфавита, цифры и символ «\_». Заполняется автоматически по названию.
...
- **Доступ** — режим доступа к данным на вложенной форме и её отображения:
  ...
  - **Скрыть** — вложенная форма не будет отображаться на текущей форме. Показать скрытую вложенную форму можно с помощью [правил для формы](https://kb.comindware.ru/article.php?id=2537).
...
**[Статические элементы формы: области, вкладки, колонки, статичный текст. Настройка представления](https://kb.comindware.ru/article.php?id=2530)**
