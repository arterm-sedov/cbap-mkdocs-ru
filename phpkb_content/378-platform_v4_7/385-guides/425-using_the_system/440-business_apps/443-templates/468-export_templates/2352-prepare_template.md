...
Если в [свойствах шаблона экспорта](https://kb.comindware.ru/article.php?id=2349) установлен флажок «**Экспортировать как PDF**», файлы PDF формируются с использованием шрифтов, установленных на сервере c экземпляром ПО **{{ productName }}** (далее «**Сервер**»).
