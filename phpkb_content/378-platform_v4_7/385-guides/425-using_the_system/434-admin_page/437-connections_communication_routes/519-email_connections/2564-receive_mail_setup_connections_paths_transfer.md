...
kbId: 2564
url: 'https://kb.comindware.ru/article.php?id=2564'
updated: '2024-10-31 13:02:49'
---
...
Кроме того, потребуется настроить **[начальное](https://kb.comindware.ru/article.php?id=2376)** или **[промежуточное](https://kb.comindware.ru/article.php?id=2382) событие-получение сообщения** на диаграмме процесса.
...
3. Настройте **[начальное](https://kb.comindware.ru/article.php?id=2376)** или [**промежуточное**](https://kb.comindware.ru/article.php?id=2382) **событие-получение сообщения** на диаграмме процесса:
...
- Передайте значения атрибутов сообщения в атрибуты записи с помощью вкладки «**Данные сообщения**» в свойствах [**события-получения сообщения**](https://kb.comindware.ru/article.php?id=2376), использующего этот путь передачи данных.
...
**[Отправка, получение и обработка эл. почты в процессе. Пример: настройка подключений, путей передачи данных, диаграммы процесса и сценария](https://kb.comindware.ru/article.php?id=2515)**
...
**[Получение эл. почты с помощью сценария через Exchange и IMAP. Настройка подключения, пути передачи данных и сценария](https://kb.comindware.ru/article.php?id=2585)**
