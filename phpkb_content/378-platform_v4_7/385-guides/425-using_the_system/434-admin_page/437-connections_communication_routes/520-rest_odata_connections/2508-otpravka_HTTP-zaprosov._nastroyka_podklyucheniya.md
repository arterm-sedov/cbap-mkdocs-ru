...
kbId: 2508
url: 'https://kb.comindware.ru/article.php?id=2508'
updated: '2024-10-02 18:28:17'
---
...
**{{ productName }}** позволяет отправлять HTTP-запросы типов `GET`, `POST`, `PUT`, `DELETE` для взаимодействия с внешними системами. В данной статье представлены инструкции по настройке подключения для отправки HTTP-запросов из сценариев с помощью [действия «**Отправить сообщение**»](https://kb.comindware.ru/article.php?id=2346#scenario_actions_send_message).
...
**[Действие «Отправить сообщение» в сценарии](https://kb.comindware.ru/article.php?id=2346#scenario_actions_send_message)**
