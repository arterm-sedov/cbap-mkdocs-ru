...
kbId: 2437
url: 'https://kb.comindware.ru/article.php?id=2437'
updated: '2024-02-02 14:27:56'
---
...
1. В [реестре процессов](https://kb.comindware.ru/article.php?id=2426#mcetoc_1h7v7ph040) наведите указатель мыши на первую ячейку в строке процесса или группы процессов, которую требуется переместить на другой уровень иерархии.
...
3. Удерживая значок *‌*, перетащите процесс или группу процессов на строку новой родительской группы процессов.
   ...
   ![Перемещение процесса в новую группу в реестре](https://kb.comindware.ru/assets/process_architecture_modeling_moving_entity_in_registry.png)
...
4. Чтобы переместить элемент на верхний уровень иерархии, перетащите его в позицию между первой строкой и заголовками столбцов, как показано на иллюстрации.
   ...
   ![Перемещение процесса на верхний уровень иерархии в реестре](https://kb.comindware.ru/assets/process_architecture_modeling_moving_entity_in_registry_top_level.png)

   Перемещение процесса на верхний уровень иерархии в реестре

## Перемещение элемента с помощью панели навигации

В [панели навигации](https://kb.comindware.ru/article.php?id=2283) нажмите и перетащите процесс или группу процессов в новую родительскую группу.
...
1. Выберите элемент в [реестре процессов](https://kb.comindware.ru/article.php?id=2426#mcetoc_1h7v7ph040).
2. Отобразится [конструктор диаграммы](https://kb.comindware.ru/article.php?id=2429) элемента
...
8. Вернитесь в [реестр процессов](https://kb.comindware.ru/article.php?id=2426#mcetoc_1h7v7ph040), чтобы просмотреть результирующие изменения нумерации и порядка элементов.
