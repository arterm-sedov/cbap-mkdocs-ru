...
title: 'Введение'
kbId: 5161
url: 'https://kb.comindware.ru/article.php?id=5161'
updated: '2026-05-29 14:07:19'
---
...
Здесь представлены инструкции для ПО **{{ productName }}** текущей рекомендованной версии **6.0**.
...
- Версии **{{ productName }}**, выпущенные **до 31.12.2025**, содержат критические уязвимости. Рекомендуется перейти на **текущую рекомендуемую версию 6.0 или более позднюю**.
...
- О выявленных уязвимостях сообщайте через **[службу поддержки](https://www.comindware.ru/company/contact-us/#tab_support) строго согласно [политике обработки уязвимостей][vulnerability_policy]**.
