...
kbId: 5362
url: 'https://kb.comindware.ru/article.php?id=5362'
updated: '2026-02-17 18:40:35'
---
...
Инструкции по работе с диаграммой Ганта см. в параграфе *«[Диаграмма Ганта. Использование][gantt_chart_use]»*.

См. также инструкции по настройке и использованию диаграммы Ганта на дашбордах: *[Временная шкала на рабочем столе. Настройка и использование][pages_setup]*.

_![Пример диаграммы Ганта](/platform/v6.0/examples/img/gantt_chart_example.png)_
...
2. В шаблоне *«Работы»* создайте и поместите на форму атрибуты:
   ...
   - *Номер работы*
     - **Тип данных: число**.
     - **Количество знаков после запятой: не преобразовывать**![Основная форма шаблона «Работы»](/platform/v6.0/examples/img/creating_gantt_chart_work_template_form.png)
   ...
   - *Тип связи*
     ...
     - **Список значений** — четыре значения:
       ...
       **Системные имена** значений данного атрибута должны быть именно такими, как указано ниже. В противном случае диаграмма Ганта не будет формироваться должным образом.
       ...
       | *endToEnd* | *End to end* | *Окончание-окончание* |![Список значений атрибута «Тип связи»](/platform/v6.0/examples/img/creating_gantt_chart_link_type_value_list.png)

   Список значений атрибута «Тип связи»

   ![Основная форма шаблона «Зависимости»](/platform/v6.0/examples/img/creating_gantt_chart_work_dependency.png)
...
4. В шаблоне *«Планы работ»* создайте и **дважды** поместите на форму атрибут:
   ...
   - *Работы*
     ...
     - **Связанный шаблон**: *Работы*
     - **Хранить несколько значений**: флажок установлен
     - **Взаимная связь с новым атрибутом**: *Связь*![Основная форма шаблона «План работ»](/platform/v6.0/examples/img/creating_gantt_chart_work_plan_form.png)
...
5. Для первого поля *«Работы»* на форме выберите **представление «Диаграмма Ганта»** и установите следующие свойства диаграммы, выбрав ранее созданные атрибуты:
   ...
   - **Задержка/опережение**: *Задержка*![Свойства диаграммы Ганта на форме](/platform/v6.0/examples/img/creating_gantt_chart_properties.png)
...
6. Для второго поля *«Работы»* на форме выберите **представление «Таблица»** и установите следующие свойства таблицы, выбрав ранее созданные атрибуты:
   ...
   - Перетащите в таблицу атрибуты шаблона *«Работы»*:
     ...
     - *Дата окончания плановая*
     - *Дата окончания*
     - *Зависимости работ* — в свойствах столбца установите флажки **«Разрешить создание записей»** и **«Разрешить редактирование записей»**.![Свойства таблицы работ на форме](/platform/v6.0/examples/img/creating_gantt_chart_table_properties.png)
...
- [Временная шкала на рабочем столе. Настройка и использование][pages_setup]
