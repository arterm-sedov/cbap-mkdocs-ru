...
- *[Курс «{{ productNameArchitect }}. Ознакомительный»][tutorial_architect]*
...
_![Добавление модуля «{{ productNameArchitect }}» в раздел навигации](/platform/v6.0/architect/img/architect_desktop_navigation_settings.png)_
...
_![Рабочий стол модуля «{{ productNameArchitect }}»](/platform/v6.0/architect/img/architect_desktop.png)_
