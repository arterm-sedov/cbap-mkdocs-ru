...
См. также *«[Адаптеры. Определения, настройка, удаление][adapters]»*.
...
Важно: не путайте с операциями в чате. См. *«[Кнопки. Настройка][button_configure]»*.
