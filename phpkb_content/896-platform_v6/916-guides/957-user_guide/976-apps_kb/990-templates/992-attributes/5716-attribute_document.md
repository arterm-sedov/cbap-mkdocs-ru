...
kbId: 5716
url: 'https://kb.comindware.ru/article.php?id=5716'
...
_![Свойства атрибута типа «Документ»](/platform/v6.0/business_apps/templates/attributes/img/attribute_document_properties.png)_
...
_![Поле «Акты»: документы без предпросмотра](/platform/v6.0/business_apps/templates/attributes/img/attribute_document_example_no_preview.png)_

_![Поле «Приложение»: документ с предпросмотром](/platform/v6.0/business_apps/templates/attributes/img/attribute_document_example_preview.png)_

_![Поле «Документы на подпись»: документы с цифровой подписью](/platform/v6.0/business_apps/templates/attributes/img/attribute_document_example_digital_signature.png)_
...
- *[Атрибут «Документ». Формирование ссылки на файл][example_document_get_uri]*
