...
kbId: 5650
url: 'https://kb.comindware.ru/article.php?id=5650'
...
_![Пример схемы веток репозитория для среды разработки и продуктивной среды](/platform/v6.0/business_apps/version_control/img/version_control_git_flow.png)_
...
_![Пример сравнения двух версий конфигурации при подготовке релиза](/platform/v6.0/business_apps/version_control/img/version_control_release_diff.png)_
...
_![Пример запроса на слияние (pull request) из рабочей ветки в стабильную ветку перед релизом](/platform/v6.0/business_apps/version_control/img/version_control_release_pr.png)_
...
_![Пример тега версии приложения в стабильной ветке репозитория](/platform/v6.0/business_apps/version_control/img/version_control_release_tag.png)_
