...
kbId: 5659
url: 'https://kb.comindware.ru/article.php?id=5659'
...
- количество экземпляров процесса в статусе «**Активен**».
  ...
  ![Просмотр списка версий диаграммы процесса с помощью списка диаграмм](/platform/v6.0/business_apps/diagrams/process_diagram/img/process_diagram_list_versions.png)
...
- На **[странице «**Диаграмма**»][process_diagram]** шаблона процесса или в [конструкторе диаграммы][process_diagram] нажмите кнопку «**Версия**» *‌*. Отобразится список версий диаграммы со следующими сведениями:
  ...
  ![Просмотр списка версий диаграммы процесса с помощью конструктора диаграмм](/platform/v6.0/business_apps/diagrams/process_diagram/img/process_diagram_version_list.png)
...
_![Переход к редактированию требуемой версии диаграммы](/platform/v6.0/business_apps/diagrams/process_diagram/img/process_diagram_version_control_edit.png)_
...
_![Восстановление версии диаграммы для редактирования](/platform/v6.0/business_apps/diagrams/process_diagram/img/process_diagram_version_control_restore.png)_
...
_![Удаление версии диаграммы для](/platform/v6.0/business_apps/diagrams/process_diagram/img/process_diagram_version_control_delete.png)_
...
_![Сообщение при попытке удаления версии диаграммы выполняющегося экземпляра процесса](/platform/v6.0/business_apps/diagrams/process_diagram/img/diagram_version_deletion_denied.png)_
