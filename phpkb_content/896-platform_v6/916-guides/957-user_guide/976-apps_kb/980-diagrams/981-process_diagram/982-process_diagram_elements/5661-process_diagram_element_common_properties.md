...
kbId: 5661
url: 'https://kb.comindware.ru/article.php?id=5661'
...
2. Нажмите кнопку «**Настроить**» *‌* в меню элемента.
   ...
   ![Переход к настройке свойств элемента диаграммы](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/img/process_diagram_element_common_properties_configure_button.png)

   Переход к настройке свойств элемента диаграммы
3. Отобразится окно свойств элемента.
4. Настройте и сохраните элемент.

   ![Настройка общих свойств элемента диаграммы процесса](/platform/v6.0/business_apps/diagrams/process_diagram/process_diagram_elements/img/process_diagram_element_common_properties.png)
