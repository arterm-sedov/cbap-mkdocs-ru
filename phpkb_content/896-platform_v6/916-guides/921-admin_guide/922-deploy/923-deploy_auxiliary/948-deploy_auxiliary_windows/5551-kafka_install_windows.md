...
kbId: 5551
url: 'https://kb.comindware.ru/article.php?id=5551'
...
12. Запустится программа `NSSM service installer`.
    ...
    ![Диалоговое окно NSSM service installer](/platform/v6.0/administration/deploy/windows/auxiliary_software_deploy/img/kafka_install_nssm_service_installer.png)
...
16. По завершении установки откройте программу *«Службы*» (*Services*) и найдите в списке `kafka`.
    ...
    ![Kafka в списке служб](/platform/v6.0/administration/deploy/windows/auxiliary_software_deploy/img/kafka_install_services.png)
...
17. В окне свойств службы на вкладке «**Восстановление**» включите и настройте перезапуск Kafka в случае сбоев.
    ...
    ![Окно настройки службы Kafka](/platform/v6.0/administration/deploy/windows/auxiliary_software_deploy/img/kafka_install_kafka_service.png)
...
19. При правильной работе Kafka выдаст предупреждение, что раннее такой ветки сообщений не было, и создаст её.
    ...
    ![Создание ветки сообщений Kafka в powershell.exe](/platform/v6.0/administration/deploy/windows/auxiliary_software_deploy/img/kafka_install_powershell.png)
