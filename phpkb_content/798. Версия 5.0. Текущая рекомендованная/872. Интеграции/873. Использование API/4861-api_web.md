...
| --- | --- |
| **Описание** | Задает репозиторий моментальных снимков OpenSearch (Elasticsearch). |
| **Параметры** | Имя существующего репозитория моментальных снимков OpenSearch (Elasticsearch). |
| **Ответ** | Объект статуса. |
