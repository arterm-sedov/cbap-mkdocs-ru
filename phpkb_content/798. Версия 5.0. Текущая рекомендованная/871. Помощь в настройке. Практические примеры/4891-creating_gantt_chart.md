...
2. В шаблоне *«Работы»* создайте и поместите на форму атрибуты:
   ...
   - *Номер работы*
     - **Тип данных: число**.
     - **Количество знаков после запятой: не преобразовывать**![Основная форма шаблона «Работы»](/platform/v5.0/examples/img/creating_gantt_chart_work_template_form.png)
   ...
   - *Тип связи*
     ...
     - **Список значений** — четыре значения:
       ...
       **Системные имена** значений данного атрибута должны быть именно такими, как указано ниже. В противном случае диаграмма Ганта не будет формироваться должным образом.
       ...
       | *endToEnd* | *End to end* | *Окончание-окончание* |![Список значений атрибута «Тип связи»](/platform/v5.0/examples/img/creating_gantt_chart_link_type_value_list.png)
...
4. В шаблоне *«Планы работ»* создайте и **дважды** поместите на форму атрибут:
   ...
   - *Работы*
     ...
     - **Связанный шаблон**: *Работы*
     - **Хранить несколько значений**: флажок установлен
     - **Взаимная связь с новым атрибутом**: *Связь*![Основная форма шаблона «План работ»](/platform/v5.0/examples/img/creating_gantt_chart_work_plan_form.png)
...
5. Для первого поля *«Работы»* на форме выберите **представление «Диаграмма Ганта»** и установите следующие свойства диаграммы, выбрав ранее созданные атрибуты:
   ...
   - **Задержка/опережение**: *Задержка*![Свойства диаграммы Ганта на форме](/platform/v5.0/examples/img/creating_gantt_chart_properties.png)
...
6. Для второго поля *«Работы»* на форме выберите **представление «Таблица»** и установите следующие свойства таблицы, выбрав ранее созданные атрибуты:
   ...
   - Перетащите в таблицу атрибуты шаблона *«Работы»*:
     ...
     - *Дата окончания плановая*
     - *Дата окончания*
     - *Зависимости работ* — в свойствах столбца установите флажки **«Разрешить создание записей»** и **«Разрешить редактирование записей»**.![Свойства таблицы работ на форме](/platform/v5.0/examples/img/creating_gantt_chart_table_properties.png)
