...
**{{ productName }}** позволяет настраивать **системные уведомления**, которые формируются в **[сценариях](https://kb.comindware.ru/article.php?id=4717)** и отображаются в **информационной панели и в push-сообщениях**.
