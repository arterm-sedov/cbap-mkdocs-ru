...
«**{{ productNameArchitect }}**» позволяет [импортировать](https://kb.comindware.ru/article.php?id=4832#architect_importing_process_entity) готовые диаграммы процессов в формате BPMN, редактировать и использовать их для моделирования архитектуры своего предприятия.
