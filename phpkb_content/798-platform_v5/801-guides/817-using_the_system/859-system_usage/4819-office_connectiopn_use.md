...
4. Отредактируйте документ. Документ сохраняется автоматически.
   ...
   ![Переименование документа Р7-Офис в {{ productName }}](https://kb.comindware.ru/assets/Pasted%20image%2020230420172116.png)

   Переименование документа Р7-Офис в {{ productName }}
