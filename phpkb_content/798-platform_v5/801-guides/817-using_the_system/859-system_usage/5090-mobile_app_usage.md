...
Рабочий стол может отсутствовать в зависимости от конкретной конфигурации приложения и сервера **{{ productName }}**.
...
Настроить **Рабочий стол** можно с помощью веб-версии **{{ productName }}**. См. *«[Рабочий стол. Настройка](https://kb.comindware.ru/article.php?id=4813)»*.
...
Настроить панель навигации, а также мобильной нижней навигации можно в веб-версии **{{ productName }}**. См. *«[Панель навигации. Настройка](https://kb.comindware.ru/article.php?id=4809)»*.
...
С помощью функции «**QR-код**» можно считывать только гиперссылки на страницы, задачи, формы и таблицы, расположенные на сервере **{{ productName }}**, на котором вы работаете в данный момент или на который вы выполнили вход в **Comindware Mobile**.

Чтобы считать гиперссылку на ресурс с другого сервера **{{ productName }}**, эта ссылка должна на текущем сервере присутствовать в панели навигации для текущего пользователя. См. *«[Панель навигации. Настройка](https://kb.comindware.ru/article.php?id=4809)»*.
...
Кнопка «**Уведомления**» может отсутствовать в зависимости от конкретной конфигурации приложения и сервера **{{ productName }}**.
...
Кнопка «**Сохранить**» может отсутствовать или быть заменена на иную кнопку в зависимости от конкретной конфигурации приложения и сервера **{{ productName }}**.
