...
- Информация о новых сообщениях в **обсуждениях** отправляеются в push-уведомлениях при использовании **[Comindware Mobile](https://kb.comindware.ru/article.php?id=5090)** и веб-версии **{{ productName }}**.
