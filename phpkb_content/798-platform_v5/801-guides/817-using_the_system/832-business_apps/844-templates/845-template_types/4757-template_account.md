...
`cmw.account.username` (Имя пользователя) и `cmw.account.mbox` (Адрес эл. почты) являются **обязательными атрибутами** и должны быть **уникальны** для каждого аккаунта в **{{ productName }}**.
