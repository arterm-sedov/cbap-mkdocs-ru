...
## Функции {{ productName }}, обеспечиваемые технологией Comindware ElasticData
...
Технология **Comindware ElasticData** открывает широкие возможности для создания бизнес-приложений на базе **{{ productName }}**, в том числе:
