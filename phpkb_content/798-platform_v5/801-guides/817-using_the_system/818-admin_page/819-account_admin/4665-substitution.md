...
- Замещения можно просматривать и создавать как на [странице «**Замещения**»](#substitution_list_and_setup), так и в [свойствах аккаунта][accounts_substitution].
...
Если замещения включены (`true`), пользователи могут создавать для себя замещения в свойствах своих аккаунтов (страница «**Мой аккаунт**»), передавая свои роли другим аккаунтам. См. *«[Аккаунты. Настройка замещений][accounts_substitution]»*.
