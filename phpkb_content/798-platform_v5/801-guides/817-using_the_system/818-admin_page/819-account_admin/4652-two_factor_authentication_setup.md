...
Двухфакторную аутентификацию в веб-версии **{{ productName }}** можно настроить средствами Keycloak. См. *«[Аутентификация через Keycloak и OpenID Connect. Настройка подключения и служб](https://kb.comindware.ru/article.php?id=4685)»*.
