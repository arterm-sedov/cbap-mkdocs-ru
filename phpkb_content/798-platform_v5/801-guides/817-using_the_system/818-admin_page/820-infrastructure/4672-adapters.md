...
5. [Загрузите и скомпилируйте адаптер](#adapters_list_configure) на сервере **{{ productName }}**.
   ...
   Чтобы скомпилировать адаптер, на сервере **{{ productName }}** должны быть установлены библиотеки .NET SDK и Runtime версии 8.0.
...
Чтобы скомпилировать адаптер, на сервере **{{ productName }}** должны быть установлены библиотеки .NET SDK и Runtime версии не ниже 8.0.
