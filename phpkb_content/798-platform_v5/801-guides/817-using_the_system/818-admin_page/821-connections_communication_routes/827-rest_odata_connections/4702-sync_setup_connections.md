...
6. Настройте синхронизацию данных между OData-сервисом и **{{ productName }}**. См. *«[Синхронизация с веб-сервисом. Интеграция по OData](https://kb.comindware.ru/article.php?id=4697)»*.
