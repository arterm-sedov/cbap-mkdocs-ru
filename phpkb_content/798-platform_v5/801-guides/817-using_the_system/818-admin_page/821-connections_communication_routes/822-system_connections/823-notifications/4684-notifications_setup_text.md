...
- в push-сообщениях при использовании **[Comindware Mobile](https://kb.comindware.ru/article.php?id=5090)** и веб-версии **{{ productName }}** (сервер должен быть подключен к интернету и Apache Kafka);
