...
Если вам необходимо отправлять в S3 файлы больше лимита, установленного вашим поставщиком S3, обратитесь в службу поддержки **Comindware** для настройки конфигурации **{{ productName }}**.
