...
Для [диаграмм процессов][process_diagram] в списке отображаются количество версий диаграммы и кнопка «**Показать все версии**» для [просмотра списка версий](process_diagram/process_diagram_version_control.html#diagram_version_list_view "Просмотр списка версий диаграммы") диаграммы.
