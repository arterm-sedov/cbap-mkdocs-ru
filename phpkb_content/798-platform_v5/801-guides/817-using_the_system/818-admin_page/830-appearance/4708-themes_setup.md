...
В **{{ productName }}** пользовательские стили темы задаются с помощью CSS.

Добавляя собственные стили, вы можете изменить внешний вид интерфейса **{{ productName }}** в случае, если вам не хватает возможностей раздела настройки тем.
...
Здесь представлен краткий обзор синтаксиса CSS Для работы с {{ productName }}.
...
#### Рекомендации по использованию CSS в {{ productName }}
