---
title: 'Политика в отношении уязвимостей'
kbId: 5157
url: 'https://kb.comindware.ru/article.php?id=5157'
updated: '2026-04-11 06:17:49'
---
...
- примечания об уязвимостях в предыдущих версиях ПО **{{ productName }}**;
- подход **Comindware** к работе с выявленными или потенциальными уязвимостями в **{{ productName }}**;
- правила ответственного информирования об уязвимостях;
- важные ограничения.

## Предыдущие версии с уязвимостями

В версиях **{{ productName }}**, выпущенных **до 31.12.2025**, были выявлены критические уязвимости.
...
Сведения об устранении отдельных уязвимостей **{{ productName }}**, выявленных ранее в ходе независимых испытаний, представлены в статье *«[Устранённые уязвимости](https://kb.comindware.ru/article.php?id=5159)»*.

## Уязвимости, создаваемые гражданскими разработчиками

При разработке и развитии прикладных решений на основе **{{ productName }}** (в том числе с использованием C#-скриптов, сценариев, интеграций, API и т. п.) гражданские разработчики могут непреднамеренно создавать уязвимости, например:
...
**Comindware** поддерживает ответственное информирование об уязвимостях в **{{ productName }}** и приветствует участие исследователей безопасности в повышении безопасности **{{ productName }}**.

Тем не менее, такие исследования и информирование **должны соответствовать** положениям настоящей Политики **Comindware** и **не должны нарушать** *[Лицензионное соглашение конечного пользователя](https://www.comindware.ru/policy/)*.

### Канал для подачи отчётов

Сообщайте о выявленных потенциальных уязвимостях через **[службу поддержки](https://www.comindware.ru/company/contact-us/#tab_support)** с пометкой «**Уязвимость**».
...
**Comindware** оставляет за собой право на судебное преследование в случае нарушения *[Лицензионного соглашения конечного пользователя](https://www.comindware.ru/policy/)*, положений настоящей Политики или применимого законодательства.
...
- отклонить отчёт об уязвимости, если он выходит за рамки настоящей Политики, не относится к **{{ productName }}** или является дубликатом ранее представленного отчёта.
...
- **Comindware** опубликует информацию об устранении уязвимости в очередном дайджесте устранённых уязвимостей (см. *«[Устранённые уязвимости](https://kb.comindware.ru/article.php?id=5159)»*);
...
- степени риска для пользователей **{{ productName }}**;
...
Сообщения об уязвимостях, соответствующие настоящей Политике и выполненные добросовестно, **Comindware** рассматривает как вклад в повышение безопасности **{{ productName }}**.

--8<-- "related_topics_heading.md"

- *[Устранённые уязвимости](https://kb.comindware.ru/article.php?id=5159)*
- *[Устранённые уязвимости, декабрь 2025][vulnerability_pt_dec2025]*
