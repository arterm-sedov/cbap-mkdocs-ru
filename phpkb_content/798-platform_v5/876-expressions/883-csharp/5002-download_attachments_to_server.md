...
Здесь представлен C#-скрипт для **[кнопки](https://kb.comindware.ru/article.php?id=4790)**, который сохраняет все файлы, прикреплённые к атрибуту типа «**Документ**», из текущей записи в локальную папку **на сервере {{ productName }}**.
