...
| `DATE()` | |
| --- | --- |
| **Описание** | Преобразует в строку в формате ISO 8601 в значение даты и времени.  Функция возвращает значение в часовом поясе, заданном на сервере **{{ productName }}**.  См. также *«[Форматирование значений в шаблонах экспорта и формулах](https://kb.comindware.ru/article.php?id=4794)»*. |
