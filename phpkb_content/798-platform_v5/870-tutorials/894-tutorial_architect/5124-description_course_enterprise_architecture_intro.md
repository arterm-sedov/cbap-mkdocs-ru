...
- [Справочник по модулю «{{ productNameArchitect }}»](https://kb.comindware.ru/article.php?id=4828#architect_description)
...
- [Справочник по разработке приложений в {{ productName }} Enterprise](https://kb.comindware.ru/article.php?id=4714)
...
- **[Урок 1. Обзор возможностей {{ productName }} Enterprise](https://kb.comindware.ru/article.php?id=5125)**
...
Теперь переходите к [первому уроку](https://kb.comindware.ru/article.php?id=5125), чтобы ознакомиться с интерфейсом, ролями, рабочим столом и навигацией в **{{ productName }} Enterprise**.
