...
- Пройден *[урок 1 «Обзор возможностей {{ productName }} Enterprise и понятий BPMS»](https://kb.comindware.ru/article.php?id=5125)*
- **Рекомендуется** ознакомиться со следующими материалами, чтобы получить базовые навыки работы с **{{ productName }} Enterprise**:
  - *[Спаравочник по модулю «{{ productNameArchitect }}»](https://kb.comindware.ru/article.php?id=4828#architect_description)*
...
См. *«[Рабочий стол «{{ productNameArchitect }}»](https://kb.comindware.ru/article.php?id=4828#architect_desktop_operations)»*.
...
- [Использование интерфейса {{ productName }} Enterprise](https://kb.comindware.ru/article.php?id=5105)
