...
kbId: 5129
url: 'https://kb.comindware.ru/article.php?id=5129'
...
**Предусловия:** пройден [урок 4 «Согласование, аудит, публикация, контроль изменений»](https://kb.comindware.ru/article.php?id=5128).
...
3. Выберите формат для экспорта диаграммы:
   ...
   ![Варианты экспорта диаграммы](/platform/v5.0/tutorials/tutorial_architect/img/lesson_5_export_button.png)
...
Настроим особый шаблон экспорта, чтобы включить в него статус согласования процесса, который мы настроили в ходе *[урока 4](https://kb.comindware.ru/article.php?id=5128)*.
...
5. Сохраните файл.
   ...
   ![Настройка шаблона экспорта регламента](/platform/v5.0/tutorials/tutorial_architect/img/lesson_5_word_settings.png)
...
8. Нажмите кнопку «**Сохранить**» в разделе «**Новый шаблон экспорта**».
   ...
   ![Добавление нового шаблона экспорта](/platform/v5.0/tutorials/tutorial_architect/img/lesson_5_export_template_settings.png)

   Добавление нового шаблона экспорта
9. В панели навигации выберите пункт «**Процессы**».
10. Откройте один из процессов.
11. Выполните его процесс согласования, настроенный в *[уроке 4](https://kb.comindware.ru/article.php?id=5128)*.
...
3. В раскрывающемся меню выберите пункт «**Сохранить версию**».
   ...
   ![Создание новой версии корпоративной архитектуры](/platform/v5.0/tutorials/tutorial_architect/img/lesson_5_version_control_create.png)

   Создание новой версии корпоративной архитектуры
4. В окне «**Сохранение версии**» введите описание версии, например *«Версия 1»* и нажмите кнопку «**Сохранить**».

   ![Ввод описания и сохранение новой версии](/platform/v5.0/tutorials/tutorial_architect/img/lesson_5_version_control_description.png)
...
3. В раскрывающемся меню выберите пункт «**Восстановить версию**».
   ...
   ![Восстановление версии корпоративной архитектуры](/platform/v5.0/tutorials/tutorial_architect/img/lesson_5_version_control_restore.png)
...
5. Введите описание новой версии и нажмите кнопку «**Сохранить**».
   ...
   ![Выбор способа восстановления версии](/platform/v5.0/tutorials/tutorial_architect/img/lesson_5_version_control_restore_options.png)
...
5. Для внесения изменений в различные версии диаграмм рекомендуем сначала сохранить текущую версию архитектуры, а затем восстановить и редактировать требуемую версию.
   ...
   ![Просмотр версий диаграммы](/platform/v5.0/tutorials/tutorial_architect/img/lesson_5_version_control_viewing_diagram_versions.png)
...
Теперь ознакомьтесь с [заключением](https://kb.comindware.ru/article.php?id=5130): подведите итоги курса, проверьте свои знания, рассмотрите возможности дальнейшего развития, ресурсы и рекомендации для самостоятельной работы.
...
- [Управление версиями корпоративной архитектуры](https://kb.comindware.ru/article.php?id=4829)
