...
В ходе этого урока вы научитесь настраивать и использовать автоматизированные процессы и интегрировать их с архитектурными моделями с помощью **{{ productName }} Enterprise**:
...
**{{ productName }} Enterprise** позволяет моделировать и интегрировать автоматизированные процессы и архитектурные модели для автоматизации управления корпоративной архитектурой.
