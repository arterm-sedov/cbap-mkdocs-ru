...
kbId: 5127
url: 'https://kb.comindware.ru/article.php?id=5127'
updated: '2025-08-07 17:29:10'
---
...
**Предусловия:** пройден *«[Урок 2. Рабочий стол, навигация, роли, оргструктура](https://kb.comindware.ru/article.php?id=5126)»*.
...
4. В раскрывающемся меню выберите пункт «**Группа процессов**» *‌*.
   ...
   ![Создание группы процессов в реестре процессов](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_process_group_create.png)
...
13. Переименуйте процесс в *«Поиск кандидата»*, дважды нажав его название.
    ...
    ![Добавление процесса на диаграмму группы процессов](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_process_add.png)
...
15. Добавьте на диаграмму новый **ресурс** и переименуйте его в *«Кандидаты»*.
    ...
    ![Добавление ресурса на диаграмму группы процессов](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_resource_add.png)
...
17. В меню элемента выберите «**Поток данных**».
    ...
    ![Добавление потока данных](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_dataflow_add.png)
...
_![Итоговая диаграмма группы процессов «Поиск и найм персонала»](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_group_process_diagram.png)_
...
3. Измените тип события на «**Событие-получение сообщения**».
   ...
   ![Создание начального события](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_start_event_add.png)
...
5. Нажмите задачу *«Создать вакансию»* и измените его тип на **пользовательскую**.
   ...
   ![Преобразование абстрактной задачи в пользовательскую](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_user_task_add.png)
...
7. Поместите на дорожку **объект данных** и переименуйте его в *«Вакансия»*.
   ![Создание объекта данных](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_dataobject_add.png)

   Создание объекта данных
8. Выберите объект *«Вакансия»*.
9. В меню элемента выберите пункт «**Поток данных**».

   ![Создание потока данных](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_flow_data_add.png)
...
13. Будет создана развилка, соединённая с задачей **потоком управления**.
    ...
    ![Создание развилки «или/или»](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_gateway_add.png)
...
16. Выберите событие *«Поступило резюме»* и измените его тип на «**Событие-условие**».
    ...
    ![Настройка промежуточного события](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_middle_event_add.png)
...
1. Поместите на диаграмму **скрытый пул** вне основного пула.
   ...
   ![Добавление скрытого пула](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_hide_pool_add.png)

   Добавление скрытого пула
2. В окне свойств скрытого пула выберите **связываемый процесс** *«Найм кандидата»*.

   ![Выбор связыемого процесса для скрытого пула](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_process_hide_pool.png)
...
4. Должна получиться показанная ниже диаграмма:
   ...
   ![Результирующая диаграмма «Поиск кандидата»](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_find_head_diagram.png)
...
7. Нажмите кнопку «**Импорт**» *‌*.
   ...
   ![Кнопка импорта bpmn-диаграммы](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_import_button.png)
...
10. Нажмите кнопку «**Продолжить**».
    ...
    ![Выбор источника импорта](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_diagram_upload.png)
...
13. Нажмите кнопку «**Импортировать**».
    ...
    ![Выбор процессов для импорта](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_process_choice.png)
...
17. Должна получиться показанная ниже диаграмма:
    ...
    ![Результирующая диаграмма «Найм кандидата»](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_head_recruite_diagram.png)
...
Регламенты процессов формируются с помощью **шаблонов экспорта**. В этом уроке мы рассмотрим использование встроенного в **{{ productName }} Enterprise** шаблона экспорта. В [уроке 5](https://kb.comindware.ru/article.php?id=5129) даны инструкции по настройке собственного шаблона экспорта.
...
_![Настройка свойств процесса «Поиск кандидата»](/platform/v5.0/tutorials/tutorial_architect/img/lesson_3_process_find_head_properties.png)_
...
В ходе [следующего урока](https://kb.comindware.ru/article.php?id=5128) вы научитесь создавать автоматизированные процессы для работы с архитектурными моделями, настраивать атрибуты и формы архитектурных моделей и выполнять процессы согласования изменений.

--8<-- "related_topics_heading.md"

Подробные сведения о настройке **{{ productName }} Enterprise** представлены в руководстве пользователя:

- [Рекомендации по построению диаграмм бизнес-процессов](../../business_apps/diagrams/process_diagram/process_diagram_build_advice.html#process_diagram_build_advice)
- [Построение процессной архитектуры](https://kb.comindware.ru/article.php?id=4833)
- [Просмотр и редактирование диаграмм процессов и бизнес-способностей](https://kb.comindware.ru/article.php?id=4835)
