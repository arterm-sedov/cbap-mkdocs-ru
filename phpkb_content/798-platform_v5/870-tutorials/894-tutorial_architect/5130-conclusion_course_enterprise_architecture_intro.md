...
- [Использование модуля «{{ productNameArchitect }}»](https://kb.comindware.ru/article.php?id=4828#architect_description) — освойте все возможности моделирования корпоративной архитектуры.
- Примеры использования **{{ productName }} Enterprise** — изучите варианты и возможности реализации корпоративной архитектуры:
...
- [Использование интерфейса {{ productName }} Enterprise](https://kb.comindware.ru/article.php?id=5105) — освойте все возможности работы с **{{ productName }} Enterprise**.
- [Разработка приложений в {{ productName }} Enterprise](https://kb.comindware.ru/article.php?id=4714) — научитесь создавать бизнес-приложения с помощью **{{ productName }} Enterprise**.
...
- Ознакомьтесь с документацией к модулю «**[{{ productNameArchitect }}](https://kb.comindware.ru/article.php?id=4828#architect_description)**».
