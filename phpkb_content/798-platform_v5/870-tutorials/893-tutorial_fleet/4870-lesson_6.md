...
**Предусловия:** пройден *[урок 5 «Структуры данных»][tutorial_fleet_lesson_5]*.
...
В [следующем уроке][tutorial_fleet_lesson_7] вы настроите автоматическое вычисление номера, статуса и итоговой суммы затрат по заявке, а также фильтрацию при выборе типа автомобиля.
