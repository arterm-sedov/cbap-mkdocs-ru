...
Если вы прошли *[Урок 8 *«Аккаунты, группы и роли»*][tutorial_fleet_lesson_8]*, пользовательские задачи назначаются разным аккаунтам.
...
В ходе [следующего урока][tutorial_fleet_lesson_10] вы научитесь прикреплять файлы к записям.
