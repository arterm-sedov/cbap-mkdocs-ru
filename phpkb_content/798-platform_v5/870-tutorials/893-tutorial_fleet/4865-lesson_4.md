...
**Предусловия:** пройден *[урок 3 «Мой первый бизнес-процесс»][tutorial_fleet_lesson_3]*.
...
Созданный **раздел навигации** *«Сводки»* мы впоследствии используем в [Уроке 8][tutorial_fleet_lesson_8].
