...
**Предусловие:** пройдены *[урок 3 «Мой первый бизнес-процесс»][tutorial_fleet_lesson_4]* и *[урок 4 «Мониторинг и аналитика»][tutorial_fleet_lesson_4]*.
...
1. Откройте список разделов навигации приложения *«Управление автопарком»*.
2. Откройте раздел навигации *«Сводки»*, созданный в ходе [Урока 4][tutorial_fleet_lesson_4].
