...
*[Урок 1. Обзор возможностей {{ productName }} и понятий BPMS](https://kb.comindware.ru/article.php?id=5113)*
...
Теперь переходите [к первому уроку](https://kb.comindware.ru/article.php?id=5113), чтобы ознакомиться с основами BPMS и возможностями **{{ productName }}**.
