...
# Оптимизация работы вычисляемых атрибутов {: #optimize_calculate_attribute }

## Описание проблемы {: #optimize_calculate_attribute_intro }
...
2. **Используйте выражения на N3**
   ...
   Вместо формул рекомендуем использовать язык N3. См. [справочник по языку N3][n3_guide_reference].
