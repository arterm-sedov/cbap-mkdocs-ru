...
4. Чтобы выключить или включить любой элемент без удаления нажмите его правой кнопкой мыши и выберите пункт **Disable** или **Enable**. Выключенные элементы подсвечиваются серым и пропускаются при выполнении теста.
