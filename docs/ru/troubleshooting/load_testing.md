...
Чтобы запускать сценарии одновременно от аккаунтов с разными ролями, создайте тестовую группы с данными для авторизации пользователя под конкретной ролью:

1. В **Test Plan** создайте новую тестовую группу (**Thread Group**): нажмите имеющуюся группу правой кнопкой мыши и выберите пункт **Duplicate**.
