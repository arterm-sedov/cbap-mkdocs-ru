...
- [Установить](#load_testing_jmeter_setup) Java 8+ и Apache JMeter.
- [Скачать и настроить](#load_testing_jmeter_setup) файл конфигурации JMeter: указать параметры подключения, количество пользователей, интервал запуска, количество итераций.
...
3. Скачайте готовый файл конфигурации Apache JMeter `jmeter-example-settings.jmx` [по этой ссылке](https://kb.comindware.ru/file.php?id=213).
