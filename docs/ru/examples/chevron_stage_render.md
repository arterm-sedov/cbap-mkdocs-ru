...
5. Перетащите атрибут _«Этапы открытия магазина»_ в область _«Прогресс открытия магазина»._
...
8. Снова перетащите атрибут _«Этапы открытия магазина»_ в область _«Прогресс открытия магазина»._
...
11. Вынесите в таблицу _«Этапы открытия магазина»_ следующие атрибуты шаблона  _«[Этапы](#example_chevron_stage_render_stages_template)»_  в качестве столбцов:
