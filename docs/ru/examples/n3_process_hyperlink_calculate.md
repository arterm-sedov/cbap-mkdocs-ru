...
# Вычисление гиперссылки на историю процесса {: #example_n3_process_hyperlink_calculate }

## Введение {: #example_n3_process_hyperlink_calculate_intro }
...
## Прикладная задача {: #example_n3_process_hyperlink_calculate_use_case }
...
## Пример решения {: #example_n3_process_hyperlink_calculate_solution }
