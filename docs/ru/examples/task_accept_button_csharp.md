...
# Кнопка «Принять в работу» для задачи. Настройка на C# {: #task_accept_button_csharp }

## Введение {: #task_accept_button_csharp_intro }
...
## Прикладная задача {: #task_accept_button_csharp_use_case }
...
- задача перестаёт отображаться у других сотрудников отдела на странице «**Мои задачи**»;
...
## Настройка скрипта {: #task_accept_button_csharp_configure .pageBreakBefore }
...
## Тестирование {: #task_accept_button_csharp_test .pageBreakBefore }
