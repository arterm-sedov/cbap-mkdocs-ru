...
# Изменение исполняемого процесса в режиме реального времени {: #change_process_real_time }
...
## Версионирование диаграммы {: #change_process_real_time_diagram_versioning }
