...
В данном примере предполагается, что диаграмма Ганта создана по инструкциям в статье _«[Диаграмма Ганта. Настройка][gantt_chart_create]»_.

См. также инструкции по настройке и использованию диаграммы Ганта на дашбордах: _[Временная шкала на рабочем столе. Настройка и использование][pages_setup_timeline]_.
...
- [Временная шкала на рабочем столе. Настройка и использование][pages_setup_timeline]
