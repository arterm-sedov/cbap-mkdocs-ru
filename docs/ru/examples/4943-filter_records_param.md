...
# Фильтр записей в коллекции по заданному параметру {: #filter_records_param }

Здесь приведён пример фильтрации записей в коллекции с помощью выражения N3 по параметру, заданному в текущей записи.

## Прикладная задача {: #filter_records_param_use_case }
...
## Модель данных {: #filter_records_param_data_model }
...
## Настройка фильтра {: #filter_records_param_filter_setup }
...
## Разбор выражения {: #filter_records_param_expression_explanation }
...
!!! note "Зарезервированные переменные N3"
...
## Результат {: #filter_records_param_result }
