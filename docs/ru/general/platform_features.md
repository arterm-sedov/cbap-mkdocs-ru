...
## Базовые функции Продукта {: #platform_features_basics }
...
## Архитектура Продукта {: #platform_features_product_architecture }
...
## Возможности слоя бизнес-логики Продукта {: #platform_features_business_logic }
