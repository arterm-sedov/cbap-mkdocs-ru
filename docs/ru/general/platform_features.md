...
## 1. Базовые функции Продукта {: #platform_features_basics }
...
## 2. Построение архитектуры данных приложений {: #platform_features_data_architecture }
...
## 3. Проектирование графического интерфейса приложений {: #platform_features_ui_design }
...
## 4. Моделирование бизнес-архитектуры {: #platform_features_business_architecture }
...
## 5. Возможности автоматизации {: #platform_features_automation }
...
## 6. Возможности системы управления базами данных {: #platform_features_dbms }
...
## 7. Архитектура Продукта {: #platform_features_product_architecture }
...
## 8. Возможности слоя бизнес-логики Продукта {: #platform_features_business_logic }
