...
### Возможности разработки приложений {: #platform_features_11_возможности_разработки }
...
- **Обработка данных**
  - Вычисления и обработка данных. См. [раздел 5.3](#platform_features_53_инструменты_для).
...
### Возможности исполнения приложений {: #platform_features_12_возможности_исполнения }
...
### Реестры данных {: #platform_features_21_реестры_данных }
...
### Атрибуты {: #platform_features_22_атрибуты }
...
Атрибуты могут как храниться в базе данных, так и вычисляться динамически. См. [раздел 5.3](#platform_features_53_инструменты_для).
...
### Создание форм для ввода и отображения данных {: #platform_features_31_создание_форм }
...
### Создание таблиц для отображения данных {: #platform_features_32_создание_таблиц }
...
### Построение диаграмм бизнес-способностей {: #platform_features_41_построение_диаграмм }
...
### Построение диаграмм бизнес-процессов {: #platform_features_42_построение_диаграмм }
...
### Сценарии {: #platform_features_51_сценарии }
...
### Правила для форм {: #platform_features_52_правила_для }
...
### Инструменты для вычислений, выборки и обработки данных {: #platform_features_53_инструменты_для }
