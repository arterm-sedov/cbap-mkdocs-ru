...
- **Обработка данных**
  - Вычисления и обработка данных. См. [раздел 5.3](#platform_features_calculation_tools).
...
Атрибуты могут как храниться в базе данных, так и вычисляться динамически. См. [раздел 5.3](#platform_features_calculation_tools).
