...
## 1. Жизненный цикл ПО {: #platform_life_cycle_software }
...
## 2. Типовой регламент технической поддержки {: #platform_life_cycle_support }
...
## 3. Контактная информация производителя ПО {: #platform_life_cycle_contacts }
