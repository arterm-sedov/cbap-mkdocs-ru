...
### Информационная страница (дашборд) {: #glossary_info_page }
...
Шаблон для определения и хранения особых атрибутов аккаунтов, изначально не предусмотренных в **{{ productName }}**.
...
### Шаблон модели {: #glossary_model_template }
...
См.: _[Шаблоны моделей][model_templates]_

### Шаблон оргединицы {: #glossary_organizational_unit_template }
...
См.: _[Шаблон организационной единицы][organizational_unit_templates]_

### Шаблон роли {: #glossary_role_template }
...
См.: _[Шаблон роли][role_templates]_
