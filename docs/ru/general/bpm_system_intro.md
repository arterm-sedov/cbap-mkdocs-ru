...
# Как работает BPM-система {: #bpm_system_intro }
...
## Моделирование бизнес-процессов {: #bpm_system_intro_modeling }
...
## Преимущества моделирования {: #bpm_system_intro_modeling_benefits }

Вы сможете удобно моделировать бизнес-процессы прямо из веб-браузера, а также работать со схемами [BPMN-процессов][bpmn_process_basics], загруженных из других приложений. Также на этапе моделирования вам не потребуются услуги программистов, потому что с данной задачей справятся бизнес-аналитики.

_![Схема процесса](https://kb.comindware.ru/assets/art1.png)_

## Исполнение бизнес-процессов {: #bpm_system_intro_execution }
...
## Контроль бизнес-процессов {: #bpm_system_intro_monitoring }

Каждая [BPMS][top10_bpm] предполагает также возможность контроля:
...
## Преимущества систем на базе платформы {{ productName }} {: #bpm_system_intro_monitoring_benefits }

Решения на базе платформы от **{{ companyName }}** позволяют собирать обширную статистику, а это помогает выявить более и менее эффективных сотрудников, сравнить их реальную нагрузку, грамотно распределить задачи.

_![Инструменты статистики](https://kb.comindware.ru/assets/art3.png)_

## Оптимизация бизнес-процессов {: #bpm_system_intro_optimization }
...
## Преимущества систем на базе платформы {{ productName }} {: #bpm_system_intro_optimization_benefits }

Применяя решения, разработанные на базе платформы от **{{ companyName }}**, вы сможете вносить изменения в бизнес-процессы и формы силами бизнес-аналитиков, а не программистов. Предусмотрено внесение изменений из браузера.

Кроме того, [схема исполняемой архитектуры предприятия][architecture_landscape_external] наглядно отображает логическую группировку бизнес-процессов и связи между процессами по ресурсам, что существенно упрощает поиск путей оптимизации.
...
## В заключение {: #bpm_system_intro_conclusion }
