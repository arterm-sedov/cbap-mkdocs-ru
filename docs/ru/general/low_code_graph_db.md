...
## Что такое настоящий Low-code {: #low_code_graph_db_what_is }
...
## Фундамент настоящего Low-code {: #low_code_graph_db_foundation }
...
| --- | --- |
| Основана на [реляционной алгебре][wikipedia_relational_algebra] | Основана на стандартах W3C: [RDF][wikipedia_rdf], [OWL][wikipedia_owl], [N-triples][wikipedia_ntriples] |
...
## Онтологии {: #low_code_graph_db_ontologies }
...
## Заключение {: #low_code_graph_db_conclusion }
