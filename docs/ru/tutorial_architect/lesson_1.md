...
- Определите бизнес-процессы и подразделения вашей организации, из которых можно сформировать корпоративную архитектуру с помощью **{{ productNameEnterprise }}**.
...
Переходите ко [второму уроку][tutorial_architect_lesson_2], чтобы научиться работать с интерфейсом, моделировать оргструктуру предприятия, настраивать роли пользователей и навигацию в **{{ productNameEnterprise }}**.
