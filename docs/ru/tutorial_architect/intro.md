...
**Предусловие:** пройден курс _«[Аналитик. Ознакомительный][tutorial_hr]»_ для ознакомления с возможностями **{{ productName }}**.

**Ожидаемое время прохождения:** 6–8 часов.

!!! tip "Как проходить этот курс"

    - Курс построен на реальных сценариях цифровой трансформации и моделирования корпоративной архитектуры.
    ...
    - После прохождения курса проверьте себя с помощью [практических заданий и тестов][tutorial_architect_intro_tests].
...
Каждый урок будет содержать практические задания, которые помогут закрепить навыки и применить их к реальным задачам бизнеса. Выполняя задания, вы научитесь использовать инструменты платформы для автоматизации, анализа и постоянного совершенствования архитектуры предприятия.
