...
- пройден курс _«[Аналитик. Ознакомительный][tutorial_hr]»_;
- имеются базовые навыки работы с **{{ productNameEnterprise }}**, включая настройку приложений, шаблонов, ролей, навигации.
...
- Формировать организационно-штатную структуру
...
- **Оргструктура** — иерархическое представление подразделений, должностей и сотрудников компании, отражающая структуру управления и распределение ролей.
...
12. Раскройте в панели слева пункт «**Страницы**».
13. Перетащите **новую страницу** внутрь **рабочего стола** на макете.
...
В ходе [следующего урока][tutorial_architect_lesson_3] вы освоите моделирование процессной архитектуры, импорт диаграмм, проверку и публикацию процессов.
