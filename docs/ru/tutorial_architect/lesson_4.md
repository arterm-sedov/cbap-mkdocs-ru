...
### Сценарий на изменение диаграмм неисполняемых процессов

1. Откройте приложение _«Архитектура компании»_.
2. Откройте раздел «**Сценарии**».
3. Создайте новый сценарий _«Редактирование процесса»_.
4. Установите следующие свойства у **начального события**:
...
1. Перейдите в раздел **«Архитектура»** — **«Процессы»**.
...
14. В поле атрибута _«Согласован»_ будет установлен флажок.
