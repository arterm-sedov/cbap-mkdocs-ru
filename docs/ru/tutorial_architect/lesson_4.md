...
- настраивать шаблоны моделей, их атрибуты и формы;
- настраивать кнопки и сценарии для автоматизации согласования;
- выполнять процессы согласования архитектурных изменений.

Освоив этот урок, вы сможете обеспечить качественный контроль изменений корпоративной архитектуры через формализованные процессы согласования, что снижает риски ошибок и обеспечивает вовлечённость всех заинтересованных сторон.
...
- Интеграция исполняемых процессов с архитектурными моделями предприятия
...
- Создавать исполняемые процессы для взаимодействия с архитектурными моделями
...
- Настроить форму пользовательской задачи
...
Шаблон моделей **«Процессы»** является системным и содержит данные всех моделей процессов, настроенных в корпоративной архитектуре с помощью **{{ productNameEnterprise }}**.
...
!!! warning "Бизнес-логика"
    ...
    Если архитектор меняет диаграмму процесса в рамках архитектурной модели, её статус согласования должен сбрасываться.
...
3. Внесите в процесс любые изменения.
...
15. Снова внесите изменения в диаграмму процесса, после чего флажок _«Согласован»_ должен автоматически сняться.
...
В ходе этого урока вы научились создавать исполняемые процессы для согласования архитектурных моделей, настраивать шаблоны моделей с атрибутами и формами, интегрировать исполняемые процессы с архитектурными моделями, настраивать кнопки и сценарии для автоматизации процессов, а также выполнять процессы согласования архитектурных изменений.
