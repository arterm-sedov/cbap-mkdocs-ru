...
Поздравляем! Вы прошли курс «**Корпоративная архитектура. Ознакомительный**» на платформе **{{ productName }}**.
...
## Рефлексия {: #tutorial_architect_outro_reflection }

- Какие темы курса были для вас самыми полезными?
- Какие навыки вы считаете наиболее ценными?
- Какие шаги вы предпримете для дальнейшего развития?
...
- Тесты: [corporate_architecture_tests]
- Примеры: [architect_example], [architect_demo]
- Руководство по **{{ productNameArchitect }}**: [architect_description], [architect_desktop], [conversations], [version_control]
- Файлы: [Демо ОШС.xlsx](files/Демо ОШС.xlsx), [Поиск и найм кандидатов.bpmn](files/Поиск и найм кандидатов.bpmn).
