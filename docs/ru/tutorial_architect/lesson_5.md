...
!!! warning "Бизнес-логика"
    ...
    Компаниям необходимо обмениваться архитектурными моделями с внешними системами и партнёрами для интеграции и совместной работы.
    
    Экспорт диаграмм в стандартных форматах (BPMN, PNG, SVG) обеспечивает совместимость с различными инструментами и упрощает передачу архитектурных решений между командами и системами.
