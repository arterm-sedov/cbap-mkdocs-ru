...
## Экспорт документов {: #tutorial_architect_lesson_5_export }

1. В реестре процессов выберите нужный процесс.
2. Нажмите кнопку «**Экспорт**» <i class="fa-light fa-file-export"></i>.
3. Выберите и нажмите тип экспортируемого файла:
