...
- [конструктор диаграммы ОФС][architect_organizational_structure_diagram_edit].
...
- Редактировать оргструктуру можно следующими способами:
    - с помощью конструктора диаграммы ОФС;
...
- Предусмотрены следующие операции с оргединицами:
    ...
    - [изменение цвета и размера на диаграмме ОФС](#architect_organizational_structure_design_unit_color_change_resize);
...
3. Чтобы [открыть диаграмму ОФС][architect_organizational_structure_diagram_edit], дважды нажмите требуемую оргединицу в реестре или выберите её на панели навигации.
...
### Создание оргединицы с помощью диаграммы ОФС

1. В [конструкторе диаграммы ОФС][architect_organizational_structure_diagram_edit] выберите оргединицу, для которой требуется создать дочернюю оргединицу.
...
### Создание комментария или надписи на диаграмме ОФС
...
1. Дважды нажмите оргединицу в [конструкторе диаграммы ОФС][architect_organizational_structure_diagram_edit].
...
1. Выберите оргединицу в [конструкторе диаграммы ОФС][architect_organizational_structure_diagram_edit].
...
1. Выберите организационную единицу в [конструкторе диаграммы ОФС][architect_organizational_structure_diagram_edit].
2. Откройте панель свойств, нажав кнопку «**Свойства**» <i class="fa-light fa-sidebar-flip"></i>.
...
## Изменение цвета и размера оргединицы на диаграмме ОФС {: #architect_organizational_structure_design_unit_color_change_resize .pageBreakBefore }
...
### Удаление с помощью диаграммы ОФС

1. Выберите оргединицу или несколько оргединиц в [конструкторе диаграммы ОФС][architect_organizational_structure_diagram_edit].
...
- _[Редактирование диаграммы ОФС][architect_organizational_structure_diagram_edit]_
