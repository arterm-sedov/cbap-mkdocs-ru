# N3 Reference — Combined

> Автосборка: этот документ сгенерирован из нескольких исходных файлов. Не редактируйте содержимое ниже вручную — изменяйте исходные файлы.


## Оглавление
- [n3_example_collection_last_item](#n3_example_collection_last_item)
- [n3_presentation_summary_notebook_lm](#n3_presentation_summary_notebook_lm)
- [n3_tutorial_plan_angelina_t](#n3_tutorial_plan_angelina_t)
- [n3_video_transcript_complete_notebook_lm](#n3_video_transcript_complete_notebook_lm)
- [N-Triples](#n-triples)
- [Примеры выражений на N3 для решения различных задач](#примеры-выражений-на-n3-для-решения-различных-задач)
- [Краткое содержание видео](#краткое-содержание-видео)
- [attribute_enum_filter_value_n3](#attribute_enum_filter_value_n3)
- [Находим атрибут EnumAttributeSystemName в шаблоне TemplateSystemName.](#находим-атрибут-enumattributesystemname-в-шаблоне-templatesystemname)
- [attribute_enum_get_data_n3](#attribute_enum_get_data_n3)
- [attribute_enum_set_value_n3](#attribute_enum_set_value_n3)
- [attribute_document_add_file_n3]
- [attribute_document_get_file_n3]
- [attribute_enum_compare_value_n3]

## n3_example_collection_last_item
...
## n3_presentation_summary_notebook_lm
...
## n3_video_transcript_complete_notebook_lm
...
## attribute_enum_filter_value_n3
...
## attribute_document_get_file_csharp
