...
Присваивание с `=` используется для связывания значений переменных и термов внутри выражения, когда синтаксис поддерживается контекстом формы запроса. Подробнее: [Руководство по N3][n3_guide_reference], [Нотация N3][n3_notation].

## Пять типов запросов и поведение интерпретатора {: #tutorial_n3_lesson_1_query_forms }

Интерпретатор выражений в **{{ productName }}** поддерживает пять форм (подробно — [Руководство по N3][n3_guide_reference]):
...
Примечание: используйте фактические предикаты и функции, доступные в **{{ productName }}**, см. каталоги и примеры в [Руководство по N3][n3_guide_reference] и раздел «Примеры».
