...
## Введение {: #n3_guide_reference_introduction }
...
## Синтаксис N3 {: #n3_guide_reference_syntax_n3 }
...
### Синтаксические элементы {: #n3_guide_reference_syntax_elements }
...
### Полезные конструкции и встроенные функции {: #n3_guide_reference_useful_constructions_builtins }
...
### Упрощения {: #n3_guide_reference_simplifications }
...
## Запросы в N3 {: #n3_guide_reference_queries }
...
### Пять видов запросов {: #n3_guide_reference_five_query_types }
...
### Порядок обработки запросов {: #n3_guide_reference_query_processing_order }
...
## Возможности использования выражений N3 {: #n3_guide_reference_n3_usage_capabilities }
...
## Входные и выходные данные выражений в зависимости от контекста {: #n3_guide_reference_io_by_context }
...
## Примеры использования встроенных функций и операторов N3 {: #n3_guide_reference_builtin_functions_examples }

### Функция `?` {: #n3_guide_reference_function_question_mark }
...
### Функция `once` {: #n3_guide_reference_function_once }
...
### Оператор `if` {: #n3_guide_reference_operator_if }
...
### Оператор `from` и функция `sum` {: #n3_guide_reference_operator_from_function_sum }
...
### Функция `count` {: #n3_guide_reference_function_count }
...
### Функция `distinct` {: #n3_guide_reference_function_distinct }
...
### Оператор `union` {: #n3_guide_reference_operator_union }
...
## Примеры использования расширений Comindware для языка N3 {: #n3_guide_reference_extensions_examples }

### Пример 1 {: #n3_guide_reference_example_1 }
...
### Пример 2 {: #n3_guide_reference_example_2 }
...
### Пример 3 {: #n3_guide_reference_example_3 }
...
### Пример 4 {: #n3_guide_reference_example_4 }
...
### Пример 5 {: #n3_guide_reference_example_5 }
...
### Пример 6 {: #n3_guide_reference_example_6 }
...
## Справочник встроенных функций N3 {: #n3_guide_reference_builtins_reference }
...
### Математические функции `w3math` {: #n3_guide_reference_math_functions_w3math }
...
### Математические функции `cmwmath` {: #n3_guide_reference_math_functions_cmwmath }
...
### Функции для работы с датами и временем `w3time` {: #n3_guide_reference_datetime_functions_w3time }
...
### Функции для работы с датами и временем `cmwtime` {: #n3_guide_reference_datetime_functions_cmwtime }
...
### Функции для работы с интервалами времени `cmwduration` {: #n3_guide_reference_duration_functions_cmwduration }
...
### Функции для работы со строками `w3string` {: #n3_guide_reference_string_functions_w3string }
...
### Функции для работы со строками `cmwstring` {: #n3_guide_reference_string_functions_cmwstring }
...
### Функции для работы со строками `cmwlogics` {: #n3_guide_reference_string_functions_cmwlogics }
...
### Функции для работы со строками `cmwentity` {: #n3_guide_reference_string_functions_cmwentity }
...
### Функции для работы со строками `cmwbuiltin` {: #n3_guide_reference_string_functions_cmwbuiltin }
...
### Функции для работы со списками `w3list` {: #n3_guide_reference_list_functions_w3list }
...
### Функции для работы со списками `cmwlist` {: #n3_guide_reference_list_functions_cmwlist }
...
### Функции группировки и сортировки списков `cmwentity` {: #n3_guide_reference_list_group_sort_functions_cmwentity }
...
### Функции логических выражений и логики `cmwassert` {: #n3_guide_reference_logic_functions_cmwassert }
...
### Функции для работы с идентификаторами ресурсов `cmwurl` {: #n3_guide_reference_resource_id_functions_cmwurl }
...
### Функции для работы с идентификаторами ресурсов `cmwui` {: #n3_guide_reference_resource_id_functions_cmwui }
...
### Функции поддерживающие и корректно обрабатывающие нулевые значения `cmwnullable` {: #n3_guide_reference_nullable_functions_cmwnullable }
...
### Функции для работы с изображениями `cmwbuiltin` {: #n3_guide_reference_image_functions_cmwbuiltin }
...
### Специальные функции для работы с аккаунтами и группами `cmwlogics` {: #n3_guide_reference_account_group_functions_cmwlogics }
...
### Специальные функции для работы с аккаунтами и группами `cmwaccount` {: #n3_guide_reference_account_group_functions_cmwaccount }
...
### Специальные функции `cmwobject` {: #n3_guide_reference_special_functions_cmwobject }
...
### Специальные функции `cmwcontext` {: #n3_guide_reference_special_functions_cmwcontext }
