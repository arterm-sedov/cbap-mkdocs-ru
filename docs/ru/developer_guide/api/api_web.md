...
## Доступ к Web API {: #api_web_access }
...
## Использование Swagger {: #api_web_swagger }
...
URL-адрес JSON-спецификации Web API:

```
https://your-host/swagger/WebApi/v1
```
...
## Описание методов Web API {: #api_web_methods }

### Аккаунт — отдельные аккаунты {: #api_web_account }
...
### AccountTemplate — шаблоны аккаунтов и связанные с ними аккаунты {: #api_web_account_template }
...
### Attribute — атрибуты шаблона {: #api_web_attribute }
...
### Backup — резервное копирование конфигураций и сессий {: #api_web_backup }
...
| POST {: .api-method .post } | /webapi/Backup/Session/CreateRecord |
| --------------------------- | ----------------------- |
| **Описание**                 | Создает запись сеанса резервного копирования. |
| **Параметры**                | Объект сеанса резервного копирования. |
| **Ответ**                    | Объект статуса.         |

| PUT {: .api-method .put } | /webapi/Backup/Session/UpdateRecord |
| --------------------------- | ----------------------- |
| **Описание**                 | Обновляет запись сеанса резервного копирования. |
| **Параметры**                | Объект сеанса резервного копирования. |
| **Ответ**                    | Объект статуса.         |

### BehaviourState — сценарии и элементы процессов {: #api_web_behaviour_state }
...
### CaseTemplate — шаблоны кейсов (не используются) {: #api_web_case_template }
...
### Dataset — таблицы {: #api_web_dataset }
...
### Document — файлы, прикрепленные к атрибутам типа «документ» {: #api_web_document }
...
### DocumentExportTemplate — шаблоны экспорта {: #api_web_document_export_template }
...
### Form — формы и правила для форм (кроме стартовых форм процессов и форм пользовательских задач) {: #api_web_form }
...
### SolutionGitIntegration — контроль версий приложений через Git {: #api_web_solution_git_integration }
...
### Heartbeat — мониторинг состояния сервера, процессов, скриптов и служб {: #api_web_heartbeat }
...
### Image — изображения {: #api_web_image }

| GET {: .api-method .get } | /webapi/Image |
| --------------------------- | -------------- |
| **Описание**                | Получает изображение по указанному идентификатору файла. |
| **Параметры**               | Идентификатор изображения. |
| **Ответ**                   | Объект изображения. |

| PUT {: .api-method .put } | /webapi/Image |
| --------------------------- | -------------- |
| **Описание**                | Изменяет изображение на основе файла. |
| **Параметры**               | Идентификатор изображения, объект изображения. |
| **Ответ**                   | Объект статуса. |

| POST {: .api-method .post } | /webapi/Image/Create |
| --------------------------- | -------------------- |
| **Описание**                | Создает изображение из содержимого. |
| **Параметры**               | Файл изображения. |
| **Ответ**                   | Объект изображения. |

### License — лицензии {: #api_web_license }

| GET {: .api-method .get } | /webapi/License/DeleteSession |
| --------------------------- | ------------------------------ |
| **Описание**                | Удаляет указанный сеанс пользователя или все сеансы пользователя. |
| **Параметры**               | Идентификатор аккаунта, идентификатор сеанса. |
| **Ответ**                   | Объект статуса. |

| GET {: .api-method .get } | /webapi/License/GetLicenseStatus |
| --------------------------- | --------------------------------- |
| **Описание**                | Получает статус лицензирования. |
| **Параметры**               | Не требуются. |
| **Ответ**                   | Объект статуса лицензирования. |

| GET {: .api-method .get } | /webapi/License/GetSessions |
| --------------------------- | ----------------------------- |
| **Описание**                | Получает сеансы. |
| **Параметры**               | Идентификатор аккаунта. |
| **Ответ**                   | Массив объектов сеансов. |

| GET {: .api-method .get } | /webapi/License/GetUserLicense |
| --------------------------- | ------------------------------ |
| **Описание**                | Получает статус лицензирования аккаунта. |
| **Параметры**               | Идентификатор аккаунта. |
| **Ответ**                   | Объект статуса лицензирования аккаунта. |

### ProcessObjects — миграция версии диаграммы процесса {: #api_web_process_objects }
...
### ProcessTemplate — шаблоны процессов {: #api_web_process_template }
...
### Record — одна запись (кроме шаблонов процессов) {: #api_web_record }
...
### Records — несколько записей и экспорт/импорт записей (кроме шаблонов процессов) {: #api_web_records }
...
### RecordTemplate — шаблоны записей {: #api_web_record_template }
...
### ReferenceData — записи с указанными значениями атрибутов {: #api_web_reference_data }
...
| POST {: .api-method .post } | /webapi/ReferenceData/List |
| --------------------------- | -------------------------- |
| **Описание**                 | Получает список записей с указанными значениями ключевых атрибутов. |
| **Параметры**                | Объект глобального псевдонима шаблона, объект с ключевыми системными именами атрибутов и значениями, массив системных имён атрибутов, которые необходимо получить. |
| **Ответ**                    | Массив объектов со значениями атрибутов записей. |
...
### Solution — приложения {: #api_web_solution }
...
### Toolbar — области кнопок и кнопки на них {: #api_web_toolbar }
...
### Transfer — экспорт/импорт модели приложения {: #api_web_transfer }
...
### UserCommand — кнопки {: #api_web_user_command }
