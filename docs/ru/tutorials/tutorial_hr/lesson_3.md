...
## Построение диаграммы бизнес-процесса {: #tutorial_hr_lesson_3_bpmn_configure }
...
### Настройка пула и дорожек {: #tutorial_hr_lesson_3_bpmn_configure_pool }
...
2. Отобразится конструктор диаграммы процесса.
    ...
    !!! question "Конструктор диаграммы процесса"
        ...
        {%
        include-markdown "business_apps/diagrams/process_diagram/index.md"
        start="<!--process-diagram-designer-definitions-start-->"
        end="<!--process-diagram-designer-definitions-end-->"
        rewrite-relative-urls=false
        %}
...
8. Чтобы переименовать дорожку, нажмите её правой кнопкой мыши и в раскрывающемся меню элемента нажмите кнопку «**Настроить**» <i class="fa-light fa-gear"></i>.
...
### Настройка элементов диаграммы {: #tutorial_hr_lesson_3_bpmn_configure_elements }

1. Удалите конечное событие. Для этого нажмите его правой кнопкой мыши и в меню элемента нажмите кнопку «**Удалить**» <i class="fa-light fa-trash-can"></i>.

    _![Удаление элемента диаграммы процесса](img/lesson_3_end_event_delete.png)_

2. Чтобы переименовать стартовое событие, нажмите его правой кнопкой мыши и в раскрывающемся меню элемента нажмите кнопку «**Настроить**» <i class="fa-light fa-gear"></i>.
3. В отобразившемся окне «**Свойства начального события**» введите новое название _«Проведено тестирование кандидата»_ и нажмите кнопку «**Сохранить**».
4. Перетащите элемент «**Пользовательская задача**» из раздела «**Действия**» с левой панели на дорожку _«HR-менеджер»_.
...
5. Присвойте задаче название:
    ...
    - На вкладке «**Основные**» введите **название** _«Зафиксировать результаты тестирования»_.
    - На вкладке «**Дополнительные**» введите **заголовок задачи** _«Зафиксировать результаты тестирования»_.

6. Присоедините **поток управления** от начального события к пользовательской задаче _«Зафиксировать результаты тестирования»._
7. Перетащите элемент «**Развилка** «**или/или**» на диаграмму и соедините его с задачей _«Зафиксировать результаты тестирования»_.
...
9. Присвойте развилке название _«Кандидат прошёл тестирование?»_. Для этого дважды нажмите развилку или нажмите кнопку «**Настроить**» <i class="fa-light fa-gear"></i> в меню элемента и введите новое название.
...
10. К развилке _«Кандидат прошёл тестирование?»_ присоедините потоками управления два новых элемента:
...
11. Нажмите развилку правой кнопкой мыши и в меню элемента нажмите кнопку «**Настроить**» <i class="fa-light fa-gear"></i>.
12. Отобразится окно «**Свойства развилки «или/или**».
13. На вкладке «**Дополнительные**» укажите названия исходящих потоков — _«Да»_ и _«Нет»_. Для этого дважды нажмите соответствующие поля.
...
16. Добавьте ещё одну **развилку «и»** и соедините с ней задачи _«Провести собеседование»_ и _«Провести проверку кандидата»_.
...
19. Присвойте развилке название _«Кандидат прошёл проверку?»_. Для этого дважды нажмите развилку или нажмите кнопку «**Настроить**» <i class="fa-light fa-gear"></i> в меню элемента и введите новое название.
20. К развилке _«Кандидат прошёл проверку?»_ присоедините потоками управления два новых элемента:
...
21. В свойствах задачи _«Сформировать и согласовать предложение с кандидатом»_ скопируйте **название** с вкладки «**Основные**» в **заголовок задачи** на вкладке «**Дополнительные**».
22. В свойствах развилки _«Кандидат прошёл проверку?»_ укажите названия исходящих потоков — _«Да»_ и _«Нет»_.
24. К задаче _«Сформировать и согласовать предложение с кандидатом»_ присоедините потоком управления **конечное событие** _«Кандидат принят на работу»_.
25. В итоге должна получиться следующая диаграмма:
...
1. Нажмите правой кнопкой мыши задачу _«Зафиксировать результаты тестирования»_ и в меню элемента нажмите кнопку «**Форма**» <i class="fa-light fa-newspaper"></i>.
...
1. Нажмите правой кнопкой мыши задачу _«Провести собеседование»_ и в меню элемента нажмите кнопку «**Форма**» <i class="fa-light fa-newspaper"></i>.
...
1. Нажмите правой кнопкой мыши задачу _«Сформировать и согласовать предложение с кандидатом»_ и в меню элемента нажмите кнопку «**Форма**» <i class="fa-light fa-newspaper"></i>.
...
## Настройка развилок {: #tutorial_hr_lesson_3_gateway_configure }
...
1. Нажмите правой кнопкой мыши развилку _«Кандидат прошёл тестирование?»_ и в меню элемента нажмите кнопку «**Настроить**» <i class="fa-light fa-gear"></i>.
...
1. Нажмите правой кнопкой мыши развилку _«Кандидат прошёл проверку?»с_ и в меню элемента нажмите кнопку «**Настроить**» <i class="fa-light fa-gear"></i>.
2. Перейдите на вкладку «**Дополнительные**».
...
[](){: #process_diagram_verify }
[](){: #process_diagram_publish }
...
1. Нажмите кнопку «**Проверить**» <i class="fa-light fa-circle-exclamation-check"></i> в конструкторе диаграммы процесса.
...
1. Откройте шаблон процесса _«Найм персонала»_.
2. На странице «**Свойства**» нажмите кнопку «**Перейти к экземплярам**».
3. Отобразится список экземпляров процесса _«Найм персонала»_.
...
6. В списке задач должна отображаться первая задача _«Найм персонала»_ — _«Зафиксировать результаты тестирования»_.
7. Откройте задачу _«Зафиксировать результаты тестирования»_.
8. Установите флажок _«Результат тестирования»_.
9. Нажмите кнопку «**Сохранить**», чтобы сохранить запись в шаблоне _«Кандидаты»_, связанную с процессом.
10. Нажмите кнопку «**Завершить задачу**», чтобы перейти к следующей задаче.
11. Убедитесь, что на странице «**Мои задачи**» появились две новые задачи _«Провести собеседование»_ и _«Провести проверку кандидата»_.
12. Завершите обе задачи, установив флажок _«Результат собеседования»_.
13. Убедитесь, что появилась задача _«Сформировать и согласовать предложение с кандидатом»_.
14. Завершите задачу _«Сформировать и согласовать предложение с кандидатом»_.
