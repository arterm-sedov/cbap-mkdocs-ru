...
# Урок 9. Формирование документов {: #tutorial_fleet_lesson_9 }
...
**Предусловие:** пройден _[урок 6 «Усовершенствованный процесс»][tutorial_fleet_lesson_6]_.
...
!!! note "Примечание"
    ...
    Если вы прошли _[Урок 8 _«Аккаунты, группы и роли»_][tutorial_fleet_lesson_8]_, пользовательские задачи назначаются разным аккаунтам.
