---
title: 'Урок 4. Автоматизированные процессы и согласование архитектурных моделей'
kbId: 5128
tags:
...
# Урок 4. Автоматизированные процессы и согласование архитектурных моделей {: #tutorial_architect_lesson_4 }
...
- Использование автоматизированных процессов в сочетании с архитектурными моделями предприятия
...
- Настраивать и выполнять автоматизированные процессы
- Интегрировать автоматизированные процессы с архитектурными моделями
- Настраивать атрибуты и формы архитектурных моделей
- Настраивать автоматизированные пользовательские задачи
...
### Настройка автоматизированного процесса «Согласование процесса» {: #tutorial_architect_lesson_4_executable_process }

Настроим автоматизированный процесс, который позволит согласовывать изменения в процессной модели предприятия.
...
6. Откроется диаграмма автоматизированного процесса для редактирования.
...
16. Поместите атрибут _«Согласован»_ на область _«Решение по согласованию процесса»_.
