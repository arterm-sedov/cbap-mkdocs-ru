...
- [Шаблон исполняемого процесса][process_templates]
- [Диаграмма исполняемого процесса. Настройка][process_diagram]
- [Элементы диаграммы исполняемого процесса][process_diagram_elements]
- [Стартовая форма и форма пользовательской задачи исполняемого процесса. ][process_diagram_forms]
