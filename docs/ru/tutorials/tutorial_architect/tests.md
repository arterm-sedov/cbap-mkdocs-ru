...
## Урок 4. Автоматизированные процессы, согласование и контроль изменений архитектурных моделей {: #tutorial_architect_tests_lesson_4 }
...
### 4.3. Настройка шаблона модели и форм {: #tutorial_architect_tests_practice_4_3 }
