...
#### Синтаксис CSS {: #themes_custom_css .pageBreakBefore }
...
#### Правила применения пользовательских стилей {: #themes_custom_css_rules .pageBreakBefore }
...
#### Рекомендации по использованию CSS в {{ productName }} {: #themes_custom_css_recommendations .pageBreakBefore }
...
- **Группировка стилей** — логически группируйте стили: _цвета, типографику, кнопки, формы, таблицы_.
