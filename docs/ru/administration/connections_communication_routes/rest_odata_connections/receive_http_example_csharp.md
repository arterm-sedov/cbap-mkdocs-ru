---
title: 'HTTP-запросы. Получение JSON-данных в сценарии с помощью C#'
kbTitle: 'HTTP-запросы. Получение JSON-данных с помощью C#-скрипта. Настройка подключения, пути передачи данных и сценария'
kbId: 5142
tags:
    - C#
    - HTTP-запрос
