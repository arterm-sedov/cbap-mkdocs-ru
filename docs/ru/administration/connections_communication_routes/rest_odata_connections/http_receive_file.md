...
## Введение {: #http_receive_file_intro }
...
## Прикладная задача {: #http_receive_file_use_case }
...
## Порядок настройки получения HTTP-запросов {: #http_receive_file_sequence .pageBreakBefore }

1. Настройте [шаблон записи](#http_receive_file_template) для хранения полученных данных.
--8<-- "http_receive_configure_sequence.md"

## Настройка шаблона записи {: #http_receive_file_template }
...
## Настройка подключения {: #http_receive_file_connection }
...
## Настройка пути передачи данных {: #http_receive_file_route }
...
### Интеграция {: #http_receive_file_route_integration .pageBreakBefore }
...
[](){: #scenario_configure }
## Настройка сценария {: #http_receive_file_scenario }
...
[](){: #testing }
## Тестирование {: #http_receive_file_testing .pageBreakBefore }
