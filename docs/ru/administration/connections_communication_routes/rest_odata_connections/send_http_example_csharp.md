---
title: 'HTTP-запросы. Отправка JSON-данных из сценария с помощью C#'
kbTitle: 'HTTP-запросы POST. Отправка JSON-данных и обработка ответа с помощью C#-скриптов. Настройка подключения, пути передачи данных и сценария'
kbId: 5141
tags:
    - C#
    - HTTP-запрос
...
# HTTP-запросы POST. Отправка JSON-данных из сценария с помощью C# {: #http_send_example_csharp }
