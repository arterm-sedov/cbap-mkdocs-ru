---
title: 'HTTP-запросы. Отправка JSON/XML из сценария с помощью C#'
kbTitle: 'HTTP-запросы POST. Отправка JSON/XML и обработка ответа с помощью C#-скриптов. Настройка подключения, пути передачи данных и сценария'
kbId: 5141
tags:
    - C#
    - HTTP-запрос
