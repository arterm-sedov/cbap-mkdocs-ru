...
Системные уведомления служат для передачи **конкретным пользователям** информации в ходе выполнения сценариев и могут содержать любые бизнес-данные. Они позволяют выводить:

- сведения о событиях, происходящих в сценариях;
- информацию в информационной панели;
- push-сообщения.
