...
!!! warning "Ограничения некоторых S3‑совместимых сервисов"
    ...
    Если вам необходимо отправлять в S3 файлы больше лимита, установленного вашим поставщиком S3, обратитесь в службу поддержки **{{ companyName }}** для настройки конфигурации **{{ productName }}**.
