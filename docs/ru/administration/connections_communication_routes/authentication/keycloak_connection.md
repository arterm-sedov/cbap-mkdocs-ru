...
!!! note "Использование нескольких доменов и каталогов"
    ...
    - **{{ productName }}** интегрируется с одним поставщиком идентификации (Keycloak или AD FS), а поддержка нескольких доменов и источников учётных записей настраивается вне **{{ productName }}**, в инфраструктуре служб идентификации организации (Keycloak, AD FS, домены Active Directory, LDAP и т.&nbsp;п.).
