...
### Потенциальные расходы и риски, связанные с использованием сервисов третьих сторон {: #third_party_services_disclaimer_risks }

Использование сервисов третьих сторон в сочетании с **{{ productName }}** может быть сопряжено с дополнительными расходами и рисками, перечисленными ниже. Компания **{{ companyName }}** не гарантирует отсутствие таких расходов и рисков.
...
- **иметь план отката** на случай сбоев или недоступности сторонних сервисов.
