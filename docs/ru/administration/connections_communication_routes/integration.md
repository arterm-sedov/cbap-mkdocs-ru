...
## Использование сервисов третьих сторон {: #third_party_services_disclaimer }

<div class="admonition warning" markdown="block">

### Ответственность за использование сервисов третьих сторон {: #third_party_services_disclaimer_responsibility }

{% include-markdown
".snippets/disclaimer_third_party_services.md"
start="<!-- third-party-services-disclaimer-start -->"
end="<!-- third-party-services-disclaimer-end -->"
%}

</div>

### Потенциальные риски и расходы, связанные с использованием сервисов третьих сторон {: #third_party_services_disclaimer_risks }

!!! danger "Внимание!"

    Компания **{{ companyName }}** не гарантирует отсутствие рисков и расходов, возникающих в связи с использованием сервисов третьих сторон.
    
    **{{ companyName }}** не делает никаких заявлений относительно возможности корректной работы каких бы то ни было сервисов третьих сторон в сочетании с **{{ productName }}** или взаимодействия с такими сервисами будь то напрямую или через цепочку промежуточных систем.
...
- **Негативное влияние** сервисов третьих сторон на работу **{{ productName }}**. См. _«[Сервисы, способные изменить работу приложений и процессов][third_party_services_types]»_.
...
### Потенциальные риски и расходы, связанные с использованием данных и результатов работы сервисов третьих сторон {: #third_party_services_data_disclaimer_risks }

!!! danger "Внимание!"

    Компания **{{ companyName }}** не гарантирует отсутствие таких рисков, не несёт какой бы то ни было ответственности за данные, передаваемые между **{{ productName }}** и сервисами третьих сторон (в том числе по цепочке через любые промежуточные системы), а также не делает никаких заявлений и не даёт никаких гарантий относительно целостности, допустимости, безопасности, конфиденциальности и безошибочности (не ограничиваясь перечисленным) таких данных.

    Результаты деятельности любых сервисов третьих сторон и ПО не могут считаться позицией, заявлением или мнением **{{ companyName }}**, а также не могут расцениваться как совет, рекомендация или руководство при принятии решений или совершении каких-либо действий в **{{ productName }}**, иных системах и каких бы то ни было процессах.

    Любые данные, переданные из **{{ productName }}** в сторонние сервисы или системы или полученные из таковых, считаются скомпрометированными, так как **{{ companyName }}** не может ни коим образом контролировать и не несёт ответственности за целостность, сохранность, точность, достоверность, допустимость и безопасность таких данных.
...
### Сервисы, способные изменить работу приложений и процессов {: #third_party_services_types }
...
### Рекомендации по использованию сервисов третьих сторон {: #third_party_services_recommendations }
...
Подробные сведения об ответственности и ограничениях использования сервисов третьих сторон см. в _**[Лицензионном соглашении конечного пользователя ПО {{ companyName }}][legal_policies]**_.
