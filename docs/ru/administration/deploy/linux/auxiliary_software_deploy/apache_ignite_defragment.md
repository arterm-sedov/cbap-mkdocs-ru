...
2. Скачайте бинарный дистрибутив {{ apacheIgniteVariants }}, например [apache-ignite-2.18.0-bin.zip](https://downloads.apache.org/ignite/2.18.0/apache-ignite-2.18.0-bin.zip) или более новую версию.
