...
7. Установите следующие директивы:
    ...
    !!! tip "Оптимальное значение vm.max_map_count"
        ...
        Определите оптимальное значение `vm.max_map_count` согласно инструкциям в параграфе «[Настройка параметра vm.max_map_count][deploy_guide_linux_vm_max_map_count]».
...
## Оптимизация параметра vm.max_map_count {: #deploy_guide_linux_vm_max_map_count } 
