...
Инструкции даны для обновления с версий 4.7.2 до версий 4.7.3–{{ productVersion }} в ОС Windows.
...
{: #dataUpgrade }
    ...
    !!! warning "Внимание!"
        ...
        При обновлении с версии 4.7.2 на версии 4.7.3–{{ productVersion }} обновляется структура базы данных.
