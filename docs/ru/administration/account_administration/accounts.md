...
## Обязательные атрибуты и уникальность аккаунтов {: #accounts_required_unique .pageBreakBefore }
...
### Дополнительные требования к атрибутам {: #accounts_required_unique_extra }
...
- **Настройка с помощью {{ productName }}** — необходимо задать:
    ...
    См. «_[Просмотр списка, создание и настройка аккаунта](#accounts_view_and_configure)»_.
...
- **Настройка через API**
    ...
    См. _«[Методы System Core API][api_system_core_account_service]»_.
...
- **Синхронизация с сервером каталогов** — **на стороне сервера каталогов** необходимо задать значения следующих атрибутов (они не должны быть пустыми и не должны иметь значение `Null`):
    ...
    См. _«[Синхронизация с сервером каталогов (Active Directory)][accounts_dc_sync]»_.

## Просмотр списка, создание и настройка аккаунтов {: #accounts_view_and_configure .pageBreakBefore }
...
!!! warning "Замещения должны быть включены в конфигурации ПО"

    Для настройки замещений, они должны быть включены в конфигурации **{{ productName }}**.
    
    См. _«[Замещения. Настройка конфигурации][substitution_configuration]»_.
...
- [Методы System Core API][api_system_core_account_service]
