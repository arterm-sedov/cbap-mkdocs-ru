...
<!--process-diagram-designer-definitions-start-->
...
<!--process-diagram-designer-definitions-end-->
...
1. Выберите способ публикации диаграммы:
...
#### Начальное событие любого типа {: #process_diagram_errors_event_start }
