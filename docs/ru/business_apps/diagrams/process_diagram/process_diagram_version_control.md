...
5. При необходимости нажмите кнопку «**Редактировать**» <i class="fa-light fa-pen-nib"></i>, чтобы [изменить][process_diagram_designer] и опубликовать новую версию диаграммы на основе **текущей** черновой.

!!! note "Примечание"

    - При [редактировании][process_diagram_designer] диаграммы будет создан её черновик с названием «**Текущая версия**».
