...
5. Выбранная версия будет восстановлена для редактирования. Неопубликованные изменения диаграммы будут утрачены. Выбранная версия станет текущей до тех пор, пока не будет опубликована.
