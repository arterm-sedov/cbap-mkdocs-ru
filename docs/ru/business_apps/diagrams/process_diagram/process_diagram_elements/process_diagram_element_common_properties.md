...
2. Нажмите кнопку «**Настроить**» <i class="fa-light fa-gear"></i> в меню элемента.
...
4. Настройте и сохраните элемент.
    ...
    _![Настройка общих свойств элемента диаграммы процесса](img/process_diagram_element_common_properties.png)_
