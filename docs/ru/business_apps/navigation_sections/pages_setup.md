...
3. Настройте **свойства виджета**:
    ...
    - **Тип** — выберите тип диаграммы:
        ...
        - **Гистограмма**
            ...
            - **Воронка** — отобразить горизонтальную гистограмму в виде воронки с убывающимися сверху вниз столбцами. Чем выше показатель, тем шире столбец. Доступно только для горизонтальной гистограммы.
        - **График**
