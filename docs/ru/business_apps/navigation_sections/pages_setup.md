...
## Настройка свойств и макета страницы {: #pages_setup_layout_configure }
...
## Добавление страницы в раздел навигации или на рабочий стол {: #pages_setup_add_to_navigation .pageBreakBefore }
...
### Область {: #pages_setup_area .pageBreakBefore }
...
### Баннер {: #pages_setup_banner .pageBreakBefore }
...
### Витрина {: #pages_setup_showcase .pageBreakBefore }
...
### Временная шкала {: #pages_setup_timeline .pageBreakBefore }
...
#### Настройка шаблона работ {: #pages_setup_timeline_template }
...
#### Настройка виджета временной шкалы {: #pages_setup_timeline_widget .pageBreakBefore }
...
### Диаграмма {: #pages_setup_diagram .pageBreakBefore }
...
3. Настройте **свойства виджета**:
    ...
    - **Сортировать по** — выберите способ упорядочивания категорий на диаграмме:
        ...
        !!! tip "Пример сортировки на гистограмме"

            На гистограмме, сгруппированной по атрибуту _Статус_ с параметром **Вычислять** = **Количество**:
    ...
    - **Детализация данных** — настройте таблицу со сводными данными записей, по которым построена диаграмма. Эта таблица будет отображаться при нажатии сектора, столбца или графика на диаграмме.
        ...
        --8<-- "charts_details_config.md"

        !!! warning "Кнопки для таблицы"
...
### Карусель и плитки {: #pages_setup_carousel_tiles .pageBreakBefore }
...
### Показатели {: #pages_setup_metrics .pageBreakBefore }
...
### Системные виджеты {: #pages_setup_system_widgets .pageBreakBefore }
...
### Список {: #pages_setup_list .pageBreakBefore }
...
### Шаги {: #pages_setup_steps .pageBreakBefore }
