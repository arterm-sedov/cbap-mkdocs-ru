...
- **Нижняя мобильная навигация** — набор кнопок, отображающихся в нижней части экрана в приложении **{{ productNameMobile }}** и в мобильных браузерах.

</div>

_![Панель и разделы навигации](img/navigation_panel.png)_

## Просмотр списка и настройка разделов навигации {: #navigation_section_setup_view}
