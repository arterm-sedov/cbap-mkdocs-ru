...
Общая методология работы со средами разработки и эксплуатации, версиями приложений, релизами и откатами описана в статье *«[Методология управления версиями приложений][version_control_methodology]»*. В данной статье рассматриваются функциональные шаги экспорта и импорта версий с помощью файлов Excel.
