...
Рекомендуемая методология работы со средами разработки и эксплуатации, ветками, релизами и откатами описана в статье *«[Методология управления версиями приложений][version_control_methodology]»*. Настоящая статья фокусируется на настройке и использовании страницы **«Управление версиями через Git»**.
