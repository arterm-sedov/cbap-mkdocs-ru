...
4. Выполните необходимые операции:
    ...
    - **Экспортировать в Git** — [экспорт](#version_control_git_export) текущей версии приложения в ветку, выбранную при [инициализации](#version_control_git_initialization) репозитория Git.
