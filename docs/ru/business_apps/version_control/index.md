...
Рекомендуемая методология настройки приложений, работы со средами разработки и эксплуатации, ветками {{ gitVariants }}, релизами и откатами описана в отдельной статье *«[Методология управления версиями приложений][version_control_methodology]»*.
...
Часть сущностей при импорте может быть удалена или заменена, если они отсутствуют в импортируемой версии приложения. Подробнее см. раздел «Особенности импорта и экспорта приложения» статьи *«[Методология управления версиями приложений][version_control_methodology]»*.
