...
## Настройка пути передачи данных {: #ai_feature_guide_route_configure }
...
фд### Предварительные условия {: #ai_feature_guide_agents_prerequisites }
...
1. 
2. Настройте событие «**Получение сообщения из чата**»
...
#### 2. Формирование сообщения для LLM {: #ai_feature_guide_form_message_llm }
...
#### 3. Отправка сообщения в LLM {: #ai_feature_guide_send_llm }
...
#### 4. Условия обработки ответа LLM {: #ai_feature_guide_conditions_llm }
...
#### 5. Формирование операций (кнопок) {: #ai_feature_guide_form_operations }
...
#### 6. Отправка ответа агента в чат пользователю {: #ai_feature_guide_send_to_chat }
