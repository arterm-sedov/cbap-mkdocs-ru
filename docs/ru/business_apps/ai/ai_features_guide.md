...
- сценарий классифицирует сообщение с помощью LLM;
- сценарий формирует набор операций;
- сценарий отправляет в чат пользователю сообщение с ответом и сформированными операциями посредством действия «**Отправить сообщение в чат**»;
