...
kbTitle: Возможности ИИ. Настройка адаптера, low-code-агентов и тестирование mock-операций
tags:
  - AI
  - low-code-агенты
  - mock-операции
...
# Возможности ИИ. Настройка адаптера, low-code-агентов и тестирование mock-операций {: #ai_features_guide }
