...
## Создание файла шаблона экспорта {: #export_template_file_configure_create }
...
### Синтаксис для экспорта без использования C\# {: #export_template_file_configure_syntax_without_csharp }
...
#### Синтаксис C# для XLSX-файлов {: #export_template_file_configure_csharp_xlsx }
...
### Решение для Word {: #export_template_file_configure_word_solution }
...
### Решение для Excel {: #export_template_file_configure_excel_solution .pageBreakBefore }
...
#### Вариант 1. Установка шрифтов на сервер {: #export_template_file_configure_option1_install_fonts }
...
#### Вариант 2. Использование шрифтов с сервера в Excel {: #export_template_file_configure_option2_server_fonts }
