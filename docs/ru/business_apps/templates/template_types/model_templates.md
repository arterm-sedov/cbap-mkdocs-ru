...
- **Шаблон модели** служит для определения свойств и хранения моделей **[корпоративной архитектуры][architect_description]** и их экземпляров (элементов корпоративной архитектуры). Шаблон модели содержит **[атрибуты][attributes]**, формы и другие данные модели. Используется аналогично **[шаблону записи][record_templates]**. Шаблон модели можно связать с другими шаблонами. **Шаблон модели процесса** можно преобразовать в **[шаблон автоматизированного процесса][process_templates]**.
- **Элемент архитектуры** — это экземпляр модели корпоративной архитектуры (процесс, группа процессов, задача, событие, оргединица и т.&nbsp;п.), определяемый соответствующим шаблоном модели и хранящийся в нём. Для каждого типа элементов корпоративной архитектуры предусмотрен отдельный шаблон.
